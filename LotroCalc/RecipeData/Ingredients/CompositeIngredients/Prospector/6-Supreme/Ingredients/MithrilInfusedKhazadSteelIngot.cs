...
{
    public class MithrilInfusedKhazadSteelIngot : SupremeIngredients
    {
        public static string DisplayName = "Mithril-Infused Khazad-steel Ingot";

        public MithrilInfusedKhazadSteelIngot(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MithrilInfusedKhazadSteelIngot(QuantityRequested);
        }
