...
{
    public class HighGradeSteelIngots : ExpertIngredients
    {
        public static string DisplayName = "High-grade Steel Ingot";

        public HighGradeSteelIngots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HighGradeSteelIngots(QuantityRequested);
        }
