...
{
    public class AncientSteelIngot : MasterIngredients
    {
        public static string DisplayName = "Ancient Steel Ingot";

        public AncientSteelIngot(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientSteelIngot(QuantityRequested);
        }
