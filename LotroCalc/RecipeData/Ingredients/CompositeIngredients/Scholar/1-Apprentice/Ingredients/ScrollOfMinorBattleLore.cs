...
{
    public class ScrollOfMinorBattleLore : ApprenticeIngredients
    {
        public static string DisplayName = "Scroll Of Minor Battle Lore";

        public ScrollOfMinorBattleLore(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ScrollOfMinorBattleLore(QuantityRequested);
        }
