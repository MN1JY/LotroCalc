...
{
    public class PureLightoil : SupremeIngredients
    {
        public static string DisplayName = "Pure Light-oil";

        public PureLightoil(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PureLightoil(QuantityRequested);
        }
