...
{
    public class SteepedConhuithDraught : SupremeIngredients
    {
        public static string DisplayName = "Steeped Conhuith Draught";

        public SteepedConhuithDraught(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SteepedConhuithDraught(QuantityRequested);
        }
