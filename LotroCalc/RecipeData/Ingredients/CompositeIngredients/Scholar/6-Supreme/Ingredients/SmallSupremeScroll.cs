...
{
    public class SmallSupremeScroll : SupremeIngredients
    {
        public static string DisplayName = "Small Supreme Scroll (Guild)";

        public SmallSupremeScroll(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallSupremeScroll(QuantityRequested);
        }
