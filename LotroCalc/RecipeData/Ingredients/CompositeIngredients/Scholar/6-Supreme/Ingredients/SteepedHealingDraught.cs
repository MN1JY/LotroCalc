...
{
    public class SteepedHealingDraught : SupremeIngredients
    {
        public static string DisplayName = "Steeped Healing Draught";

        public SteepedHealingDraught(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SteepedHealingDraught(QuantityRequested);
        }
