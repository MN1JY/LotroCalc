...
{
    public class ReforgedMinstrelsSongbookoftheSecondAge : SupremeIngredients
    {
        public static string DisplayName = "Reforged Minstrel's Songbook of the Second Age (Level 60)";

        public ReforgedMinstrelsSongbookoftheSecondAge(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedMinstrelsSongbookoftheSecondAge(QuantityRequested);
        }
