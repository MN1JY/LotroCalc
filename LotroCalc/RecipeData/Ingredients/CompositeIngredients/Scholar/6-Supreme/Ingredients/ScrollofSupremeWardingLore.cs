...
{
    public class ScrollofSupremeWardingLore : SupremeIngredients
    {
        public static string DisplayName = "Scroll of Supreme Warding Lore";

        public ScrollofSupremeWardingLore(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ScrollofSupremeWardingLore(QuantityRequested);
        }
