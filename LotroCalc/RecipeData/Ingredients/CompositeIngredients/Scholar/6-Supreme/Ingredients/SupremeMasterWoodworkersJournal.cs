...
{
    public class SupremeMasterWoodworkersJournal : SupremeIngredients
    {
        public static string DisplayName = "Supreme Master Woodworker's Journal";

        public SupremeMasterWoodworkersJournal(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SupremeMasterWoodworkersJournal(QuantityRequested);
        }
