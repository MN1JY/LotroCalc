...
{
    public class SteepedMilkthistleDraught : SupremeIngredients
    {
        public static string DisplayName = "Steeped Milkthistle Draught";

        public SteepedMilkthistleDraught(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SteepedMilkthistleDraught(QuantityRequested);
        }
