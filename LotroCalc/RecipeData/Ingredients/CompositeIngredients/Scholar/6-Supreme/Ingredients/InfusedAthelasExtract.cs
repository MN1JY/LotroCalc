...
{
    public class InfusedAthelasExtract : SupremeIngredients
    {
        public static string DisplayName = "Infused Athelas Extract (Guild)";

        public InfusedAthelasExtract(int count)
        {
            Name = DisplayName;
        ...
        {
            return new InfusedAthelasExtract(QuantityRequested);
        }
