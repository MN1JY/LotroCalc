...
{
    public class BowChantSupremeShieldbane : SupremeIngredients
    {
        public static string DisplayName = "Bow Chant: Supreme Shield-bane";

        public BowChantSupremeShieldbane(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BowChantSupremeShieldbane(QuantityRequested);
        }
