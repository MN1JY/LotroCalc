...
{
    public class SupremeMasterWeaponsmithsJournal : SupremeIngredients
    {
        public static string DisplayName = "Supreme Master Weaponsmith's Journal";

        public SupremeMasterWeaponsmithsJournal(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SupremeMasterWeaponsmithsJournal(QuantityRequested);
        }
