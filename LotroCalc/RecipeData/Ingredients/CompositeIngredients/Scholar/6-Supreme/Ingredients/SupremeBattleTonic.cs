...
{
    public class SupremeBattleTonic : SupremeIngredients
    {
        public static string DisplayName = "Supreme Battle Tonic";

        public SupremeBattleTonic(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SupremeBattleTonic(QuantityRequested);
        }
