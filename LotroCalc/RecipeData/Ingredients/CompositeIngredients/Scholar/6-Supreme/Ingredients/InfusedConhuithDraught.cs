...
{
    public class InfusedConhuithDraught : SupremeIngredients
    {
        public static string DisplayName = "Infused Conhuith Draught";

        public InfusedConhuithDraught(int count)
        {
            Name = DisplayName;
        ...
        {
            return new InfusedConhuithDraught(QuantityRequested);
        }
