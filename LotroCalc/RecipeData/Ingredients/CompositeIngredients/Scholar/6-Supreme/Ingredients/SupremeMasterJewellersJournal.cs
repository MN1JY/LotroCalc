...
{
    public class SupremeMasterJewellersJournal : SupremeIngredients
    {
        public static string DisplayName = "Supreme Master Jeweller's Journal";

        public SupremeMasterJewellersJournal(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SupremeMasterJewellersJournal(QuantityRequested);
        }
