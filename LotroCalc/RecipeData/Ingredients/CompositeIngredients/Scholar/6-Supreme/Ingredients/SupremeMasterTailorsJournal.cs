...
{
    public class SupremeMasterTailorsJournal : SupremeIngredients
    {
        public static string DisplayName = "Supreme Master Tailor's Journal";

        public SupremeMasterTailorsJournal(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SupremeMasterTailorsJournal(QuantityRequested);
        }
