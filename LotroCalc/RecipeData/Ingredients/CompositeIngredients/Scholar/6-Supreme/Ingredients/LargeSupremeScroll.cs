...
{
    public class LargeSupremeScroll : SupremeIngredients
    {
        public static string DisplayName = "Large Supreme Scroll (Guild)";

        public LargeSupremeScroll(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LargeSupremeScroll(QuantityRequested);
        }
