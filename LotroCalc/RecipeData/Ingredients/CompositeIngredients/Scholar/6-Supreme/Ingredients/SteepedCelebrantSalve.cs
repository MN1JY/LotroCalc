...
{
    public class SteepedCelebrantSalve : SupremeIngredients
    {
        public static string DisplayName = "Steeped Celebrant Salve";

        public SteepedCelebrantSalve(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SteepedCelebrantSalve(QuantityRequested);
        }
