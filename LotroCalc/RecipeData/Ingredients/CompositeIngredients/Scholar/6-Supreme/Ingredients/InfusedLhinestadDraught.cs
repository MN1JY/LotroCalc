...
{
    public class InfusedLhinestadDraught : SupremeIngredients
    {
        public static string DisplayName = "Infused Lhinestad Draught";

        public InfusedLhinestadDraught(int count)
        {
            Name = DisplayName;
        ...
        {
            return new InfusedLhinestadDraught(QuantityRequested);
        }
