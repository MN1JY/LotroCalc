...
{
    public class InfusedCelebrantSalve : SupremeIngredients
    {
        public static string DisplayName = "Infused Celebrant Salve";

        public InfusedCelebrantSalve(int count)
        {
            Name = DisplayName;
        ...
        {
            return new InfusedCelebrantSalve(QuantityRequested);
        }
