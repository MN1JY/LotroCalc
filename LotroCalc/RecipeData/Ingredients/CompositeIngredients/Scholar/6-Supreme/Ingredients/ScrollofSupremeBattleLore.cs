...
{
    public class ScrollofSupremeBattleLore : SupremeIngredients
    {
        public static string DisplayName = "Scroll of Supreme Battle Lore";

        public ScrollofSupremeBattleLore(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ScrollofSupremeBattleLore(QuantityRequested);
        }
