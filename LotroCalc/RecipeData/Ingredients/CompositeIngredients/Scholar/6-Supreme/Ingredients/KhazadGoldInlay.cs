...
{
    public class KhazadGoldInlay : SupremeIngredients
    {
        public static string DisplayName = "Khazad-Gold Inlay";

        public KhazadGoldInlay(int count)
        {
            Name = DisplayName;
        ...
        {
            return new KhazadGoldInlay(QuantityRequested);
        }
