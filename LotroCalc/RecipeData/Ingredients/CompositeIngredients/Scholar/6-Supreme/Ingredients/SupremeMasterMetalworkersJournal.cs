...
{
    public class SupremeMasterMetalworkersJournal : SupremeIngredients
    {
        public static string DisplayName = "Supreme Master Metalworker's Journal";

        public SupremeMasterMetalworkersJournal(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SupremeMasterMetalworkersJournal(QuantityRequested);
        }
