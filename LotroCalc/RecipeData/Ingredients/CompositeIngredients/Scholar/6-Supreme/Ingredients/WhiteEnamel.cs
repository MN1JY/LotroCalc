...
{
    public class WhiteEnamel : SupremeIngredients
    {
        public static string DisplayName = "White Enamel";

        public WhiteEnamel(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WhiteEnamel(QuantityRequested);
        }
