...
{
    public class SteepedLhinestadDraught : SupremeIngredients
    {
        public static string DisplayName = "Steeped Lhinestad Draught";

        public SteepedLhinestadDraught(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SteepedLhinestadDraught(QuantityRequested);
        }
