...
{
    public class PureFireoil : SupremeIngredients
    {
        public static string DisplayName = "Pure Fire-oil";

        public PureFireoil(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PureFireoil(QuantityRequested);
        }
