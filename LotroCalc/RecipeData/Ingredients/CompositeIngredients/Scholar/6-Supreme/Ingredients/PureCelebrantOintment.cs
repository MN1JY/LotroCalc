...
{
    public class PureCelebrantOintment : SupremeIngredients
    {
        public static string DisplayName = "Pure Celebrant Ointment (Guild)";

        public PureCelebrantOintment(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PureCelebrantOintment(QuantityRequested);
        }
