...
{
    public class InfusedHealingDraught : SupremeIngredients
    {
        public static string DisplayName = "Infused Healing Draught";

        public InfusedHealingDraught(int count)
        {
            Name = DisplayName;
        ...
        {
            return new InfusedHealingDraught(QuantityRequested);
        }
