...
{
    public class BowChantSupremeFoefinder : SupremeIngredients
    {
        public static string DisplayName = "Bow Chant: Supreme Foe-finder";

        public BowChantSupremeFoefinder(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BowChantSupremeFoefinder(QuantityRequested);
        }
