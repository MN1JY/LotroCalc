...
{
    public class CraftedLoremastersBookoftheThirdAge : SupremeIngredients
    {
        public static string DisplayName = "Crafted Lore-master's Book of the Third Age (Level 60)";
