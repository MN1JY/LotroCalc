...
{
    public class CalenardInlay : WestfoldIngredients
    {
        public static string DisplayName = "Calenard Inlay";

        public CalenardInlay(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CalenardInlay(QuantityRequested);
        }
