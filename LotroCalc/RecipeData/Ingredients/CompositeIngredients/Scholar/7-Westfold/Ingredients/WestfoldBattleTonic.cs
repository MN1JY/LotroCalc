...
{
    public class WestfoldBattleTonic : WestfoldIngredients
    {
        public static string DisplayName = "Westfold Battle Tonic";

        public WestfoldBattleTonic(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WestfoldBattleTonic(QuantityRequested);
        }
