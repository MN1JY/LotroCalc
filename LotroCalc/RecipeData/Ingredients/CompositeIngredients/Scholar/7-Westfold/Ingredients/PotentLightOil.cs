...
{
    public class PotentLightOil : WestfoldIngredients
    {
        public static string DisplayName = "Potent Light-oil";

        public PotentLightOil(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PotentLightOil(QuantityRequested);
        }
