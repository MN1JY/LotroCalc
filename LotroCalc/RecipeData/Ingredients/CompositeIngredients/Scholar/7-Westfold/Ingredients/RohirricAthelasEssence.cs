...
{
    public class RohirricAthelasEssence : WestfoldIngredients
    {
        public static string DisplayName = "Rohirric Athelas Essence";

        public RohirricAthelasEssence(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RohirricAthelasEssence(QuantityRequested);
        }
