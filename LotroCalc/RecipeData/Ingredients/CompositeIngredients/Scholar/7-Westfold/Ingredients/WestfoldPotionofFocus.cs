...
{
    public class WestfoldPotionofFocus : WestfoldIngredients
    {
        public static string DisplayName = "Westfold Potion of Focus";

        public WestfoldPotionofFocus(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WestfoldPotionofFocus(QuantityRequested);
        }
