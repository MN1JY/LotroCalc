...
{
    public class RohirricCelebrantSalve : WestfoldIngredients
    {
        public static string DisplayName = "Rohirric Celebrant Salve";

        public RohirricCelebrantSalve(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RohirricCelebrantSalve(QuantityRequested);
        }
