...
{
    public class CraftedLoremastersBookoftheThirdAge : WestfoldIngredients
    {
        public static string DisplayName = "Crafter Lore-master's Book of the Third Age";

        public CraftedLoremastersBookoftheThirdAge(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedLoremastersBookoftheThirdAge(QuantityRequested);
        }
