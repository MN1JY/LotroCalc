...
{
   public class ScrollofWoodsmansLore : WestfoldIngredients
   {
       public static string DisplayName = "Scroll of Woodsman's Lore";

       public ScrollofWoodsmansLore(int count)
       {
           Name = DisplayName;
       ...
       {
           return new ScrollofWoodsmansLore(QuantityRequested);
       }
