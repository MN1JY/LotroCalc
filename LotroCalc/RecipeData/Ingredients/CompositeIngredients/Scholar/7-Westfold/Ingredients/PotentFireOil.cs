...
{
    public class PotentFireOil : WestfoldIngredients
    {
        public static string DisplayName = "Potent Fire-oil";

        public PotentFireOil(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PotentFireOil(QuantityRequested);
        }
