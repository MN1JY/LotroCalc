...
{
    public class WestfoldPotionofFervour : WestfoldIngredients
    {
        public static string DisplayName = "Westfold Potion of Fervour";

        public WestfoldPotionofFervour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WestfoldPotionofFervour(QuantityRequested);
        }
