...
{
    public class RefinedFireOils : ArtisanIngredients
    {
        public static string DisplayName = "Refined Fire-Oil";

        public RefinedFireOils(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RefinedFireOils(QuantityRequested);
        }
