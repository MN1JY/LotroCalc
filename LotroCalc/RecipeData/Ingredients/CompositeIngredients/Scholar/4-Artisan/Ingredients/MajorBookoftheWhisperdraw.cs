...
{
    public class MajorBookoftheWhisperdraw : ArtisanIngredients
    {
        public static string DisplayName = "Major Book of the Whisper-draw";

        public MajorBookoftheWhisperdraw(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MajorBookoftheWhisperdraw(QuantityRequested);
        }
