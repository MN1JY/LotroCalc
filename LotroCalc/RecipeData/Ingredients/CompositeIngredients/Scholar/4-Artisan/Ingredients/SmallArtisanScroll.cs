...
{
    public class SmallArtisanScroll : ArtisanIngredients
    {
        public static string DisplayName = "Small Artisan Scroll (Guild)";

        public SmallArtisanScroll(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallArtisanScroll(QuantityRequested);
        }
