...
{
    public class MajorBookoftheWindrider : ArtisanIngredients
    {
        public static string DisplayName = "Major Book of the Wind-rider";

        public MajorBookoftheWindrider(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MajorBookoftheWindrider(QuantityRequested);
        }
