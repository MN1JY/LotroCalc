...
{
    public class MediumArtisanScroll : ArtisanIngredients
    {
        public static string DisplayName = "Medium Artisan Scroll (Guild)";

        public MediumArtisanScroll(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MediumArtisanScroll(QuantityRequested);
        }
