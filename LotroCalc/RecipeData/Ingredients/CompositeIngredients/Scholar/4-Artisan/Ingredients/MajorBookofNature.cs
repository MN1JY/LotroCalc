...
{
    public class MajorBookofNature : ArtisanIngredients
    {
        public static string DisplayName = "Major Book of Nature";

        public MajorBookofNature(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MajorBookofNature(QuantityRequested);
        }
