...
{
    public class BowChantFoefinder : ArtisanIngredients
    {
        public static string DisplayName = "Bow Chant: Foe-finder";

        public BowChantFoefinder(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BowChantFoefinder(QuantityRequested);
        }
