...
{
    public class MajorBookofBeasts : ArtisanIngredients
    {
        public static string DisplayName = "Major Book of Beasts";

        public MajorBookofBeasts(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MajorBookofBeasts(QuantityRequested);
        }
