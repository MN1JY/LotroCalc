...
{
    public class PlatinumInlay : ArtisanIngredients
    {
        public static string DisplayName = "Platinum Inlay";

        public PlatinumInlay(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PlatinumInlay(QuantityRequested);
        }
