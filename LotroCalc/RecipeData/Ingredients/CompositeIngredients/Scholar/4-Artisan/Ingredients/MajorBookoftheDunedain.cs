...
{
    public class MajorBookoftheDunedain : ArtisanIngredients
    {
        public static string DisplayName = "Major Book of the Dunedain";

        public MajorBookoftheDunedain(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MajorBookoftheDunedain(QuantityRequested);
        }
