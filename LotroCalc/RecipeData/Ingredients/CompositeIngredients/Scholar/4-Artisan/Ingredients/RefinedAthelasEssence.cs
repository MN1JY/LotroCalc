...
{
    public class RefinedAthelasEssence : ArtisanIngredients
    {
        public static string DisplayName = "Refined Athelas Essence";

        public RefinedAthelasEssence(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RefinedAthelasEssence(QuantityRequested);
        }
