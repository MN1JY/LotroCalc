...
{
    public class BookOfBeasts : ExpertIngredients
    {
        public static string DisplayName = "Book Of Beasts";

        public BookOfBeasts(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BookOfBeasts(QuantityRequested);
        }
