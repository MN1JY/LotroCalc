...
{
    public class BookOfTheWhisperDraw : ExpertIngredients
    {
        public static string DisplayName = "Book Of The Whisper-Draw";

        public BookOfTheWhisperDraw(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BookOfTheWhisperDraw(QuantityRequested);
        }
