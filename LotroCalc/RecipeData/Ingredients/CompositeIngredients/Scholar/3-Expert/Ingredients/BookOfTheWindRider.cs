...
{
    public class BookOfTheWindRider : ExpertIngredients
    {
        public static string DisplayName = "Book Of The Wind-Rider";

        public BookOfTheWindRider(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BookOfTheWindRider(QuantityRequested);
        }
