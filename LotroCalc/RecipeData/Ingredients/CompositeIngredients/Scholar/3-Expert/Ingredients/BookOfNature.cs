...
{
    public class BookOfNature : ExpertIngredients
    {
        public static string DisplayName = "Book Of Nature";

        public BookOfNature(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BookOfNature(QuantityRequested);
        }
