...
{
    public class GreaterAthelasEssence : ExpertIngredients
    {
        public static string DisplayName = "Greater Athelas Essence";

        public GreaterAthelasEssence(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GreaterAthelasEssence(QuantityRequested);
        }
