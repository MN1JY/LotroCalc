...
{
    public class BowChantMajorFoefinder : MasterIngredients
    {
        public static string DisplayName = "Bow Chant: Major Foe-finder";

        public BowChantMajorFoefinder(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BowChantMajorFoefinder(QuantityRequested);
        }
