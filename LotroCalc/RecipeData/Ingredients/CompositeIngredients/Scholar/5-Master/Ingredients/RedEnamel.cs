...
{
    public class RedEnamel : MasterIngredients
    {
        public static string DisplayName = "Red Enamel";

        public RedEnamel(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RedEnamel(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = FarmedIngredients.JuicyStrawberry;
