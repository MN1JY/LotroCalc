...
{
    public class StudyoftheUnknown : MasterIngredients
    {
        public static string DisplayName = "Study of the Unknown";

        public StudyoftheUnknown(int count)
        {
            Name = DisplayName;
        ...
        {
            return new StudyoftheUnknown(QuantityRequested);
        }
