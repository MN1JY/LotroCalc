...
{
    public class DistilledCelebrantSalve : MasterIngredients
    {
        public static string DisplayName = "Distilled Celebrant Salve";

        public DistilledCelebrantSalve(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DistilledCelebrantSalve(QuantityRequested);
        }
