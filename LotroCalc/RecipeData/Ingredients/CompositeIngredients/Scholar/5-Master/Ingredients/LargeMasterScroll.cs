...
{
    public class LargeMasterScroll : MasterIngredients
    {
        public static string DisplayName = "Large Master Scroll (Guild)";

        public LargeMasterScroll(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LargeMasterScroll(QuantityRequested);
        }
