...
{
    public class BowChantMajorShieldbane : MasterIngredients
    {
        public static string DisplayName = "Bow Chant: Major Shield-bane";

        public BowChantMajorShieldbane(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BowChantMajorShieldbane(QuantityRequested);
        }
