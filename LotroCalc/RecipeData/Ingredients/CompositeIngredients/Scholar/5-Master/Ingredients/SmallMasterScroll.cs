...
{
    public class SmallMasterScroll : MasterIngredients
    {
        public static string DisplayName = "Small Master Scroll (Guild)";

        public SmallMasterScroll(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallMasterScroll(QuantityRequested);
        }
