...
{
    public class BowChantMajorBreachfinder : MasterIngredients
    {
        public static string DisplayName = "Bow Chant: Major Breach-finder";

        public BowChantMajorBreachfinder(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BowChantMajorBreachfinder(QuantityRequested);
        }
