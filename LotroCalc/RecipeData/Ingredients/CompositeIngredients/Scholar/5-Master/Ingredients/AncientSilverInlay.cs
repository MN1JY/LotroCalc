...
{
    public class AncientSilverInlay : MasterIngredients
    {
        public static string DisplayName = "Ancient Silver Inlay";

        public AncientSilverInlay(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientSilverInlay(QuantityRequested);
        }
