...
{
    public class DistilledConhuithDraught : MasterIngredients
    {
        public static string DisplayName = "Distilled Conhuith Draught";

        public DistilledConhuithDraught(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DistilledConhuithDraught(QuantityRequested);
        }
