...
{
    public class MinorBookOfNature : JourneymanIngredients
    {
        public static string DisplayName = "Minor Book Of Nature";

        public MinorBookOfNature(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MinorBookOfNature(QuantityRequested);
        }
