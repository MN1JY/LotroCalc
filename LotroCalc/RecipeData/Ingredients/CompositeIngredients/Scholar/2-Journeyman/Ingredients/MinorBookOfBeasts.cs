...
{
    public class MinorBookOfBeasts : JourneymanIngredients
    {
        public static string DisplayName = "Minor Book Of Beasts";

        public MinorBookOfBeasts(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MinorBookOfBeasts(QuantityRequested);
        }
