...
{
    public class DwarfmakeOutridersBoots : ExpertIngredients
    {
        public static string DisplayName = "Dwarf-make Outrider's Boots";

        public DwarfmakeOutridersBoots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DwarfmakeOutridersBoots(QuantityRequested);
        }
