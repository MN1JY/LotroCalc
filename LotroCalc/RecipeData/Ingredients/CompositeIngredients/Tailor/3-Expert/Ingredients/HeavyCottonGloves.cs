...
{
    public class HeavyCottonGloves : ExpertIngredients
    {
        public static string DisplayName = "Heavy Cotton Gloves";

        public HeavyCottonGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyCottonGloves(QuantityRequested);
        }
