...
{
    public class SuperbTravellersShoulderGuards : ExpertIngredients
    {
        public static string DisplayName = "Superb Traveller's Shoulder Guards";

        public SuperbTravellersShoulderGuards(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbTravellersShoulderGuards(QuantityRequested);
        }
