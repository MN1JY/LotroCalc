...
{
    public class TravellersCap : ExpertIngredients
    {
        public static string DisplayName = "Traveller's Cap";

        public TravellersCap(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TravellersCap(QuantityRequested);
        }
