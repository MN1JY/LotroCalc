...
{
    public class ScholarsRunesatchelofNestad : ExpertIngredients
    {
        public static string DisplayName = "Scholar's Rune-satchel of Nestad";

        public ScholarsRunesatchelofNestad(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ScholarsRunesatchelofNestad(QuantityRequested);
        }
