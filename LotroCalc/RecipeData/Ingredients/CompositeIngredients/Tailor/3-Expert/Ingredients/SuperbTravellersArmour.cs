...
{
    public class SuperbTravellersArmour : ExpertIngredients
    {
        public static string DisplayName = "Superb Traveller's Armour";

        public SuperbTravellersArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbTravellersArmour(QuantityRequested);
        }
