...
{
    public class OutridersShoulderGuards : ExpertIngredients
    {
        public static string DisplayName = "Outrider's Shoulder Guards";

        public OutridersShoulderGuards(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OutridersShoulderGuards(QuantityRequested);
        }
