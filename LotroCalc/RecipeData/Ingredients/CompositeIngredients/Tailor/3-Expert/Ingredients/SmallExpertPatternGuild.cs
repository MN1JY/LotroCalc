...
{
    public class SmallExpertPatternGuild : ExpertIngredients
    {
        public static string DisplayName = "Small Expert Pattern (Guild)";

        public SmallExpertPatternGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallExpertPatternGuild(QuantityRequested);
        }
