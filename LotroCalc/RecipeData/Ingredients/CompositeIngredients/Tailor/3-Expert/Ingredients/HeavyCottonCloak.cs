...
{
    public class HeavyCottonCloak : ExpertIngredients
    {
        public static string DisplayName = "Heavy Cotton Cloak";

        public HeavyCottonCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyCottonCloak(QuantityRequested);
        }
