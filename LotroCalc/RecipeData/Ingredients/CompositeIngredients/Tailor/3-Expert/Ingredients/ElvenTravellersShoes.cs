...
{
    public class ElvenTravellersShoes : ExpertIngredients
    {
        public static string DisplayName = "Elven Traveller's Shoes";

        public ElvenTravellersShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenTravellersShoes(QuantityRequested);
        }
