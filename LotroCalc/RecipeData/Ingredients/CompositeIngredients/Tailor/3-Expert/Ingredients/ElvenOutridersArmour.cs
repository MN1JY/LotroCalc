...
{
    public class ElvenOutridersArmour : ExpertIngredients
    {
        public static string DisplayName = "Elven Outrider's Armour";

        public ElvenOutridersArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenOutridersArmour(QuantityRequested);
        }
