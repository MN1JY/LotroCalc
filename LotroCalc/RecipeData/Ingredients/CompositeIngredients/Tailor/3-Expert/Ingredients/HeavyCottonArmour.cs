...
{
    public class HeavyCottonArmour : ExpertIngredients
    {
        public static string DisplayName = "Heavy Cotton Armour";

        public HeavyCottonArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyCottonArmour(QuantityRequested);
        }
