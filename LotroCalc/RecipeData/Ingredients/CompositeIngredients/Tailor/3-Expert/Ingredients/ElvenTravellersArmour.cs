...
{
    public class ElvenTravellersArmour : ExpertIngredients
    {
        public static string DisplayName = "Elven Traveller's Armour";

        public ElvenTravellersArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenTravellersArmour(QuantityRequested);
        }
