...
{
    public class TravellersRobe : ExpertIngredients
    {
        public static string DisplayName = "Traveller's Robe";

        public TravellersRobe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TravellersRobe(QuantityRequested);
        }
