...
{
    public class OutridersGloves : ExpertIngredients
    {
        public static string DisplayName = "Outrider's Gloves";

        public OutridersGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OutridersGloves(QuantityRequested);
        }
