...
{
    public class TravellersShoes : ExpertIngredients
    {
        public static string DisplayName = "Traveller's Shoes";

        public TravellersShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TravellersShoes(QuantityRequested);
        }
