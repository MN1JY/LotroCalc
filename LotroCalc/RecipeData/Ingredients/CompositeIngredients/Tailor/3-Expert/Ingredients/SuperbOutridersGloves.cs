...
{
    public class SuperbOutridersGloves : ExpertIngredients
    {
        public static string DisplayName = "Superb Outrider's Gloves";

        public SuperbOutridersGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbOutridersGloves(QuantityRequested);
        }
