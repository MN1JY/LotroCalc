...
{
    public class CottonRobe : ExpertIngredients
    {
        public static string DisplayName = "Cotton Robe";

        public CottonRobe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CottonRobe(QuantityRequested);
        }
