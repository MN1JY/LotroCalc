...
{
    public class SturdyLeatherGloves : ExpertIngredients
    {
        public static string DisplayName = "Sturdy Leather Gloves";

        public SturdyLeatherGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SturdyLeatherGloves(QuantityRequested);
        }
