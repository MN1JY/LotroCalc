...
{
    public class ElvenCottonShoes : ExpertIngredients
    {
        public static string DisplayName = "Elven Cotton Shoes";

        public ElvenCottonShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenCottonShoes(QuantityRequested);
        }
