...
{
    public class SuperbElvenTravellersShoes : ExpertIngredients
    {
        public static string DisplayName = "Superb Elven Traveller's Shoes";

        public SuperbElvenTravellersShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbElvenTravellersShoes(QuantityRequested);
        }
