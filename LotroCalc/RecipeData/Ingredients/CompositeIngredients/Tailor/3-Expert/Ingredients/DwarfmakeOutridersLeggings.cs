...
{
    public class DwarfmakeOutridersLeggings : ExpertIngredients
    {
        public static string DisplayName = "Dwarf-make Outrider's Leggings";

        public DwarfmakeOutridersLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DwarfmakeOutridersLeggings(QuantityRequested);
        }
