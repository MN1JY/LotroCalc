...
{
    public class SuperbTravellersShoes : ExpertIngredients
    {
        public static string DisplayName = "Superb Traveller's Shoes";

        public SuperbTravellersShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbTravellersShoes(QuantityRequested);
        }
