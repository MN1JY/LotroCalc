...
{
    public class DwarfmakeOutridersGloves : ExpertIngredients
    {
        public static string DisplayName = "Dwarf-make Outrider's Gloves";

        public DwarfmakeOutridersGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DwarfmakeOutridersGloves(QuantityRequested);
        }
