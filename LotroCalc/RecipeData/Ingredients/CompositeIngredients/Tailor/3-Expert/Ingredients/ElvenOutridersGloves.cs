...
{
    public class ElvenOutridersGloves : ExpertIngredients
    {
        public static string DisplayName = "Elven Outrider's Gloves";

        public ElvenOutridersGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenOutridersGloves(QuantityRequested);
        }
