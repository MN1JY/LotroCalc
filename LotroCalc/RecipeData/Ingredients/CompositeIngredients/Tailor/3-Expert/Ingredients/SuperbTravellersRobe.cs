...
{
    public class SuperbTravellersRobe : ExpertIngredients
    {
        public static string DisplayName = "Superb Traveller's Robe";

        public SuperbTravellersRobe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbTravellersRobe(QuantityRequested);
        }
