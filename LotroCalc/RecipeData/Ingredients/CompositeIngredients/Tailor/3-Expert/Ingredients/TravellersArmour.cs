...
{
    public class TravellersArmour : ExpertIngredients
    {
        public static string DisplayName = "Traveller's Armour";

        public TravellersArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TravellersArmour(QuantityRequested);
        }
