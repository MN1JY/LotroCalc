...
{
    public class MaidatarmsHeraldArmaments : ExpertIngredients
    {
        public static string DisplayName = "Maid-at-arms Herald Armaments";

        public MaidatarmsHeraldArmaments(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MaidatarmsHeraldArmaments(QuantityRequested);
        }
