...
{
    public class SturdyLeatherHelm : ExpertIngredients
    {
        public static string DisplayName = "Sturdy Leather Helm";

        public SturdyLeatherHelm(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SturdyLeatherHelm(QuantityRequested);
        }
