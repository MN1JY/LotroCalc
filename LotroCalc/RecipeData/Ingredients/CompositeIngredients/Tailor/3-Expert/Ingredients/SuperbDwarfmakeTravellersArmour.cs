...
{
    public class SuperbDwarfmakeTravellersArmour : ExpertIngredients
    {
        public static string DisplayName = "Superb Dwarf-make Traveller's Armour";

        public SuperbDwarfmakeTravellersArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbDwarfmakeTravellersArmour(QuantityRequested);
        }
