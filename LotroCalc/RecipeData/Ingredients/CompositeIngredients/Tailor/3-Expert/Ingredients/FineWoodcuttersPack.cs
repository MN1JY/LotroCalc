...
{
    public class FineWoodcuttersPack : ExpertIngredients
    {
        public static string DisplayName = "Fine Woodcutter's Pack";

        public FineWoodcuttersPack(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FineWoodcuttersPack(QuantityRequested);
        }
