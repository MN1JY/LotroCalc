...
{
    public class SuperbOutridersArmour : ExpertIngredients
    {
        public static string DisplayName = "Superb Outrider's Armour";

        public SuperbOutridersArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbOutridersArmour(QuantityRequested);
        }
