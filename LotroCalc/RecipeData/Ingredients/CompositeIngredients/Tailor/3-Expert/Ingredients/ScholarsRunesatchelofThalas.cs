...
{
    public class ScholarsRunesatchelofThalas : ExpertIngredients
    {
        public static string DisplayName = "Scholar's Rune-satchel of Thalas";

        public ScholarsRunesatchelofThalas(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ScholarsRunesatchelofThalas(QuantityRequested);
        }
