...
{
    public class SturdyLeatherGuard : ExpertIngredients
    {
        public static string DisplayName = "Sturdy Leather Guard";

        public SturdyLeatherGuard(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SturdyLeatherGuard(QuantityRequested);
        }
