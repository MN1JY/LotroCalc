...
{
    public class CommonerHeraldArmaments : ExpertIngredients
    {
        public static string DisplayName = "Commoner Herald Armaments";

        public CommonerHeraldArmaments(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CommonerHeraldArmaments(QuantityRequested);
        }
