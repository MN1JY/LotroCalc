...
{
    public class SuperbTravellersLeggings : ExpertIngredients
    {
        public static string DisplayName = "Superb Traveller's Leggings";

        public SuperbTravellersLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbTravellersLeggings(QuantityRequested);
        }
