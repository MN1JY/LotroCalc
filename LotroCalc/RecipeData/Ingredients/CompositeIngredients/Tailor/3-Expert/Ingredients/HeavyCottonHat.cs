...
{
    public class HeavyCottonHat : ExpertIngredients
    {
        public static string DisplayName = "Heavy Cotton Hat";

        public HeavyCottonHat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyCottonHat(QuantityRequested);
        }
