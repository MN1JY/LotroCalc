...
{
    public class ElvenCottonArmour : ExpertIngredients
    {
        public static string DisplayName = "Elven Cotton Armour";

        public ElvenCottonArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenCottonArmour(QuantityRequested);
        }
