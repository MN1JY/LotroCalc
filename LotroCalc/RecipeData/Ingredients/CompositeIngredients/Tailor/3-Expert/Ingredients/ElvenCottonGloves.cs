...
{
    public class ElvenCottonGloves : ExpertIngredients
    {
        public static string DisplayName = "Elven Cotton Gloves";

        public ElvenCottonGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenCottonGloves(QuantityRequested);
        }
