...
{
    public class OutridersHelm : ExpertIngredients
    {
        public static string DisplayName = "Outrider's Helm";

        public OutridersHelm(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OutridersHelm(QuantityRequested);
        }
