...
{
    public class ElvenOutridersLeggings : ExpertIngredients
    {
        public static string DisplayName = "Elven Outrider's Leggings";

        public ElvenOutridersLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenOutridersLeggings(QuantityRequested);
        }
