...
{
    public class SuperbTravellersCloak : ExpertIngredients
    {
        public static string DisplayName = "Superb Traveller's Cloak";

        public SuperbTravellersCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbTravellersCloak(QuantityRequested);
        }
