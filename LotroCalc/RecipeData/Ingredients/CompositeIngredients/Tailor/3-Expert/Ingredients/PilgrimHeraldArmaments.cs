...
{
    public class PilgrimHeraldArmaments : ExpertIngredients
    {
        public static string DisplayName = "Pilgrim Herald Armaments";

        public PilgrimHeraldArmaments(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PilgrimHeraldArmaments(QuantityRequested);
        }
