...
{
    public class CottonShoes : ExpertIngredients
    {
        public static string DisplayName = "Cotton Shoes";

        public CottonShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CottonShoes(QuantityRequested);
        }
