...
{
    public class OutridersLeggings : ExpertIngredients
    {
        public static string DisplayName = "Outrider's Leggings";

        public OutridersLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OutridersLeggings(QuantityRequested);
        }
