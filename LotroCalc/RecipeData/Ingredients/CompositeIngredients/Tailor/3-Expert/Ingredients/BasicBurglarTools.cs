...
{
    public class BasicBurglarTools : ExpertIngredients
    {
        public static string DisplayName = "Basic Burglar Tools";

        public BasicBurglarTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BasicBurglarTools(QuantityRequested);
        }
