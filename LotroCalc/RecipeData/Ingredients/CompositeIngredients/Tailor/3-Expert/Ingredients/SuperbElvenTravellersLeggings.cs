...
{
    public class SuperbElvenTravellersLeggings : ExpertIngredients
    {
        public static string DisplayName = "Superb Elven Traveller's Leggings";

        public SuperbElvenTravellersLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbElvenTravellersLeggings(QuantityRequested);
        }
