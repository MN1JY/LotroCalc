...
{
    public class DwarfmakeTravellersShoes : ExpertIngredients
    {
        public static string DisplayName = "Dwarf-make Traveller's Shoes";

        public DwarfmakeTravellersShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DwarfmakeTravellersShoes(QuantityRequested);
        }
