...
{
    public class HeavyCottonShoes : ExpertIngredients
    {
        public static string DisplayName = "Heavy Cotton Shoes";

        public HeavyCottonShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyCottonShoes(QuantityRequested);
        }
