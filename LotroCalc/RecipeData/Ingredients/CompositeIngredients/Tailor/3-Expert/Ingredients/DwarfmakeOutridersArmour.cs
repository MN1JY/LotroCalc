...
{
    public class DwarfmakeOutridersArmour : ExpertIngredients
    {
        public static string DisplayName = "Dwarf-make Outrider's Armour";

        public DwarfmakeOutridersArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DwarfmakeOutridersArmour(QuantityRequested);
        }
