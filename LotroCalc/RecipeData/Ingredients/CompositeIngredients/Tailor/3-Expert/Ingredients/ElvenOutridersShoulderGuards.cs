...
{
    public class ElvenOutridersShoulderGuards : ExpertIngredients
    {
        public static string DisplayName = "Elven Outrider's Shoulder Guards";

        public ElvenOutridersShoulderGuards(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenOutridersShoulderGuards(QuantityRequested);
        }
