...
{
    public class TravellersCloak : ExpertIngredients
    {
        public static string DisplayName = "Traveller's Cloak";

        public TravellersCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TravellersCloak(QuantityRequested);
        }
