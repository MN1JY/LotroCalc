...
{
    public class ManatArmsHeraldArmaments : ExpertIngredients
    {
        public static string DisplayName = "Man-at-Arms Herald Armaments";

        public ManatArmsHeraldArmaments(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ManatArmsHeraldArmaments(QuantityRequested);
        }
