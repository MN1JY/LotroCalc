...
{
    public class DwarfmakeTravellersArmour : ExpertIngredients
    {
        public static string DisplayName = "Dwarf-make Traveller's Armour";

        public DwarfmakeTravellersArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DwarfmakeTravellersArmour(QuantityRequested);
        }
