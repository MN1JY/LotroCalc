...
{
    public class ScholarsRunesatchelofDagor : ExpertIngredients
    {
        public static string DisplayName = "Scholar's Rune-satchel of Dagor";

        public ScholarsRunesatchelofDagor(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ScholarsRunesatchelofDagor(QuantityRequested);
        }
