...
{
    public class CottonArmour : ExpertIngredients
    {
        public static string DisplayName = "Cotton Armour";

        public CottonArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CottonArmour(QuantityRequested);
        }
