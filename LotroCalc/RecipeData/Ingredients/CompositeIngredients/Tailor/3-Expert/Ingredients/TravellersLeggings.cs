...
{
    public class TravellersLeggings : ExpertIngredients
    {
        public static string DisplayName = "Traveller's Leggings";

        public TravellersLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TravellersLeggings(QuantityRequested);
        }
