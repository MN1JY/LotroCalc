...
{
    public class SquireHeraldArmaments : ExpertIngredients
    {
        public static string DisplayName = "Squire Herald Armaments";

        public SquireHeraldArmaments(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SquireHeraldArmaments(QuantityRequested);
        }
