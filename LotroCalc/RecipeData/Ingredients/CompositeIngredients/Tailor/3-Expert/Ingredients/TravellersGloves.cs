...
{
    public class TravellersGloves : ExpertIngredients
    {
        public static string DisplayName = "Traveller's Gloves";

        public TravellersGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TravellersGloves(QuantityRequested);
        }
