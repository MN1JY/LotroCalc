...
{
    public class SwordswomanHeraldArmaments : ExpertIngredients
    {
        public static string DisplayName = "Swordswoman Herald Armaments";

        public SwordswomanHeraldArmaments(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SwordswomanHeraldArmaments(QuantityRequested);
        }
