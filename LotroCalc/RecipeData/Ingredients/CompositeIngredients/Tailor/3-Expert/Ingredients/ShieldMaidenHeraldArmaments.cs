...
{
    public class ShieldMaidenHeraldArmaments : ExpertIngredients
    {
        public static string DisplayName = "Shield-maiden Herald Armaments";

        public ShieldMaidenHeraldArmaments(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ShieldMaidenHeraldArmaments(QuantityRequested);
        }
