...
{
    public class DwarfmakeTravellersGloves : ExpertIngredients
    {
        public static string DisplayName = "Dwarf-make Traveller's Gloves";

        public DwarfmakeTravellersGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DwarfmakeTravellersGloves(QuantityRequested);
        }
