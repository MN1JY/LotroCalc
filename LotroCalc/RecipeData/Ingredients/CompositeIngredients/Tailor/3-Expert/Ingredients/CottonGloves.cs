...
{
    public class CottonGloves : ExpertIngredients
    {
        public static string DisplayName = "Cotton Gloves";

        public CottonGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CottonGloves(QuantityRequested);
        }
