...
{
    public class SturdyLeatherShoes : ExpertIngredients
    {
        public static string DisplayName = "Sturdy Leather Shoes";

        public SturdyLeatherShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SturdyLeatherShoes(QuantityRequested);
        }
