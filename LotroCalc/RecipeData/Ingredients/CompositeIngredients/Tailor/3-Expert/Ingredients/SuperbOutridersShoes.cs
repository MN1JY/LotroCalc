...
{
    public class SuperbOutridersShoes : ExpertIngredients
    {
        public static string DisplayName = "Superb Outrider's Shoes";

        public SuperbOutridersShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbOutridersShoes(QuantityRequested);
        }
