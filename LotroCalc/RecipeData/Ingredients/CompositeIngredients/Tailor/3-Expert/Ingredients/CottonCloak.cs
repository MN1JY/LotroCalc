...
{
    public class CottonCloak : ExpertIngredients
    {
        public static string DisplayName = "Cotton Cloak";

        public CottonCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CottonCloak(QuantityRequested);
        }
