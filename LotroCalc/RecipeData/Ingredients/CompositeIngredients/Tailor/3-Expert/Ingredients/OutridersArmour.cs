...
{
    public class OutridersArmour : ExpertIngredients
    {
        public static string DisplayName = "Outrider's Armour";

        public OutridersArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OutridersArmour(QuantityRequested);
        }
