...
{
    public class HeavyCottonRobe : ExpertIngredients
    {
        public static string DisplayName = "Heavy Cotton Robe";

        public HeavyCottonRobe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyCottonRobe(QuantityRequested);
        }
