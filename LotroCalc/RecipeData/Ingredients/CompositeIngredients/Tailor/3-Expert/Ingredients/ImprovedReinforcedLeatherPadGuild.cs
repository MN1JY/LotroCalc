...
{
    public class ImprovedReinforcedLeatherPadGuild : ExpertIngredients
    {
        public static string DisplayName = "Improved Reinforced Leather Pad (Guild)";

        public ImprovedReinforcedLeatherPadGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedReinforcedLeatherPadGuild(QuantityRequested);
        }
