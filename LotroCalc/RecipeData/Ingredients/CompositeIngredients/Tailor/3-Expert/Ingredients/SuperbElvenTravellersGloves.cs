...
{
    public class SuperbElvenTravellersGloves : ExpertIngredients
    {
        public static string DisplayName = "Superb Elven Traveller's Gloves";

        public SuperbElvenTravellersGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbElvenTravellersGloves(QuantityRequested);
        }
