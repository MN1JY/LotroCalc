...
{
    public class OutridersShoes : ExpertIngredients
    {
        public static string DisplayName = "Outrider's Shoes";

        public OutridersShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OutridersShoes(QuantityRequested);
        }
