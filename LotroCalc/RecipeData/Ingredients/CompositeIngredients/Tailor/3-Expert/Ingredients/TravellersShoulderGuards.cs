...
{
    public class TravellersShoulderGuards : ExpertIngredients
    {
        public static string DisplayName = "Traveller's Shoulder Guards";

        public TravellersShoulderGuards(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TravellersShoulderGuards(QuantityRequested);
        }
