...
{
    public class SmallRingandLeafRug : ExpertIngredients
    {
        public static string DisplayName = "Small 'Ring and Leaf' Rug";

        public SmallRingandLeafRug(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallRingandLeafRug(QuantityRequested);
        }
