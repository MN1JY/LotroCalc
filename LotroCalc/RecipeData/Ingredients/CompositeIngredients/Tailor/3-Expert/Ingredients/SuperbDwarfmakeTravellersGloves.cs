...
{
    public class SuperbDwarfmakeTravellersGloves : ExpertIngredients
    {
        public static string DisplayName = "Superb Dwarf-make Traveller's Gloves";

        public SuperbDwarfmakeTravellersGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbDwarfmakeTravellersGloves(QuantityRequested);
        }
