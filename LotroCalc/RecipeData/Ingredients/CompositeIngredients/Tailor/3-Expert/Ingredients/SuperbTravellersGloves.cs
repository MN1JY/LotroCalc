...
{
    public class SuperbTravellersGloves : ExpertIngredients
    {
        public static string DisplayName = "Superb Traveller's Gloves";

        public SuperbTravellersGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbTravellersGloves(QuantityRequested);
        }
