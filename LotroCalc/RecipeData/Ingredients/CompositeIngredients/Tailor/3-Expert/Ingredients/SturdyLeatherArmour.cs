...
{
    public class SturdyLeatherArmour : ExpertIngredients
    {
        public static string DisplayName = "Sturdy Leather Armour";

        public SturdyLeatherArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SturdyLeatherArmour(QuantityRequested);
        }
