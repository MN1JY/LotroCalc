...
{
    public class SuperbDwarfmakeTravellersShoes : ExpertIngredients
    {
        public static string DisplayName = "Superb Dwarf-make Traveller's Shoes";

        public SuperbDwarfmakeTravellersShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbDwarfmakeTravellersShoes(QuantityRequested);
        }
