...
{
    public class ElvenTravellersGloves : ExpertIngredients
    {
        public static string DisplayName = "Elven Traveller's Gloves";

        public ElvenTravellersGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenTravellersGloves(QuantityRequested);
        }
