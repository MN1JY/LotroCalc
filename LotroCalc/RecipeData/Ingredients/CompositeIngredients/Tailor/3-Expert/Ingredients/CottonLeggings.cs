...
{
    public class CottonLeggings : ExpertIngredients
    {
        public static string DisplayName = "Cotton Leggings";

        public CottonLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CottonLeggings(QuantityRequested);
        }
