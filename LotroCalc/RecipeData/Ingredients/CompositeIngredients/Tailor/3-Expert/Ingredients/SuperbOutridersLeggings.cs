...
{
    public class SuperbOutridersLeggings : ExpertIngredients
    {
        public static string DisplayName = "Superb Outrider's Leggings";

        public SuperbOutridersLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbOutridersLeggings(QuantityRequested);
        }
