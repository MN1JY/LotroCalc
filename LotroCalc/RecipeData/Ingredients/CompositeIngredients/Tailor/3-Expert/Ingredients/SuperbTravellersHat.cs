...
{
    public class SuperbTravellersHat : ExpertIngredients
    {
        public static string DisplayName = "Superb Traveller's Hat";

        public SuperbTravellersHat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbTravellersHat(QuantityRequested);
        }
