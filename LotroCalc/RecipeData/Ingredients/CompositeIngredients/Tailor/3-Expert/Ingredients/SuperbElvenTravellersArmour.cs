...
{
    public class SuperbElvenTravellersArmour : ExpertIngredients
    {
        public static string DisplayName = "Superb Elven Traveller's Armour";

        public SuperbElvenTravellersArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbElvenTravellersArmour(QuantityRequested);
        }
