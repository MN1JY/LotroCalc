...
{
    public class ElvenOutridersBoots : ExpertIngredients
    {
        public static string DisplayName = "Elven Outrider's Boots";

        public ElvenOutridersBoots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenOutridersBoots(QuantityRequested);
        }
