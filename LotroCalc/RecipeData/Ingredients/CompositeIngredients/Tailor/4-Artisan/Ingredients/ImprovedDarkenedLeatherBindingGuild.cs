...
{
    public class ImprovedDarkenedLeatherBindingGuild : ArtisanIngredients
    {
        public static string DisplayName = "Improved Darkened Leather Binding (Guild)";

        public ImprovedDarkenedLeatherBindingGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedDarkenedLeatherBindingGuild(QuantityRequested);
        }
