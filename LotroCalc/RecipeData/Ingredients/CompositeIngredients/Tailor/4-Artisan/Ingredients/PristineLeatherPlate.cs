...
{
    public class PristineLeatherPlate : ArtisanIngredients
    {
        public static string DisplayName = "Pristine Leather Plate";

        public PristineLeatherPlate(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PristineLeatherPlate(QuantityRequested);
        }
