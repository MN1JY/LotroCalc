...
{
    public class PristineLeatherBrace : ArtisanIngredients
    {
        public static string DisplayName = "Pristine Leather Brace";

        public PristineLeatherBrace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PristineLeatherBrace(QuantityRequested);
        }
