...
{
    public class HeavyQuiltedGloves : JourneymanIngredients
    {
        public static string DisplayName = "Heavy Quilted Gloves";

        public HeavyQuiltedGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyQuiltedGloves(QuantityRequested);
        }
