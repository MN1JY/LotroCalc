...
{
    public class LinenShoes : JourneymanIngredients
    {
        public static string DisplayName = "Linen Shoes";

        public LinenShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LinenShoes(QuantityRequested);
        }
