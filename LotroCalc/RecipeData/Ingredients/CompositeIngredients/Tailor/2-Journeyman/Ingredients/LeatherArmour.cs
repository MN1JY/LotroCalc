...
{
    public class LeatherArmour : JourneymanIngredients
    {
        public static string DisplayName = "Leather Armour";

        public LeatherArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LeatherArmour(QuantityRequested);
        }
