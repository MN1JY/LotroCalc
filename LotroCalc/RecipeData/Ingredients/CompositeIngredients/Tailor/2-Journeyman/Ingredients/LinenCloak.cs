...
{
    public class LinenCloak : JourneymanIngredients
    {
        public static string DisplayName = "Linen Cloak";

        public LinenCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LinenCloak(QuantityRequested);
        }
