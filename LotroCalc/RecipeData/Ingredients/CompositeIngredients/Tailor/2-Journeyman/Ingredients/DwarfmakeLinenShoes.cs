...
{
    public class DwarfmakeLinenShoes : JourneymanIngredients
    {
        public static string DisplayName = "Dwarf-make Linen Shoes";

        public DwarfmakeLinenShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DwarfmakeLinenShoes(QuantityRequested);
        }
