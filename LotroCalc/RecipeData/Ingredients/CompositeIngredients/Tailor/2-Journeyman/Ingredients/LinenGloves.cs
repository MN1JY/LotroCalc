...
{
    public class LinenGloves : JourneymanIngredients
    {
        public static string DisplayName = "Linen Gloves";

        public LinenGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LinenGloves(QuantityRequested);
        }
