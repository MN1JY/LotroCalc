...
{
    public class ToughLeatherShoes : JourneymanIngredients
    {
        public static string DisplayName = "Tough Leather Shoes";

        public ToughLeatherShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ToughLeatherShoes(QuantityRequested);
        }
