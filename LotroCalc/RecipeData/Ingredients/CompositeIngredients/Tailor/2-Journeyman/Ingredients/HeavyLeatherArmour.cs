...
{
    public class HeavyLeatherArmour : JourneymanIngredients
    {
        public static string DisplayName = "Heavy Leather Armour";

        public HeavyLeatherArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyLeatherArmour(QuantityRequested);
        }
