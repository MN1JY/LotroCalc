...
{
    public class SuperbDwarfmakeLeatherArmour : JourneymanIngredients
    {
        public static string DisplayName = "Superb Dwarf-make Leather Armour";

        public SuperbDwarfmakeLeatherArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbDwarfmakeLeatherArmour(QuantityRequested);
        }
