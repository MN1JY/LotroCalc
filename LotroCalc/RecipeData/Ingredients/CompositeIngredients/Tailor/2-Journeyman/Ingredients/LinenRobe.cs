...
{
    public class LinenRobe : JourneymanIngredients
    {
        public static string DisplayName = "Linen Robe";

        public LinenRobe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LinenRobe(QuantityRequested);
        }
