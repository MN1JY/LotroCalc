...
{
    public class HeavyLeatherShoes : JourneymanIngredients
    {
        public static string DisplayName = "Heavy Leather Shoes";

        public HeavyLeatherShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyLeatherShoes(QuantityRequested);
        }
