...
{
    public class LeatherHelm : JourneymanIngredients
    {
        public static string DisplayName = "Leather Helm";

        public LeatherHelm(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LeatherHelm(QuantityRequested);
        }
