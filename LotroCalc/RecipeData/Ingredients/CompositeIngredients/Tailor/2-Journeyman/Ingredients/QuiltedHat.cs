...
{
    public class QuiltedHat : JourneymanIngredients
    {
        public static string DisplayName = "Quilted Hat";

        public QuiltedHat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new QuiltedHat(QuantityRequested);
        }
