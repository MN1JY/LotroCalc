...
{
    public class SuperbDwarfmakeLeatherGloves : JourneymanIngredients
    {
        public static string DisplayName = "Superb Dwarf-make Leather Gloves";

        public SuperbDwarfmakeLeatherGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbDwarfmakeLeatherGloves(QuantityRequested);
        }
