...
{
    public class HeavyQuiltedCloak : JourneymanIngredients
    {
        public static string DisplayName = "Heavy Quilted Cloak";

        public HeavyQuiltedCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyQuiltedCloak(QuantityRequested);
        }
