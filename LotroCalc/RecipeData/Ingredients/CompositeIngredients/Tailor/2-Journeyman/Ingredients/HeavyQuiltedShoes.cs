...
{
    public class HeavyQuiltedShoes : JourneymanIngredients
    {
        public static string DisplayName = "Heavy Quilted Shoes";

        public HeavyQuiltedShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyQuiltedShoes(QuantityRequested);
        }
