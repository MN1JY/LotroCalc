...
{
    public class ToughLeatherHelm : JourneymanIngredients
    {
        public static string DisplayName = "Tough Leather Helm";

        public ToughLeatherHelm(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ToughLeatherHelm(QuantityRequested);
        }
