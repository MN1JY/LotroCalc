...
{
    public class HeavyQuiltedRobe : JourneymanIngredients
    {
        public static string DisplayName = "Heavy Quilted Robe";

        public HeavyQuiltedRobe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyQuiltedRobe(QuantityRequested);
        }
