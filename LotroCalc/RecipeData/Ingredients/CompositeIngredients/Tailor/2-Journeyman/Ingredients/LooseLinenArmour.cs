...
{
    public class LooseLinenArmour : JourneymanIngredients
    {
        public static string DisplayName = "Loose Linen Armour";

        public LooseLinenArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LooseLinenArmour(QuantityRequested);
        }
