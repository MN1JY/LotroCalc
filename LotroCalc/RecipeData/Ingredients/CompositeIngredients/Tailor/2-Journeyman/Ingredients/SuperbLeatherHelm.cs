...
{
    public class SuperbLeatherHelm : JourneymanIngredients
    {
        public static string DisplayName = "Superb Leather Helm";

        public SuperbLeatherHelm(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbLeatherHelm(QuantityRequested);
        }
