...
{
    public class QuiltedRobe : JourneymanIngredients
    {
        public static string DisplayName = "Quilted Robe";

        public QuiltedRobe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new QuiltedRobe(QuantityRequested);
        }
