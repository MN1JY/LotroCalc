...
{
    public class ToughLeatherArmour : JourneymanIngredients
    {
        public static string DisplayName = "Tough Leather Armour";

        public ToughLeatherArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ToughLeatherArmour(QuantityRequested);
        }
