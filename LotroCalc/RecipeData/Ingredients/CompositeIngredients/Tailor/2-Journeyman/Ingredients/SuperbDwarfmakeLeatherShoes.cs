...
{
    public class SuperbDwarfmakeLeatherShoes : JourneymanIngredients
    {
        public static string DisplayName = "Superb Dwarf-make Leather Boots";

        public SuperbDwarfmakeLeatherShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbDwarfmakeLeatherShoes(QuantityRequested);
        }
