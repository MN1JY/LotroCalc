...
{
    public class LargeWhiteLeafBorderRug : JourneymanIngredients
    {
        public static string DisplayName = "Large White 'Leaf Border' Rug";

        public LargeWhiteLeafBorderRug(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LargeWhiteLeafBorderRug(QuantityRequested);
        }
