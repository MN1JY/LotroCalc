...
{
    public class LeatherShoes : JourneymanIngredients
    {
        public static string DisplayName = "Leather Shoes";

        public LeatherShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LeatherShoes(QuantityRequested);
        }
