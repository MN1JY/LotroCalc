...
{
    public class ToughLeatherLeggings : JourneymanIngredients
    {
        public static string DisplayName = "Tough Leather Leggings";

        public ToughLeatherLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ToughLeatherLeggings(QuantityRequested);
        }
