...
{
    public class SuperbLeatherArmour : JourneymanIngredients
    {
        public static string DisplayName = "Superb Leather Armour";

        public SuperbLeatherArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbLeatherArmour(QuantityRequested);
        }
