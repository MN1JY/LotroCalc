...
{
    public class LooseDwarfmakeLinenLeggings : JourneymanIngredients
    {
        public static string DisplayName = "Loose Dwarf-make Linen Leggings";

        public LooseDwarfmakeLinenLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LooseDwarfmakeLinenLeggings(QuantityRequested);
        }
