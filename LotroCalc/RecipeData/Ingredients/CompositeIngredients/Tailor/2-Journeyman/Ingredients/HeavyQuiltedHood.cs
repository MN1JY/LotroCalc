...
{
    public class HeavyQuiltedHood : JourneymanIngredients
    {
        public static string DisplayName = "Heavy Quilted Hood";

        public HeavyQuiltedHood(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyQuiltedHood(QuantityRequested);
        }
