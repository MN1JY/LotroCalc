...
{
    public class CrudeBurglarTools : JourneymanIngredients
    {
        public static string DisplayName = "Crude Burglar Tools";

        public CrudeBurglarTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CrudeBurglarTools(QuantityRequested);
        }
