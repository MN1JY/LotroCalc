...
{
    public class LooseDwarfmakeLinenShoes : JourneymanIngredients
    {
        public static string DisplayName = "Loose Dwarf-make Linen Shoes";

        public LooseDwarfmakeLinenShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LooseDwarfmakeLinenShoes(QuantityRequested);
        }
