...
{
    public class LeatherGloves : JourneymanIngredients
    {
        public static string DisplayName = "Leather Gloves";

        public LeatherGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LeatherGloves(QuantityRequested);
        }
