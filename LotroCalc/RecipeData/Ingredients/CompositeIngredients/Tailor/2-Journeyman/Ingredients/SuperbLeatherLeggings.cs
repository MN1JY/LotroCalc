...
{
    public class SuperbLeatherLeggings : JourneymanIngredients
    {
        public static string DisplayName = "Superb Leather Leggings";

        public SuperbLeatherLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbLeatherLeggings(QuantityRequested);
        }
