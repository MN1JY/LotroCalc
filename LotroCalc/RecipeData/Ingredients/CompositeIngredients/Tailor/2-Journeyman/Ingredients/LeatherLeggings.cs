...
{
    public class LeatherLeggings : JourneymanIngredients
    {
        public static string DisplayName = "Leather Leggings";

        public LeatherLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LeatherLeggings(QuantityRequested);
        }
