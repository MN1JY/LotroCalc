...
{
    public class ToughLeatherGloves : JourneymanIngredients
    {
        public static string DisplayName = "Tough Leather Gloves";

        public ToughLeatherGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ToughLeatherGloves(QuantityRequested);
        }
