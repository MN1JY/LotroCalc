...
{
    public class QuiltedShoes : JourneymanIngredients
    {
        public static string DisplayName = "Quilted Shoes";

        public QuiltedShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new QuiltedShoes(QuantityRequested);
        }
