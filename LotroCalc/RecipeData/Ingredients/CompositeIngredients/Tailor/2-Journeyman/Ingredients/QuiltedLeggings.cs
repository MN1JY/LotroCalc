...
{
    public class QuiltedLeggings : JourneymanIngredients
    {
        public static string DisplayName = "Quilted Leggings";

        public QuiltedLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new QuiltedLeggings(QuantityRequested);
        }
