...
{
    public class HeavyQuiltedLeggings : JourneymanIngredients
    {
        public static string DisplayName = "Heavy Quilted Leggings";

        public HeavyQuiltedLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyQuiltedLeggings(QuantityRequested);
        }
