...
{
    public class QuiltedGloves : JourneymanIngredients
    {
        public static string DisplayName = "Quilted Gloves";

        public QuiltedGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new QuiltedGloves(QuantityRequested);
        }
