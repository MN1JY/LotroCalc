...
{
    public class SuperbLeatherShoulderGuards : JourneymanIngredients
    {
        public static string DisplayName = "Superb Leather Shoulder Guards";

        public SuperbLeatherShoulderGuards(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbLeatherShoulderGuards(QuantityRequested);
        }
