...
{
    public class HeavyQuiltedArmour : JourneymanIngredients
    {
        public static string DisplayName = "Heavy Quilted Armour";

        public HeavyQuiltedArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyQuiltedArmour(QuantityRequested);
        }
