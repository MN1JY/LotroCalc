...
{
    public class HeavyLeatherLeggings : JourneymanIngredients
    {
        public static string DisplayName = "Heavy Leather Leggings";

        public HeavyLeatherLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyLeatherLeggings(QuantityRequested);
        }
