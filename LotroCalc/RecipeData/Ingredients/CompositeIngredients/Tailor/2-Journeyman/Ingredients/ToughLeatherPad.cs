...
{
    public class ToughLeatherPad : JourneymanIngredients
    {
        public static string DisplayName = "Tough Leather Pad";

        public ToughLeatherPad(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ToughLeatherPad(QuantityRequested);
        }
