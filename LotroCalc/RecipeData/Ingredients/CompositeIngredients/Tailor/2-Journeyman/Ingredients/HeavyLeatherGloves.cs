...
{
    public class HeavyLeatherGloves : JourneymanIngredients
    {
        public static string DisplayName = "Heavy Leather Gloves";

        public HeavyLeatherGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyLeatherGloves(QuantityRequested);
        }
