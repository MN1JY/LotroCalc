...
{
    public class LinenShoulderGuards : JourneymanIngredients
    {
        public static string DisplayName = "Linen Shoulder Guards";

        public LinenShoulderGuards(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LinenShoulderGuards(QuantityRequested);
        }
