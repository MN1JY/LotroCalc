...
{
    public class LooseDwarfmakeLinenShoulderGuards : JourneymanIngredients
    {
        public static string DisplayName = "Loose Dwarf-make Linen Shoulder Guards";

        public LooseDwarfmakeLinenShoulderGuards(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LooseDwarfmakeLinenShoulderGuards(QuantityRequested);
        }
