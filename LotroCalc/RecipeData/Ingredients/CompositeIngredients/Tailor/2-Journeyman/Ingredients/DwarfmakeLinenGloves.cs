...
{
    public class DwarfmakeLinenGloves : JourneymanIngredients
    {
        public static string DisplayName = "Dwarf-make Linen Gloves";

        public DwarfmakeLinenGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DwarfmakeLinenGloves(QuantityRequested);
        }
