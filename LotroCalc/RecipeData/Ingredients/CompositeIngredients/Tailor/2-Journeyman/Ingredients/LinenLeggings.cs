...
{
    public class LinenLeggings : JourneymanIngredients
    {
        public static string DisplayName = "Linen Leggings";

        public LinenLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LinenLeggings(QuantityRequested);
        }
