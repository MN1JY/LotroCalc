...
{
    public class LooseDwarfmakeLinenArmour : JourneymanIngredients
    {
        public static string DisplayName = "Loose Dwarf-make Linen Armour";

        public LooseDwarfmakeLinenArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LooseDwarfmakeLinenArmour(QuantityRequested);
        }
