...
{
    public class SuperbDwarfmakeLeatherLeggings : JourneymanIngredients
    {
        public static string DisplayName = "Superb Dwarf-make Leather Leggings";

        public SuperbDwarfmakeLeatherLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbDwarfmakeLeatherLeggings(QuantityRequested);
        }
