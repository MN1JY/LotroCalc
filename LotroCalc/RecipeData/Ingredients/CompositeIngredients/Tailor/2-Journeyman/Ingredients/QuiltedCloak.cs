...
{
    public class QuiltedCloak : JourneymanIngredients
    {
        public static string DisplayName = "Quilted Cloak";

        public QuiltedCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new QuiltedCloak(QuantityRequested);
        }
