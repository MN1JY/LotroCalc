...
{
    public class LeatherBrace : JourneymanIngredients
    {
        public static string DisplayName = "Leather Brace";

        public LeatherBrace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LeatherBrace(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = PieceOfMediumLeather.DisplayName;
