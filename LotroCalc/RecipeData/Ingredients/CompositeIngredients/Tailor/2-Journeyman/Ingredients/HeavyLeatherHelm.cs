...
{
    public class HeavyLeatherHelm : JourneymanIngredients
    {
        public static string DisplayName = "Heavy Leather Helm";

        public HeavyLeatherHelm(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyLeatherHelm(QuantityRequested);
        }
