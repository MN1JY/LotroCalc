...
{
    public class LooseLinenShoulderGuards : JourneymanIngredients
    {
        public static string DisplayName = "Loose Linen Shoulder Guards";

        public LooseLinenShoulderGuards(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LooseLinenShoulderGuards(QuantityRequested);
        }
