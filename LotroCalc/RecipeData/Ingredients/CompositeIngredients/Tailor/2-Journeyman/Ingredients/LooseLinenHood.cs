...
{
    public class LooseLinenHood : JourneymanIngredients
    {
        public static string DisplayName = "Loose Linen Hood";

        public LooseLinenHood(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LooseLinenHood(QuantityRequested);
        }
