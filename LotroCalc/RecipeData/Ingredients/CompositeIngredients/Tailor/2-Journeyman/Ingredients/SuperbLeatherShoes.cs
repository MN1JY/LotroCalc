...
{
    public class SuperbLeatherShoes : JourneymanIngredients
    {
        public static string DisplayName = "Superb Leather Shoes";

        public SuperbLeatherShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbLeatherShoes(QuantityRequested);
        }
