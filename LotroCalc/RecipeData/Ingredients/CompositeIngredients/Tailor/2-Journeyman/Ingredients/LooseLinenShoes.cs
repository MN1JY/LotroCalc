...
{
    public class LooseLinenShoes : JourneymanIngredients
    {
        public static string DisplayName = "Loose Linen Shoes";

        public LooseLinenShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LooseLinenShoes(QuantityRequested);
        }
