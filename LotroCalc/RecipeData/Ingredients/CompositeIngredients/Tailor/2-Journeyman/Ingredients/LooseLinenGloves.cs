...
{
    public class LooseLinenGloves : JourneymanIngredients
    {
        public static string DisplayName = "Loose Linen Gloves";

        public LooseLinenGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LooseLinenGloves(QuantityRequested);
        }
