...
{
    public class SuperbLeatherGloves : JourneymanIngredients
    {
        public static string DisplayName = "Superb Leather Gloves";

        public SuperbLeatherGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbLeatherGloves(QuantityRequested);
        }
