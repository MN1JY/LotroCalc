...
{
    public class LooseLinenLeggings : JourneymanIngredients
    {
        public static string DisplayName = "Loose Linen Leggings";

        public LooseLinenLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LooseLinenLeggings(QuantityRequested);
        }
