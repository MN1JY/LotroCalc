...
{
    public class LinenArmour : JourneymanIngredients
    {
        public static string DisplayName = "Linen Armour";

        public LinenArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LinenArmour(QuantityRequested);
        }
