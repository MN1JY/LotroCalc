...
{
    public class LooseLinenRobe : JourneymanIngredients
    {
        public static string DisplayName = "Loose Linen Robe";

        public LooseLinenRobe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LooseLinenRobe(QuantityRequested);
        }
