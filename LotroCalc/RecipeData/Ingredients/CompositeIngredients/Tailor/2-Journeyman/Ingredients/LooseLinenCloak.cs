...
{
    public class LooseLinenCloak : JourneymanIngredients
    {
        public static string DisplayName = "Loose Linen Cloak";

        public LooseLinenCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LooseLinenCloak(QuantityRequested);
        }
