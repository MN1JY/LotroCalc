...
{
    public class LooseDwarfmakeLinenGloves : JourneymanIngredients
    {
        public static string DisplayName = "Loose Dwarf-make Linen Gloves";

        public LooseDwarfmakeLinenGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LooseDwarfmakeLinenGloves(QuantityRequested);
        }
