...
{
    public class FineQuiver : JourneymanIngredients
    {
        public static string DisplayName = "Fine Quiver";

        public FineQuiver(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FineQuiver(QuantityRequested);
        }
