...
{
    public class SearchersShoes : SupremeIngredients
    {
        public static string DisplayName = "Searcher's Shoes";

        public SearchersShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SearchersShoes(QuantityRequested);
        }
