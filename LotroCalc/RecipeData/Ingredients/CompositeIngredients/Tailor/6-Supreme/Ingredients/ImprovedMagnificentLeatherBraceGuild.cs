...
{
    public class ImprovedMagnificentLeatherBraceGuild : SupremeIngredients
    {
        public static string DisplayName = "Improved Magnificent Leather Brace (Guild)";

        public ImprovedMagnificentLeatherBraceGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedMagnificentLeatherBraceGuild(QuantityRequested);
        }
