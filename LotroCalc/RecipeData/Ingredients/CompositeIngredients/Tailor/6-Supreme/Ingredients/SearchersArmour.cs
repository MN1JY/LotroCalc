...
{
    public class SearchersArmour : SupremeIngredients
    {
        public static string DisplayName = "Searcher's Armour";

        public SearchersArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SearchersArmour(QuantityRequested);
        }
