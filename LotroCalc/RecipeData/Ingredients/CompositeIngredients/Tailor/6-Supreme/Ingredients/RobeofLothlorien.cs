...
{
    public class RobeofLothlorien : SupremeIngredients
    {
        public static string DisplayName = "Robe of Lothlorien";

        public RobeofLothlorien(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RobeofLothlorien(QuantityRequested);
        }
