...
{
    public class MastersGloves : SupremeIngredients
    {
        public static string DisplayName = "Master's Gloves";

        public MastersGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MastersGloves(QuantityRequested);
        }
