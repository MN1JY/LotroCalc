...
{
    public class RockClimbersShoes : SupremeIngredients
    {
        public static string DisplayName = "Rock Climber's Shoes";

        public RockClimbersShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RockClimbersShoes(QuantityRequested);
        }
