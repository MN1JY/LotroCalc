...
{
    public class LothlorienStalkersCloak : SupremeIngredients
    {
        public static string DisplayName = "Lothlorien Stalker's Cloak";

        public LothlorienStalkersCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LothlorienStalkersCloak(QuantityRequested);
        }
