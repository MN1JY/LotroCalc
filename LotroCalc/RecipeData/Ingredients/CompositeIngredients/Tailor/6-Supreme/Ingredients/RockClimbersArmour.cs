...
{
    public class RockClimbersArmour : SupremeIngredients
    {
        public static string DisplayName = "Rock Climber's Armour";

        public RockClimbersArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RockClimbersArmour(QuantityRequested);
        }
