...
{
    public class HeraldsCloak : SupremeIngredients
    {
        public static string DisplayName = "Herald's Cloak";

        public HeraldsCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeraldsCloak(QuantityRequested);
        }
