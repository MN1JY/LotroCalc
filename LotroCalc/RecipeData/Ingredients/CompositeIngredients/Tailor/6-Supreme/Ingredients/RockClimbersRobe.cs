...
{
    public class RockClimbersRobe : SupremeIngredients
    {
        public static string DisplayName = "Rock Climber's Robe";

        public RockClimbersRobe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RockClimbersRobe(QuantityRequested);
        }
