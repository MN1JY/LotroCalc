...
{
    public class SearchersHat : SupremeIngredients
    {
        public static string DisplayName = "Searcher's Hat";

        public SearchersHat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SearchersHat(QuantityRequested);
        }
