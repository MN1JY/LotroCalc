...
{
    public class CraftedRunekeepersRunesatcheloftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Rune-keeper's Rune-satchel of the Third Age (Level 65)";

        public CraftedRunekeepersRunesatcheloftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedRunekeepersRunesatcheloftheThirdAgeLevel65(QuantityRequested);
        }
