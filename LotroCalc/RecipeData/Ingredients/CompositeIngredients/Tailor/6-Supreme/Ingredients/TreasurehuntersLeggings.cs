...
{
    public class TreasurehuntersLeggings : SupremeIngredients
    {
        public static string DisplayName = "Treasure-hunter's Leggings";

        public TreasurehuntersLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TreasurehuntersLeggings(QuantityRequested);
        }
