...
{
    public class ImprovedExtraordinaryLeatherGuardGuild : SupremeIngredients
    {
        public static string DisplayName = "Improved Extraordinary Leather Guard (Guild)";

        public ImprovedExtraordinaryLeatherGuardGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedExtraordinaryLeatherGuardGuild(QuantityRequested);
        }
