...
{
    public class HatofLothlorien : SupremeIngredients
    {
        public static string DisplayName = "Hat of Lothlorien";

        public HatofLothlorien(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HatofLothlorien(QuantityRequested);
        }
