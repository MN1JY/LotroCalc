...
{
    public class CraftedBurglarsToolsoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Burglar's Tools of the Third Age (Level 60)";

        public CraftedBurglarsToolsoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedBurglarsToolsoftheThirdAgeLevel60(QuantityRequested);
        }
