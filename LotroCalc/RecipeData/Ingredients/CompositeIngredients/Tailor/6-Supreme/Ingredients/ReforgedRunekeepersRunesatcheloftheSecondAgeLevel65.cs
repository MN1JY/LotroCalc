...
{
    public class ReforgedRunekeepersRunesatcheloftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Rune-keeper's Rune-satchel of the Second Age (Level 65)";

        public ReforgedRunekeepersRunesatcheloftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedRunekeepersRunesatcheloftheSecondAgeLevel65(QuantityRequested);
        }
