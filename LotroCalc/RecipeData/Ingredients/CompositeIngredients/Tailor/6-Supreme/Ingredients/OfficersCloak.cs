...
{
    public class OfficersCloak : SupremeIngredients
    {
        public static string DisplayName = "Officer's Cloak";

        public OfficersCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OfficersCloak(QuantityRequested);
        }
