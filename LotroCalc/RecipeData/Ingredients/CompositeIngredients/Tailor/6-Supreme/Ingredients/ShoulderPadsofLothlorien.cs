...
{
    public class ShoulderPadsofLothlorien : SupremeIngredients
    {
        public static string DisplayName = "Shoulder Pads of Lothlorien";

        public ShoulderPadsofLothlorien(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ShoulderPadsofLothlorien(QuantityRequested);
        }
