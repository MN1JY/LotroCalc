...
{
    public class LothlorienSentinelsCloak : SupremeIngredients
    {
        public static string DisplayName = "Lothlorien Sentinel's Cloak";

        public LothlorienSentinelsCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LothlorienSentinelsCloak(QuantityRequested);
        }
