...
{
    public class MarchwardensGloves : SupremeIngredients
    {
        public static string DisplayName = "Marchwarden's Gloves";

        public MarchwardensGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MarchwardensGloves(QuantityRequested);
        }
