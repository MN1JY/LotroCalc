...
{
    public class TreasurehuntersHat : SupremeIngredients
    {
        public static string DisplayName = "Treasure-hunter's Hat";

        public TreasurehuntersHat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TreasurehuntersHat(QuantityRequested);
        }
