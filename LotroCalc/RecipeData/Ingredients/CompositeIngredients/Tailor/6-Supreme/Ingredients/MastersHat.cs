...
{
    public class MastersHat : SupremeIngredients
    {
        public static string DisplayName = "Master's Hat";

        public MastersHat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MastersHat(QuantityRequested);
        }
