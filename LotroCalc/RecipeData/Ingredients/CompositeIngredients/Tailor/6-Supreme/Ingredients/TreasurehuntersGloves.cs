...
{
    public class TreasurehuntersGloves : SupremeIngredients
    {
        public static string DisplayName = "Treasure-hunter's Gloves";

        public TreasurehuntersGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TreasurehuntersGloves(QuantityRequested);
        }
