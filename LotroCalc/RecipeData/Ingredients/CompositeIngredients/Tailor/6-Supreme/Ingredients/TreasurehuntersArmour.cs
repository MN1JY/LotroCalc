...
{
    public class TreasurehuntersArmour : SupremeIngredients
    {
        public static string DisplayName = "Treasure-hunter's Armour";

        public TreasurehuntersArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TreasurehuntersArmour(QuantityRequested);
        }
