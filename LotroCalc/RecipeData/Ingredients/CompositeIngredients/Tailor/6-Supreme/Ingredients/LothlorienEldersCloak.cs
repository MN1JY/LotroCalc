...
{
    public class LothlorienEldersCloak : SupremeIngredients
    {
        public static string DisplayName = "Lothlorien Elder's Cloak";

        public LothlorienEldersCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LothlorienEldersCloak(QuantityRequested);
        }
