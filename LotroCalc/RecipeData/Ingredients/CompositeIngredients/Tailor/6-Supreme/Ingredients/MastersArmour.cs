...
{
    public class MastersArmour : SupremeIngredients
    {
        public static string DisplayName = "Master's Armour";

        public MastersArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MastersArmour(QuantityRequested);
        }
