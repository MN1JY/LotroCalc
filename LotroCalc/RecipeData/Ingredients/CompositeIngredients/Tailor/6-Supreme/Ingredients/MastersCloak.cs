...
{
    public class MastersCloak : SupremeIngredients
    {
        public static string DisplayName = "Master's Cloak";

        public MastersCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MastersCloak(QuantityRequested);
        }
