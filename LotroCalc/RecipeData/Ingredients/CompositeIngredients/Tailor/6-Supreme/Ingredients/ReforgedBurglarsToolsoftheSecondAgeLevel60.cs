...
{
    public class ReforgedBurglarsToolsoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Burglar's Tools of the Second Age (Level 60)";

        public ReforgedBurglarsToolsoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedBurglarsToolsoftheSecondAgeLevel60(QuantityRequested);
        }
