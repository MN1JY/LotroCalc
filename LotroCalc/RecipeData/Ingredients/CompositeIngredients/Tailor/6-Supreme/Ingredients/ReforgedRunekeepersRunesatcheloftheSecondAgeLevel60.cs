...
{
    public class ReforgedRunekeepersRunesatcheloftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Rune-keeper's Rune-satchel of the Second Age (Level 60)";

        public ReforgedRunekeepersRunesatcheloftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedRunekeepersRunesatcheloftheSecondAgeLevel60(QuantityRequested);
        }
