...
{
    public class MarchwardensShoulderGuards : SupremeIngredients
    {
        public static string DisplayName = "Marchwarden's Shoulder Guards";

        public MarchwardensShoulderGuards(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MarchwardensShoulderGuards(QuantityRequested);
        }
