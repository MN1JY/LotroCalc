...
{
    public class SearchersGloves : SupremeIngredients
    {
        public static string DisplayName = "Searcher's Gloves";

        public SearchersGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SearchersGloves(QuantityRequested);
        }
