...
{
    public class RockClimbersHat : SupremeIngredients
    {
        public static string DisplayName = "Rock Climber's Hat";

        public RockClimbersHat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RockClimbersHat(QuantityRequested);
        }
