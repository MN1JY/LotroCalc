...
{
    public class MarchwardensArmour : SupremeIngredients
    {
        public static string DisplayName = "Marchwarden's Armour";

        public MarchwardensArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MarchwardensArmour(QuantityRequested);
        }
