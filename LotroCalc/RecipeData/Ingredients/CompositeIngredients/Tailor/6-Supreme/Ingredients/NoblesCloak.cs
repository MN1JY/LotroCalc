...
{
    public class NoblesCloak : SupremeIngredients
    {
        public static string DisplayName = "Noble's Cloak";

        public NoblesCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new NoblesCloak(QuantityRequested);
        }
