...
{
    public class MarchwardensHelm : SupremeIngredients
    {
        public static string DisplayName = "Marchwarden's Helm";

        public MarchwardensHelm(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MarchwardensHelm(QuantityRequested);
        }
