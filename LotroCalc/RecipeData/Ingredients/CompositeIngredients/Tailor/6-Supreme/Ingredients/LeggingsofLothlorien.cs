...
{
    public class LeggingsofLothlorien : SupremeIngredients
    {
        public static string DisplayName = "Leggings of Lothlorien";

        public LeggingsofLothlorien(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LeggingsofLothlorien(QuantityRequested);
        }
