...
{
    public class ExtraordinaryLeatherPlate : SupremeIngredients
    {
        public static string DisplayName = "Extraordinary Leather Plate";

        public ExtraordinaryLeatherPlate(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ExtraordinaryLeatherPlate(QuantityRequested);
        }
