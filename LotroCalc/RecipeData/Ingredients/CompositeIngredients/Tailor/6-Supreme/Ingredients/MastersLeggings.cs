...
{
    public class MastersLeggings : SupremeIngredients
    {
        public static string DisplayName = "Master's Leggings";

        public MastersLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MastersLeggings(QuantityRequested);
        }
