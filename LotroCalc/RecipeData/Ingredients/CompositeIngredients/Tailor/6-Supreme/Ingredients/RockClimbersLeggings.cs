...
{
    public class RockClimbersLeggings : SupremeIngredients
    {
        public static string DisplayName = "Rock Climber's Leggings";

        public RockClimbersLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RockClimbersLeggings(QuantityRequested);
        }
