...
{
    public class GlovesofLothlorien : SupremeIngredients
    {
        public static string DisplayName = "Gloves of Lothlorien";

        public GlovesofLothlorien(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlovesofLothlorien(QuantityRequested);
        }
