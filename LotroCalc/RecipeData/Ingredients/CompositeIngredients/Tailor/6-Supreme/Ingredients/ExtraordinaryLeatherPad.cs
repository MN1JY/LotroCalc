...
{
    public class ExtraordinaryLeatherPad : SupremeIngredients
    {
        public static string DisplayName = "Extraordinary Leather Pad";

        public ExtraordinaryLeatherPad(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ExtraordinaryLeatherPad(QuantityRequested);
        }
