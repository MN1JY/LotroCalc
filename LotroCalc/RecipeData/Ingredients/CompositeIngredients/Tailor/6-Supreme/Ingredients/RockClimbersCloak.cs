...
{
    public class RockClimbersCloak : SupremeIngredients
    {
        public static string DisplayName = "Rock Climber's Cloak";

        public RockClimbersCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RockClimbersCloak(QuantityRequested);
        }
