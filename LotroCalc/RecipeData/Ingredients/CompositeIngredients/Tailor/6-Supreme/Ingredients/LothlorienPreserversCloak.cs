...
{
    public class LothlorienPreserversCloak : SupremeIngredients
    {
        public static string DisplayName = "Lothlorien Preserver's Cloak";

        public LothlorienPreserversCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LothlorienPreserversCloak(QuantityRequested);
        }
