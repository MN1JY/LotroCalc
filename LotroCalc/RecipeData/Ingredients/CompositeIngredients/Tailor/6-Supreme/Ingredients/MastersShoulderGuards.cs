...
{
    public class MastersShoulderGuards : SupremeIngredients
    {
        public static string DisplayName = "Master's Shoulder Guards";

        public MastersShoulderGuards(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MastersShoulderGuards(QuantityRequested);
        }
