...
{
    public class ShoesofLothlorien : SupremeIngredients
    {
        public static string DisplayName = "Shoes of Lothlorien";

        public ShoesofLothlorien(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ShoesofLothlorien(QuantityRequested);
        }
