...
{
    public class MarchwardensBoots : SupremeIngredients
    {
        public static string DisplayName = "Marchwarden's Boots";

        public MarchwardensBoots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MarchwardensBoots(QuantityRequested);
        }
