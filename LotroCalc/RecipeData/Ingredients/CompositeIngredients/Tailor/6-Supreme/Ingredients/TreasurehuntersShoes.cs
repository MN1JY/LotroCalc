...
{
    public class TreasurehuntersShoes : SupremeIngredients
    {
        public static string DisplayName = "Treasure-hunter's Shoes";

        public TreasurehuntersShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TreasurehuntersShoes(QuantityRequested);
        }
