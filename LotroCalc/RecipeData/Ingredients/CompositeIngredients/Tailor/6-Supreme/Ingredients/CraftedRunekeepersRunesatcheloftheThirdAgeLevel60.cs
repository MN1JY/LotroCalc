...
{
    public class CraftedRunekeepersRunesatcheloftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Rune-keeper's Rune-satchel of the Third Age (Level 60)";

        public CraftedRunekeepersRunesatcheloftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedRunekeepersRunesatcheloftheThirdAgeLevel60(QuantityRequested);
        }
