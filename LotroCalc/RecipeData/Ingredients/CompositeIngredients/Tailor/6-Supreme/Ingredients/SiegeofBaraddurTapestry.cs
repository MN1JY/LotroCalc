...
{
    public class SiegeofBaraddurTapestry : SupremeIngredients
    {
        public static string DisplayName = "'Siege of Barad-dur' Tapestry";

        public SiegeofBaraddurTapestry(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SiegeofBaraddurTapestry(QuantityRequested);
        }
