...
{
    public class MastersShoes : SupremeIngredients
    {
        public static string DisplayName = "Master's Shoes";

        public MastersShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MastersShoes(QuantityRequested);
        }
