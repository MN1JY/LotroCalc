...
{
    public class MarchwardensLeggings : SupremeIngredients
    {
        public static string DisplayName = "Marchwarden's Leggings";

        public MarchwardensLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MarchwardensLeggings(QuantityRequested);
        }
