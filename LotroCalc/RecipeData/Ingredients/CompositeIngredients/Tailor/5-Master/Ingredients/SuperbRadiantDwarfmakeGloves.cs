...
{
    public class SuperbRadiantDwarfmakeGloves : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Dwarf-make Gloves";

        public SuperbRadiantDwarfmakeGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantDwarfmakeGloves(QuantityRequested);
        }
