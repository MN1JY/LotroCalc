...
{
    public class RadiantDwarfmakeGloves : MasterIngredients
    {
        public static string DisplayName = "Radiant Dwarf-make Gloves";

        public RadiantDwarfmakeGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantDwarfmakeGloves(QuantityRequested);
        }
