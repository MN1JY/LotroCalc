...
{
    public class SuperbRadiantElvenShoes : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Elven Shoes";

        public SuperbRadiantElvenShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantElvenShoes(QuantityRequested);
        }
