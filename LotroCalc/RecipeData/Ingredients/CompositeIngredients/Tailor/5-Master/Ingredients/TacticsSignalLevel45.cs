...
{
    public class TacticsSignalLevel45 : MasterIngredients
    {
        public static string DisplayName = "Tactics Signal (Level 45)";

        public TacticsSignalLevel45(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TacticsSignalLevel45(QuantityRequested);
        }
