...
{
    public class SuperbRadiantCloak : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Cloak";

        public SuperbRadiantCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantCloak(QuantityRequested);
        }
