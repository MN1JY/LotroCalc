...
{
    public class SuperbRadiantLeggings : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Leggings";

        public SuperbRadiantLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantLeggings(QuantityRequested);
        }
