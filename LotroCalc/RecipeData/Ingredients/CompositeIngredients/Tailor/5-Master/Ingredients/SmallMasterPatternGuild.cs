...
{
    public class SmallMasterPatternGuild : MasterIngredients
    {
        public static string DisplayName = "Small Master Pattern (Guild)";

        public SmallMasterPatternGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallMasterPatternGuild(QuantityRequested);
        }
