...
{
    public class ElvenProtectorsBoots : MasterIngredients
    {
        public static string DisplayName = "Elven Protector's Boots";

        public ElvenProtectorsBoots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenProtectorsBoots(QuantityRequested);
        }
