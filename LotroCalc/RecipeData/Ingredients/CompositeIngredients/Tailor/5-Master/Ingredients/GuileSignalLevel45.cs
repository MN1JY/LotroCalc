...
{
    public class GuileSignalLevel45 : MasterIngredients
    {
        public static string DisplayName = "Guile Signal (Level 45)";

        public GuileSignalLevel45(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GuileSignalLevel45(QuantityRequested);
        }
