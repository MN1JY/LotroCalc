...
{
    public class PristineShoes : MasterIngredients
    {
        public static string DisplayName = "Pristine Shoes";

        public PristineShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PristineShoes(QuantityRequested);
        }
