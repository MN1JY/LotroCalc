...
{
    public class SuperbRadiantElvenGloves : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Elven Gloves";

        public SuperbRadiantElvenGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantElvenGloves(QuantityRequested);
        }
