...
{
    public class RadiantDwarfmakeArmour : MasterIngredients
    {
        public static string DisplayName = "Radiant Dwarf-make Armour";

        public RadiantDwarfmakeArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantDwarfmakeArmour(QuantityRequested);
        }
