...
{
    public class SuperbRadiantRobe : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Robe";

        public SuperbRadiantRobe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantRobe(QuantityRequested);
        }
