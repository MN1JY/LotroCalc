...
{
    public class SuperbRadiantElvenLeggings : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Elven Leggings";

        public SuperbRadiantElvenLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantElvenLeggings(QuantityRequested);
        }
