...
{
    public class RadiantWesternesseArmour : MasterIngredients
    {
        public static string DisplayName = "Radiant Westernesse Armour";

        public RadiantWesternesseArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantWesternesseArmour(QuantityRequested);
        }
