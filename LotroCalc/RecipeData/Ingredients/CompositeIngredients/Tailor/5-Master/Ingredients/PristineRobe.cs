...
{
    public class PristineRobe : MasterIngredients
    {
        public static string DisplayName = "Pristine Robe";

        public PristineRobe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PristineRobe(QuantityRequested);
        }
