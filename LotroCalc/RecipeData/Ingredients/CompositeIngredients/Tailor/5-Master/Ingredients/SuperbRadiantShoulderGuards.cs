...
{
    public class SuperbRadiantShoulderGuards : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Shoulder Guards";

        public SuperbRadiantShoulderGuards(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantShoulderGuards(QuantityRequested);
        }
