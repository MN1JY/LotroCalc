...
{
    public class SuperbElvenProtectorsArmour : MasterIngredients
    {
        public static string DisplayName = "Superb Elven Protector's Armour";

        public SuperbElvenProtectorsArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbElvenProtectorsArmour(QuantityRequested);
        }
