...
{
    public class ProtectorsArmour : MasterIngredients
    {
        public static string DisplayName = "Protector's Armour";

        public ProtectorsArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ProtectorsArmour(QuantityRequested);
        }
