...
{
    public class RadiantCloak : MasterIngredients
    {
        public static string DisplayName = "Radiant Cloak";

        public RadiantCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantCloak(QuantityRequested);
        }
