...
{
    public class RadiantElvenShoes : MasterIngredients
    {
        public static string DisplayName = "Radiant Elven Shoes";

        public RadiantElvenShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantElvenShoes(QuantityRequested);
        }
