...
{
    public class ElvenProtectorsGloves : MasterIngredients
    {
        public static string DisplayName = "Elven Protector's Gloves";

        public ElvenProtectorsGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenProtectorsGloves(QuantityRequested);
        }
