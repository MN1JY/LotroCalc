...
{
    public class SuperbDwarfmakeProtectorsBoots : MasterIngredients
    {
        public static string DisplayName = "Superb Dwarf-make Protector's Boots";

        public SuperbDwarfmakeProtectorsBoots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbDwarfmakeProtectorsBoots(QuantityRequested);
        }
