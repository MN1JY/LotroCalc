...
{
    public class RadiantHat : MasterIngredients
    {
        public static string DisplayName = "Radiant Hat";

        public RadiantHat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantHat(QuantityRequested);
        }
