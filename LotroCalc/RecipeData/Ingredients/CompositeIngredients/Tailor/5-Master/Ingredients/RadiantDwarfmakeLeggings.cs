...
{
    public class RadiantDwarfmakeLeggings : MasterIngredients
    {
        public static string DisplayName = "Radiant Dwarf-make Leggings";

        public RadiantDwarfmakeLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantDwarfmakeLeggings(QuantityRequested);
        }
