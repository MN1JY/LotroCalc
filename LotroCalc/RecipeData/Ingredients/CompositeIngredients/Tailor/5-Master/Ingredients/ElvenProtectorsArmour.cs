...
{
    public class ElvenProtectorsArmour : MasterIngredients
    {
        public static string DisplayName = "Elven Protector's Armour";

        public ElvenProtectorsArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenProtectorsArmour(QuantityRequested);
        }
