...
{
    public class ExceptionalLeatherBindings : MasterIngredients
    {
        public static string DisplayName = "Exceptional Leather Binding";

        public ExceptionalLeatherBindings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ExceptionalLeatherBindings(QuantityRequested);
        }
