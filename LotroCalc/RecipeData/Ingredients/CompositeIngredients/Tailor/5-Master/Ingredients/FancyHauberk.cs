...
{
    public class FancyHauberk : MasterIngredients
    {
        public static string DisplayName = "Fancy Hauberk";

        public FancyHauberk(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FancyHauberk(QuantityRequested);
        }
