...
{
    public class SuperbRadiantDwarfmakeArmour : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Dwarf-make Armour";

        public SuperbRadiantDwarfmakeArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantDwarfmakeArmour(QuantityRequested);
        }
