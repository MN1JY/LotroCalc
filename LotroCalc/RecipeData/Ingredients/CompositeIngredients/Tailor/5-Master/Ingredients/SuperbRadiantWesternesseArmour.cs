...
{
    public class SuperbRadiantWesternesseArmour : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Westernesse Armour";

        public SuperbRadiantWesternesseArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantWesternesseArmour(QuantityRequested);
        }
