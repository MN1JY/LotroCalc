...
{
    public class SmallHighSeasRug : MasterIngredients
    {
        public static string DisplayName = "Small 'High Seas' Rug";

        public SmallHighSeasRug(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallHighSeasRug(QuantityRequested);
        }
