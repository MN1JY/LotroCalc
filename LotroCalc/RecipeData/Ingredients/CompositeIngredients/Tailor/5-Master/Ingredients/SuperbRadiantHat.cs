...
{
    public class SuperbRadiantHat : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Hat";

        public SuperbRadiantHat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantHat(QuantityRequested);
        }
