...
{
    public class RadiantShoes : MasterIngredients
    {
        public static string DisplayName = "Radiant Shoes";

        public RadiantShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantShoes(QuantityRequested);
        }
