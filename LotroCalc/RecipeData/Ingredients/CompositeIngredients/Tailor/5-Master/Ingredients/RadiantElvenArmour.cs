...
{
    public class RadiantElvenArmour : MasterIngredients
    {
        public static string DisplayName = "Radiant Elven Armour";

        public RadiantElvenArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantElvenArmour(QuantityRequested);
        }
