...
{
    public class ProtectorsLeggings : MasterIngredients
    {
        public static string DisplayName = "Protector's Leggings";

        public ProtectorsLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ProtectorsLeggings(QuantityRequested);
        }
