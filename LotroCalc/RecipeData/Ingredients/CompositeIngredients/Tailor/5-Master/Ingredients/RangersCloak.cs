...
{
    public class RangersCloak : MasterIngredients
    {
        public static string DisplayName = "Ranger's Cloak";

        public RangersCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RangersCloak(QuantityRequested);
        }
