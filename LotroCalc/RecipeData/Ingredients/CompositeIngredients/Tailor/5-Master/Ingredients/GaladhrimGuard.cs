...
{
    public class GaladhrimGuard : MasterIngredients
    {
        public static string DisplayName = "Galadhrim Guard";

        public GaladhrimGuard(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GaladhrimGuard(QuantityRequested);
        }
