...
{
    public class RadiantRobe : MasterIngredients
    {
        public static string DisplayName = "Radiant Robe";

        public RadiantRobe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantRobe(QuantityRequested);
        }
