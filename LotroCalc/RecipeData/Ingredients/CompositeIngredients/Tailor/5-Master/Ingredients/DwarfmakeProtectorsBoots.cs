...
{
    public class DwarfmakeProtectorsBoots : MasterIngredients
    {
        public static string DisplayName = "Dwarf-make Protector's Boots";

        public DwarfmakeProtectorsBoots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DwarfmakeProtectorsBoots(QuantityRequested);
        }
