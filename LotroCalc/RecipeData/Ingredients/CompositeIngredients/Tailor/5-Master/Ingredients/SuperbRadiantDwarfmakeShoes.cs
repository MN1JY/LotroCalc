...
{
    public class SuperbRadiantDwarfmakeShoes : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Dwarf-make Shoes";

        public SuperbRadiantDwarfmakeShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantDwarfmakeShoes(QuantityRequested);
        }
