...
{
    public class SuperbRadiantWesternesseShoes : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Westernesse Shoes";

        public SuperbRadiantWesternesseShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantWesternesseShoes(QuantityRequested);
        }
