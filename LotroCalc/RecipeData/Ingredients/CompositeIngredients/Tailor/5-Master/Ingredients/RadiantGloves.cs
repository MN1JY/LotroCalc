...
{
    public class RadiantGloves : MasterIngredients
    {
        public static string DisplayName = "Radiant Gloves";

        public RadiantGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantGloves(QuantityRequested);
        }
