...
{
    public class ProtectorsHelm : MasterIngredients
    {
        public static string DisplayName = "Protector's Helm";

        public ProtectorsHelm(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ProtectorsHelm(QuantityRequested);
        }
