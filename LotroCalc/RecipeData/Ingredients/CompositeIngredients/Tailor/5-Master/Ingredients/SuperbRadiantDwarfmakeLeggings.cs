...
{
    public class SuperbRadiantDwarfmakeLeggings : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Dwarf-make Leggings";

        public SuperbRadiantDwarfmakeLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantDwarfmakeLeggings(QuantityRequested);
        }
