...
{
    public class SuperbElvenProtectorsGloves : MasterIngredients
    {
        public static string DisplayName = "Superb Elven Protector's Gloves";

        public SuperbElvenProtectorsGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbElvenProtectorsGloves(QuantityRequested);
        }
