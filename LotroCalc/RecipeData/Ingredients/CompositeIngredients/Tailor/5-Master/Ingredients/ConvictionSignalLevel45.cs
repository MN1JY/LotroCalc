...
{
    public class ConvictionSignalLevel45 : MasterIngredients
    {
        public static string DisplayName = "Conviction Signal (Level 45)";

        public ConvictionSignalLevel45(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ConvictionSignalLevel45(QuantityRequested);
        }
