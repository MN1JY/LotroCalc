...
{
    public class ProtectorsGloves : MasterIngredients
    {
        public static string DisplayName = "Protector's Gloves";

        public ProtectorsGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ProtectorsGloves(QuantityRequested);
        }
