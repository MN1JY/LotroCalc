...
{
    public class SuperbRadiantGloves : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Gloves";

        public SuperbRadiantGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantGloves(QuantityRequested);
        }
