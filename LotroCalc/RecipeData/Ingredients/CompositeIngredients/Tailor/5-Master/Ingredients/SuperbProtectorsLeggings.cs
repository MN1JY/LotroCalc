...
{
    public class SuperbProtectorsLeggings : MasterIngredients
    {
        public static string DisplayName = "Superb Protector's Leggings";

        public SuperbProtectorsLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbProtectorsLeggings(QuantityRequested);
        }
