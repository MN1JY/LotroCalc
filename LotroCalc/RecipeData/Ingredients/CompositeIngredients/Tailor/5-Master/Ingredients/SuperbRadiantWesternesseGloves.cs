...
{
    public class SuperbRadiantWesternesseGloves : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Westernesse Gloves";

        public SuperbRadiantWesternesseGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantWesternesseGloves(QuantityRequested);
        }
