...
{
    public class LossothHeraldArmaments : MasterIngredients
    {
        public static string DisplayName = "Lossoth Herald Armaments";

        public LossothHeraldArmaments(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LossothHeraldArmaments(QuantityRequested);
        }
