...
{
    public class PristineHat : MasterIngredients
    {
        public static string DisplayName = "Pristine Hat";

        public PristineHat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PristineHat(QuantityRequested);
        }
