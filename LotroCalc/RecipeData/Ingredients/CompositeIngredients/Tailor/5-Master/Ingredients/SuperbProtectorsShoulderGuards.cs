...
{
    public class SuperbProtectorsShoulderGuards : MasterIngredients
    {
        public static string DisplayName = "Superb Protector's Shoulder Guards";

        public SuperbProtectorsShoulderGuards(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbProtectorsShoulderGuards(QuantityRequested);
        }
