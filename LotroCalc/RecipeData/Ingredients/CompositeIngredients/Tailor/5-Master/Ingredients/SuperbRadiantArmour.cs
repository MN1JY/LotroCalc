...
{
    public class SuperbRadiantArmour : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Armour";

        public SuperbRadiantArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantArmour(QuantityRequested);
        }
