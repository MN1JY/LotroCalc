...
{
    public class RadiantElvenLeggings : MasterIngredients
    {
        public static string DisplayName = "Radiant Elven Leggings";

        public RadiantElvenLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantElvenLeggings(QuantityRequested);
        }
