...
{
    public class RadiantWesternesseGloves : MasterIngredients
    {
        public static string DisplayName = "Radiant Westernesse Gloves";

        public RadiantWesternesseGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantWesternesseGloves(QuantityRequested);
        }
