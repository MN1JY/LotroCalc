...
{
    public class RadiantWesternesseShoes : MasterIngredients
    {
        public static string DisplayName = "Radiant Westernesse Shoes";

        public RadiantWesternesseShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantWesternesseShoes(QuantityRequested);
        }
