...
{
    public class RadiantArmour : MasterIngredients
    {
        public static string DisplayName = "Radiant Armour";

        public RadiantArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantArmour(QuantityRequested);
        }
