...
{
    public class RadiantDwarfmakeShoes : MasterIngredients
    {
        public static string DisplayName = "Radiant Dwarf-make Shoes";

        public RadiantDwarfmakeShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantDwarfmakeShoes(QuantityRequested);
        }
