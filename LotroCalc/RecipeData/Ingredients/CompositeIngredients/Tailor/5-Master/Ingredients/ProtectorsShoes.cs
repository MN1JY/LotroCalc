...
{
    public class ProtectorsShoes : MasterIngredients
    {
        public static string DisplayName = "Protector's Shoes";

        public ProtectorsShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ProtectorsShoes(QuantityRequested);
        }
