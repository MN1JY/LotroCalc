...
{
    public class SuperbProtectorsShoes : MasterIngredients
    {
        public static string DisplayName = "Superb Protector's Shoes";

        public SuperbProtectorsShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbProtectorsShoes(QuantityRequested);
        }
