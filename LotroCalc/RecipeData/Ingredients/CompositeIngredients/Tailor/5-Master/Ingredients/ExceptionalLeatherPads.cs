...
{
    public class ExceptionalLeatherPads : MasterIngredients
    {
        public static string DisplayName = "Exceptional Leather Pad";

        public ExceptionalLeatherPads(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ExceptionalLeatherPads(QuantityRequested);
        }
