...
{
    public class SuperbElvenProtectorsLeggings : MasterIngredients
    {
        public static string DisplayName = "Superb Elven Protector's Leggings";

        public SuperbElvenProtectorsLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbElvenProtectorsLeggings(QuantityRequested);
        }
