...
{
    public class FineHauberk : MasterIngredients
    {
        public static string DisplayName = "Fine Hauberk";

        public FineHauberk(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FineHauberk(QuantityRequested);
        }
