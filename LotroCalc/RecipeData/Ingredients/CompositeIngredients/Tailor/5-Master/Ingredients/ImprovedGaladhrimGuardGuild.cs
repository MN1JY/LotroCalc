...
{
    public class ImprovedGaladhrimGuardGuild : MasterIngredients
    {
        public static string DisplayName = "Improved Galadhrim Guard (Guild)";

        public ImprovedGaladhrimGuardGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedGaladhrimGuardGuild(QuantityRequested);
        }
