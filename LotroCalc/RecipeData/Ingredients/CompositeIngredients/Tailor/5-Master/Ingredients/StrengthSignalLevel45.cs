...
{
    public class StrengthSignalLevel45 : MasterIngredients
    {
        public static string DisplayName = "Strength Signal (Level 45)";

        public StrengthSignalLevel45(int count)
        {
            Name = DisplayName;
        ...
        {
            return new StrengthSignalLevel45(QuantityRequested);
        }
