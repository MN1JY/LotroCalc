...
{
    public class ElvenProtectorsLeggings : MasterIngredients
    {
        public static string DisplayName = "Elven Protector's Leggings";

        public ElvenProtectorsLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenProtectorsLeggings(QuantityRequested);
        }
