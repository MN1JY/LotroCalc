...
{
    public class RadiantShoulderGuards : MasterIngredients
    {
        public static string DisplayName = "Radiant Shoulder Guards";

        public RadiantShoulderGuards(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantShoulderGuards(QuantityRequested);
        }
