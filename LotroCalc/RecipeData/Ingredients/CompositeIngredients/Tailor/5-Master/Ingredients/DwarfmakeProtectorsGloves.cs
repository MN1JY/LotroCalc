...
{
    public class DwarfmakeProtectorsGloves : MasterIngredients
    {
        public static string DisplayName = "Dwarf-make Protector's Gloves";

        public DwarfmakeProtectorsGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DwarfmakeProtectorsGloves(QuantityRequested);
        }
