...
{
    public class SuperbProtectorsHelm : MasterIngredients
    {
        public static string DisplayName = "Superb Protector's Helm";

        public SuperbProtectorsHelm(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbProtectorsHelm(QuantityRequested);
        }
