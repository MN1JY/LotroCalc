...
{
    public class RadiantLeggings : MasterIngredients
    {
        public static string DisplayName = "Radiant Leggings";

        public RadiantLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantLeggings(QuantityRequested);
        }
