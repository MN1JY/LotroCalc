...
{
    public class ProtectorsShoulderGuards : MasterIngredients
    {
        public static string DisplayName = "Protector's Shoulder Guards";

        public ProtectorsShoulderGuards(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ProtectorsShoulderGuards(QuantityRequested);
        }
