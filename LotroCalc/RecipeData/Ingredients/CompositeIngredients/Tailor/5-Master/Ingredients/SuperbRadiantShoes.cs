...
{
    public class SuperbRadiantShoes : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Shoes";

        public SuperbRadiantShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantShoes(QuantityRequested);
        }
