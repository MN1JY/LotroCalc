...
{
    public class CeremonialDress : MasterIngredients
    {
        public static string DisplayName = "Ceremonial Dress";

        public CeremonialDress(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CeremonialDress(QuantityRequested);
        }
