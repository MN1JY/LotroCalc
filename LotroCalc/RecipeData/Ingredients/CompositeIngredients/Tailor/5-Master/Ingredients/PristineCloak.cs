...
{
    public class PristineCloak : MasterIngredients
    {
        public static string DisplayName = "Pristine Cloak";

        public PristineCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PristineCloak(QuantityRequested);
        }
