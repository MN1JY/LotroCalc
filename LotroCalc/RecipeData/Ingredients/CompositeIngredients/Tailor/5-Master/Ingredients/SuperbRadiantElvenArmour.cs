...
{
    public class SuperbRadiantElvenArmour : MasterIngredients
    {
        public static string DisplayName = "Superb Radiant Elven Armour";

        public SuperbRadiantElvenArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbRadiantElvenArmour(QuantityRequested);
        }
