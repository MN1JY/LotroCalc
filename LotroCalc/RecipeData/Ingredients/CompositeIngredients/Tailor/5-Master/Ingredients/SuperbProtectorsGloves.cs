...
{
    public class SuperbProtectorsGloves : MasterIngredients
    {
        public static string DisplayName = "Superb Protector's Gloves";

        public SuperbProtectorsGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbProtectorsGloves(QuantityRequested);
        }
