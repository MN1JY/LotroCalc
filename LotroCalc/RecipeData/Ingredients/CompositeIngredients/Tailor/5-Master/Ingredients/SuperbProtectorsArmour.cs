...
{
    public class SuperbProtectorsArmour : MasterIngredients
    {
        public static string DisplayName = "Superb Protector's Armour";

        public SuperbProtectorsArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbProtectorsArmour(QuantityRequested);
        }
