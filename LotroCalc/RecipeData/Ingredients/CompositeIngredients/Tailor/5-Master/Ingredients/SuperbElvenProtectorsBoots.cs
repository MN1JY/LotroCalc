...
{
    public class SuperbElvenProtectorsBoots : MasterIngredients
    {
        public static string DisplayName = "Superb Elven Protector's Boots";

        public SuperbElvenProtectorsBoots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbElvenProtectorsBoots(QuantityRequested);
        }
