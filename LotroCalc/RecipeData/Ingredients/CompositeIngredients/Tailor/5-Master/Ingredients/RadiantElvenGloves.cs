...
{
    public class RadiantElvenGloves : MasterIngredients
    {
        public static string DisplayName = "Radiant Elven Gloves";

        public RadiantElvenGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RadiantElvenGloves(QuantityRequested);
        }
