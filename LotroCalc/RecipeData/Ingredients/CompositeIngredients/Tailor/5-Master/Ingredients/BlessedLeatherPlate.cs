...
{
    public class BlessedLeatherPlate : MasterIngredients
    {
        public static string DisplayName = "Blessed Leather Plate";

        public BlessedLeatherPlate(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BlessedLeatherPlate(QuantityRequested);
        }
