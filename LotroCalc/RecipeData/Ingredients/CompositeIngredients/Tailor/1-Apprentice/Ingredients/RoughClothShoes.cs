...
{
    public class RoughClothShoes : ApprenticeIngredients
    {
        public static string DisplayName = "Rough Cloth Shoes";

        public RoughClothShoes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RoughClothShoes(QuantityRequested);
        }
