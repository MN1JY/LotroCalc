...
{
    public class RoughClothGloves : ApprenticeIngredients
    {
        public static string DisplayName = "Rough Cloth Gloves";

        public RoughClothGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RoughClothGloves(QuantityRequested);
        }
