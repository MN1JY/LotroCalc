...
{
    public class RoughClothCloak : ApprenticeIngredients
    {
        public static string DisplayName = "Rough Cloth Cloak";

        public RoughClothCloak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RoughClothCloak(QuantityRequested);
        }
