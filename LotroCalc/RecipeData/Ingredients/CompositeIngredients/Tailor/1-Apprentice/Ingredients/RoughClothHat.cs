...
{
    public class RoughClothHat : ApprenticeIngredients
    {
        public static string DisplayName = "Rough Cloth Hat";

        public RoughClothHat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RoughClothHat(QuantityRequested);
        }
