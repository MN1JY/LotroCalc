...
{
    public class LeatherPad : ApprenticeIngredients
    {
        public static string DisplayName = "Leather Pad";

        public LeatherPad(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LeatherPad(QuantityRequested);
        }
