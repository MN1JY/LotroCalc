...
{
    public class RoughClothArmour : ApprenticeIngredients
    {
        public static string DisplayName = "Rough Cloth Armour";

        public RoughClothArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RoughClothArmour(QuantityRequested);
        }
