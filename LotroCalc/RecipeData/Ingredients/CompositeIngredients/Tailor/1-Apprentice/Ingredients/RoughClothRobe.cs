...
{
    public class RoughClothRobe : ApprenticeIngredients
    {
        public static string DisplayName = "Rough Cloth Robe";

        public RoughClothRobe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RoughClothRobe(QuantityRequested);
        }
