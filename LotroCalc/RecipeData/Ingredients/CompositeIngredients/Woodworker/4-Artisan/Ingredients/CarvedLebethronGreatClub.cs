...
{
    public class CarvedLebethronGreatClub : ArtisanIngredients
    {
        public static string DisplayName = "Carved Lebethron Great Club";

        public CarvedLebethronGreatClub(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedLebethronGreatClub(QuantityRequested);
        }
