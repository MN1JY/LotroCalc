...
{
    public class ReinforcedLebethronStaff : ArtisanIngredients
    {
        public static string DisplayName = "Reinforced Lebethron Staff";

        public ReinforcedLebethronStaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReinforcedLebethronStaff(QuantityRequested);
        }
