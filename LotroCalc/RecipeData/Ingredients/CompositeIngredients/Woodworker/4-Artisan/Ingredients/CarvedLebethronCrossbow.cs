...
{
    public class CarvedLebethronCrossbow : ArtisanIngredients
    {
        public static string DisplayName = "Carved Lebethron Crossbow";

        public CarvedLebethronCrossbow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedLebethronCrossbow(QuantityRequested);
        }
