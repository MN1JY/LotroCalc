...
{
    public class SpearCarving : ArtisanIngredients
    {
        public static string DisplayName = "Spear Carving";

        public SpearCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SpearCarving(QuantityRequested);
        }
