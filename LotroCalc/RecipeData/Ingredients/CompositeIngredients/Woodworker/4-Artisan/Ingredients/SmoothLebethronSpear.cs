...
{
    public class SmoothLebethronSpear : ArtisanIngredients
    {
        public static string DisplayName = "Smooth Lebethron Spear";

        public SmoothLebethronSpear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmoothLebethronSpear(QuantityRequested);
        }
