...
{
    public class LebethronHaft : ArtisanIngredients
    {
        public static string DisplayName = "Lebethron Haft";

        public LebethronHaft(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LebethronHaft(QuantityRequested);
        }
