...
{
    public class OrnateLebethronBowGuild : ArtisanIngredients
    {
        public static string DisplayName = "Ornate Lebethron Bow (Guild)";

        public OrnateLebethronBowGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OrnateLebethronBowGuild(QuantityRequested);
        }
