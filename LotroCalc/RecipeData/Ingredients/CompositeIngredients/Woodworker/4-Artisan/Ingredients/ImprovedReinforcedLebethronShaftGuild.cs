...
{
    public class ImprovedReinforcedLebethronShaftGuild : ArtisanIngredients
    {
        public static string DisplayName = "Improved Reinforced Lebethron Shaft (Guild)";

        public ImprovedReinforcedLebethronShaftGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedReinforcedLebethronShaftGuild(QuantityRequested);
        }
