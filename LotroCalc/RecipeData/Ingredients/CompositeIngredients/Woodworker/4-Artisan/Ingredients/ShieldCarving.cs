...
{
    public class ShieldCarving : ArtisanIngredients
    {
        public static string DisplayName = "Shield Carving";

        public ShieldCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ShieldCarving(QuantityRequested);
        }
