...
{
    public class OrnateLebethronJavelinGuild : ArtisanIngredients
    {
        public static string DisplayName = "Ornate Lebethron Javelin (Guild)";

        public OrnateLebethronJavelinGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OrnateLebethronJavelinGuild(QuantityRequested);
        }
