...
{
    public class SmoothLebethronCrossbow : ArtisanIngredients
    {
        public static string DisplayName = "Smooth Lebethron Crossbow";

        public SmoothLebethronCrossbow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmoothLebethronCrossbow(QuantityRequested);
        }
