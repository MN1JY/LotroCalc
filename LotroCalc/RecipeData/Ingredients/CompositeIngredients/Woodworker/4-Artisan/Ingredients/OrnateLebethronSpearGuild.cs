...
{
    public class OrnateLebethronSpearGuild : ArtisanIngredients
    {
        public static string DisplayName = "Ornate Lebethron Spear (Guild)";

        public OrnateLebethronSpearGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OrnateLebethronSpearGuild(QuantityRequested);
        }
