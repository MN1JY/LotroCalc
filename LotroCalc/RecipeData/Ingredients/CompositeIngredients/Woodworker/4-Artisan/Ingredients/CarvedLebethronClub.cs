...
{
    public class CarvedLebethronClub : ArtisanIngredients
    {
        public static string DisplayName = "Carved Lebethron Club";

        public CarvedLebethronClub(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedLebethronClub(QuantityRequested);
        }
