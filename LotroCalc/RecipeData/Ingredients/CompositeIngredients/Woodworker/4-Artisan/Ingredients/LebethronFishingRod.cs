...
{
    public class LebethronFishingRod : ArtisanIngredients
    {
        public static string DisplayName = "Lebethron Fishing Rod";

        public LebethronFishingRod(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LebethronFishingRod(QuantityRequested);
        }
