...
{
    public class OrnateLebethronHammerGuild : ArtisanIngredients
    {
        public static string DisplayName = "Ornate Lebethron Hammer (Guild)";

        public OrnateLebethronHammerGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OrnateLebethronHammerGuild(QuantityRequested);
        }
