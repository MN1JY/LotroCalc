...
{
    public class CarvedLebethronSpear : ArtisanIngredients
    {
        public static string DisplayName = "Carved Lebethron Spear";

        public CarvedLebethronSpear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedLebethronSpear(QuantityRequested);
        }
