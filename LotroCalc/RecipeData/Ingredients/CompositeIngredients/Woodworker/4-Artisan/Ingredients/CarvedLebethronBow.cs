...
{
    public class CarvedLebethronBow : ArtisanIngredients
    {
        public static string DisplayName = "Carved Lebethron Bow";

        public CarvedLebethronBow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedLebethronBow(QuantityRequested);
        }
