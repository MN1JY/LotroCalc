...
{
    public class OrnateLebethronGreatClubGuild : ArtisanIngredients
    {
        public static string DisplayName = "Ornate Lebethron Great Club (Guild)";

        public OrnateLebethronGreatClubGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OrnateLebethronGreatClubGuild(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = LebethronHaft.DisplayName;
            ing = (Ingredient)DictCraftedIngredients[ingName].Clone();
            ing.QuantityRequested = 1 * QuantityRequested;
            recipe.Add(ingName, ing);
