...
{
    public class ScholarsRoundTable : ArtisanIngredients
    {
        public static string DisplayName = "Scholar's Round Table";

        public ScholarsRoundTable(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ScholarsRoundTable(QuantityRequested);
        }
