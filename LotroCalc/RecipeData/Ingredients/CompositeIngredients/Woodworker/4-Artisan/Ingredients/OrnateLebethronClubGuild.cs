...
{
    public class OrnateLebethronClubGuild : ArtisanIngredients
    {
        public static string DisplayName = "Ornate Lebethron Club (Guild)";

        public OrnateLebethronClubGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OrnateLebethronClubGuild(QuantityRequested);
        }
