...
{
    public class CarvedLebethronJavelin : ArtisanIngredients
    {
        public static string DisplayName = "Carved Lebethron Javelin";

        public CarvedLebethronJavelin(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedLebethronJavelin(QuantityRequested);
        }
