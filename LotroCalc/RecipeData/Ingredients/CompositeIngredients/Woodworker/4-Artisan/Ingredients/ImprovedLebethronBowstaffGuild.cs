...
{
    public class ImprovedLebethronBowstaffGuild : ArtisanIngredients
    {
        public static string DisplayName = "Improved Lebethron Bowstaff (Guild)";

        public ImprovedLebethronBowstaffGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedLebethronBowstaffGuild(QuantityRequested);
        }
