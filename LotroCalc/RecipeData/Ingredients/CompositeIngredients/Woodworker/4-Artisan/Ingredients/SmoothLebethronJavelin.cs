...
{
    public class SmoothLebethronJavelin : ArtisanIngredients
    {
        public static string DisplayName = "Smooth Lebethron Javelin";

        public SmoothLebethronJavelin(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmoothLebethronJavelin(QuantityRequested);
        }
