...
{
    public class SuperiorTheorbo : ArtisanIngredients
    {
        public static string DisplayName = "Superior Theorbo";

        public SuperiorTheorbo(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorTheorbo(QuantityRequested);
        }
