...
{
    public class SmallArtisanCarving : ArtisanIngredients
    {
        public static string DisplayName = "Small Artisan Carving (Guild)";

        public SmallArtisanCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallArtisanCarving(QuantityRequested);
        }
