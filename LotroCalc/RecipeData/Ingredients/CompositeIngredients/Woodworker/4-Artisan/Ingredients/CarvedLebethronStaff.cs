...
{
    public class CarvedLebethronStaff : ArtisanIngredients
    {
        public static string DisplayName = "Carved Lebethron Staff";

        public CarvedLebethronStaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedLebethronStaff(QuantityRequested);
        }
