...
{
    public class SmoothLebethronBow : ArtisanIngredients
    {
        public static string DisplayName = "Smooth Lebethron Bow";

        public SmoothLebethronBow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmoothLebethronBow(QuantityRequested);
        }
