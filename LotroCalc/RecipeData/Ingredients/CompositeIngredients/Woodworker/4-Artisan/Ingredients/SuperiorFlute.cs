...
{
    public class SuperiorFlute : ArtisanIngredients
    {
        public static string DisplayName = "Superior Flute";

        public SuperiorFlute(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorFlute(QuantityRequested);
        }
