...
{
    public class LebethronBowstaff : ArtisanIngredients
    {
        public static string DisplayName = "Lebethron Bowstaff";

        public LebethronBowstaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LebethronBowstaff(QuantityRequested);
        }
