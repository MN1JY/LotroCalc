...
{
    public class SuperiorDrum : ArtisanIngredients
    {
        public static string DisplayName = "Superior Drum";

        public SuperiorDrum(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorDrum(QuantityRequested);
        }
