...
{
    public class SuperiorHarp : ArtisanIngredients
    {
        public static string DisplayName = "Superior Harp";

        public SuperiorHarp(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorHarp(QuantityRequested);
        }
