...
{
    public class ReinforcedLebethronBow : ArtisanIngredients
    {
        public static string DisplayName = "Reinforced Lebethron Bow";

        public ReinforcedLebethronBow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReinforcedLebethronBow(QuantityRequested);
        }
