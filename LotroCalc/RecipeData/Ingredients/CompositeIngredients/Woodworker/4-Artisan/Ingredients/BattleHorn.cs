...
{
    public class BattleHorn : ArtisanIngredients
    {
        public static string DisplayName = "Battle Horn";

        public BattleHorn(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BattleHorn(QuantityRequested);
        }
