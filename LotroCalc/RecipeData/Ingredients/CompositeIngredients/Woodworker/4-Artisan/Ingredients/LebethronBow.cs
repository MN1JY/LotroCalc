...
{
    public class LebethronBow : ArtisanIngredients
    {
        public static string DisplayName = "Lebethron Bow";

        public LebethronBow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LebethronBow(QuantityRequested);
        }
