...
{
    public class SuperiorLute : ArtisanIngredients
    {
        public static string DisplayName = "Superior Lute";

        public SuperiorLute(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorLute(QuantityRequested);
        }
