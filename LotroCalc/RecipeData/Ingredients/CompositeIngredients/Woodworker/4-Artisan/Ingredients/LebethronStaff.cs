...
{
    public class LebethronStaff : ArtisanIngredients
    {
        public static string DisplayName = "Lebethron Staff";

        public LebethronStaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LebethronStaff(QuantityRequested);
        }
