...
{
    public class ScholarsCupboard : ArtisanIngredients
    {
        public static string DisplayName = "Scholar's Cupboard";

        public ScholarsCupboard(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ScholarsCupboard(QuantityRequested);
        }
