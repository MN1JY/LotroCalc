...
{
    public class OrnateLebethronStaffGuild : ArtisanIngredients
    {
        public static string DisplayName = "Ornate Lebethron Staff (Guild)";

        public OrnateLebethronStaffGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OrnateLebethronStaffGuild(QuantityRequested);
        }
