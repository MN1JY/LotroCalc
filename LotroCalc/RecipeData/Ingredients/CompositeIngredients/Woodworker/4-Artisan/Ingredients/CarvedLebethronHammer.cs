...
{
    public class CarvedLebethronHammer : ArtisanIngredients
    {
        public static string DisplayName = "Carved Lebethron Hammer";

        public CarvedLebethronHammer(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedLebethronHammer(QuantityRequested);
        }
