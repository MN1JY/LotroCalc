...
{
    public class SmoothLebethronStaff : ArtisanIngredients
    {
        public static string DisplayName = "Smooth Lebethron Staff";

        public SmoothLebethronStaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmoothLebethronStaff(QuantityRequested);
        }
