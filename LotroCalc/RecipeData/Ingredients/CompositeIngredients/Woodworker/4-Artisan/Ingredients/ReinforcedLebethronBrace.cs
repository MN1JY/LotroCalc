...
{
    public class ReinforcedLebethronBrace : ArtisanIngredients
    {
        public static string DisplayName = "Reinforced Lebethron Brace";

        public ReinforcedLebethronBrace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReinforcedLebethronBrace(QuantityRequested);
        }
