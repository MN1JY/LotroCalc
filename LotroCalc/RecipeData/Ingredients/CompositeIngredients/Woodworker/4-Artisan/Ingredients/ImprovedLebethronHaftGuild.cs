...
{
    public class ImprovedLebethronHaftGuild : ArtisanIngredients
    {
        public static string DisplayName = "Improved Lebethron Haft (Guild)";

        public ImprovedLebethronHaftGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedLebethronHaftGuild(QuantityRequested);
        }
