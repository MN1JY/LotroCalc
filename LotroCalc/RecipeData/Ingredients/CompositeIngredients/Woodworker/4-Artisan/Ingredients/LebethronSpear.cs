...
{
    public class LebethronSpear : ArtisanIngredients
    {
        public static string DisplayName = "Lebethron Spear";

        public LebethronSpear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LebethronSpear(QuantityRequested);
        }
