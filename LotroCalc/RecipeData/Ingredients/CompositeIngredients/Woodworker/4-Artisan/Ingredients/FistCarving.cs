...
{
    public class FistCarving : ArtisanIngredients
    {
        public static string DisplayName = "Fist Carving";

        public FistCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FistCarving(QuantityRequested);
        }
