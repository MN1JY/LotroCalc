...
{
    public class ReinforcedLebethronSpear : ArtisanIngredients
    {
        public static string DisplayName = "Reinforced Lebethron Spear";

        public ReinforcedLebethronSpear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReinforcedLebethronSpear(QuantityRequested);
        }
