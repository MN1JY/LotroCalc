...
{
    public class GoldenHostHammerofWarding : SupremeIngredients
    {
        public static string DisplayName = "Golden Host Hammer of Warding";

        public GoldenHostHammerofWarding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenHostHammerofWarding(QuantityRequested);
        }
