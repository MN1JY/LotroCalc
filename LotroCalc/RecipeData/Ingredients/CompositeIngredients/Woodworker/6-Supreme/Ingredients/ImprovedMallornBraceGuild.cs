...
{
    public class ImprovedMallornBraceGuild : SupremeIngredients
    {
        public static string DisplayName = "Improved Mallorn Brace (Guild)";

        public ImprovedMallornBraceGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedMallornBraceGuild(QuantityRequested);
        }
