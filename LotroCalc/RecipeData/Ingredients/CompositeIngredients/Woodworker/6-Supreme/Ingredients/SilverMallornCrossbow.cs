...
{
    public class SilverMallornCrossbow : SupremeIngredients
    {
        public static string DisplayName = "Silver Mallorn Crossbow";

        public SilverMallornCrossbow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SilverMallornCrossbow(QuantityRequested);
        }
