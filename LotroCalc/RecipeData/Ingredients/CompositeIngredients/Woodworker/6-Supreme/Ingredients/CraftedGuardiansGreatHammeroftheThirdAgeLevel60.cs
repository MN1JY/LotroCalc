...
{
    public class CraftedGuardiansGreatHammeroftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Great Hammer of the Third Age (Level 60)";

        public CraftedGuardiansGreatHammeroftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansGreatHammeroftheThirdAgeLevel60(QuantityRequested);
        }
