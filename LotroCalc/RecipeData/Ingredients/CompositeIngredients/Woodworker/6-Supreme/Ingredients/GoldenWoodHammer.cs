...
{
    public class GoldenWoodHammer : SupremeIngredients
    {
        public static string DisplayName = "Golden Wood Hammer";

        public GoldenWoodHammer(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenWoodHammer(QuantityRequested);
        }
