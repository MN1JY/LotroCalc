...
{
    public class PeerlessSilverMallornCrossbowGuild : SupremeIngredients
    {
        public static string DisplayName = "Peerless Silver Mallorn Crossbow (Guild)";

        public PeerlessSilverMallornCrossbowGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PeerlessSilverMallornCrossbowGuild(QuantityRequested);
        }
