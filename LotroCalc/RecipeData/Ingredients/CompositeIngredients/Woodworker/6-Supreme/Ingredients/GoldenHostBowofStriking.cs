...
{
    public class GoldenHostBowofStriking : SupremeIngredients
    {
        public static string DisplayName = "Golden Host Bow of Striking";

        public GoldenHostBowofStriking(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenHostBowofStriking(QuantityRequested);
        }
