...
{
    public class SilverMallornBow : SupremeIngredients
    {
        public static string DisplayName = "Silver Mallorn Bow";

        public SilverMallornBow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SilverMallornBow(QuantityRequested);
        }
