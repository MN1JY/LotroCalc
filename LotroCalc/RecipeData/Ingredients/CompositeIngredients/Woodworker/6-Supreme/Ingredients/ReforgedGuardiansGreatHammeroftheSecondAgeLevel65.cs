...
{
    public class ReforgedGuardiansGreatHammeroftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Great Hammer of the Second Age (Level 65)";

        public ReforgedGuardiansGreatHammeroftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansGreatHammeroftheSecondAgeLevel65(QuantityRequested);
        }
