...
{
    public class IlexBowstaff : SupremeIngredients
    {
        public static string DisplayName = "Ilex Bowstaff";

        public IlexBowstaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IlexBowstaff(QuantityRequested);
        }
