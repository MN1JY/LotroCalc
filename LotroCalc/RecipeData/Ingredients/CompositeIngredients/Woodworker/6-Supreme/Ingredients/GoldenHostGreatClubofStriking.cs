...
{
    public class GoldenHostGreatClubofStriking : SupremeIngredients
    {
        public static string DisplayName = "Golden Host Great Club of Striking";

        public GoldenHostGreatClubofStriking(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenHostGreatClubofStriking(QuantityRequested);
        }
