...
{
    public class ReforgedGuardiansGreatHammeroftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Great Hammer of the Second Age (Level 60)";

        public ReforgedGuardiansGreatHammeroftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansGreatHammeroftheSecondAgeLevel60(QuantityRequested);
        }
