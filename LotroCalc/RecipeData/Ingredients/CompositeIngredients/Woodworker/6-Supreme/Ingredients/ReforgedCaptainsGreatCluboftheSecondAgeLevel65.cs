...
{
    public class ReforgedCaptainsGreatCluboftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Great Club of the Second Age (Level 65)";

        public ReforgedCaptainsGreatCluboftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsGreatCluboftheSecondAgeLevel65(QuantityRequested);
        }
