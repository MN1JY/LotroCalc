...
{
    public class ReforgedWardensSpearoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Warden's Spear of the Second Age (Level 60)";

        public ReforgedWardensSpearoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedWardensSpearoftheSecondAgeLevel60(QuantityRequested);
        }
