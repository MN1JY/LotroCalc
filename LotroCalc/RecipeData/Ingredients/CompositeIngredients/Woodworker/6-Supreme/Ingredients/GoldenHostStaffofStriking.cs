...
{
    public class GoldenHostStaffofStriking : SupremeIngredients
    {
        public static string DisplayName = "Golden Host Staff of Striking";

        public GoldenHostStaffofStriking(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenHostStaffofStriking(QuantityRequested);
        }
