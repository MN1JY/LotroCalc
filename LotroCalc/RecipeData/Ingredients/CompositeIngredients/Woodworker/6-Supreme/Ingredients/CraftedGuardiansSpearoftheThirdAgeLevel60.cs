...
{
    public class CraftedGuardiansSpearoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Spear of the Third Age (Level 60)";

        public CraftedGuardiansSpearoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansSpearoftheThirdAgeLevel60(QuantityRequested);
        }
