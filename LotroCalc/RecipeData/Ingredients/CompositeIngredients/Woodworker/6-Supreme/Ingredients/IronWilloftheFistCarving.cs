...
{
    public class IronWilloftheFistCarving : SupremeIngredients
    {
        public static string DisplayName = "Iron Will of the Fist Carving";

        public IronWilloftheFistCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IronWilloftheFistCarving(QuantityRequested);
        }
