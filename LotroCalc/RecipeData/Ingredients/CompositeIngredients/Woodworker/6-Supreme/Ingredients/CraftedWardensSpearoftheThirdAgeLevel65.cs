...
{
    public class CraftedWardensSpearoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Warden's Spear of the Third Age (Level 65)";

        public CraftedWardensSpearoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedWardensSpearoftheThirdAgeLevel65(QuantityRequested);
        }
