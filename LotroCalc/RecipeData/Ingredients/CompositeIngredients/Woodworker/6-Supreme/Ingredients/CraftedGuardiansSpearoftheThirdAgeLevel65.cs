...
{
    public class CraftedGuardiansSpearoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Spear of the Third Age (Level 65)";

        public CraftedGuardiansSpearoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansSpearoftheThirdAgeLevel65(QuantityRequested);
        }
