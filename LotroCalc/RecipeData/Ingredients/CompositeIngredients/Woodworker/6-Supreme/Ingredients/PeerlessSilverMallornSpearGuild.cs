...
{
    public class PeerlessSilverMallornSpearGuild : SupremeIngredients
    {
        public static string DisplayName = "Peerless Silver Mallorn Spear (Guild)";

        public PeerlessSilverMallornSpearGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PeerlessSilverMallornSpearGuild(QuantityRequested);
        }
