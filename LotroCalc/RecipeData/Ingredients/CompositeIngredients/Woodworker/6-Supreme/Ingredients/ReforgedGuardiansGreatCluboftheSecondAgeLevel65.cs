...
{
    public class ReforgedGuardiansGreatCluboftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Great Club of the Second Age (Level 65)";

        public ReforgedGuardiansGreatCluboftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansGreatCluboftheSecondAgeLevel65(QuantityRequested);
        }
