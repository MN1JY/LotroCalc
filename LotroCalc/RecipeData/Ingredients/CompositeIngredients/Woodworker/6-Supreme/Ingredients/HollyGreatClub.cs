...
{
    public class HollyGreatClub : SupremeIngredients
    {
        public static string DisplayName = "Holly Great Club";

        public HollyGreatClub(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HollyGreatClub(QuantityRequested);
        }
