...
{
    public class CraftedCaptainsGreatCluboftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Great Club of the Third Age (Level 65)";

        public CraftedCaptainsGreatCluboftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsGreatCluboftheThirdAgeLevel65(QuantityRequested);
        }
