...
{
    public class ReforgedChampionsGreatHammeroftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Great Hammer of the Second Age (Level 65)";

        public ReforgedChampionsGreatHammeroftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsGreatHammeroftheSecondAgeLevel65(QuantityRequested);
        }
