...
{
    public class GoldenWoodCrossbow : SupremeIngredients
    {
        public static string DisplayName = "Golden Wood Crossbow";

        public GoldenWoodCrossbow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenWoodCrossbow(QuantityRequested);
        }
