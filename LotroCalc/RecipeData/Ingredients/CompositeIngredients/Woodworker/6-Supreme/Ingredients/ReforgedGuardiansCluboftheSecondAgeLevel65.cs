...
{
    public class ReforgedGuardiansCluboftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Club of the Second Age (Level 65)";

        public ReforgedGuardiansCluboftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansCluboftheSecondAgeLevel65(QuantityRequested);
        }
