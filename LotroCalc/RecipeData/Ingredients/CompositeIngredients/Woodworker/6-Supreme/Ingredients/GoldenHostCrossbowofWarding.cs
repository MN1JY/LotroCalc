...
{
    public class GoldenHostCrossbowofWarding : SupremeIngredients
    {
        public static string DisplayName = "Golden Host Crossbow of Warding";

        public GoldenHostCrossbowofWarding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenHostCrossbowofWarding(QuantityRequested);
        }
