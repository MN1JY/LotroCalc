...
{
    public class ElegantDrum : SupremeIngredients
    {
        public static string DisplayName = "Elegant Drum";

        public ElegantDrum(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElegantDrum(QuantityRequested);
        }
