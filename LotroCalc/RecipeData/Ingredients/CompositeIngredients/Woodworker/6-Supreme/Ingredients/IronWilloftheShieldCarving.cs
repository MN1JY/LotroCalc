...
{
    public class IronWilloftheShieldCarving : SupremeIngredients
    {
        public static string DisplayName = "Iron Will of the Shield Carving";

        public IronWilloftheShieldCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IronWilloftheShieldCarving(QuantityRequested);
        }
