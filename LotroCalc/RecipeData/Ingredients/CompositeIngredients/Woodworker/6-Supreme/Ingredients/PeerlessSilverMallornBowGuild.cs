...
{
    public class PeerlessSilverMallornBowGuild : SupremeIngredients
    {
        public static string DisplayName = "Peerless Silver Mallorn Bow (Guild)";

        public PeerlessSilverMallornBowGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PeerlessSilverMallornBowGuild(QuantityRequested);
        }
