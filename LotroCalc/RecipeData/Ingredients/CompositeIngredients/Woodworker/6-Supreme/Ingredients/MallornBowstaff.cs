...
{
    public class MallornBowstaff : SupremeIngredients
    {
        public static string DisplayName = "Mallorn Bowstaff";

        public MallornBowstaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MallornBowstaff(QuantityRequested);
        }
