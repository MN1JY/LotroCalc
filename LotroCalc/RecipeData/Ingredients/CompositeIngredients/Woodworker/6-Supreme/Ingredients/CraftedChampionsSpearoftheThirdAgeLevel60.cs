...
{
    public class CraftedChampionsSpearoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Spear of the Third Age (Level 60)";

        public CraftedChampionsSpearoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsSpearoftheThirdAgeLevel60(QuantityRequested);
        }
