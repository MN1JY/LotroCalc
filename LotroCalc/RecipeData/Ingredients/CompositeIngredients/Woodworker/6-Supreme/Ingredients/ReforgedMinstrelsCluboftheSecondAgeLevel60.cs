...
{
    public class ReforgedMinstrelsCluboftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Minstrel's Club of the Second Age (Level 60)";

        public ReforgedMinstrelsCluboftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedMinstrelsCluboftheSecondAgeLevel60(QuantityRequested);
        }
