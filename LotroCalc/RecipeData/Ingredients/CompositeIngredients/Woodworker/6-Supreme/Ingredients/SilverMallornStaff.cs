...
{
    public class SilverMallornStaff : SupremeIngredients
    {
        public static string DisplayName = "Silver Mallorn Staff";

        public SilverMallornStaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SilverMallornStaff(QuantityRequested);
        }
