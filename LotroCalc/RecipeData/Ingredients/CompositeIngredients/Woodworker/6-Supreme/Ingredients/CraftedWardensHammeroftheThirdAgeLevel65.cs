...
{
    public class CraftedWardensHammeroftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Warden's Hammer of the Third Age (Level 65)";

        public CraftedWardensHammeroftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedWardensHammeroftheThirdAgeLevel65(QuantityRequested);
        }
