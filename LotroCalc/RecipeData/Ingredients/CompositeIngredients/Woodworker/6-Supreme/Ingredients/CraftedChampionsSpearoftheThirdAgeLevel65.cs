...
{
    public class CraftedChampionsSpearoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Spear of the Third Age (Level 65)";

        public CraftedChampionsSpearoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsSpearoftheThirdAgeLevel65(QuantityRequested);
        }
