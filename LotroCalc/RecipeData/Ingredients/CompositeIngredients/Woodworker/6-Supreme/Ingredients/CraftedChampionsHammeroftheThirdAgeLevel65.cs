...
{
    public class CraftedChampionsHammeroftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Hammer of the Third Age (Level 65)";

        public CraftedChampionsHammeroftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsHammeroftheThirdAgeLevel65(QuantityRequested);
        }
