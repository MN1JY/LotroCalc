...
{
    public class CraftedWardensHammeroftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Warden's Hammer of the Third Age (Level 60)";

        public CraftedWardensHammeroftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedWardensHammeroftheThirdAgeLevel60(QuantityRequested);
        }
