...
{
    public class GoldenHostClubofStriking : SupremeIngredients
    {
        public static string DisplayName = "Golden Host Club of Striking";

        public GoldenHostClubofStriking(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenHostClubofStriking(QuantityRequested);
        }
