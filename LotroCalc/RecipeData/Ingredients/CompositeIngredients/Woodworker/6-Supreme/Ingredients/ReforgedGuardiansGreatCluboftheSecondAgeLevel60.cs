...
{
    public class ReforgedGuardiansGreatCluboftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Great Club of the Second Age (Level 60)";

        public ReforgedGuardiansGreatCluboftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansGreatCluboftheSecondAgeLevel60(QuantityRequested);
        }
