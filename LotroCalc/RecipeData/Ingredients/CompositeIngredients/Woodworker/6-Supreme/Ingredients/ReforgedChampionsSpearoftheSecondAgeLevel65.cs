...
{
    public class ReforgedChampionsSpearoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Spear of the Second Age (Level 65)";

        public ReforgedChampionsSpearoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsSpearoftheSecondAgeLevel65(QuantityRequested);
        }
