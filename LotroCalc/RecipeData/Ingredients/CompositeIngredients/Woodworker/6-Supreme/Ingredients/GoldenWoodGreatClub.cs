...
{
    public class GoldenWoodGreatClub : SupremeIngredients
    {
        public static string DisplayName = "Golden Wood Great Club";

        public GoldenWoodGreatClub(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenWoodGreatClub(QuantityRequested);
        }
