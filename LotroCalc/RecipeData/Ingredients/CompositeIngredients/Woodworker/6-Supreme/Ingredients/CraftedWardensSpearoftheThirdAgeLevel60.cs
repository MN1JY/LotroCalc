...
{
    public class CraftedWardensSpearoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Warden's Spear of the Third Age (Level 60)";

        public CraftedWardensSpearoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedWardensSpearoftheThirdAgeLevel60(QuantityRequested);
        }
