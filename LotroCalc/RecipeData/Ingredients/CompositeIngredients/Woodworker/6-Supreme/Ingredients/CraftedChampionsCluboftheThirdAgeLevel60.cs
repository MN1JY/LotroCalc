...
{
    public class CraftedChampionsCluboftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Club of the Third Age (Level 60)";

        public CraftedChampionsCluboftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsCluboftheThirdAgeLevel60(QuantityRequested);
        }
