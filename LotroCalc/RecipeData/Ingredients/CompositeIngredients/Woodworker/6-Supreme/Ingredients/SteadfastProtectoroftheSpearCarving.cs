...
{
    public class SteadfastProtectoroftheSpearCarving : SupremeIngredients
    {
        public static string DisplayName = "Steadfast Protector of the Spear Carving";

        public SteadfastProtectoroftheSpearCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SteadfastProtectoroftheSpearCarving(QuantityRequested);
        }
