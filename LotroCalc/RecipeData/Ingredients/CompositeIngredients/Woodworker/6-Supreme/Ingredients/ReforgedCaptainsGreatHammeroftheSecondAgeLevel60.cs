...
{
    public class ReforgedCaptainsGreatHammeroftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Great Hammer of the Second Age (Level 60)";

        public ReforgedCaptainsGreatHammeroftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsGreatHammeroftheSecondAgeLevel60(QuantityRequested);
        }
