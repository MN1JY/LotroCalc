...
{
    public class ReforgedHuntersSpearoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Spear of the Second Age (Level 60)";

        public ReforgedHuntersSpearoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersSpearoftheSecondAgeLevel60(QuantityRequested);
        }
