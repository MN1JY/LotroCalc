...
{
    public class ReforgedLoremastersStaffoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Lore-master's Staff of the Second Age (Level 65)";

        public ReforgedLoremastersStaffoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedLoremastersStaffoftheSecondAgeLevel65(QuantityRequested);
        }
