...
{
    public class ReforgedHuntersCrossbowoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Crossbow of the Second Age (Level 65)";

        public ReforgedHuntersCrossbowoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersCrossbowoftheSecondAgeLevel65(QuantityRequested);
        }
