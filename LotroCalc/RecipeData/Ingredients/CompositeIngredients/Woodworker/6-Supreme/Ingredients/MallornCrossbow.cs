...
{
    public class MallornCrossbow : SupremeIngredients
    {
        public static string DisplayName = "Mallorn Crossbow";

        public MallornCrossbow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MallornCrossbow(QuantityRequested);
        }
