...
{
    public class GoldenHostJavelinofStriking : SupremeIngredients
    {
        public static string DisplayName = "Golden Host Javelin of Striking";

        public GoldenHostJavelinofStriking(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenHostJavelinofStriking(QuantityRequested);
        }
