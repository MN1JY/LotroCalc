...
{
    public class CraftedCaptainsGreatCluboftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Great Club of the Third Age (Level 60)";

        public CraftedCaptainsGreatCluboftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsGreatCluboftheThirdAgeLevel60(QuantityRequested);
        }
