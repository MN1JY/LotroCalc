...
{
    public class CraftedHuntersBowoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Hunter's Bow of the Third Age (Level 60)";

        public CraftedHuntersBowoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedHuntersBowoftheThirdAgeLevel60(QuantityRequested);
        }
