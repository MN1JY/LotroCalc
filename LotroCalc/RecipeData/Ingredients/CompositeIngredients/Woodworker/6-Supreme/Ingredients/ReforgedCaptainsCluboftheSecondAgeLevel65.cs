...
{
    public class ReforgedCaptainsCluboftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Club of the Second Age (Level 65)";

        public ReforgedCaptainsCluboftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsCluboftheSecondAgeLevel65(QuantityRequested);
        }
