...
{
    public class FlashingBaneoftheSpearCarving : SupremeIngredients
    {
        public static string DisplayName = "Flashing Bane of the Spear Carving";

        public FlashingBaneoftheSpearCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FlashingBaneoftheSpearCarving(QuantityRequested);
        }
