...
{
    public class CraftedLoremastersStaffoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Lore-master's Staff of the Third Age (Level 65)";

        public CraftedLoremastersStaffoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedLoremastersStaffoftheThirdAgeLevel65(QuantityRequested);
        }
