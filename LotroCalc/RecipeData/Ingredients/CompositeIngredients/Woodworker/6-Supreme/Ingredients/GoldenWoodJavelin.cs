...
{
    public class GoldenWoodJavelin : SupremeIngredients
    {
        public static string DisplayName = "Golden Wood Javelin";

        public GoldenWoodJavelin(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenWoodJavelin(QuantityRequested);
        }
