...
{
    public class PeerlessSilverMallornJavelinGuild : SupremeIngredients
    {
        public static string DisplayName = "Peerless Silver Mallorn Javelin (Guild)";

        public PeerlessSilverMallornJavelinGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PeerlessSilverMallornJavelinGuild(QuantityRequested);
        }
