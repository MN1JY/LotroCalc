...
{
    public class CraftedGuardiansGreatCluboftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Great Club of the Third Age (Level 60)";

        public CraftedGuardiansGreatCluboftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansGreatCluboftheThirdAgeLevel60(QuantityRequested);
        }
