...
{
    public class CraftedChampionsHammeroftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Hammer of the Third Age (Level 60)";

        public CraftedChampionsHammeroftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsHammeroftheThirdAgeLevel60(QuantityRequested);
        }
