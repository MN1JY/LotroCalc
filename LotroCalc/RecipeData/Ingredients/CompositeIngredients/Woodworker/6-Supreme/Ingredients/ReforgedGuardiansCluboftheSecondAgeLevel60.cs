...
{
    public class ReforgedGuardiansCluboftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Club of the Second Age (Level 60)";

        public ReforgedGuardiansCluboftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansCluboftheSecondAgeLevel60(QuantityRequested);
        }
