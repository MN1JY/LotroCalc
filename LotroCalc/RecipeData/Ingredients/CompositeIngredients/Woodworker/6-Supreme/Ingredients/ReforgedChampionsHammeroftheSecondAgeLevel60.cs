...
{
    public class ReforgedChampionsHammeroftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Hammer of the Second Age (Level 60)";

        public ReforgedChampionsHammeroftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsHammeroftheSecondAgeLevel60(QuantityRequested);
        }
