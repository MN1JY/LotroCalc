...
{
    public class IlexHammer : SupremeIngredients
    {
        public static string DisplayName = "Ilex Hammer";

        public IlexHammer(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IlexHammer(QuantityRequested);
        }
