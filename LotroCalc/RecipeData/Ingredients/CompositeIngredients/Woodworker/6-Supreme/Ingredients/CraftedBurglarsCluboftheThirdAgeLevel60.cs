...
{
    public class CraftedBurglarsCluboftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Burglar's Club of the Third Age (Level 60)";

        public CraftedBurglarsCluboftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedBurglarsCluboftheThirdAgeLevel60(QuantityRequested);
        }
