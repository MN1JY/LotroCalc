...
{
    public class CraftedLoremastersStaffoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Lore-master's Staff of the Third Age (Level 60)";

        public CraftedLoremastersStaffoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedLoremastersStaffoftheThirdAgeLevel60(QuantityRequested);
        }
