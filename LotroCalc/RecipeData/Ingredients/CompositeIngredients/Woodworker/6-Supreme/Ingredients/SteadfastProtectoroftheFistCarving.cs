...
{
    public class SteadfastProtectoroftheFistCarving : SupremeIngredients
    {
        public static string DisplayName = "Steadfast Protector of the Fist Carving";

        public SteadfastProtectoroftheFistCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SteadfastProtectoroftheFistCarving(QuantityRequested);
        }
