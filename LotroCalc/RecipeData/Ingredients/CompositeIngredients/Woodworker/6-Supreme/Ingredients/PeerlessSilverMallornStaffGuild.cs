...
{
    public class PeerlessSilverMallornStaffGuild : SupremeIngredients
    {
        public static string DisplayName = "Peerless Silver Mallorn Staff (Guild)";

        public PeerlessSilverMallornStaffGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PeerlessSilverMallornStaffGuild(QuantityRequested);
        }
