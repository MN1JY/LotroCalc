...
{
    public class TrueGoldenWoodBow : SupremeIngredients
    {
        public static string DisplayName = "True Golden Wood Bow (Guild)";

        public TrueGoldenWoodBow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TrueGoldenWoodBow(QuantityRequested);
        }
