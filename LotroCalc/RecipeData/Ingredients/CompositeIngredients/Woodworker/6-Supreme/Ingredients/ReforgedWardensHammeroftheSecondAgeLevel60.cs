...
{
    public class ReforgedWardensHammeroftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Warden's Hammer of the Second Age (Level 60)";

        public ReforgedWardensHammeroftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedWardensHammeroftheSecondAgeLevel60(QuantityRequested);
        }
