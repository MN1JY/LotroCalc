...
{
    public class ReforgedCaptainsGreatHammeroftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Great Hammer of the Second Age (Level 65)";

        public ReforgedCaptainsGreatHammeroftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsGreatHammeroftheSecondAgeLevel65(QuantityRequested);
        }
