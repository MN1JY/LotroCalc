...
{
    public class SilverMallornGreatClub : SupremeIngredients
    {
        public static string DisplayName = "Silver Mallorn Great Club";

        public SilverMallornGreatClub(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SilverMallornGreatClub(QuantityRequested);
        }
