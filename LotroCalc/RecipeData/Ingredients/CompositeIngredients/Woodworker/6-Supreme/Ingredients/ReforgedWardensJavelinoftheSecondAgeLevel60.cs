...
{
    public class ReforgedWardensJavelinoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Warden's Javelin of the Second Age (Level 60)";

        public ReforgedWardensJavelinoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedWardensJavelinoftheSecondAgeLevel60(QuantityRequested);
        }
