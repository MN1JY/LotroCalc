...
{
    public class CraftedChampionsGreatHammeroftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Great Hammer of the Third Age (Level 60)";

        public CraftedChampionsGreatHammeroftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsGreatHammeroftheThirdAgeLevel60(QuantityRequested);
        }
