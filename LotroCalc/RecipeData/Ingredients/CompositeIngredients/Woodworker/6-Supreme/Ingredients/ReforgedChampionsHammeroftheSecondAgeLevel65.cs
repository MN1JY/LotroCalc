...
{
    public class ReforgedChampionsHammeroftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Hammer of the Second Age (Level 65)";

        public ReforgedChampionsHammeroftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsHammeroftheSecondAgeLevel65(QuantityRequested);
        }
