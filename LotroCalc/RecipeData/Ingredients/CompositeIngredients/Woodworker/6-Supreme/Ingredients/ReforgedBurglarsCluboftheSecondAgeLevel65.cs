...
{
    public class ReforgedBurglarsCluboftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Burglar's Club of the Second Age (Level 65)";

        public ReforgedBurglarsCluboftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedBurglarsCluboftheSecondAgeLevel65(QuantityRequested);
        }
