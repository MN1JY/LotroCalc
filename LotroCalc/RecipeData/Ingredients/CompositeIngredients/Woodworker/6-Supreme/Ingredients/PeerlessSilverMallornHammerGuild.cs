...
{
    public class PeerlessSilverMallornHammerGuild : SupremeIngredients
    {
        public static string DisplayName = "Peerless Silver Mallorn Hammer (Guild)";

        public PeerlessSilverMallornHammerGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PeerlessSilverMallornHammerGuild(QuantityRequested);
        }
