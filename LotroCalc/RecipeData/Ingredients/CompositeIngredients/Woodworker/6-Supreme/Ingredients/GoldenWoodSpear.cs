...
{
    public class GoldenWoodSpear : SupremeIngredients
    {
        public static string DisplayName = "Golden Wood Spear";

        public GoldenWoodSpear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenWoodSpear(QuantityRequested);
        }
