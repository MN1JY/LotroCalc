...
{
    public class CraftedGuardiansHammeroftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Hammer of the Third Age (Level 60)";

        public CraftedGuardiansHammeroftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansHammeroftheThirdAgeLevel60(QuantityRequested);
        }
