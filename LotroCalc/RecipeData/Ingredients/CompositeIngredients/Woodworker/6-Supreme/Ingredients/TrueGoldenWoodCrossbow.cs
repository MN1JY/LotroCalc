...
{
    public class TrueGoldenWoodCrossbow : SupremeIngredients
    {
        public static string DisplayName = "True Golden Wood Crossbow (Guild)";

        public TrueGoldenWoodCrossbow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TrueGoldenWoodCrossbow(QuantityRequested);
        }
