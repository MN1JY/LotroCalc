...
{
    public class SilverMallornHammer : SupremeIngredients
    {
        public static string DisplayName = "Silver Mallorn Hammer";

        public SilverMallornHammer(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SilverMallornHammer(QuantityRequested);
        }
