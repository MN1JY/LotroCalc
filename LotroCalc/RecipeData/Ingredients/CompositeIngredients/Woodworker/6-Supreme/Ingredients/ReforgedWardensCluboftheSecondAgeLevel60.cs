...
{
    public class ReforgedWardensCluboftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Warden's Club of the Second Age (Level 60)";

        public ReforgedWardensCluboftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedWardensCluboftheSecondAgeLevel60(QuantityRequested);
        }
