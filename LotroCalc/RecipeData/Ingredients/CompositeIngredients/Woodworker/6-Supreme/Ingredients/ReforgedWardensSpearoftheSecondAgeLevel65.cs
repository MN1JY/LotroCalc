...
{
    public class ReforgedWardensSpearoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Warden's Spear of the Second Age (Level 65)";

        public ReforgedWardensSpearoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedWardensSpearoftheSecondAgeLevel65(QuantityRequested);
        }
