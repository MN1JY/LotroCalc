...
{
    public class GoldenHostSpearofWarding : SupremeIngredients
    {
        public static string DisplayName = "Golden Host Spear of Warding";

        public GoldenHostSpearofWarding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenHostSpearofWarding(QuantityRequested);
        }
