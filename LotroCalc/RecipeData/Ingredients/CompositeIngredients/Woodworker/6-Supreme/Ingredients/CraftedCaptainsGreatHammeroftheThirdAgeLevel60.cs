...
{
    public class CraftedCaptainsGreatHammeroftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Great Hammer of the Third Age (Level 60)";

        public CraftedCaptainsGreatHammeroftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsGreatHammeroftheThirdAgeLevel60(QuantityRequested);
        }
