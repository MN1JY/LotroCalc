...
{
    public class GoldenHostHammerofStriking : SupremeIngredients
    {
        public static string DisplayName = "Golden Host Hammer of Striking";

        public GoldenHostHammerofStriking(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenHostHammerofStriking(QuantityRequested);
        }
