...
{
    public class SmallSupremeCarvingGuild : SupremeIngredients
    {
        public static string DisplayName = "Small Supreme Carving (Guild)";

        public SmallSupremeCarvingGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallSupremeCarvingGuild(QuantityRequested);
        }
