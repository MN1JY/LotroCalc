...
{
    public class CraftedCaptainsCluboftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Club of the Third Age (Level 65)";

        public CraftedCaptainsCluboftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsCluboftheThirdAgeLevel65(QuantityRequested);
        }
