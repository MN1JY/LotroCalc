...
{
    public class CraftedHuntersCrossbowoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Hunter's Crossbow of the Third Age (Level 60)";

        public CraftedHuntersCrossbowoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedHuntersCrossbowoftheThirdAgeLevel60(QuantityRequested);
        }
