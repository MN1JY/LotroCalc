...
{
    public class ReforgedCaptainsHammeroftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Hammer of the Second Age (Level 60)";

        public ReforgedCaptainsHammeroftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsHammeroftheSecondAgeLevel60(QuantityRequested);
        }
