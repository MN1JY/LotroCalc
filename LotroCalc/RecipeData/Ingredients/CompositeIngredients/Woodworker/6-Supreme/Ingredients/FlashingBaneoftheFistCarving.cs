...
{
    public class FlashingBaneoftheFistCarving : SupremeIngredients
    {
        public static string DisplayName = "Flashing Bane of the Fist Carving";

        public FlashingBaneoftheFistCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FlashingBaneoftheFistCarving(QuantityRequested);
        }
