...
{
    public class CraftedGuardiansCluboftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Club of the Third Age (Level 65)";

        public CraftedGuardiansCluboftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansCluboftheThirdAgeLevel65(QuantityRequested);
        }
