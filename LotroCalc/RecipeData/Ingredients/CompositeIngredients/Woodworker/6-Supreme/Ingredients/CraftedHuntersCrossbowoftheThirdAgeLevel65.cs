...
{
    public class CraftedHuntersCrossbowoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Hunter's Crossbow of the Third Age (Level 65)";

        public CraftedHuntersCrossbowoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedHuntersCrossbowoftheThirdAgeLevel65(QuantityRequested);
        }
