...
{
    public class ReforgedHuntersSpearoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Spear of the Second Age (Level 65)";

        public ReforgedHuntersSpearoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersSpearoftheSecondAgeLevel65(QuantityRequested);
        }
