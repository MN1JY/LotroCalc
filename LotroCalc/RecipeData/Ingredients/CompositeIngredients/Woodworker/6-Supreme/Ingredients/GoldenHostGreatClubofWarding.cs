...
{
    public class GoldenHostGreatClubofWarding : SupremeIngredients
    {
        public static string DisplayName = "Golden Host Great Club of Warding";

        public GoldenHostGreatClubofWarding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenHostGreatClubofWarding(QuantityRequested);
        }
