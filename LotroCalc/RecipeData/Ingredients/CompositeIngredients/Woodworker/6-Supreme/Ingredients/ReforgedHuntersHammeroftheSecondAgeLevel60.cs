...
{
    public class ReforgedHuntersHammeroftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Hammer of the Second Age (Level 60)";

        public ReforgedHuntersHammeroftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersHammeroftheSecondAgeLevel60(QuantityRequested);
        }
