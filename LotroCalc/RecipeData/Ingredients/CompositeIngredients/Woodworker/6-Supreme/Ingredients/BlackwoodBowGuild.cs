...
{
    public class BlackwoodBowGuild : SupremeIngredients
    {
        public static string DisplayName = "Black-wood Bow (Guild)";

        public BlackwoodBowGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BlackwoodBowGuild(QuantityRequested);
        }
