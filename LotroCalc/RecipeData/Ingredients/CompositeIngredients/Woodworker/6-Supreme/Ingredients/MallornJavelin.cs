...
{
    public class MallornJavelin : SupremeIngredients
    {
        public static string DisplayName = "Mallorn Javelin";

        public MallornJavelin(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MallornJavelin(QuantityRequested);
        }
