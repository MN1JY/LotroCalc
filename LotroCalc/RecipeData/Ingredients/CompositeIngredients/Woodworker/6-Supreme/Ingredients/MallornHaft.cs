...
{
    public class MallornHaft : SupremeIngredients
    {
        public static string DisplayName = "Mallorn Haft";

        public MallornHaft(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MallornHaft(QuantityRequested);
        }
