...
{
    public class ReforgedChampionsCluboftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Club of the Second Age (Level 60)";

        public ReforgedChampionsCluboftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsCluboftheSecondAgeLevel60(QuantityRequested);
        }
