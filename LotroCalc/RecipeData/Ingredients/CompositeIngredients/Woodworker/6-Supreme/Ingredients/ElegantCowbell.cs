...
{
    public class ElegantCowbell : SupremeIngredients
    {
        public static string DisplayName = "Elegant Cowbell";

        public ElegantCowbell(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElegantCowbell(QuantityRequested);
        }
