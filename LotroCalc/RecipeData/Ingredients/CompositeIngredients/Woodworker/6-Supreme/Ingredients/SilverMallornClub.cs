...
{
    public class SilverMallornClub : SupremeIngredients
    {
        public static string DisplayName = "Silver Mallorn Club";

        public SilverMallornClub(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SilverMallornClub(QuantityRequested);
        }
