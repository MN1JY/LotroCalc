...
{
    public class CraftedHuntersSpearoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Hunter's Spear of the Third Age (Level 60)";

        public CraftedHuntersSpearoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedHuntersSpearoftheThirdAgeLevel60(QuantityRequested);
        }
