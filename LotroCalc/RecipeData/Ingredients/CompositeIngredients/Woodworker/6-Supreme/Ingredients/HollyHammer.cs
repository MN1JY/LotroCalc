...
{
    public class HollyHammer : SupremeIngredients
    {
        public static string DisplayName = "Holly Hammer";

        public HollyHammer(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HollyHammer(QuantityRequested);
        }
