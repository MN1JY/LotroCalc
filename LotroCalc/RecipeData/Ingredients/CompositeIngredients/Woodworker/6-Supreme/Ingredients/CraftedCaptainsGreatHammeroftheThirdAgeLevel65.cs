...
{
    public class CraftedCaptainsGreatHammeroftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Great Hammer of the Third Age (Level 65)";

        public CraftedCaptainsGreatHammeroftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsGreatHammeroftheThirdAgeLevel65(QuantityRequested);
        }
