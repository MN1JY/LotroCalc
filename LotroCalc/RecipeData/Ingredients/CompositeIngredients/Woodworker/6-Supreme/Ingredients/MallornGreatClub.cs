...
{
    public class MallornGreatClub : SupremeIngredients
    {
        public static string DisplayName = "Mallorn Great Club";

        public MallornGreatClub(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MallornGreatClub(QuantityRequested);
        }
