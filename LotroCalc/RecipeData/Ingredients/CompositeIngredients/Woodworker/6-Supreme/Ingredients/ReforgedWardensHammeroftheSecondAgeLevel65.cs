...
{
    public class ReforgedWardensHammeroftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Warden's Hammer of the Second Age (Level 65)";

        public ReforgedWardensHammeroftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedWardensHammeroftheSecondAgeLevel65(QuantityRequested);
        }
