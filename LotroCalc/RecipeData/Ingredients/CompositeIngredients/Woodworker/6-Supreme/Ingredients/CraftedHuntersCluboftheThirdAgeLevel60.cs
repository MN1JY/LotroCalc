...
{
    public class CraftedHuntersCluboftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Hunter's Club of the Third Age (Level 60)";

        public CraftedHuntersCluboftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedHuntersCluboftheThirdAgeLevel60(QuantityRequested);
        }
