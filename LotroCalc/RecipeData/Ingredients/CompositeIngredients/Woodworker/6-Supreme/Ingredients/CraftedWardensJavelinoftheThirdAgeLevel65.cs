...
{
    public class CraftedWardensJavelinoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Warden's Javelin of the Third Age (Level 65)";

        public CraftedWardensJavelinoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedWardensJavelinoftheThirdAgeLevel65(QuantityRequested);
        }
