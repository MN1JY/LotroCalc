...
{
    public class MallornClub : SupremeIngredients
    {
        public static string DisplayName = "Mallorn Club";

        public MallornClub(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MallornClub(QuantityRequested);
        }
