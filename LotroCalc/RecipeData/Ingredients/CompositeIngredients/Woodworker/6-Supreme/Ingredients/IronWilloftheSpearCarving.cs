...
{
    public class IronWilloftheSpearCarving : SupremeIngredients
    {
        public static string DisplayName = "Iron Will of the Spear Carving";

        public IronWilloftheSpearCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IronWilloftheSpearCarving(QuantityRequested);
        }
