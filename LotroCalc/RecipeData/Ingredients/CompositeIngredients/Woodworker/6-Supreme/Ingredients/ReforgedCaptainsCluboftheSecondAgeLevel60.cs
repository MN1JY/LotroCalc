...
{
    public class ReforgedCaptainsCluboftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Club of the Second Age (Level 60)";

        public ReforgedCaptainsCluboftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsCluboftheSecondAgeLevel60(QuantityRequested);
        }
