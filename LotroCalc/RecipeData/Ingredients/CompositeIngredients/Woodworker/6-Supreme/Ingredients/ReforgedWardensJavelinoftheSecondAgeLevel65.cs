...
{
    public class ReforgedWardensJavelinoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Warden's Javelin of the Second Age (Level 65)";

        public ReforgedWardensJavelinoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedWardensJavelinoftheSecondAgeLevel65(QuantityRequested);
        }
