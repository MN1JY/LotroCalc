...
{
    public class SilverMallornSpear : SupremeIngredients
    {
        public static string DisplayName = "Silver Mallorn Spear";

        public SilverMallornSpear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SilverMallornSpear(QuantityRequested);
        }
