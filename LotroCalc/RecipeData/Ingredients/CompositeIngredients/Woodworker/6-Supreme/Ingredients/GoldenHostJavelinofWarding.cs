...
{
    public class GoldenHostJavelinofWarding : SupremeIngredients
    {
        public static string DisplayName = "Golden Host Javelin of Warding";

        public GoldenHostJavelinofWarding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenHostJavelinofWarding(QuantityRequested);
        }
