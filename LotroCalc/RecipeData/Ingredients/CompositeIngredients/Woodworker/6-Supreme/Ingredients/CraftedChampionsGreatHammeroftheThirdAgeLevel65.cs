...
{
    public class CraftedChampionsGreatHammeroftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Great Hammer of the Third Age (Level 65)";

        public CraftedChampionsGreatHammeroftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsGreatHammeroftheThirdAgeLevel65(QuantityRequested);
        }
