...
{
    public class CraftedGuardiansGreatCluboftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Great Club of the Third Age (Level 65)";

        public CraftedGuardiansGreatCluboftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansGreatCluboftheThirdAgeLevel65(QuantityRequested);
        }
