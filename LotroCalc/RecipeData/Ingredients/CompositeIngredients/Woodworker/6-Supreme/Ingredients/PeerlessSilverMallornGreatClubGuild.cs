...
{
    public class PeerlessSilverMallornGreatClubGuild : SupremeIngredients
    {
        public static string DisplayName = "Peerless Silver Mallorn Great Club (Guild)";

        public PeerlessSilverMallornGreatClubGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PeerlessSilverMallornGreatClubGuild(QuantityRequested);
        }
