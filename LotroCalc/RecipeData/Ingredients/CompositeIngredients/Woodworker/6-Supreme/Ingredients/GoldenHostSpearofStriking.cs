...
{
    public class GoldenHostSpearofStriking : SupremeIngredients
    {
        public static string DisplayName = "Golden Host Spear of Striking";

        public GoldenHostSpearofStriking(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenHostSpearofStriking(QuantityRequested);
        }
