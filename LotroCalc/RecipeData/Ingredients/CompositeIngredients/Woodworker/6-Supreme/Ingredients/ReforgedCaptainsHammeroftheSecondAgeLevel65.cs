...
{
    public class ReforgedCaptainsHammeroftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Hammer of the Second Age (Level 65)";

        public ReforgedCaptainsHammeroftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsHammeroftheSecondAgeLevel65(QuantityRequested);
        }
