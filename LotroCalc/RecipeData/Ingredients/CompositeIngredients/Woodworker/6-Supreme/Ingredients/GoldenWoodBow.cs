...
{
    public class GoldenWoodBow : SupremeIngredients
    {
        public static string DisplayName = "Golden Wood Bow";

        public GoldenWoodBow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenWoodBow(QuantityRequested);
        }
