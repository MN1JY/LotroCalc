...
{
    public class GoldenWoodClub : SupremeIngredients
    {
        public static string DisplayName = "Golden Wood Club";

        public GoldenWoodClub(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenWoodClub(QuantityRequested);
        }
