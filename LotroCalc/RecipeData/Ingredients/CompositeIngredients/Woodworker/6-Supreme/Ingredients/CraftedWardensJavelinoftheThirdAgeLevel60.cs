...
{
    public class CraftedWardensJavelinoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Warden's Javelin of the Third Age (Level 60)";

        public CraftedWardensJavelinoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedWardensJavelinoftheThirdAgeLevel60(QuantityRequested);
        }
