...
{
    public class GoldenHostStaffofWarding : SupremeIngredients
    {
        public static string DisplayName = "Golden Host Staff of Warding";

        public GoldenHostStaffofWarding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenHostStaffofWarding(QuantityRequested);
        }
