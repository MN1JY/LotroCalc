...
{
    public class ElegantClarinet : SupremeIngredients
    {
        public static string DisplayName = "Elegant Clarinet";

        public ElegantClarinet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElegantClarinet(QuantityRequested);
        }
