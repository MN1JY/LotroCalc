...
{
    public class CraftedCaptainsSpearoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Spear of the Third Age (Level 60)";

        public CraftedCaptainsSpearoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsSpearoftheThirdAgeLevel60(QuantityRequested);
        }
