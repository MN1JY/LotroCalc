...
{
    public class ReforgedChampionsGreatHammeroftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Great Hammer of the Second Age (Level 60)";

        public ReforgedChampionsGreatHammeroftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsGreatHammeroftheSecondAgeLevel60(QuantityRequested);
        }
