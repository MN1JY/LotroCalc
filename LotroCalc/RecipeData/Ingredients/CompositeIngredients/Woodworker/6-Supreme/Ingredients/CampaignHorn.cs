...
{
    public class CampaignHorn : SupremeIngredients
    {
        public static string DisplayName = "Campaign Horn";

        public CampaignHorn(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CampaignHorn(QuantityRequested);
        }
