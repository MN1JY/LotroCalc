...
{
    public class GoldenHostClubofWarding : SupremeIngredients
    {
        public static string DisplayName = "Golden Host Club of Warding";

        public GoldenHostClubofWarding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenHostClubofWarding(QuantityRequested);
        }
