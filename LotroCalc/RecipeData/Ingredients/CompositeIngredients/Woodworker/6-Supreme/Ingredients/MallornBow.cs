...
{
    public class MallornBow : SupremeIngredients
    {
        public static string DisplayName = "Mallorn Bow";

        public MallornBow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MallornBow(QuantityRequested);
        }
