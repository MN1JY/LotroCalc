...
{
    public class MediumSupremeCarving : SupremeIngredients
    {
        public static string DisplayName = "Medium Supreme Carving (Guild)";

        public MediumSupremeCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MediumSupremeCarving(QuantityRequested);
        }
