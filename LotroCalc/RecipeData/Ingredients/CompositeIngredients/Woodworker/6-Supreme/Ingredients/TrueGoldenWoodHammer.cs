...
{
    public class TrueGoldenWoodHammer : SupremeIngredients
    {
        public static string DisplayName = "True Golden Wood Hammer (Guild)";

        public TrueGoldenWoodHammer(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TrueGoldenWoodHammer(QuantityRequested);
        }
