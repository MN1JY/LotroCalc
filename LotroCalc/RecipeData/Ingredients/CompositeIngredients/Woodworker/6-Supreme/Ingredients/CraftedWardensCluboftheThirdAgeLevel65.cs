...
{
    public class CraftedWardensCluboftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Warden's Club of the Third Age (Level 65)";

        public CraftedWardensCluboftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedWardensCluboftheThirdAgeLevel65(QuantityRequested);
        }
