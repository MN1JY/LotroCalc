...
{
    public class ReforgedLoremastersStaffoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Lore-master's Staff of the Second Age (Level 60)";

        public ReforgedLoremastersStaffoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedLoremastersStaffoftheSecondAgeLevel60(QuantityRequested);
        }
