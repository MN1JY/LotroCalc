...
{
    public class FlashingBaneoftheShieldCarving : SupremeIngredients
    {
        public static string DisplayName = "Flashing Bane of the Shield Carving";

        public FlashingBaneoftheShieldCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FlashingBaneoftheShieldCarving(QuantityRequested);
        }
