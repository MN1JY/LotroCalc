...
{
    public class ReforgedHuntersHammeroftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Hammer of the Second Age (Level 65)";

        public ReforgedHuntersHammeroftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersHammeroftheSecondAgeLevel65(QuantityRequested);
        }
