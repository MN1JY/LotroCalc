...
{
    public class CraftedChampionsCluboftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Club of the Third Age (Level 65)";

        public CraftedChampionsCluboftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsCluboftheThirdAgeLevel65(QuantityRequested);
        }
