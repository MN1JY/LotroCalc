...
{
    public class ElegantHorn : SupremeIngredients
    {
        public static string DisplayName = "Elegant Horn";

        public ElegantHorn(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElegantHorn(QuantityRequested);
        }
