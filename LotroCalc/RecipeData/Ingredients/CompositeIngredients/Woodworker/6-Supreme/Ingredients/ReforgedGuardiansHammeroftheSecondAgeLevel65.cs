...
{
    public class ReforgedGuardiansHammeroftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Hammer of the Second Age (Level 65)";

        public ReforgedGuardiansHammeroftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansHammeroftheSecondAgeLevel65(QuantityRequested);
        }
