...
{
    public class CraftedHuntersBowoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Hunter's Bow of the Third Age (Level 65)";

        public CraftedHuntersBowoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedHuntersBowoftheThirdAgeLevel65(QuantityRequested);
        }
