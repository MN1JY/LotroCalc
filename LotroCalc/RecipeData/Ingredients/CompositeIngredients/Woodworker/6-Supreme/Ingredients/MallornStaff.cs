...
{
    public class MallornStaff : SupremeIngredients
    {
        public static string DisplayName = "Mallorn Staff";

        public MallornStaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MallornStaff(QuantityRequested);
        }
