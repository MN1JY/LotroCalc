...
{
    public class CraftedCaptainsSpearoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Spear of the Third Age (Level 65)";

        public CraftedCaptainsSpearoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsSpearoftheThirdAgeLevel65(QuantityRequested);
        }
