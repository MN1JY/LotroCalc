...
{
    public class ReforgedGuardiansHammeroftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Hammer of the Second Age (Level 60)";

        public ReforgedGuardiansHammeroftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansHammeroftheSecondAgeLevel60(QuantityRequested);
        }
