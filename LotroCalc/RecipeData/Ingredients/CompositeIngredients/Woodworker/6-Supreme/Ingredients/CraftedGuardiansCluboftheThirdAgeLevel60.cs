...
{
    public class CraftedGuardiansCluboftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Club of the Third Age (Level 60)";

        public CraftedGuardiansCluboftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansCluboftheThirdAgeLevel60(QuantityRequested);
        }
