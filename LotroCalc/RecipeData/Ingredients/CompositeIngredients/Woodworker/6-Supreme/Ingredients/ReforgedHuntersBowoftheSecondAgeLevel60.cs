...
{
    public class ReforgedHuntersBowoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Bow of the Second Age (Level 60)";

        public ReforgedHuntersBowoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersBowoftheSecondAgeLevel60(QuantityRequested);
        }
