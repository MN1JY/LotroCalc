...
{
    public class CraftedCaptainsHammeroftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Hammer of the Third Age (Level 65)";

        public CraftedCaptainsHammeroftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsHammeroftheThirdAgeLevel65(QuantityRequested);
        }
