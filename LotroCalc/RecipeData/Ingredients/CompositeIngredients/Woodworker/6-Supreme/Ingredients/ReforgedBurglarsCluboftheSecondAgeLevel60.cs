...
{
    public class ReforgedBurglarsCluboftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Burglar's Club of the Second Age (Level 60)";

        public ReforgedBurglarsCluboftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedBurglarsCluboftheSecondAgeLevel60(QuantityRequested);
        }
