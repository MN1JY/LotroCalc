...
{
    public class ReforgedHuntersCluboftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Club of the Second Age (Level 60)";

        public ReforgedHuntersCluboftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersCluboftheSecondAgeLevel60(QuantityRequested);
        }
