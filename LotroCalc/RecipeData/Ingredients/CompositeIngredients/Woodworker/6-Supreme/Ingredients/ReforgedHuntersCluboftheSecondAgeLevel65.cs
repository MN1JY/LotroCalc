...
{
    public class ReforgedHuntersCluboftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Club of the Second Age (Level 65)";

        public ReforgedHuntersCluboftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersCluboftheSecondAgeLevel65(QuantityRequested);
        }
