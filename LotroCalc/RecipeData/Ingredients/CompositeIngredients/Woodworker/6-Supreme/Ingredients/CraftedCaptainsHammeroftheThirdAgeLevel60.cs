...
{
    public class CraftedCaptainsHammeroftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Hammer of the Third Age (Level 60)";

        public CraftedCaptainsHammeroftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsHammeroftheThirdAgeLevel60(QuantityRequested);
        }
