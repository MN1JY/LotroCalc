...
{
    public class CraftedWardensCluboftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Warden's Club of the Third Age (Level 60)";

        public CraftedWardensCluboftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedWardensCluboftheThirdAgeLevel60(QuantityRequested);
        }
