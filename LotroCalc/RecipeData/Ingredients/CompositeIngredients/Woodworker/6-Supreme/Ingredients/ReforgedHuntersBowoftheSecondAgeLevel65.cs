...
{
    public class ReforgedHuntersBowoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Bow of the Second Age (Level 65)";

        public ReforgedHuntersBowoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersBowoftheSecondAgeLevel65(QuantityRequested);
        }
