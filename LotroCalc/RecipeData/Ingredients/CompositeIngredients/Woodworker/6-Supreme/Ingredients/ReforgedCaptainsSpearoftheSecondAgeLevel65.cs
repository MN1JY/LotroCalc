...
{
    public class ReforgedCaptainsSpearoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Spear of the Second Age (Level 65)";

        public ReforgedCaptainsSpearoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsSpearoftheSecondAgeLevel65(QuantityRequested);
        }
