...
{
    public class CraftedHuntersSpearoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Hunter's Spear of the Third Age (Level 65)";

        public CraftedHuntersSpearoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedHuntersSpearoftheThirdAgeLevel65(QuantityRequested);
        }
