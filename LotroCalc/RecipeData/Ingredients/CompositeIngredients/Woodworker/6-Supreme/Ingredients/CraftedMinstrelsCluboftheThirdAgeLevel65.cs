...
{
    public class CraftedMinstrelsCluboftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Minstrel's Club of the Third Age (Level 65)";

        public CraftedMinstrelsCluboftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedMinstrelsCluboftheThirdAgeLevel65(QuantityRequested);
        }
