...
{
    public class ReforgedGuardiansSpearoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Spear of the Second Age (Level 60)";

        public ReforgedGuardiansSpearoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansSpearoftheSecondAgeLevel60(QuantityRequested);
        }
