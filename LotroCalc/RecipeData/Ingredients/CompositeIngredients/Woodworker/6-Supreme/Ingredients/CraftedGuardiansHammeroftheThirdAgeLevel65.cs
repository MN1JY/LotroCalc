...
{
    public class CraftedGuardiansHammeroftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Hammer of the Third Age (Level 65)";

        public CraftedGuardiansHammeroftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansHammeroftheThirdAgeLevel65(QuantityRequested);
        }
