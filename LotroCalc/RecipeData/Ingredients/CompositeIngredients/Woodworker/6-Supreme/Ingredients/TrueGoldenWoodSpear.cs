...
{
    public class TrueGoldenWoodSpear : SupremeIngredients
    {
        public static string DisplayName = "True Golden Wood Spear (Guild)";

        public TrueGoldenWoodSpear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TrueGoldenWoodSpear(QuantityRequested);
        }
