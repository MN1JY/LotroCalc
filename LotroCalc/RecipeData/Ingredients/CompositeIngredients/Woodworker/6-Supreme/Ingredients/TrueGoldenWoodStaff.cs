...
{
    public class TrueGoldenWoodStaff : SupremeIngredients
    {
        public static string DisplayName = "True Golden Wood Staff (Guild)";

        public TrueGoldenWoodStaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TrueGoldenWoodStaff(QuantityRequested);
        }
