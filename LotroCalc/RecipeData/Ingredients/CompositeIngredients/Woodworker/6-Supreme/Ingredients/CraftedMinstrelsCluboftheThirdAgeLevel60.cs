...
{
    public class CraftedMinstrelsCluboftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Minstrel's Club of the Third Age (Level 60)";

        public CraftedMinstrelsCluboftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedMinstrelsCluboftheThirdAgeLevel60(QuantityRequested);
        }
