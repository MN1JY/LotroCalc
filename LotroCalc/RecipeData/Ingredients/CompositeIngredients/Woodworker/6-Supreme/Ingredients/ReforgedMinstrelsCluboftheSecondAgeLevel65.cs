...
{
    public class ReforgedMinstrelsCluboftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Minstrel's Club of the Second Age (Level 65)";

        public ReforgedMinstrelsCluboftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedMinstrelsCluboftheSecondAgeLevel65(QuantityRequested);
        }
