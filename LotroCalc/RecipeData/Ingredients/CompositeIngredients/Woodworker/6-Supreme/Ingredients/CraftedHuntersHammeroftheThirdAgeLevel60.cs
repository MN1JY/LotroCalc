...
{
    public class CraftedHuntersHammeroftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Hunter's Hammer of the Third Age (Level 60)";

        public CraftedHuntersHammeroftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedHuntersHammeroftheThirdAgeLevel60(QuantityRequested);
        }
