...
{
    public class GoldenHostCrossbowofStriking : SupremeIngredients
    {
        public static string DisplayName = "Golden Host Crossbow of Striking";

        public GoldenHostCrossbowofStriking(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenHostCrossbowofStriking(QuantityRequested);
        }
