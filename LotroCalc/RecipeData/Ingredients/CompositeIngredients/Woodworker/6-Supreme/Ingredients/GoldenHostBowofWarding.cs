...
{
    public class GoldenHostBowofWarding : SupremeIngredients
    {
        public static string DisplayName = "Golden Host Bow of Warding";

        public GoldenHostBowofWarding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenHostBowofWarding(QuantityRequested);
        }
