...
{
    public class ReforgedCaptainsSpearoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Spear of the Second Age (Level 60)";

        public ReforgedCaptainsSpearoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsSpearoftheSecondAgeLevel60(QuantityRequested);
        }
