...
{
    public class MallornShaft : SupremeIngredients
    {
        public static string DisplayName = "Mallorn Shaft";

        public MallornShaft(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MallornShaft(QuantityRequested);
        }
