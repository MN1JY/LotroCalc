...
{
    public class GoldenWoodStaff : SupremeIngredients
    {
        public static string DisplayName = "Golden Wood Staff";

        public GoldenWoodStaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenWoodStaff(QuantityRequested);
        }
