...
{
    public class RedArrowGuild : SupremeIngredients
    {
        public static string DisplayName = "Red Arrow (Guild)";

        public RedArrowGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RedArrowGuild(QuantityRequested);
        }
