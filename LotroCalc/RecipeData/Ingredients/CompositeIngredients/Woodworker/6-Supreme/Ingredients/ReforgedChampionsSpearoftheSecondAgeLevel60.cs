...
{
    public class ReforgedChampionsSpearoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Spear of the Second Age (Level 60)";

        public ReforgedChampionsSpearoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsSpearoftheSecondAgeLevel60(QuantityRequested);
        }
