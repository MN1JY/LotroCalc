...
{
    public class ReforgedWardensCluboftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Warden's Club of the Second Age (Level 65)";

        public ReforgedWardensCluboftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedWardensCluboftheSecondAgeLevel65(QuantityRequested);
        }
