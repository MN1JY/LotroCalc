...
{
    public class TrueGoldenWoodJavelin : SupremeIngredients
    {
        public static string DisplayName = "True Golden Wood Javelin (Guild)";

        public TrueGoldenWoodJavelin(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TrueGoldenWoodJavelin(QuantityRequested);
        }
