...
{
    public class ElegantBagpipes : SupremeIngredients
    {
        public static string DisplayName = "Elegant Bagpipes";

        public ElegantBagpipes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElegantBagpipes(QuantityRequested);
        }
