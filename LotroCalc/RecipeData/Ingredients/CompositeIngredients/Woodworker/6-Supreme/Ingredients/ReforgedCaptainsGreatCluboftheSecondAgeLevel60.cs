...
{
    public class ReforgedCaptainsGreatCluboftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Great Club of the Second Age (Level 60)";

        public ReforgedCaptainsGreatCluboftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsGreatCluboftheSecondAgeLevel60(QuantityRequested);
        }
