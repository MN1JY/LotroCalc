...
{
    public class CraftedGuardiansGreatHammeroftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Great Hammer of the Third Age (Level 65)";

        public CraftedGuardiansGreatHammeroftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansGreatHammeroftheThirdAgeLevel65(QuantityRequested);
        }
