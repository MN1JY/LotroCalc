...
{
    public class PeerlessSilverMallornClubGuild : SupremeIngredients
    {
        public static string DisplayName = "Peerless Silver Mallorn Club (Guild)";

        public PeerlessSilverMallornClubGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PeerlessSilverMallornClubGuild(QuantityRequested);
        }
