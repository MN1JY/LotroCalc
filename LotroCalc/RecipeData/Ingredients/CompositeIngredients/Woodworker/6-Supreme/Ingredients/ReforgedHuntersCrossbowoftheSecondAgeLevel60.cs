...
{
    public class ReforgedHuntersCrossbowoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Crossbow of the Second Age (Level 60)";

        public ReforgedHuntersCrossbowoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersCrossbowoftheSecondAgeLevel60(QuantityRequested);
        }
