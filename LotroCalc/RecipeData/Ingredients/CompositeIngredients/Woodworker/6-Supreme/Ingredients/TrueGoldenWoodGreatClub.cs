...
{
    public class TrueGoldenWoodGreatClub : SupremeIngredients
    {
        public static string DisplayName = "True Golden Wood Great Club (Guild)";

        public TrueGoldenWoodGreatClub(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TrueGoldenWoodGreatClub(QuantityRequested);
        }
