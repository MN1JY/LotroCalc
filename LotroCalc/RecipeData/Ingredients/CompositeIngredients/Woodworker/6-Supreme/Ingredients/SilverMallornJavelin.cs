...
{
    public class SilverMallornJavelin : SupremeIngredients
    {
        public static string DisplayName = "Silver Mallorn Javelin";

        public SilverMallornJavelin(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SilverMallornJavelin(QuantityRequested);
        }
