...
{
    public class CraftedHuntersCluboftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Hunter's Club of the Third Age (Level 65)";

        public CraftedHuntersCluboftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedHuntersCluboftheThirdAgeLevel65(QuantityRequested);
        }
