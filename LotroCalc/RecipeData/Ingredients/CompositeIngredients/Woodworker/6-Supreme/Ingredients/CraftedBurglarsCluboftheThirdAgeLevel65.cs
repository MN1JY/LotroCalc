...
{
    public class CraftedBurglarsCluboftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Burglar's Club of the Third Age (Level 65)";

        public CraftedBurglarsCluboftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedBurglarsCluboftheThirdAgeLevel65(QuantityRequested);
        }
