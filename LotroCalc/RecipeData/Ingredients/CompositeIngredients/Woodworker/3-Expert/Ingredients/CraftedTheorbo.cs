...
{
    public class CraftedTheorbo : ExpertIngredients
    {
        public static string DisplayName = "Crafted Theorbo";

        public CraftedTheorbo(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedTheorbo(QuantityRequested);
        }
