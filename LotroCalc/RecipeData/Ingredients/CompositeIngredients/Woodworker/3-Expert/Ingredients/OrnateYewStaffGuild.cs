...
{
    public class OrnateYewStaffGuild : ExpertIngredients
    {
        public static string DisplayName = "Ornate Yew Staff (Guild)";

        public OrnateYewStaffGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OrnateYewStaffGuild(QuantityRequested);
        }
