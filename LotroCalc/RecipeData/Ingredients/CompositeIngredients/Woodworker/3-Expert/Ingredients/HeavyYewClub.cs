...
{
    public class HeavyYewClub : ExpertIngredients
    {
        public static string DisplayName = "Heavy Yew Club";

        public HeavyYewClub(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyYewClub(QuantityRequested);
        }
