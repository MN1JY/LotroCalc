...
{
    public class ExpertBlazonedCrestOfWar : ExpertIngredients
    {
        public static string DisplayName = "Expert Blazoned Crest Of War";

        public ExpertBlazonedCrestOfWar(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ExpertBlazonedCrestOfWar(QuantityRequested);
        }
