...
{
    public class RedScholarsBookshelf : ExpertIngredients
    {
        public static string DisplayName = "Red Scholar's Bookshelf";

        public RedScholarsBookshelf(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RedScholarsBookshelf(QuantityRequested);
        }
