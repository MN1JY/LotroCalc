...
{
    public class EtchedYewBow : ExpertIngredients
    {
        public static string DisplayName = "Etched Yew Bow";

        public EtchedYewBow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedYewBow(QuantityRequested);
        }
