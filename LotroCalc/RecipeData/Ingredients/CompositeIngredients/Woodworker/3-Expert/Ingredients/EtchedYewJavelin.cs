...
{
    public class EtchedYewJavelin : ExpertIngredients
    {
        public static string DisplayName = "Etched Yew Javelin";

        public EtchedYewJavelin(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedYewJavelin(QuantityRequested);
        }
