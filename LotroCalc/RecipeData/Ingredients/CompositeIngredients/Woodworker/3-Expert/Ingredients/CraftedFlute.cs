...
{
    public class CraftedFlute : ExpertIngredients
    {
        public static string DisplayName = "Crafted Flute";

        public CraftedFlute(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedFlute(QuantityRequested);
        }
