...
{
    public class CraftedLute : ExpertIngredients
    {
        public static string DisplayName = "Crafted Lute";

        public CraftedLute(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedLute(QuantityRequested);
        }
