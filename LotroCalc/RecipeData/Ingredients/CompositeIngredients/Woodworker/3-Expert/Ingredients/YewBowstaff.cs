...
{
    public class YewBowstaff : ExpertIngredients
    {
        public static string DisplayName = "Yew Bowstaff";

        public YewBowstaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new YewBowstaff(QuantityRequested);
        }
