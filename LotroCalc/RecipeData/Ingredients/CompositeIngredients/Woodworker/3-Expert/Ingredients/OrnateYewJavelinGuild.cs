...
{
    public class OrnateYewJavelinGuild : ExpertIngredients
    {
        public static string DisplayName = "Ornate Yew Javelin (Guild)";

        public OrnateYewJavelinGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OrnateYewJavelinGuild(QuantityRequested);
        }
