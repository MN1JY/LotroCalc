...
{
    public class HeavyYewStaff : ExpertIngredients
    {
        public static string DisplayName = "Heavy Yew Staff";

        public HeavyYewStaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyYewStaff(QuantityRequested);
        }
