...
{
    public class LesserFistCarving : ExpertIngredients
    {
        public static string DisplayName = "Lesser Fist Carving";

        public LesserFistCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LesserFistCarving(QuantityRequested);
        }
