...
{
    public class CarvedYewCrossbow : ExpertIngredients
    {
        public static string DisplayName = "Carved Yew Crossbow";

        public CarvedYewCrossbow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedYewCrossbow(QuantityRequested);
        }
