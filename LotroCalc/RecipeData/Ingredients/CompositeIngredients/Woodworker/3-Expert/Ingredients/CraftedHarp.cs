...
{
    public class CraftedHarp : ExpertIngredients
    {
        public static string DisplayName = "Crafted Harp";

        public CraftedHarp(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedHarp(QuantityRequested);
        }
