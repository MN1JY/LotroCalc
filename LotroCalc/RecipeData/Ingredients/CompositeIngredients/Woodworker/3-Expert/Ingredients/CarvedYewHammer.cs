...
{
    public class CarvedYewHammer : ExpertIngredients
    {
        public static string DisplayName = "Carved Yew Hammer";

        public CarvedYewHammer(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedYewHammer(QuantityRequested);
        }
