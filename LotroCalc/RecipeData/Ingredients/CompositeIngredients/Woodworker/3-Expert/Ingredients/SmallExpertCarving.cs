...
{
    public class SmallExpertCarving : ExpertIngredients
    {
        public static string DisplayName = "Small Expert Carving (Guild)";

        public SmallExpertCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallExpertCarving(QuantityRequested);
        }
