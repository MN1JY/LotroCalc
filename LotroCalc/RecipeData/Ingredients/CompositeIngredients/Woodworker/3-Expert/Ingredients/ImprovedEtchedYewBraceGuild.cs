...
{
    public class ImprovedEtchedYewBraceGuild : ExpertIngredients
    {
        public static string DisplayName = "Improved Etched Yew Brace (Guild)";

        public ImprovedEtchedYewBraceGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedEtchedYewBraceGuild(QuantityRequested);
        }
