...
{
    public class LesserSpearCarving : ExpertIngredients
    {
        public static string DisplayName = "Lesser Spear Carving";

        public LesserSpearCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LesserSpearCarving(QuantityRequested);
        }
