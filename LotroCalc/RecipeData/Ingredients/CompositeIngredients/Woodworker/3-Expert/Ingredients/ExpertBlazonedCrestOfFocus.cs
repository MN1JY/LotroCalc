...
{
    public class ExpertBlazonedCrestOfFocus : ExpertIngredients
    {
        public static string DisplayName = "Expert Blazoned Crest Of Focus";

        public ExpertBlazonedCrestOfFocus(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ExpertBlazonedCrestOfFocus(QuantityRequested);
        }
