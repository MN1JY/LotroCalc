...
{
    public class YewCrossbow : ExpertIngredients
    {
        public static string DisplayName = "Yew Crossbow";

        public YewCrossbow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new YewCrossbow(QuantityRequested);
        }
