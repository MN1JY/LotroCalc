...
{
    public class ScholarsPointedBookshelf : ExpertIngredients
    {
        public static string DisplayName = "Scholar's Pointed Bookshelf";

        public ScholarsPointedBookshelf(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ScholarsPointedBookshelf(QuantityRequested);
        }
