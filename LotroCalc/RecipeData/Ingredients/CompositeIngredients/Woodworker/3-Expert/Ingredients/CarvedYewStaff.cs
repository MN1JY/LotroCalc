...
{
    public class CarvedYewStaff : ExpertIngredients
    {
        public static string DisplayName = "Carved Yew Staff";

        public CarvedYewStaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedYewStaff(QuantityRequested);
        }
