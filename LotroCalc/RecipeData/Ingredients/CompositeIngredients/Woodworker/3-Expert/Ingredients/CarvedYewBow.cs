...
{
    public class CarvedYewBow : ExpertIngredients
    {
        public static string DisplayName = "Carved Yew Bow";

        public CarvedYewBow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedYewBow(QuantityRequested);
        }
