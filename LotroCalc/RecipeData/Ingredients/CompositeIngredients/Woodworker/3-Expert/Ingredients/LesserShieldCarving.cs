...
{
    public class LesserShieldCarving : ExpertIngredients
    {
        public static string DisplayName = "Lesser Shield Carving";

        public LesserShieldCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LesserShieldCarving(QuantityRequested);
        }
