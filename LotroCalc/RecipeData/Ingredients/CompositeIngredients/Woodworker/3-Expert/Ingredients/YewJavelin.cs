...
{
    public class YewJavelin : ExpertIngredients
    {
        public static string DisplayName = "Yew Javelin";

        public YewJavelin(int count)
        {
            Name = DisplayName;
        ...
        {
            return new YewJavelin(QuantityRequested);
        }
