...
{
    public class ImprovedYewBowstaffGuild : ExpertIngredients
    {
        public static string DisplayName = "Improved Yew Bowstaff (Guild)";

        public ImprovedYewBowstaffGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedYewBowstaffGuild(QuantityRequested);
        }
