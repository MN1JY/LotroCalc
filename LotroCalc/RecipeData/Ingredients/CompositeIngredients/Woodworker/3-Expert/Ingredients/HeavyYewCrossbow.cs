...
{
    public class HeavyYewCrossbow : ExpertIngredients
    {
        public static string DisplayName = "Heavy Yew Crossbow";

        public HeavyYewCrossbow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyYewCrossbow(QuantityRequested);
        }
