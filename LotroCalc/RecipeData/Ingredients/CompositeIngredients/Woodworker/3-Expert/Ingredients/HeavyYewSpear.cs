...
{
    public class HeavyYewSpear : ExpertIngredients
    {
        public static string DisplayName = "Heavy Yew Spear";

        public HeavyYewSpear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyYewSpear(QuantityRequested);
        }
