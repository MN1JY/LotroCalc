...
{
    public class OrnateYewBowGuild : ExpertIngredients
    {
        public static string DisplayName = "Ornate Yew Bow (Guild)";

        public OrnateYewBowGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OrnateYewBowGuild(QuantityRequested);
        }
