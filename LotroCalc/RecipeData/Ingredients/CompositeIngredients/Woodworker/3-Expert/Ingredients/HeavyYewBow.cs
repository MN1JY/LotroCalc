...
{
    public class HeavyYewBow : ExpertIngredients
    {
        public static string DisplayName = "Heavy Yew Bow";

        public HeavyYewBow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyYewBow(QuantityRequested);
        }
