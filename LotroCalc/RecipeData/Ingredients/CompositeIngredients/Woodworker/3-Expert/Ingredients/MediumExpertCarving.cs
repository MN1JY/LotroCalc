...
{
    public class MediumExpertCarving : ExpertIngredients
    {
        public static string DisplayName = "Medium Expert Carving (Guild)";

        public MediumExpertCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MediumExpertCarving(QuantityRequested);
        }
