...
{
    public class OrnateYewCrossbowGuild : ExpertIngredients
    {
        public static string DisplayName = "Ornate Yew Crossbow (Guild)";

        public OrnateYewCrossbowGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OrnateYewCrossbowGuild(QuantityRequested);
        }
