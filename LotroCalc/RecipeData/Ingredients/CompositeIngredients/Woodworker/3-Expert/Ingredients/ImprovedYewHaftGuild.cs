...
{
    public class ImprovedYewHaftGuild : ExpertIngredients
    {
        public static string DisplayName = "Improved Yew Haft (Guild)";

        public ImprovedYewHaftGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedYewHaftGuild(QuantityRequested);
        }
