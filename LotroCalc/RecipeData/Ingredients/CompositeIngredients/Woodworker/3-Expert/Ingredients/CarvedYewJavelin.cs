...
{
    public class CarvedYewJavelin : ExpertIngredients
    {
        public static string DisplayName = "Carved Yew Javelin";

        public CarvedYewJavelin(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedYewJavelin(QuantityRequested);
        }
