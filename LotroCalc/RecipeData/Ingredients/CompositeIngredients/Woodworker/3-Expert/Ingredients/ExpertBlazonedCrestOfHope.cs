...
{
    public class ExpertBlazonedCrestOfHope : ExpertIngredients
    {
        public static string DisplayName = "Expert Blazoned Crest Of Hope";

        public ExpertBlazonedCrestOfHope(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ExpertBlazonedCrestOfHope(QuantityRequested);
        }
