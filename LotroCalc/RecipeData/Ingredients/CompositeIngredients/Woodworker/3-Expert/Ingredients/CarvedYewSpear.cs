...
{
    public class CarvedYewSpear : ExpertIngredients
    {
        public static string DisplayName = "Carved Yew Spear";

        public CarvedYewSpear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedYewSpear(QuantityRequested);
        }
