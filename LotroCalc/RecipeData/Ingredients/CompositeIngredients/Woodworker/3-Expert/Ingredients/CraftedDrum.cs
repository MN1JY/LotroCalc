...
{
    public class CraftedDrum : ExpertIngredients
    {
        public static string DisplayName = "Crafted Drum";

        public CraftedDrum(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedDrum(QuantityRequested);
        }
