...
{
    public class CarvedYewGreatClub : ExpertIngredients
    {
        public static string DisplayName = "Carved Yew Great Club";

        public CarvedYewGreatClub(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedYewGreatClub(QuantityRequested);
        }
