...
{
    public class CarvedYewClub : ExpertIngredients
    {
        public static string DisplayName = "Carved Yew Club";

        public CarvedYewClub(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedYewClub(QuantityRequested);
        }
