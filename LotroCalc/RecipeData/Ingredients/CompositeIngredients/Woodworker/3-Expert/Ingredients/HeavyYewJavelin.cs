...
{
    public class HeavyYewJavelin : ExpertIngredients
    {
        public static string DisplayName = "Heavy Yew Javelin";

        public HeavyYewJavelin(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyYewJavelin(QuantityRequested);
        }
