...
{
    public class OrnateYewSpearGuild : ExpertIngredients
    {
        public static string DisplayName = "Ornate Yew Spear (Guild)";

        public OrnateYewSpearGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OrnateYewSpearGuild(QuantityRequested);
        }
