...
{
    public class SimpleFlute : JourneymanIngredients
    {
        public static string DisplayName = "Simple Flute";

        public SimpleFlute(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SimpleFlute(QuantityRequested);
        }
