...
{
    public class SimpleDrum : JourneymanIngredients
    {
        public static string DisplayName = "Simple Drum";

        public SimpleDrum(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SimpleDrum(QuantityRequested);
        }
