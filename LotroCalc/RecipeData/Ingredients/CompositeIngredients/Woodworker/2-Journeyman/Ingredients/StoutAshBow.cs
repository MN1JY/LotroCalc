...
{
    public class StoutAshBow : JourneymanIngredients
    {
        public static string DisplayName = "Stout Ash Bow";

        public StoutAshBow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new StoutAshBow(QuantityRequested);
        }
