...
{
    public class AshCrossbow : JourneymanIngredients
    {
        public static string DisplayName = "Ash Crossbow";

        public AshCrossbow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AshCrossbow(QuantityRequested);
        }
