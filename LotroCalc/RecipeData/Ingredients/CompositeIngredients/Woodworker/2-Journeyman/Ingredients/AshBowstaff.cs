...
{
    public class AshBowstaff : JourneymanIngredients
    {
        public static string DisplayName = "Ash Bowstaff";

        public AshBowstaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AshBowstaff(QuantityRequested);
        }
