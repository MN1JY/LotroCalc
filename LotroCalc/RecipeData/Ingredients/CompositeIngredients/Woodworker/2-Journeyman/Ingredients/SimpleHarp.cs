...
{
    public class SimpleHarp : JourneymanIngredients
    {
        public static string DisplayName = "Simple Harp";

        public SimpleHarp(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SimpleHarp(QuantityRequested);
        }
