...
{
    public class MinorSpearCarving : JourneymanIngredients
    {
        public static string DisplayName = "Minor Spear Carving";

        public MinorSpearCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MinorSpearCarving(QuantityRequested);
        }
