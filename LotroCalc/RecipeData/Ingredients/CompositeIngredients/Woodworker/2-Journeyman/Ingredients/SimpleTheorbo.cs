...
{
    public class SimpleTheorbo : JourneymanIngredients
    {
        public static string DisplayName = "Simple Theorbo";

        public SimpleTheorbo(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SimpleTheorbo(QuantityRequested);
        }
