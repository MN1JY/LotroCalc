...
{
    public class MinorShieldCarving : JourneymanIngredients
    {
        public static string DisplayName = "Minor Shield Carving";

        public MinorShieldCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MinorShieldCarving(QuantityRequested);
        }
