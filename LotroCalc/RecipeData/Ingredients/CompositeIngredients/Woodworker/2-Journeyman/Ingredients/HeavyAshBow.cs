...
{
    public class HeavyAshBow : JourneymanIngredients
    {
        public static string DisplayName = "Heavy Ash Bow";

        public HeavyAshBow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyAshBow(QuantityRequested);
        }
