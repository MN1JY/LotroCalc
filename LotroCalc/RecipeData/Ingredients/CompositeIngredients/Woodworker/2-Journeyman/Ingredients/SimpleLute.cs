...
{
    public class SimpleLute : JourneymanIngredients
    {
        public static string DisplayName = "Simple Lute";

        public SimpleLute(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SimpleLute(QuantityRequested);
        }
