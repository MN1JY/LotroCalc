...
{
    public class MinorFistCarving : JourneymanIngredients
    {
        public static string DisplayName = "Minor Fist Carving";

        public MinorFistCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MinorFistCarving(QuantityRequested);
        }
