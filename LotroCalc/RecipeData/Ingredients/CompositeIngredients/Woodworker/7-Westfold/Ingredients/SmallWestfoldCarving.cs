...
{
    public class SmallWestfoldCarving : WestfoldIngredients
    {
        public static string DisplayName = "Small Westfold Carving (Guild)";

        public SmallWestfoldCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallWestfoldCarving(QuantityRequested);
        }
