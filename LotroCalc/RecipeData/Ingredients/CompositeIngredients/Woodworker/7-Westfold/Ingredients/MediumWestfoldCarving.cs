...
{
    public class MediumWestfoldCarving : WestfoldIngredients
    {
        public static string DisplayName = "Medium Westfold Carving (Guild)";

        public MediumWestfoldCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MediumWestfoldCarving(QuantityRequested);
        }
