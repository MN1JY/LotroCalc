...
{
    public class BirchwoodHammer : WestfoldIngredients
    {
        public static string DisplayName = "Birch-wood Hammer";

        public BirchwoodHammer(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BirchwoodHammer(QuantityRequested);
        }
