...
{
    public class SmoothBlackAshSpear : MasterIngredients
    {
        public static string DisplayName = "Smooth Black Ash Spear";

        public SmoothBlackAshSpear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmoothBlackAshSpear(QuantityRequested);
        }
