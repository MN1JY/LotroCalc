...
{
    public class CombatHorn : MasterIngredients
    {
        public static string DisplayName = "Combat Horn";

        public CombatHorn(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CombatHorn(QuantityRequested);
        }
