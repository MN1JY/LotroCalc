...
{
    public class BlackAshBow : MasterIngredients
    {
        public static string DisplayName = "Black Ash Bow";

        public BlackAshBow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BlackAshBow(QuantityRequested);
        }
