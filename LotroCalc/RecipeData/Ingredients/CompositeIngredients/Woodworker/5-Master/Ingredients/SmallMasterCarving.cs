...
{
    public class SmallMasterCarving : MasterIngredients
    {
        public static string DisplayName = "Small Master Carving (Guild)";

        public SmallMasterCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallMasterCarving(QuantityRequested);
        }
