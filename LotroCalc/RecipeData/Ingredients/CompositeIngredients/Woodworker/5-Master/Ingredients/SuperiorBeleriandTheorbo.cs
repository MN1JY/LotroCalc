...
{
    public class SuperiorBeleriandTheorbo : MasterIngredients
    {
        public static string DisplayName = "Superior Beleriand Theorbo";

        public SuperiorBeleriandTheorbo(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorBeleriandTheorbo(QuantityRequested);
        }
