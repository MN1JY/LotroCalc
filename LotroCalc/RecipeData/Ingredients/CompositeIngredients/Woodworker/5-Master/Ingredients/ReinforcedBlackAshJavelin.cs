...
{
    public class ReinforcedBlackAshJavelin : MasterIngredients
    {
        public static string DisplayName = "Reinforced Black Ash Javelin";

        public ReinforcedBlackAshJavelin(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReinforcedBlackAshJavelin(QuantityRequested);
        }
