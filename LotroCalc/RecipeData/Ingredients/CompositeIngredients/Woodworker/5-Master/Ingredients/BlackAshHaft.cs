...
{
    public class BlackAshHaft : MasterIngredients
    {
        public static string DisplayName = "Black Ash Haft";

        public BlackAshHaft(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BlackAshHaft(QuantityRequested);
        }
