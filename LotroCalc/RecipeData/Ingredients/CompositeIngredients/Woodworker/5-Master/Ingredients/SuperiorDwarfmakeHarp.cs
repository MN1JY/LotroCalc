...
{
    public class SuperiorDwarfmakeHarp : MasterIngredients
    {
        public static string DisplayName = "Superior Dwarf-make Harp";

        public SuperiorDwarfmakeHarp(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorDwarfmakeHarp(QuantityRequested);
        }
