...
{
    public class SuperiorDwarfmakeDrum : MasterIngredients
    {
        public static string DisplayName = "Superior Dwarf-make Drum";

        public SuperiorDwarfmakeDrum(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorDwarfmakeDrum(QuantityRequested);
        }
