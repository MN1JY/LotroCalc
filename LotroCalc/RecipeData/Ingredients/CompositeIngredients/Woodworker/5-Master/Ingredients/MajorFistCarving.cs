...
{
    public class MajorFistCarving : MasterIngredients
    {
        public static string DisplayName = "Major Fist Carving";

        public MajorFistCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MajorFistCarving(QuantityRequested);
        }
