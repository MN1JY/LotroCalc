...
{
    public class BlackAshStaff : MasterIngredients
    {
        public static string DisplayName = "Black Ash Staff";

        public BlackAshStaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BlackAshStaff(QuantityRequested);
        }
