...
{
    public class BlackAshJavelin : MasterIngredients
    {
        public static string DisplayName = "Black Ash Javelin";

        public BlackAshJavelin(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BlackAshJavelin(QuantityRequested);
        }
