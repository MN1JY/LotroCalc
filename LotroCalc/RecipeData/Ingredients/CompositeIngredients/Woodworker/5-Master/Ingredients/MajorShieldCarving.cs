...
{
    public class MajorShieldCarving : MasterIngredients
    {
        public static string DisplayName = "Major Shield Carving";

        public MajorShieldCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MajorShieldCarving(QuantityRequested);
        }
