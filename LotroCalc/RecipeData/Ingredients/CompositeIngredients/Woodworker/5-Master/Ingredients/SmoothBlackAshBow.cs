...
{
    public class SmoothBlackAshBow : MasterIngredients
    {
        public static string DisplayName = "Smooth Black Ash Bow";

        public SmoothBlackAshBow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmoothBlackAshBow(QuantityRequested);
        }
