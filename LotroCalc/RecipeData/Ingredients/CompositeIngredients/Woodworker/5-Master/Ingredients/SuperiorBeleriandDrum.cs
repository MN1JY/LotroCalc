...
{
    public class SuperiorBeleriandDrum : MasterIngredients
    {
        public static string DisplayName = "Superior Beleriand Drum";

        public SuperiorBeleriandDrum(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorBeleriandDrum(QuantityRequested);
        }
