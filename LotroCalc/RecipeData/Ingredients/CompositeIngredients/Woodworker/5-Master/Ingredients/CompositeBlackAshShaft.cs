...
{
    public class CompositeBlackAshShaft : MasterIngredients
    {
        public static string DisplayName = "Composite Black Ash Shaft";

        public CompositeBlackAshShaft(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CompositeBlackAshShaft(QuantityRequested);
        }
