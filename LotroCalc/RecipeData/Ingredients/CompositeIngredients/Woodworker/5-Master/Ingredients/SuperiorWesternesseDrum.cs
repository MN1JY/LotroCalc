...
{
    public class SuperiorWesternesseDrum : MasterIngredients
    {
        public static string DisplayName = "Superior Westernesse Drum";

        public SuperiorWesternesseDrum(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorWesternesseDrum(QuantityRequested);
        }
