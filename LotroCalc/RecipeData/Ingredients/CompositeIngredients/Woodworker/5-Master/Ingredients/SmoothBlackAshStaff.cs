...
{
    public class SmoothBlackAshStaff : MasterIngredients
    {
        public static string DisplayName = "Smooth Black Ash Staff";

        public SmoothBlackAshStaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmoothBlackAshStaff(QuantityRequested);
        }
