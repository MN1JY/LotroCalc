...
{
    public class CarvedBlackAshBow : MasterIngredients
    {
        public static string DisplayName = "Carved Black Ash Bow";

        public CarvedBlackAshBow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedBlackAshBow(QuantityRequested);
        }
