...
{
    public class CarvedBlackAshStaff : MasterIngredients
    {
        public static string DisplayName = "Carved Black Ash Staff";

        public CarvedBlackAshStaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedBlackAshStaff(QuantityRequested);
        }
