...
{
    public class SuperiorDwarfmakeLute : MasterIngredients
    {
        public static string DisplayName = "Superior Dwarf-make Lute";

        public SuperiorDwarfmakeLute(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorDwarfmakeLute(QuantityRequested);
        }
