...
{
    public class SuperiorBeleriandFlute : MasterIngredients
    {
        public static string DisplayName = "Superior Beleriand Flute";

        public SuperiorBeleriandFlute(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorBeleriandFlute(QuantityRequested);
        }
