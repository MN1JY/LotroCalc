...
{
    public class Kerialaulu : MasterIngredients
    {
        public static string DisplayName = "Keria-laulu";

        public Kerialaulu(int count)
        {
            Name = DisplayName;
        ...
        {
            return new Kerialaulu(QuantityRequested);
        }
