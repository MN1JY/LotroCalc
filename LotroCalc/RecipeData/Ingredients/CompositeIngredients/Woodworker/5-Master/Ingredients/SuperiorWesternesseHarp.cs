...
{
    public class SuperiorWesternesseHarp : MasterIngredients
    {
        public static string DisplayName = "Superior Westernesse Harp";

        public SuperiorWesternesseHarp(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorWesternesseHarp(QuantityRequested);
        }
