...
{
    public class MajorSpearCarving : MasterIngredients
    {
        public static string DisplayName = "Major Spear Carving";

        public MajorSpearCarving(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MajorSpearCarving(QuantityRequested);
        }
