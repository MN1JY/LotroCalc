...
{
    public class SuperiorDwarfmakeFlute : MasterIngredients
    {
        public static string DisplayName = "Superior Dwarf-make Flute";

        public SuperiorDwarfmakeFlute(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorDwarfmakeFlute(QuantityRequested);
        }
