...
{
    public class CarvedBlackAshJavelin : MasterIngredients
    {
        public static string DisplayName = "Carved Black Ash Javelin";

        public CarvedBlackAshJavelin(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedBlackAshJavelin(QuantityRequested);
        }
