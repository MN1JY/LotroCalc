...
{
    public class ImprovedBlackAshBowstaffGuild : MasterIngredients
    {
        public static string DisplayName = "Improved Black Ash Bowstaff (Guild)";

        public ImprovedBlackAshBowstaffGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedBlackAshBowstaffGuild(QuantityRequested);
        }
