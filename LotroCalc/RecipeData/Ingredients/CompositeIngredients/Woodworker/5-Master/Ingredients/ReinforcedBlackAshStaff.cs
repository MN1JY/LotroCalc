...
{
    public class ReinforcedBlackAshStaff : MasterIngredients
    {
        public static string DisplayName = "Reinforced Black Ash Staff";

        public ReinforcedBlackAshStaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReinforcedBlackAshStaff(QuantityRequested);
        }
