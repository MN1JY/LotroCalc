...
{
    public class SuperiorWesternesseLute : MasterIngredients
    {
        public static string DisplayName = "Superior Westernesse Lute";

        public SuperiorWesternesseLute(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorWesternesseLute(QuantityRequested);
        }
