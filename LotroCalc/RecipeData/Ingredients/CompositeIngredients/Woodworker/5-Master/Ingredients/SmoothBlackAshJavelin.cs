...
{
    public class SmoothBlackAshJavelin : MasterIngredients
    {
        public static string DisplayName = "Smooth Black Ash Javelin";

        public SmoothBlackAshJavelin(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmoothBlackAshJavelin(QuantityRequested);
        }
