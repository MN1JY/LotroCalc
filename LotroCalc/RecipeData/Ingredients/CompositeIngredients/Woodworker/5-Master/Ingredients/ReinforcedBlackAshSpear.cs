...
{
    public class ReinforcedBlackAshSpear : MasterIngredients
    {
        public static string DisplayName = "Reinforced Black Ash Spear";

        public ReinforcedBlackAshSpear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReinforcedBlackAshSpear(QuantityRequested);
        }
