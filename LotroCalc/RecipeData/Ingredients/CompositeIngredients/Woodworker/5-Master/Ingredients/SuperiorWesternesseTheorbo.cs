...
{
    public class SuperiorWesternesseTheorbo : MasterIngredients
    {
        public static string DisplayName = "Superior Westernesse Theorbo";

        public SuperiorWesternesseTheorbo(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorWesternesseTheorbo(QuantityRequested);
        }
