...
{
    public class SuperiorBeleriandHarp : MasterIngredients
    {
        public static string DisplayName = "Superior Beleriand Harp";

        public SuperiorBeleriandHarp(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorBeleriandHarp(QuantityRequested);
        }
