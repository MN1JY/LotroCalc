...
{
    public class BlackAshSpear : MasterIngredients
    {
        public static string DisplayName = "Black Ash Spear";

        public BlackAshSpear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BlackAshSpear(QuantityRequested);
        }
