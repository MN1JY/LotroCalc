...
{
    public class CarvedBlackAshSpear : MasterIngredients
    {
        public static string DisplayName = "Carved Black Ash Spear";

        public CarvedBlackAshSpear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedBlackAshSpear(QuantityRequested);
        }
