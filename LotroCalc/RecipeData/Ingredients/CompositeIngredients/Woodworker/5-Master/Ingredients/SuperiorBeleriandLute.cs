...
{
    public class SuperiorBeleriandLute : MasterIngredients
    {
        public static string DisplayName = "Superior Beleriand Lute";

        public SuperiorBeleriandLute(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorBeleriandLute(QuantityRequested);
        }
