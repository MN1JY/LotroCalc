...
{
    public class CarvedBlackAshCrossbow : MasterIngredients
    {
        public static string DisplayName = "Carved Black Ash Crossbow";

        public CarvedBlackAshCrossbow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarvedBlackAshCrossbow(QuantityRequested);
        }
