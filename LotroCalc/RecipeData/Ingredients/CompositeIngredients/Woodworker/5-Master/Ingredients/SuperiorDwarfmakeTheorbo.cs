...
{
    public class SuperiorDwarfmakeTheorbo : MasterIngredients
    {
        public static string DisplayName = "Superior Dwarf-make Theorbo";

        public SuperiorDwarfmakeTheorbo(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorDwarfmakeTheorbo(QuantityRequested);
        }
