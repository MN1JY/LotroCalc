...
{
    public class ReinforcedBlackAshBow : MasterIngredients
    {
        public static string DisplayName = "Reinforced Black Ash Bow";

        public ReinforcedBlackAshBow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReinforcedBlackAshBow(QuantityRequested);
        }
