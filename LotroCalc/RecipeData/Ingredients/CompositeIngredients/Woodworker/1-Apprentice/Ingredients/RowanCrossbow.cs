...
{
    public class RowanCrossbow : ApprenticeIngredients
    {
        public static string DisplayName = "Rowan Crossbow";

        public RowanCrossbow(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RowanCrossbow(QuantityRequested);
        }
