...
{
    public class RowanSpear : ApprenticeIngredients
    {
        public static string DisplayName = "Rowan Spear";

        public RowanSpear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RowanSpear(QuantityRequested);
        }
