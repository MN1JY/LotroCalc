...
{
    public class RowanHammer : ApprenticeIngredients
    {
        public static string DisplayName = "Rowan Hammer";

        public RowanHammer(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RowanHammer(QuantityRequested);
        }
