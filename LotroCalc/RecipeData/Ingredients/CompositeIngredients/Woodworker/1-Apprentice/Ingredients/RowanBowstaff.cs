...
{
    public class RowanBowstaff : ApprenticeIngredients
    {
        public static string DisplayName = "Rowan Bowstaff";

        public RowanBowstaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RowanBowstaff(QuantityRequested);
        }
