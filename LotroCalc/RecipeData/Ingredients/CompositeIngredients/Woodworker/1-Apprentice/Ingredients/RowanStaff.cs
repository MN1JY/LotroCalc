...
{
    public class RowanStaff : ApprenticeIngredients
    {
        public static string DisplayName = "Rowan Staff";

        public RowanStaff(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RowanStaff(QuantityRequested);
        }
