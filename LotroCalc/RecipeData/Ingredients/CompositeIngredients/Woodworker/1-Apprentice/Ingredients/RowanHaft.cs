...
{
    public class RowanHaft : ApprenticeIngredients
    {
        public static string DisplayName = "Rowan Haft";

        public RowanHaft(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RowanHaft(QuantityRequested);
        }
