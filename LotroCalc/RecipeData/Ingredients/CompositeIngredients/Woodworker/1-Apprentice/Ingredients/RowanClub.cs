...
{
    public class RowanClub : ApprenticeIngredients
    {
        public static string DisplayName = "Rowan Club";

        public RowanClub(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RowanClub(QuantityRequested);
        }
