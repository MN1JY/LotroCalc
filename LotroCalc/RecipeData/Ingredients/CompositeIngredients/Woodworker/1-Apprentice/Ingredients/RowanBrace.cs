...
{
    public class RowanBrace : ApprenticeIngredients
    {
        public static string DisplayName = "Rowan Brace";

        public RowanBrace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RowanBrace(QuantityRequested);
        }
