...
{
    public class EngravedOpalBraceletofSuccour : JourneymanIngredients
    {
        public static string DisplayName = "Engraved Opal Bracelet of Succour";

        public EngravedOpalBraceletofSuccour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedOpalBraceletofSuccour(QuantityRequested);
        }
