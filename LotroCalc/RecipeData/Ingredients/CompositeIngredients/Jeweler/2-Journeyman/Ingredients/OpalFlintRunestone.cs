...
{
    public class OpalFlintRunestone : JourneymanIngredients
    {
        public static string DisplayName = "Opal Flint Rune-stone";

        public OpalFlintRunestone(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OpalFlintRunestone(QuantityRequested);
        }
