...
{
    public class BasicAmuletoftheBlackBear : JourneymanIngredients
    {
        public static string DisplayName = "Basic Amulet of the Black Bear";

        public BasicAmuletoftheBlackBear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BasicAmuletoftheBlackBear(QuantityRequested);
        }
