...
{
    public class OpalNecklaceofHealing : JourneymanIngredients
    {
        public static string DisplayName = "Opal Necklace of Healing";

        public OpalNecklaceofHealing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OpalNecklaceofHealing(QuantityRequested);
        }
