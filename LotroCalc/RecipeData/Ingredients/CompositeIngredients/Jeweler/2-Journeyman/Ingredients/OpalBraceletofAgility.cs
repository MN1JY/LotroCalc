...
{
    public class OpalBraceletofAgility : JourneymanIngredients
    {
        public static string DisplayName = "Opal Bracelet of Agility";

        public OpalBraceletofAgility(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OpalBraceletofAgility(QuantityRequested);
        }
