...
{
    public class BloodstoneRingofTactics : JourneymanIngredients
    {
        public static string DisplayName = "Bloodstone Ring of Tactics";

        public BloodstoneRingofTactics(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BloodstoneRingofTactics(QuantityRequested);
        }
