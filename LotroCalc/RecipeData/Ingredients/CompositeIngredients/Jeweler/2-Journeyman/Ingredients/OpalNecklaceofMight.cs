...
{
    public class OpalNecklaceofMight : JourneymanIngredients
    {
        public static string DisplayName = "Opal Necklace of Might";

        public OpalNecklaceofMight(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OpalNecklaceofMight(QuantityRequested);
        }
