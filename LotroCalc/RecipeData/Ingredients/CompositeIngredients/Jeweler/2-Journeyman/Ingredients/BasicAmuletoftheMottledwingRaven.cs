...
{
    public class BasicAmuletoftheMottledwingRaven : JourneymanIngredients
    {
        public static string DisplayName = "Basic Amulet of the Mottled-wing Raven";

        public BasicAmuletoftheMottledwingRaven(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BasicAmuletoftheMottledwingRaven(QuantityRequested);
        }
