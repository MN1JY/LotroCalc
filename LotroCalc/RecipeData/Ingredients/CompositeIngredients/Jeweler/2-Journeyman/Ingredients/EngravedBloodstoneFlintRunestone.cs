...
{
    public class EngravedBloodstoneFlintRunestone : JourneymanIngredients
    {
        public static string DisplayName = "Engraved Bloodstone Flint Rune-stone";

        public EngravedBloodstoneFlintRunestone(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedBloodstoneFlintRunestone(QuantityRequested);
        }
