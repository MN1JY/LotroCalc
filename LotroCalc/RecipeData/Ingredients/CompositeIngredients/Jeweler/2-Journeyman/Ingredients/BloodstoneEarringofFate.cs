...
{
    public class BloodstoneEarringofFate : JourneymanIngredients
    {
        public static string DisplayName = "Bloodstone Earring of Fate";

        public BloodstoneEarringofFate(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BloodstoneEarringofFate(QuantityRequested);
        }
