...
{
    public class FaintEdhelharnToken : JourneymanIngredients
    {
        public static string DisplayName = "Faint Edhelharn Token";

        public FaintEdhelharnToken(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FaintEdhelharnToken(QuantityRequested);
        }
