...
{
    public class OpalBraceletofBlocking : JourneymanIngredients
    {
        public static string DisplayName = "Opal Bracelet of Blocking";

        public OpalBraceletofBlocking(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OpalBraceletofBlocking(QuantityRequested);
        }
