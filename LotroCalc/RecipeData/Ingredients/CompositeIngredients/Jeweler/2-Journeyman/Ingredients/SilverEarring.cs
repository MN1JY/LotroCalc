...
{
    public class SilverEarring : JourneymanIngredients
    {
        public static string DisplayName = "Silver Earring";

        public SilverEarring(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SilverEarring(QuantityRequested);
        }
