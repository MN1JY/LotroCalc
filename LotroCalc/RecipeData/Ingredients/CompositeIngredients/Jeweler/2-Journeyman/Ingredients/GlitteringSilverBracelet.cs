...
{
    public class GlitteringSilverBracelet : JourneymanIngredients
    {
        public static string DisplayName = "Glittering Silver Bracelet";

        public GlitteringSilverBracelet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringSilverBracelet(QuantityRequested);
        }
