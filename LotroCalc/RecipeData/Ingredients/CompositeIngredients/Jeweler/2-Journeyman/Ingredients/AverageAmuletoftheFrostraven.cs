...
{
    public class AverageAmuletoftheFrostraven : JourneymanIngredients
    {
        public static string DisplayName = "Average Amulet of the Frost-raven";

        public AverageAmuletoftheFrostraven(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AverageAmuletoftheFrostraven(QuantityRequested);
        }
