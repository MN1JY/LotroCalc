...
{
    public class EngravedBloodstoneEarringofCombat : JourneymanIngredients
    {
        public static string DisplayName = "Engraved Bloodstone Earring of Combat";

        public EngravedBloodstoneEarringofCombat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedBloodstoneEarringofCombat(QuantityRequested);
        }
