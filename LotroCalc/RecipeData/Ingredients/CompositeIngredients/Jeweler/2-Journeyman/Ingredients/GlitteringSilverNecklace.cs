...
{
    public class GlitteringSilverNecklace : JourneymanIngredients
    {
        public static string DisplayName = "Glittering Silver Necklace";

        public GlitteringSilverNecklace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringSilverNecklace(QuantityRequested);
        }
