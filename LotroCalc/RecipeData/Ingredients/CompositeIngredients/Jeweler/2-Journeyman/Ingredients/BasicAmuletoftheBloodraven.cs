...
{
    public class BasicAmuletoftheBloodraven : JourneymanIngredients
    {
        public static string DisplayName = "Basic Amulet of the Blood-raven";

        public BasicAmuletoftheBloodraven(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BasicAmuletoftheBloodraven(QuantityRequested);
        }
