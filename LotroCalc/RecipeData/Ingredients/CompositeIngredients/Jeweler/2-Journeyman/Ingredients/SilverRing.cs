...
{
    public class SilverRing : JourneymanIngredients
    {
        public static string DisplayName = "Silver Ring";

        public SilverRing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SilverRing(QuantityRequested);
        }
