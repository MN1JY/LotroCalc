...
{
    public class EngravedOpalBraceletofMorale : JourneymanIngredients
    {
        public static string DisplayName = "Engraved Opal Bracelet of Morale";

        public EngravedOpalBraceletofMorale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedOpalBraceletofMorale(QuantityRequested);
        }
