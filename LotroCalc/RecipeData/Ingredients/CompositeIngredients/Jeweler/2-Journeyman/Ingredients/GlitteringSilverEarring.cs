...
{
    public class GlitteringSilverEarring : JourneymanIngredients
    {
        public static string DisplayName = "Glittering Silver Earring";

        public GlitteringSilverEarring(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringSilverEarring(QuantityRequested);
        }
