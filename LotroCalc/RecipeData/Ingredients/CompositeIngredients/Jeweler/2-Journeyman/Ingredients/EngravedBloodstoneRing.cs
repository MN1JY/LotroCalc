...
{
    public class EngravedBloodstoneRing : JourneymanIngredients
    {
        public static string DisplayName = "Engraved Bloodstone Ring";

        public EngravedBloodstoneRing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedBloodstoneRing(QuantityRequested);
        }
