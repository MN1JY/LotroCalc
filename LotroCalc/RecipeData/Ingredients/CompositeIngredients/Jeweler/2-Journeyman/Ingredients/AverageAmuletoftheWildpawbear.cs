...
{
    public class AverageAmuletoftheWildpawbear : JourneymanIngredients
    {
        public static string DisplayName = "Average Amulet of the Wildpaw-bear";

        public AverageAmuletoftheWildpawbear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AverageAmuletoftheWildpawbear(QuantityRequested);
        }
