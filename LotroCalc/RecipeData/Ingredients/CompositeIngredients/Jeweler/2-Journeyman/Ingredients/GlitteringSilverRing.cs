...
{
    public class GlitteringSilverRing : JourneymanIngredients
    {
        public static string DisplayName = "Glittering Silver Ring";

        public GlitteringSilverRing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringSilverRing(QuantityRequested);
        }
