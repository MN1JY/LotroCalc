...
{
    public class SilverBracelet : JourneymanIngredients
    {
        public static string DisplayName = "Silver Bracelet";

        public SilverBracelet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SilverBracelet(QuantityRequested);
        }
