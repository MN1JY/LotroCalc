...
{
    public class EngravedOpalNecklaceofEvasion : JourneymanIngredients
    {
        public static string DisplayName = "Engraved Opal Necklace of Evasion";

        public EngravedOpalNecklaceofEvasion(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedOpalNecklaceofEvasion(QuantityRequested);
        }
