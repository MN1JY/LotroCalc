...
{
    public class EngravedBloodstoneRingofTactics : JourneymanIngredients
    {
        public static string DisplayName = "Engraved Bloodstone Ring of Tactics";

        public EngravedBloodstoneRingofTactics(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedBloodstoneRingofTactics(QuantityRequested);
        }
