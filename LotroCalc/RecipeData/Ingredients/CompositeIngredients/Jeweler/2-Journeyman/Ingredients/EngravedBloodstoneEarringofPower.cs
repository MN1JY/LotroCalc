...
{
    public class EngravedBloodstoneEarringofPower : JourneymanIngredients
    {
        public static string DisplayName = "Engraved Bloodstone Earring of Power";

        public EngravedBloodstoneEarringofPower(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedBloodstoneEarringofPower(QuantityRequested);
        }
