...
{
    public class SilverNecklace : JourneymanIngredients
    {
        public static string DisplayName = "Silver Necklace";

        public SilverNecklace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SilverNecklace(QuantityRequested);
        }
