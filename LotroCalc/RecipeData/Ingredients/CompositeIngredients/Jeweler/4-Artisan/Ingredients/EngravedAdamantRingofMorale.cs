...
{
    public class EngravedAdamantRingofMorale : ArtisanIngredients
    {
        public static string DisplayName = "Engraved Adamant Ring of Morale";

        public EngravedAdamantRingofMorale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedAdamantRingofMorale(QuantityRequested);
        }
