...
{
    public class ExcellentAmuletoftheFrostlynx : ArtisanIngredients
    {
        public static string DisplayName = "Excellent Amulet of the Frost-lynx";

        public ExcellentAmuletoftheFrostlynx(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ExcellentAmuletoftheFrostlynx(QuantityRequested);
        }
