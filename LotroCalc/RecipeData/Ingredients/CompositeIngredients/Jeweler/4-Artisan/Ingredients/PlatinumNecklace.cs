...
{
    public class PlatinumNecklace : ArtisanIngredients
    {
        public static string DisplayName = "Platinum Necklace";

        public PlatinumNecklace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PlatinumNecklace(QuantityRequested);
        }
