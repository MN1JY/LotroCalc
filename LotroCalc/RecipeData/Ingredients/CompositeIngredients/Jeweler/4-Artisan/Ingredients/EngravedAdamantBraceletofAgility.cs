...
{
    public class EngravedAdamantBraceletofAgility : ArtisanIngredients
    {
        public static string DisplayName = "Engraved Adamant Bracelet of Agility";

        public EngravedAdamantBraceletofAgility(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedAdamantBraceletofAgility(QuantityRequested);
        }
