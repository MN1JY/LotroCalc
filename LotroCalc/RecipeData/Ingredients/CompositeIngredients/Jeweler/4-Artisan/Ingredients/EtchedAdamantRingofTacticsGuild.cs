...
{
    public class EtchedAdamantRingofTacticsGuild : ArtisanIngredients
    {
        public static string DisplayName = "Etched Adamant Ring of Tactics (Guild)";

        public EtchedAdamantRingofTacticsGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedAdamantRingofTacticsGuild(QuantityRequested);
        }
