...
{
    public class AdamantEarringofCombat : ArtisanIngredients
    {
        public static string DisplayName = "Adamant Earring of Combat";

        public AdamantEarringofCombat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AdamantEarringofCombat(QuantityRequested);
        }
