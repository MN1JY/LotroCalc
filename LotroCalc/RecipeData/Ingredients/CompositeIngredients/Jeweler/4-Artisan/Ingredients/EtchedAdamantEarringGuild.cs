...
{
    public class EtchedAdamantEarringGuild : ArtisanIngredients
    {
        public static string DisplayName = "Etched Adamant Earring (Guild)";

        public EtchedAdamantEarringGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedAdamantEarringGuild(QuantityRequested);
        }
