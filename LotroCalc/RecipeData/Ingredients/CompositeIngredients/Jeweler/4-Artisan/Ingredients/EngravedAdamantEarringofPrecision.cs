...
{
    public class EngravedAdamantEarringofPrecision : ArtisanIngredients
    {
        public static string DisplayName = "Engraved Adamant Earring of Precision";

        public EngravedAdamantEarringofPrecision(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedAdamantEarringofPrecision(QuantityRequested);
        }
