...
{
    public class EtchedAdamantNecklaceofMoraleGuild : ArtisanIngredients
    {
        public static string DisplayName = "Etched Adamant Necklace of Morale (Guild)";

        public EtchedAdamantNecklaceofMoraleGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedAdamantNecklaceofMoraleGuild(QuantityRequested);
        }
