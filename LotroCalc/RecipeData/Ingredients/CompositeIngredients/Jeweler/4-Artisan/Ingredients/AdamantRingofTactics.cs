...
{
    public class AdamantRingofTactics : ArtisanIngredients
    {
        public static string DisplayName = "Adamant Ring of Tactics";

        public AdamantRingofTactics(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AdamantRingofTactics(QuantityRequested);
        }
