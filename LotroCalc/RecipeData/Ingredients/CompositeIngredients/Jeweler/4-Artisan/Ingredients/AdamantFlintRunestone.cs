...
{
    public class AdamantFlintRunestone : ArtisanIngredients
    {
        public static string DisplayName = "Adamant Flint Rune-stone";

        public AdamantFlintRunestone(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AdamantFlintRunestone(QuantityRequested);
        }
