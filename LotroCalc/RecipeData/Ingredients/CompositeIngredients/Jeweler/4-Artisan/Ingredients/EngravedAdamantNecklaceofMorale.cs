...
{
    public class EngravedAdamantNecklaceofMorale : ArtisanIngredients
    {
        public static string DisplayName = "Engraved Adamant Necklace of Morale";

        public EngravedAdamantNecklaceofMorale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedAdamantNecklaceofMorale(QuantityRequested);
        }
