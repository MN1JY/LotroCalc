...
{
    public class AdamantNecklaceofMorale : ArtisanIngredients
    {
        public static string DisplayName = "Adamant Necklace of Morale";

        public AdamantNecklaceofMorale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AdamantNecklaceofMorale(QuantityRequested);
        }
