...
{
    public class EtchedAdamantNecklaceGuild : ArtisanIngredients
    {
        public static string DisplayName = "Etched Adamant Necklace (Guild)";

        public EtchedAdamantNecklaceGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedAdamantNecklaceGuild(QuantityRequested);
        }
