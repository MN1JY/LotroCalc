...
{
    public class AdamantEarringofWillpower : ArtisanIngredients
    {
        public static string DisplayName = "Adamant Earring of Willpower";

        public AdamantEarringofWillpower(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AdamantEarringofWillpower(QuantityRequested);
        }
