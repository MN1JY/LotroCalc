...
{
    public class ShiningEdhelharnToken : ArtisanIngredients
    {
        public static string DisplayName = "Shining Edhelharn Token";

        public ShiningEdhelharnToken(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ShiningEdhelharnToken(QuantityRequested);
        }
