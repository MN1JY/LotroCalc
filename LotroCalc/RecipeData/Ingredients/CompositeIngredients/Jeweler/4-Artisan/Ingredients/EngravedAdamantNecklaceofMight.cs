...
{
    public class EngravedAdamantNecklaceofMight : ArtisanIngredients
    {
        public static string DisplayName = "Engraved Adamant Necklace of Might";

        public EngravedAdamantNecklaceofMight(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedAdamantNecklaceofMight(QuantityRequested);
        }
