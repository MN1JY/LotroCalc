...
{
    public class GlitteringPlatinumRing : ArtisanIngredients
    {
        public static string DisplayName = "Glittering Platinum Ring";

        public GlitteringPlatinumRing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringPlatinumRing(QuantityRequested);
        }
