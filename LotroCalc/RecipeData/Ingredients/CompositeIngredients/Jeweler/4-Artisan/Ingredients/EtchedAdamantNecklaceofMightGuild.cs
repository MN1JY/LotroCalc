...
{
    public class EtchedAdamantNecklaceofMightGuild : ArtisanIngredients
    {
        public static string DisplayName = "Etched Adamant Necklace of Might (Guild)";

        public EtchedAdamantNecklaceofMightGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedAdamantNecklaceofMightGuild(QuantityRequested);
        }
