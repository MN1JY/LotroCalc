...
{
    public class WhiteGoldEarring : ArtisanIngredients
    {
        public static string DisplayName = "White Gold Earring";

        public WhiteGoldEarring(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WhiteGoldEarring(QuantityRequested);
        }
