...
{
    public class WhiteGoldRing : ArtisanIngredients
    {
        public static string DisplayName = "White Gold Ring";

        public WhiteGoldRing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WhiteGoldRing(QuantityRequested);
        }
