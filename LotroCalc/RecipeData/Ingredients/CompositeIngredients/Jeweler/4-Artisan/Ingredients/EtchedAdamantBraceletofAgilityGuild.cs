...
{
    public class EtchedAdamantBraceletofAgilityGuild : ArtisanIngredients
    {
        public static string DisplayName = "Etched Adamant Bracelet of Agility (Guild)";

        public EtchedAdamantBraceletofAgilityGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedAdamantBraceletofAgilityGuild(QuantityRequested);
        }
