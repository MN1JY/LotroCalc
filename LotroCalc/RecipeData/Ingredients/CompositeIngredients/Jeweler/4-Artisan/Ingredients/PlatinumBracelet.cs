...
{
    public class PlatinumBracelet : ArtisanIngredients
    {
        public static string DisplayName = "Platinum Bracelet";

        public PlatinumBracelet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PlatinumBracelet(QuantityRequested);
        }
