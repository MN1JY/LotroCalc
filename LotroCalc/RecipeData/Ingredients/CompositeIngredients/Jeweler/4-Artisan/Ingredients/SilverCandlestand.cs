...
{
    public class SilverCandlestand : ArtisanIngredients
    {
        public static string DisplayName = "Silver Candlestand";

        public SilverCandlestand(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SilverCandlestand(QuantityRequested);
        }
