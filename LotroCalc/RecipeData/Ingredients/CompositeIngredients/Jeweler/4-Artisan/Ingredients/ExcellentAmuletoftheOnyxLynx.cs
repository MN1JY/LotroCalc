...
{
    public class ExcellentAmuletoftheOnyxLynx : ArtisanIngredients
    {
        public static string DisplayName = "Excellent Amulet of the Onyx Lynx";

        public ExcellentAmuletoftheOnyxLynx(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ExcellentAmuletoftheOnyxLynx(QuantityRequested);
        }
