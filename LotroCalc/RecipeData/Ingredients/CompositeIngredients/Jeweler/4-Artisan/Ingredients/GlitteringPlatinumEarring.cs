...
{
    public class GlitteringPlatinumEarring : ArtisanIngredients
    {
        public static string DisplayName = "Glittering Platinum Earring";

        public GlitteringPlatinumEarring(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringPlatinumEarring(QuantityRequested);
        }
