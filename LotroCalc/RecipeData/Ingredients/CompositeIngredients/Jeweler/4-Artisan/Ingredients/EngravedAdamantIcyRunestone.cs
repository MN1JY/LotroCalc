...
{
    public class EngravedAdamantIcyRunestone : ArtisanIngredients
    {
        public static string DisplayName = "Engraved Adamant Icy Rune-stone";

        public EngravedAdamantIcyRunestone(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedAdamantIcyRunestone(QuantityRequested);
        }
