...
{
    public class EtchedAdamantRingofMoraleGuild : ArtisanIngredients
    {
        public static string DisplayName = "Etched Adamant Ring of Morale (Guild)";

        public EtchedAdamantRingofMoraleGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedAdamantRingofMoraleGuild(QuantityRequested);
        }
