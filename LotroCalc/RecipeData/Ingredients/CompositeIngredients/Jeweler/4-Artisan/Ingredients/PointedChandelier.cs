...
{
    public class PointedChandelier : ArtisanIngredients
    {
        public static string DisplayName = "Pointed Chandelier";

        public PointedChandelier(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PointedChandelier(QuantityRequested);
        }
