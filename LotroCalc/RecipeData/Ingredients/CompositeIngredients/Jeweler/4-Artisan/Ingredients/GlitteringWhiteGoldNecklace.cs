...
{
    public class GlitteringWhiteGoldNecklace : ArtisanIngredients
    {
        public static string DisplayName = "Glittering White Gold Necklace";

        public GlitteringWhiteGoldNecklace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringWhiteGoldNecklace(QuantityRequested);
        }
