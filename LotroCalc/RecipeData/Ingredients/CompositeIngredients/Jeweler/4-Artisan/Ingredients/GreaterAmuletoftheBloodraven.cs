...
{
    public class GreaterAmuletoftheBloodraven : ArtisanIngredients
    {
        public static string DisplayName = "Greater Amulet of the Blood-raven";

        public GreaterAmuletoftheBloodraven(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GreaterAmuletoftheBloodraven(QuantityRequested);
        }
