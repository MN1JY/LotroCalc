...
{
    public class EtchedAdamantEarringofWillpowerGuild : ArtisanIngredients
    {
        public static string DisplayName = "Etched Adamant Earring of Willpower (Guild)";

        public EtchedAdamantEarringofWillpowerGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedAdamantEarringofWillpowerGuild(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = MediumArtisanSymbol.DisplayName;
            ing = (Ingredient)DictCraftedIngredients[ingName].Clone();
            ing.QuantityRequested = 1 * QuantityRequested;
            recipe.Add(ingName, ing);
