...
{
    public class EngravedAdamantEarringofCombat : ArtisanIngredients
    {
        public static string DisplayName = "Engraved Adamant Earring of Combat";

        public EngravedAdamantEarringofCombat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedAdamantEarringofCombat(QuantityRequested);
        }
