...
{
    public class ExcellentAmuletoftheSpottedLynx : ArtisanIngredients
    {
        public static string DisplayName = "Excellent Amulet of the Spotted Lynx";

        public ExcellentAmuletoftheSpottedLynx(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ExcellentAmuletoftheSpottedLynx(QuantityRequested);
        }
