...
{
    public class EngravedAdamantRingofTactics : ArtisanIngredients
    {
        public static string DisplayName = "Engraved Adamant Ring of Tactics";

        public EngravedAdamantRingofTactics(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedAdamantRingofTactics(QuantityRequested);
        }
