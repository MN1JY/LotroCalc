...
{
    public class AdamantRingofVitality : ArtisanIngredients
    {
        public static string DisplayName = "Adamant Ring of Vitality";

        public AdamantRingofVitality(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AdamantRingofVitality(QuantityRequested);
        }
