...
{
    public class EtchedAdamantRingGuild : ArtisanIngredients
    {
        public static string DisplayName = "Etched Adamant Ring (Guild)";

        public EtchedAdamantRingGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedAdamantRingGuild(QuantityRequested);
        }
