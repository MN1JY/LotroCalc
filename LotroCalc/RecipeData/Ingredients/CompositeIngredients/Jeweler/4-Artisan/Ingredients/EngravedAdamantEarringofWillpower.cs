...
{
    public class EngravedAdamantEarringofWillpower : ArtisanIngredients
    {
        public static string DisplayName = "Engraved Adamant Earring of Willpower";

        public EngravedAdamantEarringofWillpower(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedAdamantEarringofWillpower(QuantityRequested);
        }
