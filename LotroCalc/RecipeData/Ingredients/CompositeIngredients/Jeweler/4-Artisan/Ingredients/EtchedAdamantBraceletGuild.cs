...
{
    public class EtchedAdamantBraceletGuild : ArtisanIngredients
    {
        public static string DisplayName = "Etched Adamant Bracelet (Guild)";

        public EtchedAdamantBraceletGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedAdamantBraceletGuild(QuantityRequested);
        }
