...
{
    public class EtchedAdamantEarringofCombatGuild : ArtisanIngredients
    {
        public static string DisplayName = "Etched Adamant Earring of Combat (Guild)";

        public EtchedAdamantEarringofCombatGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedAdamantEarringofCombatGuild(QuantityRequested);
        }
