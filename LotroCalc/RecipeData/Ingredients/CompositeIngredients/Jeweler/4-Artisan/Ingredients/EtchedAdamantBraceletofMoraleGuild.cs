...
{
    public class EtchedAdamantBraceletofMoraleGuild : ArtisanIngredients
    {
        public static string DisplayName = "Etched Adamant Bracelet of Morale (Guild)";

        public EtchedAdamantBraceletofMoraleGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedAdamantBraceletofMoraleGuild(QuantityRequested);
        }
