...
{
    public class AdamantNecklaceofMight : ArtisanIngredients
    {
        public static string DisplayName = "Adamant Necklace of Might";

        public AdamantNecklaceofMight(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AdamantNecklaceofMight(QuantityRequested);
        }
