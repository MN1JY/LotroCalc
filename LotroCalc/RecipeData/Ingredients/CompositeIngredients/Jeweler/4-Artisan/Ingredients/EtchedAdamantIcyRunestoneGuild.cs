...
{
    public class EtchedAdamantIcyRunestoneGuild : ArtisanIngredients
    {
        public static string DisplayName = "Etched Adamant Icy Rune-stone (Guild)";

        public EtchedAdamantIcyRunestoneGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedAdamantIcyRunestoneGuild(QuantityRequested);
        }
