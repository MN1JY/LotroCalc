...
{
    public class SmallArtisanSymbol : ArtisanIngredients
    {
        public static string DisplayName = "Small Artisan Symbol (Guild)";

        public SmallArtisanSymbol(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallArtisanSymbol(QuantityRequested);
        }
