...
{
    public class EngravedAdamantBraceletofMorale : ArtisanIngredients
    {
        public static string DisplayName = "Engraved Adamant Bracelet of Morale";

        public EngravedAdamantBraceletofMorale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedAdamantBraceletofMorale(QuantityRequested);
        }
