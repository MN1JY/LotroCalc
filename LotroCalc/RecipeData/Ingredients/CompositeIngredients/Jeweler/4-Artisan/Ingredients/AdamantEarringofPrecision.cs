...
{
    public class AdamantEarringofPrecision : ArtisanIngredients
    {
        public static string DisplayName = "Adamant Earring of Precision";

        public AdamantEarringofPrecision(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AdamantEarringofPrecision(QuantityRequested);
        }
