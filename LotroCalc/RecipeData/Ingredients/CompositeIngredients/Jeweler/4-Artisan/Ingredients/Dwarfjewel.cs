...
{
    public class Dwarfjewel : ArtisanIngredients
    {
        public static string DisplayName = "Dwarf-jewel";

        public Dwarfjewel(int count)
        {
            Name = DisplayName;
        ...
        {
            return new Dwarfjewel(QuantityRequested);
        }
