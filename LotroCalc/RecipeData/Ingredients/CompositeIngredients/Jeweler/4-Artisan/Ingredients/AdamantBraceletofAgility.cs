...
{
    public class AdamantBraceletofAgility : ArtisanIngredients
    {
        public static string DisplayName = "Adamant Bracelet of Agility";

        public AdamantBraceletofAgility(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AdamantBraceletofAgility(QuantityRequested);
        }
