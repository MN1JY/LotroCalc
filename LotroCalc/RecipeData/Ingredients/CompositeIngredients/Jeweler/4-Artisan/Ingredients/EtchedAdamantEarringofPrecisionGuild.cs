...
{
    public class EtchedAdamantEarringofPrecisionGuild : ArtisanIngredients
    {
        public static string DisplayName = "Etched Adamant Earring of Precision (Guild)";

        public EtchedAdamantEarringofPrecisionGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedAdamantEarringofPrecisionGuild(QuantityRequested);
        }
