...
{
    public class WeakAmuletoftheBloodraven : ApprenticeIngredients
    {
        public static string DisplayName = "Weak Amulet of the Blood-raven";

        public WeakAmuletoftheBloodraven(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WeakAmuletoftheBloodraven(QuantityRequested);
        }
