...
{
    public class AgateNecklaceofQuickness : ApprenticeIngredients
    {
        public static string DisplayName = "Agate Necklace of Quickness";

        public AgateNecklaceofQuickness(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AgateNecklaceofQuickness(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = PolishedAgate.DisplayName;
            ing = (Ingredient)DictCraftedIngredients[ingName].Clone();
