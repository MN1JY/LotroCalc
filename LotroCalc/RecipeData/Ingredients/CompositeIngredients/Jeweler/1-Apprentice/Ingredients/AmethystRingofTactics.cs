...
{
    public class AmethystRingofTactics : ApprenticeIngredients
    {
        public static string DisplayName = "Amethyst Ring of Tactics";

        public AmethystRingofTactics(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AmethystRingofTactics(QuantityRequested);
        }
