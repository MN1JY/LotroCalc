...
{
    public class GlitteringCopperBracelet : ApprenticeIngredients
    {
        public static string DisplayName = "Glittering Copper Bracelet";

        public GlitteringCopperBracelet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringCopperBracelet(QuantityRequested);
        }
