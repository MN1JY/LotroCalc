...
{
    public class CopperNecklace : ApprenticeIngredients
    {
        public static string DisplayName = "Copper Necklace";

        public CopperNecklace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CopperNecklace(QuantityRequested);
        }
