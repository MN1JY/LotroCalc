...
{
    public class AgateNecklaceofMorale : ApprenticeIngredients
    {
        public static string DisplayName = "Agate Necklace of Morale";

        public AgateNecklaceofMorale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AgateNecklaceofMorale(QuantityRequested);
        }
