...
{
    public class CopperEarring : ApprenticeIngredients
    {
        public static string DisplayName = "Copper Earring";

        public CopperEarring(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CopperEarring(QuantityRequested);
        }
