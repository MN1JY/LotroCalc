...
{
    public class GlitteringCopperNecklace : ApprenticeIngredients
    {
        public static string DisplayName = "Glittering Copper Necklace";

        public GlitteringCopperNecklace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringCopperNecklace(QuantityRequested);
        }
