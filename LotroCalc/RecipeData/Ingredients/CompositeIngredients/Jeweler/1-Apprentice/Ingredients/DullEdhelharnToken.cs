...
{
    public class DullEdhelharnToken : ApprenticeIngredients
    {
        public static string DisplayName = "Dull Edhelharn Token";

        public DullEdhelharnToken(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DullEdhelharnToken(QuantityRequested);
        }
