...
{
    public class GlitteringCopperRing : ApprenticeIngredients
    {
        public static string DisplayName = "Glittering Copper Ring";

        public GlitteringCopperRing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringCopperRing(QuantityRequested);
        }
