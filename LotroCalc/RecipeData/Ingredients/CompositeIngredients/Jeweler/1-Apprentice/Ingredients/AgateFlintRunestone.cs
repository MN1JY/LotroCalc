...
{
    public class AgateFlintRunestone : ApprenticeIngredients
    {
        public static string DisplayName = "Agate Flint Rune-stone";

        public AgateFlintRunestone(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AgateFlintRunestone(QuantityRequested);
        }
