...
{
    public class AmethystEarringofMorale : ApprenticeIngredients
    {
        public static string DisplayName = "Amethyst Earring of Morale";

        public AmethystEarringofMorale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AmethystEarringofMorale(QuantityRequested);
        }
