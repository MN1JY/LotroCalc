...
{
    public class AgateBraceletofMorale : ApprenticeIngredients
    {
        public static string DisplayName = "Agate Bracelet of Morale";

        public AgateBraceletofMorale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AgateBraceletofMorale(QuantityRequested);
        }
