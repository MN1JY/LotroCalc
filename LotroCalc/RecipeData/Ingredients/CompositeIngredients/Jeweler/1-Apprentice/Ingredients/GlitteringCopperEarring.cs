...
{
    public class GlitteringCopperEarring : ApprenticeIngredients
    {
        public static string DisplayName = "Glittering Copper Earring";

        public GlitteringCopperEarring(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringCopperEarring(QuantityRequested);
        }
