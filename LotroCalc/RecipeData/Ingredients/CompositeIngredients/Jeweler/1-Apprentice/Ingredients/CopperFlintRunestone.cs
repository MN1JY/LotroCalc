...
{
    public class CopperFlintRunestone : ApprenticeIngredients
    {
        public static string DisplayName = "Copper Flint Rune-stone";

        public CopperFlintRunestone(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CopperFlintRunestone(QuantityRequested);
        }
