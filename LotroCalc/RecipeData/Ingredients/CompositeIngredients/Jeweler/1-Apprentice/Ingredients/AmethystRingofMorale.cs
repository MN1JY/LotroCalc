...
{
    public class AmethystRingofMorale : ApprenticeIngredients
    {
        public static string DisplayName = "Amethyst Ring of Morale";

        public AmethystRingofMorale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AmethystRingofMorale(QuantityRequested);
        }
