...
{
    public class AgateBraceletofBlocking : ApprenticeIngredients
    {
        public static string DisplayName = "Agate Bracelet of Blocking";

        public AgateBraceletofBlocking(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AgateBraceletofBlocking(QuantityRequested);
        }
