...
{
    public class AmethystEarringofPrecision : ApprenticeIngredients
    {
        public static string DisplayName = "Amethyst Earring of Precision";

        public AmethystEarringofPrecision(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AmethystEarringofPrecision(QuantityRequested);
        }
