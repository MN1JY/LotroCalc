...
{
    public class AureateHoopofWillpower : SupremeIngredients
    {
        public static string DisplayName = "Aureate Hoop of Willpower";

        public AureateHoopofWillpower(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AureateHoopofWillpower(QuantityRequested);
        }
