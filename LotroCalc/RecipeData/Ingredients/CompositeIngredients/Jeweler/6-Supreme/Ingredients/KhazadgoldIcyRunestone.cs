...
{
    public class KhazadgoldIcyRunestone : SupremeIngredients
    {
        public static string DisplayName = "Khazad-gold Icy Rune-stone";

        public KhazadgoldIcyRunestone(int count)
        {
            Name = DisplayName;
        ...
        {
            return new KhazadgoldIcyRunestone(QuantityRequested);
        }
