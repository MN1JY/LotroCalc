...
{
    public class AureateBraceletofMorale : SupremeIngredients
    {
        public static string DisplayName = "Aureate Bracelet of Morale";

        public AureateBraceletofMorale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AureateBraceletofMorale(QuantityRequested);
        }
