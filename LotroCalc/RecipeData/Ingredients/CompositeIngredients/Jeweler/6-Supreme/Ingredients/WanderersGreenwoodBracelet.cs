...
{
    public class WanderersGreenwoodBracelet : SupremeIngredients
    {
        public static string DisplayName = "Wanderer's Greenwood Bracelet";

        public WanderersGreenwoodBracelet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WanderersGreenwoodBracelet(QuantityRequested);
        }
