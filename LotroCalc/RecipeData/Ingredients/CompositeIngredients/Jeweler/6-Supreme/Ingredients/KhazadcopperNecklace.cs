...
{
    public class KhazadcopperNecklace : SupremeIngredients
    {
        public static string DisplayName = "Khazad-copper Necklace";

        public KhazadcopperNecklace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new KhazadcopperNecklace(QuantityRequested);
        }
