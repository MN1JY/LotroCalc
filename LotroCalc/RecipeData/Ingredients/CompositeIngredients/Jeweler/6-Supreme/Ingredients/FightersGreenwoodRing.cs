...
{
    public class FightersGreenwoodRing : SupremeIngredients
    {
        public static string DisplayName = "Fighter's Greenwood Ring";

        public FightersGreenwoodRing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FightersGreenwoodRing(QuantityRequested);
        }
