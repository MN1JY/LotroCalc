...
{
    public class SuperbAmuletoftheSnowcrestEagle : SupremeIngredients
    {
        public static string DisplayName = "Superb Amulet of the Snowcrest Eagle";

        public SuperbAmuletoftheSnowcrestEagle(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbAmuletoftheSnowcrestEagle(QuantityRequested);
        }
