...
{
    public class AquamarineBracelet : SupremeIngredients
    {
        public static string DisplayName = "Aquamarine Bracelet";

        public AquamarineBracelet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AquamarineBracelet(QuantityRequested);
        }
