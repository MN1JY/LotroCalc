...
{
    public class GrandAmuletoftheAshenEagle : SupremeIngredients
    {
        public static string DisplayName = "Grand Amulet of the Ashen Eagle";

        public GrandAmuletoftheAshenEagle(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GrandAmuletoftheAshenEagle(QuantityRequested);
        }
