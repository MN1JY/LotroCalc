...
{
    public class ReforgedObsidianRunestoneoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Obsidian Rune-stone of the Second Age (Level 65)";

        public ReforgedObsidianRunestoneoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedObsidianRunestoneoftheSecondAgeLevel65(QuantityRequested);
        }
