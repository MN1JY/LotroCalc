...
{
    public class KhazadgoldRing : SupremeIngredients
    {
        public static string DisplayName = "Khazad-gold Ring";

        public KhazadgoldRing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new KhazadgoldRing(QuantityRequested);
        }
