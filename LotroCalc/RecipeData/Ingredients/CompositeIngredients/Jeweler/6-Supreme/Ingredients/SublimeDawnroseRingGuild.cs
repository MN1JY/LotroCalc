...
{
    public class SublimeDawnroseRingGuild : SupremeIngredients
    {
        public static string DisplayName = "Sublime Dawn-rose Ring (Guild)";

        public SublimeDawnroseRingGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SublimeDawnroseRingGuild(QuantityRequested);
        }
