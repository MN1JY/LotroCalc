...
{
    public class ReforgedFlintRunestoneoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Flint Rune-stone of the Second Age (Level 60)";

        public ReforgedFlintRunestoneoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedFlintRunestoneoftheSecondAgeLevel60(QuantityRequested);
        }
