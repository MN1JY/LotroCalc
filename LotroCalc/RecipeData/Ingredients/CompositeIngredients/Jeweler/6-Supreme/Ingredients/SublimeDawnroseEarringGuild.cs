...
{
    public class SublimeDawnroseEarringGuild : SupremeIngredients
    {
        public static string DisplayName = "Sublime Dawn-rose Earring (Guild)";

        public SublimeDawnroseEarringGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SublimeDawnroseEarringGuild(QuantityRequested);
        }
