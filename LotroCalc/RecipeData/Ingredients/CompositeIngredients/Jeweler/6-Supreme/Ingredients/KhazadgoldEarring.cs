...
{
    public class KhazadgoldEarring : SupremeIngredients
    {
        public static string DisplayName = "Khazad-gold Earring";

        public KhazadgoldEarring(int count)
        {
            Name = DisplayName;
        ...
        {
            return new KhazadgoldEarring(QuantityRequested);
        }
