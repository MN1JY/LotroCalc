...
{
    public class DawnroseBraceletofPower : SupremeIngredients
    {
        public static string DisplayName = "Dawn-rose Bracelet of Power";

        public DawnroseBraceletofPower(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DawnroseBraceletofPower(QuantityRequested);
        }
