...
{
    public class PhilosophersGreenwoodEarring : SupremeIngredients
    {
        public static string DisplayName = "Philosopher's Greenwood Earring";

        public PhilosophersGreenwoodEarring(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PhilosophersGreenwoodEarring(QuantityRequested);
        }
