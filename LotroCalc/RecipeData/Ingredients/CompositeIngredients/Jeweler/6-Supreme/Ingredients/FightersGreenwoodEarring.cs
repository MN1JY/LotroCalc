...
{
    public class FightersGreenwoodEarring : SupremeIngredients
    {
        public static string DisplayName = "Fighter's Greenwood Earring";

        public FightersGreenwoodEarring(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FightersGreenwoodEarring(QuantityRequested);
        }
