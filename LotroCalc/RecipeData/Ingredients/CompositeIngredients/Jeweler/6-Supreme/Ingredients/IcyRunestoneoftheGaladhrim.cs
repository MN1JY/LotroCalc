...
{
    public class IcyRunestoneoftheGaladhrim : SupremeIngredients
    {
        public static string DisplayName = "Icy Rune-stone of the Galadhrim";

        public IcyRunestoneoftheGaladhrim(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IcyRunestoneoftheGaladhrim(QuantityRequested);
        }
