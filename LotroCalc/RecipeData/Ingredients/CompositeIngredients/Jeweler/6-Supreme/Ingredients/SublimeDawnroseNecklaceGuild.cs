...
{
    public class SublimeDawnroseNecklaceGuild : SupremeIngredients
    {
        public static string DisplayName = "Sublime Dawn-rose Necklace (Guild)";

        public SublimeDawnroseNecklaceGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SublimeDawnroseNecklaceGuild(QuantityRequested);
        }
