...
{
    public class GlowingAureateHoopofWillpowerGuild : SupremeIngredients
    {
        public static string DisplayName = "Glowing Aureate Hoop of Willpower (Guild)";

        public GlowingAureateHoopofWillpowerGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlowingAureateHoopofWillpowerGuild(QuantityRequested);
        }
