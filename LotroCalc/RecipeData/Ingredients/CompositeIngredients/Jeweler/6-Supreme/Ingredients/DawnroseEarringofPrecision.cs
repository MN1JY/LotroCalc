...
{
    public class DawnroseEarringofPrecision : SupremeIngredients
    {
        public static string DisplayName = "Dawn-rose Earring of Precision";

        public DawnroseEarringofPrecision(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DawnroseEarringofPrecision(QuantityRequested);
        }
