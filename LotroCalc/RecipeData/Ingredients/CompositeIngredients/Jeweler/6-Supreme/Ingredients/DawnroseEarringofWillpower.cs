...
{
    public class DawnroseEarringofWillpower : SupremeIngredients
    {
        public static string DisplayName = "Dawn-rose Earring of Willpower";

        public DawnroseEarringofWillpower(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DawnroseEarringofWillpower(QuantityRequested);
        }
