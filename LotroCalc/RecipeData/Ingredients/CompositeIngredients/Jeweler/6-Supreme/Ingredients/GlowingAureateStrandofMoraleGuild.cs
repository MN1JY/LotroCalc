...
{
    public class GlowingAureateStrandofMoraleGuild : SupremeIngredients
    {
        public static string DisplayName = "Glowing Aureate Strand of Morale (Guild)";

        public GlowingAureateStrandofMoraleGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlowingAureateStrandofMoraleGuild(QuantityRequested);
        }
