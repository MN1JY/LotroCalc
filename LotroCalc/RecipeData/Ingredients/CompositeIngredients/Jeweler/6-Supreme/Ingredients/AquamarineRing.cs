...
{
    public class AquamarineRing : SupremeIngredients
    {
        public static string DisplayName = "Aquamarine Ring";

        public AquamarineRing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AquamarineRing(QuantityRequested);
        }
