...
{
    public class SuperbAmuletoftheFrostlynx : SupremeIngredients
    {
        public static string DisplayName = "Superb Amulet of the Frost-lynx";

        public SuperbAmuletoftheFrostlynx(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbAmuletoftheFrostlynx(QuantityRequested);
        }
