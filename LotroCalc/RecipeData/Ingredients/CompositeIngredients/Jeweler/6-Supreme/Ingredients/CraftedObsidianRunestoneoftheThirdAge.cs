...
{
    public class CraftedObsidianRunestoneoftheThirdAge : SupremeIngredients
    {
        public static string DisplayName = "Crafted Obsidian Rune-stone of the Third Age";

        public CraftedObsidianRunestoneoftheThirdAge(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedObsidianRunestoneoftheThirdAge(QuantityRequested);
        }
