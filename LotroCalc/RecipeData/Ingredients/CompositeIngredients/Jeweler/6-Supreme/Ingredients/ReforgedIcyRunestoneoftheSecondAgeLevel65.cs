...
{
    public class ReforgedIcyRunestoneoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Icy Rune-stone of the Second Age (Level 65)";

        public ReforgedIcyRunestoneoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedIcyRunestoneoftheSecondAgeLevel65(QuantityRequested);
        }
