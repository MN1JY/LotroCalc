...
{
    public class GrandAmuletoftheSpottedLynx : SupremeIngredients
    {
        public static string DisplayName = "Grand Amulet of the Spotted Lynx";

        public GrandAmuletoftheSpottedLynx(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GrandAmuletoftheSpottedLynx(QuantityRequested);
        }
