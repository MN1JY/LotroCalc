...
{
    public class AureateStrandofMight : SupremeIngredients
    {
        public static string DisplayName = "Aureate Strand of Might";

        public AureateStrandofMight(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AureateStrandofMight(QuantityRequested);
        }
