...
{
    public class PerfectFlintRunestoneoftheGaladhrimGuild : SupremeIngredients
    {
        public static string DisplayName = "Perfect Flint Rune-stone of the Galadhrim (Guild)";

        public PerfectFlintRunestoneoftheGaladhrimGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PerfectFlintRunestoneoftheGaladhrimGuild(QuantityRequested);
        }
