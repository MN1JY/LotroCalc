...
{
    public class AureateBandofTactics : SupremeIngredients
    {
        public static string DisplayName = "Aureate Band of Tactics";

        public AureateBandofTactics(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AureateBandofTactics(QuantityRequested);
        }
