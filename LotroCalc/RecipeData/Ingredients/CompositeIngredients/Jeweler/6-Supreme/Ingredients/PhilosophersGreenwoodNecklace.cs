...
{
    public class PhilosophersGreenwoodNecklace : SupremeIngredients
    {
        public static string DisplayName = "Philosopher's Greenwood Necklace";

        public PhilosophersGreenwoodNecklace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PhilosophersGreenwoodNecklace(QuantityRequested);
        }
