...
{
    public class GlowingAureateStrandofMightGuild : SupremeIngredients
    {
        public static string DisplayName = "Glowing Aureate Strand of Might (Guild)";

        public GlowingAureateStrandofMightGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlowingAureateStrandofMightGuild(QuantityRequested);
        }
