...
{
    public class DawnroseNecklaceofMorale : SupremeIngredients
    {
        public static string DisplayName = "Dawn-rose Necklace of Morale";

        public DawnroseNecklaceofMorale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DawnroseNecklaceofMorale(QuantityRequested);
        }
