...
{
    public class AureateStrandofMorale : SupremeIngredients
    {
        public static string DisplayName = "Aureate Strand of Morale";

        public AureateStrandofMorale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AureateStrandofMorale(QuantityRequested);
        }
