...
{
    public class AureateHoopofCombat : SupremeIngredients
    {
        public static string DisplayName = "Aureate Hoop of Combat";

        public AureateHoopofCombat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AureateHoopofCombat(QuantityRequested);
        }
