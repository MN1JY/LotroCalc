...
{
    public class ReforgedChampionsRuneoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Rune of the Second Age (Level 65)";

        public ReforgedChampionsRuneoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsRuneoftheSecondAgeLevel65(QuantityRequested);
        }
