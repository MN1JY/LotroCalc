...
{
    public class GlowingAureateBraceletofMoraleGuild : SupremeIngredients
    {
        public static string DisplayName = "Glowing Aureate Bracelet of Morale (Guild)";

        public GlowingAureateBraceletofMoraleGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlowingAureateBraceletofMoraleGuild(QuantityRequested);
        }
