...
{
    public class GrandAmuletoftheOnyxLynx : SupremeIngredients
    {
        public static string DisplayName = "Grand Amulet of the Onyx Lynx";

        public GrandAmuletoftheOnyxLynx(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GrandAmuletoftheOnyxLynx(QuantityRequested);
        }
