...
{
    public class KhazadgoldNecklace : SupremeIngredients
    {
        public static string DisplayName = "Khazad-gold Necklace";

        public KhazadgoldNecklace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new KhazadgoldNecklace(QuantityRequested);
        }
