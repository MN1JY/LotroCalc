...
{
    public class FightersGreenwoodNecklace : SupremeIngredients
    {
        public static string DisplayName = "Fighter's Greenwood Necklace";

        public FightersGreenwoodNecklace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FightersGreenwoodNecklace(QuantityRequested);
        }
