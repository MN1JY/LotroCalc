...
{
    public class SuperbAmuletoftheOnyxLynx : SupremeIngredients
    {
        public static string DisplayName = "Superb Amulet of the Onyx Lynx";

        public SuperbAmuletoftheOnyxLynx(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbAmuletoftheOnyxLynx(QuantityRequested);
        }
