...
{
    public class AureateBandofMorale : SupremeIngredients
    {
        public static string DisplayName = "Aureate Band of Morale";

        public AureateBandofMorale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AureateBandofMorale(QuantityRequested);
        }
