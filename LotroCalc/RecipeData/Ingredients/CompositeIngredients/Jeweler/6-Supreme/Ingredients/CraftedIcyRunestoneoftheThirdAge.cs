...
{
    public class CraftedIcyRunestoneoftheThirdAge : SupremeIngredients
    {
        public static string DisplayName = "Crafted Icy Rune-stone of the Third Age";

        public CraftedIcyRunestoneoftheThirdAge(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedIcyRunestoneoftheThirdAge(QuantityRequested);
        }
