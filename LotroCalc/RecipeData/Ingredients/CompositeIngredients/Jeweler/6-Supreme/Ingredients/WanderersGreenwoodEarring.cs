...
{
    public class WanderersGreenwoodEarring : SupremeIngredients
    {
        public static string DisplayName = "Wanderer's Greenwood Earring";

        public WanderersGreenwoodEarring(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WanderersGreenwoodEarring(QuantityRequested);
        }
