...
{
    public class AureateBraceletofPower : SupremeIngredients
    {
        public static string DisplayName = "Aureate Bracelet of Power";

        public AureateBraceletofPower(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AureateBraceletofPower(QuantityRequested);
        }
