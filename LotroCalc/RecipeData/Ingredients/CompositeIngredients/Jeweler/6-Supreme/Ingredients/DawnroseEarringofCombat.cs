...
{
    public class DawnroseEarringofCombat : SupremeIngredients
    {
        public static string DisplayName = "Dawn-rose Earring of Combat";

        public DawnroseEarringofCombat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DawnroseEarringofCombat(QuantityRequested);
        }
