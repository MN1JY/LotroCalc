...
{
    public class AureateHoopofPrecision : SupremeIngredients
    {
        public static string DisplayName = "Aureate Hoop of Precision";

        public AureateHoopofPrecision(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AureateHoopofPrecision(QuantityRequested);
        }
