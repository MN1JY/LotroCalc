...
{
    public class KhazadcopperEarring : SupremeIngredients
    {
        public static string DisplayName = "Khazad-copper Earring";

        public KhazadcopperEarring(int count)
        {
            Name = DisplayName;
        ...
        {
            return new KhazadcopperEarring(QuantityRequested);
        }
