...
{
    public class DawnroseRingofTactics : SupremeIngredients
    {
        public static string DisplayName = "Dawn-rose Ring of Tactics";

        public DawnroseRingofTactics(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DawnroseRingofTactics(QuantityRequested);
        }
