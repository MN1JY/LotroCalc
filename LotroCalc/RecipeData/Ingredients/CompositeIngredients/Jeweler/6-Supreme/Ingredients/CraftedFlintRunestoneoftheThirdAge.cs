...
{
    public class CraftedFlintRunestoneoftheThirdAge : SupremeIngredients
    {
        public static string DisplayName = "Crafted Flint Rune-stone of the Third Age";

        public CraftedFlintRunestoneoftheThirdAge(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedFlintRunestoneoftheThirdAge(QuantityRequested);
        }
