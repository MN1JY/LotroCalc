...
{
    public class DunedainStar : SupremeIngredients
    {
        public static string DisplayName = "Dunedain Star (Guild)";

        public DunedainStar(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DunedainStar(QuantityRequested);
        }
