...
{
    public class ObsidianRunestoneoftheGoldenHost : SupremeIngredients
    {
        public static string DisplayName = "Obsidian Rune-stone of the Golden Host";

        public ObsidianRunestoneoftheGoldenHost(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ObsidianRunestoneoftheGoldenHost(QuantityRequested);
        }
