...
{
    public class KhazadcopperRing : SupremeIngredients
    {
        public static string DisplayName = "Khazad-copper Ring";

        public KhazadcopperRing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new KhazadcopperRing(QuantityRequested);
        }
