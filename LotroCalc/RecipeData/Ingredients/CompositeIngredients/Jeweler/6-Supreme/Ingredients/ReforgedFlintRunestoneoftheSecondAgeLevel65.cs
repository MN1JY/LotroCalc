...
{
    public class ReforgedFlintRunestoneoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Flint Rune-stone of the Second Age (Level 65)";

        public ReforgedFlintRunestoneoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedFlintRunestoneoftheSecondAgeLevel65(QuantityRequested);
        }
