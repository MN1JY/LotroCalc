...
{
    public class FightersGreenwoodBracelet : SupremeIngredients
    {
        public static string DisplayName = "Fighter's Greenwood Bracelet";

        public FightersGreenwoodBracelet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FightersGreenwoodBracelet(QuantityRequested);
        }
