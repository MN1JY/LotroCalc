...
{
    public class WanderersGreenwoodNecklace : SupremeIngredients
    {
        public static string DisplayName = "Wanderer's Greenwood Necklace";

        public WanderersGreenwoodNecklace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WanderersGreenwoodNecklace(QuantityRequested);
        }
