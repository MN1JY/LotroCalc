...
{
    public class AquamarineRingofTactics : SupremeIngredients
    {
        public static string DisplayName = "Aquamarine Ring of Tactics";

        public AquamarineRingofTactics(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AquamarineRingofTactics(QuantityRequested);
        }
