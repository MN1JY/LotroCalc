...
{
    public class RoyalCirclet : SupremeIngredients
    {
        public static string DisplayName = "Royal Circlet (Guild)";

        public RoyalCirclet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RoyalCirclet(QuantityRequested);
        }
