...
{
    public class KhazadgoldBracelet : SupremeIngredients
    {
        public static string DisplayName = "Khazad-gold Bracelet";

        public KhazadgoldBracelet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new KhazadgoldBracelet(QuantityRequested);
        }
