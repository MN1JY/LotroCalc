...
{
    public class PerfectObsidianRunestoneoftheGaladhrimGuild : SupremeIngredients
    {
        public static string DisplayName = "Perfect Obsidian Rune-stone of the Galadhrim (Guild)";

        public PerfectObsidianRunestoneoftheGaladhrimGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PerfectObsidianRunestoneoftheGaladhrimGuild(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = LargeSupremeSymbol.DisplayName;
            ing = (Ingredient)DictCraftedIngredients[ingName].Clone();
            ing.QuantityRequested = 1 * QuantityRequested;
            recipe.Add(ingName, ing);
