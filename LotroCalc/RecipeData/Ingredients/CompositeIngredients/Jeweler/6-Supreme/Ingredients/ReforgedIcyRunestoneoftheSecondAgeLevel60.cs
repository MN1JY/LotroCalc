...
{
    public class ReforgedIcyRunestoneoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Icy Rune-stone of the Second Age (Level 60)";

        public ReforgedIcyRunestoneoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedIcyRunestoneoftheSecondAgeLevel60(QuantityRequested);
        }
