...
{
    public class AquamarineFlintRunestone : SupremeIngredients
    {
        public static string DisplayName = "Aquamarine Flint Rune-stone";

        public AquamarineFlintRunestone(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AquamarineFlintRunestone(QuantityRequested);
        }
