...
{
    public class GlowingAureateBraceletofPowerGuild : SupremeIngredients
    {
        public static string DisplayName = "Glowing Aureate Bracelet of Power (Guild)";

        public GlowingAureateBraceletofPowerGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlowingAureateBraceletofPowerGuild(QuantityRequested);
        }
