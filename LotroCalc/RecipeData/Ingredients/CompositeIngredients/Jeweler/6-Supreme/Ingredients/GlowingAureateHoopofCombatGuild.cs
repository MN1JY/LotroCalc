...
{
    public class GlowingAureateHoopofCombatGuild : SupremeIngredients
    {
        public static string DisplayName = "Glowing Aureate Hoop of Combat (Guild)";

        public GlowingAureateHoopofCombatGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlowingAureateHoopofCombatGuild(QuantityRequested);
        }
