...
{
    public class DawnroseNecklaceofEvasion : SupremeIngredients
    {
        public static string DisplayName = "Dawn-rose Necklace of Evasion";

        public DawnroseNecklaceofEvasion(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DawnroseNecklaceofEvasion(QuantityRequested);
        }
