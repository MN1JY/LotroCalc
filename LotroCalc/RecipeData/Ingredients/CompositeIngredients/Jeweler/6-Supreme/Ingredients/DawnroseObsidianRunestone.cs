...
{
    public class DawnroseObsidianRunestone : SupremeIngredients
    {
        public static string DisplayName = "Dawn-rose Obsidian Rune-stone";

        public DawnroseObsidianRunestone(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DawnroseObsidianRunestone(QuantityRequested);
        }
