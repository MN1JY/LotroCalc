...
{
    public class ObsidianRunestoneoftheGaladhrim : SupremeIngredients
    {
        public static string DisplayName = "Obsidian Rune-stone of the Galadhrim";

        public ObsidianRunestoneoftheGaladhrim(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ObsidianRunestoneoftheGaladhrim(QuantityRequested);
        }
