...
{
    public class SmallSupremeSymbol : SupremeIngredients
    {
        public static string DisplayName = "Small Supreme Symbol (Guild)";

        public SmallSupremeSymbol(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallSupremeSymbol(QuantityRequested);
        }
