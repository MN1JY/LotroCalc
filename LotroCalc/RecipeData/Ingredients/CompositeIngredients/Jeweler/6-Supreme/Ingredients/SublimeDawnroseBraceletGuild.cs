...
{
    public class SublimeDawnroseBraceletGuild : SupremeIngredients
    {
        public static string DisplayName = "Sublime Dawn-rose Bracelet (Guild)";

        public SublimeDawnroseBraceletGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SublimeDawnroseBraceletGuild(QuantityRequested);
        }
