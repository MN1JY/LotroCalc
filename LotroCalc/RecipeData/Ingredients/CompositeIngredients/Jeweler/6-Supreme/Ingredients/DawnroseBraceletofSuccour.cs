...
{
    public class DawnroseBraceletofSuccour : SupremeIngredients
    {
        public static string DisplayName = "Dawn-rose Bracelet of Succour";

        public DawnroseBraceletofSuccour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DawnroseBraceletofSuccour(QuantityRequested);
        }
