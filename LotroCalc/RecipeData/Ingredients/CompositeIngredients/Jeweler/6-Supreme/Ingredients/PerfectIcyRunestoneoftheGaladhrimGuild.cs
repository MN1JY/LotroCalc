...
{
    public class PerfectIcyRunestoneoftheGaladhrimGuild : SupremeIngredients
    {
        public static string DisplayName = "Perfect Icy Rune-stone of the Galadhrim (Guild)";

        public PerfectIcyRunestoneoftheGaladhrimGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PerfectIcyRunestoneoftheGaladhrimGuild(QuantityRequested);
        }
