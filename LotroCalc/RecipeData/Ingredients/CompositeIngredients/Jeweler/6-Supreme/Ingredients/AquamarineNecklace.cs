...
{
    public class AquamarineNecklace : SupremeIngredients
    {
        public static string DisplayName = "Aquamarine Necklace";

        public AquamarineNecklace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AquamarineNecklace(QuantityRequested);
        }
