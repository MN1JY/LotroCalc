...
{
    public class GlowingAureateBandofTacticsGuild : SupremeIngredients
    {
        public static string DisplayName = "Glowing Aureate Band of Tactics (Guild)";

        public GlowingAureateBandofTacticsGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlowingAureateBandofTacticsGuild(QuantityRequested);
        }
