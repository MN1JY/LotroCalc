...
{
    public class AquamarineEarring : SupremeIngredients
    {
        public static string DisplayName = "Aquamarine Earring";

        public AquamarineEarring(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AquamarineEarring(QuantityRequested);
        }
