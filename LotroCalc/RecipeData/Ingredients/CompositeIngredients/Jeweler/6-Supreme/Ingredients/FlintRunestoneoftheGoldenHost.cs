...
{
    public class FlintRunestoneoftheGoldenHost : SupremeIngredients
    {
        public static string DisplayName = "Flint Rune-stone of the Golden Host";

        public FlintRunestoneoftheGoldenHost(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FlintRunestoneoftheGoldenHost(QuantityRequested);
        }
