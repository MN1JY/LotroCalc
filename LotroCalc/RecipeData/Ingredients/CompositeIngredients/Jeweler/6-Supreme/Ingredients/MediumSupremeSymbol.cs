...
{
    public class MediumSupremeSymbol : SupremeIngredients
    {
        public static string DisplayName = "Medium Supreme Symbol (Guild)";

        public MediumSupremeSymbol(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MediumSupremeSymbol(QuantityRequested);
        }
