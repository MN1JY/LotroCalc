...
{
    public class DawnroseRingofPower : SupremeIngredients
    {
        public static string DisplayName = "Dawn-rose Ring of Power";

        public DawnroseRingofPower(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DawnroseRingofPower(QuantityRequested);
        }
