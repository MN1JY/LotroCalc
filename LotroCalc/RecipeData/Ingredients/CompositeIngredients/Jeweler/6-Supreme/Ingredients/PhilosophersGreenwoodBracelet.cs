...
{
    public class PhilosophersGreenwoodBracelet : SupremeIngredients
    {
        public static string DisplayName = "Philosopher's Greenwood Bracelet";

        public PhilosophersGreenwoodBracelet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PhilosophersGreenwoodBracelet(QuantityRequested);
        }
