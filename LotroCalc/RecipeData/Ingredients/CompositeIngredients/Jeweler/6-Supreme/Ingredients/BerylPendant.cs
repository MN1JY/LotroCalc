...
{
    public class BerylPendant : SupremeIngredients
    {
        public static string DisplayName = "Beryl Pendant (Guild)";

        public BerylPendant(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BerylPendant(QuantityRequested);
        }
