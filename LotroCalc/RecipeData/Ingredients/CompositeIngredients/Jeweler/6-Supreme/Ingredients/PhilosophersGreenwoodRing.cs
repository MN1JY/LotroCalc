...
{
    public class PhilosophersGreenwoodRing : SupremeIngredients
    {
        public static string DisplayName = "Philosopher's Greenwood Ring";

        public PhilosophersGreenwoodRing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PhilosophersGreenwoodRing(QuantityRequested);
        }
