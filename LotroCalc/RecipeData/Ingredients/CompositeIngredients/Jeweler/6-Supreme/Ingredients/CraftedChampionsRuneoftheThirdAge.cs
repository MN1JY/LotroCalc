...
{
    public class CraftedChampionsRuneoftheThirdAge : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Rune of the Third Age";

        public CraftedChampionsRuneoftheThirdAge(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsRuneoftheThirdAge(QuantityRequested);
        }
