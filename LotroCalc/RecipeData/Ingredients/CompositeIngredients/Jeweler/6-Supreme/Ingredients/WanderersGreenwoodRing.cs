...
{
    public class WanderersGreenwoodRing : SupremeIngredients
    {
        public static string DisplayName = "Wanderer's Greenwood Ring";

        public WanderersGreenwoodRing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WanderersGreenwoodRing(QuantityRequested);
        }
