...
{
    public class SublimeDawnroseObsidianRunestoneGuild : SupremeIngredients
    {
        public static string DisplayName = "Sublime Dawn-rose Obsidian Rune-stone (Guild)";

        public SublimeDawnroseObsidianRunestoneGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SublimeDawnroseObsidianRunestoneGuild(QuantityRequested);
        }
