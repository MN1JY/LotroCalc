...
{
    public class ReforgedObsidianRunestoneoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Obsidian Rune-stone of the Second Age (Level 60)";

        public ReforgedObsidianRunestoneoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedObsidianRunestoneoftheSecondAgeLevel60(QuantityRequested);
        }
