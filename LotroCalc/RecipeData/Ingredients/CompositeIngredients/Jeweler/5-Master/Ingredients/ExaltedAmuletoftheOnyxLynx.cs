...
{
    public class ExaltedAmuletoftheOnyxLynx : MasterIngredients
    {
        public static string DisplayName = "Exalted Amulet of the Onyx Lynx";

        public ExaltedAmuletoftheOnyxLynx(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ExaltedAmuletoftheOnyxLynx(QuantityRequested);
        }
