...
{
    public class AncientSilverNecklace : MasterIngredients
    {
        public static string DisplayName = "Ancient Silver Necklace";

        public AncientSilverNecklace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientSilverNecklace(QuantityRequested);
        }
