...
{
    public class GlitteringAncientSilverEarring : MasterIngredients
    {
        public static string DisplayName = "Glittering Ancient Silver Earring";

        public GlitteringAncientSilverEarring(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringAncientSilverEarring(QuantityRequested);
        }
