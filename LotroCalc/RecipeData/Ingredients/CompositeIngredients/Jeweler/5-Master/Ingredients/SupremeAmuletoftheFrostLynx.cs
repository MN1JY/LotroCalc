...
{
    public class SupremeAmuletoftheFrostLynx : MasterIngredients
    {
        public static string DisplayName = "Supreme Amulet of the Frost Lynx";

        public SupremeAmuletoftheFrostLynx(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SupremeAmuletoftheFrostLynx(QuantityRequested);
        }
