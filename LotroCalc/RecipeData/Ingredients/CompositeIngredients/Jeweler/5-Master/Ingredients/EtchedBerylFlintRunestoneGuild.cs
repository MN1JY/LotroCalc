...
{
    public class EtchedBerylFlintRunestoneGuild : MasterIngredients
    {
        public static string DisplayName = "Etched Beryl Flint Rune-stone (Guild)";

        public EtchedBerylFlintRunestoneGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedBerylFlintRunestoneGuild(QuantityRequested);
        }
