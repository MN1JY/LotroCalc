...
{
    public class EngravedBerylEarringofWillpower : MasterIngredients
    {
        public static string DisplayName = "Engraved Beryl Earring of Willpower";

        public EngravedBerylEarringofWillpower(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedBerylEarringofWillpower(QuantityRequested);
        }
