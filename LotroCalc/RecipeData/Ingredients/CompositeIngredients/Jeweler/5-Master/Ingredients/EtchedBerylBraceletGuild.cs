...
{
    public class EtchedBerylBraceletGuild : MasterIngredients
    {
        public static string DisplayName = "Etched Beryl Bracelet (Guild)";

        public EtchedBerylBraceletGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedBerylBraceletGuild(QuantityRequested);
        }
