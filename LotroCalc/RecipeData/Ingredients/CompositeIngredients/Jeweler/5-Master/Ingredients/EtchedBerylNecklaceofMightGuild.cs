...
{
    public class EtchedBerylNecklaceofMightGuild : MasterIngredients
    {
        public static string DisplayName = "Etched Beryl Necklace of Might (Guild)";

        public EtchedBerylNecklaceofMightGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedBerylNecklaceofMightGuild(QuantityRequested);
        }
