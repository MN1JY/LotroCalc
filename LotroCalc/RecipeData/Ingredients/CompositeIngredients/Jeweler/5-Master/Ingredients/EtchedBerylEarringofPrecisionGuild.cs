...
{
    public class EtchedBerylEarringofPrecisionGuild : MasterIngredients
    {
        public static string DisplayName = "Etched Beryl Earring of Precision (Guild)";

        public EtchedBerylEarringofPrecisionGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedBerylEarringofPrecisionGuild(QuantityRequested);
        }
