...
{
    public class SupremeAmuletoftheSnowcrestEagle : MasterIngredients
    {
        public static string DisplayName = "Supreme Amulet of the Snowcrest Eagle";

        public SupremeAmuletoftheSnowcrestEagle(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SupremeAmuletoftheSnowcrestEagle(QuantityRequested);
        }
