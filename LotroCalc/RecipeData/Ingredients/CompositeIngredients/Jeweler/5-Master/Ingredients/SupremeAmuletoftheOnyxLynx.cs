...
{
    public class SupremeAmuletoftheOnyxLynx : MasterIngredients
    {
        public static string DisplayName = "Supreme Amulet of the Onyx Lynx";

        public SupremeAmuletoftheOnyxLynx(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SupremeAmuletoftheOnyxLynx(QuantityRequested);
        }
