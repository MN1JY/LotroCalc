...
{
    public class EngravedBerylNecklaceofHealing : MasterIngredients
    {
        public static string DisplayName = "Engraved Beryl Necklace of Healing";

        public EngravedBerylNecklaceofHealing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedBerylNecklaceofHealing(QuantityRequested);
        }
