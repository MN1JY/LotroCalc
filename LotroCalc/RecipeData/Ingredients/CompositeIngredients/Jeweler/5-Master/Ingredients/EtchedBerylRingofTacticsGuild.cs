...
{
    public class EtchedBerylRingofTacticsGuild : MasterIngredients
    {
        public static string DisplayName = "Etched Beryl Ring of Tactics (Guild)";

        public EtchedBerylRingofTacticsGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedBerylRingofTacticsGuild(QuantityRequested);
        }
