...
{
    public class EtchedBerylEarringGuild : MasterIngredients
    {
        public static string DisplayName = "Etched Beryl Earring (Guild)";

        public EtchedBerylEarringGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedBerylEarringGuild(QuantityRequested);
        }
