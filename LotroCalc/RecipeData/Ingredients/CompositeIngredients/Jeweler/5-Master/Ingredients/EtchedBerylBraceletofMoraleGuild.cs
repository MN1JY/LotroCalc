...
{
    public class EtchedBerylBraceletofMoraleGuild : MasterIngredients
    {
        public static string DisplayName = "Etched Beryl Bracelet of Morale (Guild)";

        public EtchedBerylBraceletofMoraleGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedBerylBraceletofMoraleGuild(QuantityRequested);
        }
