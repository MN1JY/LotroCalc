...
{
    public class EtchedBerylEarringofWillpowerGuild : MasterIngredients
    {
        public static string DisplayName = "Etched Beryl Earring of Willpower (Guild)";

        public EtchedBerylEarringofWillpowerGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedBerylEarringofWillpowerGuild(QuantityRequested);
        }
