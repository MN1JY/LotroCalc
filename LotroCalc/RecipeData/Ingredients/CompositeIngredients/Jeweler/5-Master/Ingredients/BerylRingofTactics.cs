...
{
    public class BerylRingofTactics : MasterIngredients
    {
        public static string DisplayName = "Beryl Ring of Tactics";

        public BerylRingofTactics(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BerylRingofTactics(QuantityRequested);
        }
