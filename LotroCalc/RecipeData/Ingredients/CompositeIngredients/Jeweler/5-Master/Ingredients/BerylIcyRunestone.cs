...
{
    public class BerylIcyRunestone : MasterIngredients
    {
        public static string DisplayName = "Beryl Icy Rune-stone";

        public BerylIcyRunestone(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BerylIcyRunestone(QuantityRequested);
        }
