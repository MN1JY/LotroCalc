...
{
    public class EtchedBerylRingGuild : MasterIngredients
    {
        public static string DisplayName = "Etched Beryl Ring (Guild)";

        public EtchedBerylRingGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedBerylRingGuild(QuantityRequested);
        }
