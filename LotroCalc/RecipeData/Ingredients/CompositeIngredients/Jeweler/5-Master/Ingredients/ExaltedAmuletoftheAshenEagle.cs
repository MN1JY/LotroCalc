...
{
    public class ExaltedAmuletoftheAshenEagle : MasterIngredients
    {
        public static string DisplayName = "Exalted Amulet of the Ashen Eagle";

        public ExaltedAmuletoftheAshenEagle(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ExaltedAmuletoftheAshenEagle(QuantityRequested);
        }
