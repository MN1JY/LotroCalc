...
{
    public class ExaltedAmuletoftheSpottedLynx : MasterIngredients
    {
        public static string DisplayName = "Exalted Amulet of the Spotted Lynx";

        public ExaltedAmuletoftheSpottedLynx(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ExaltedAmuletoftheSpottedLynx(QuantityRequested);
        }
