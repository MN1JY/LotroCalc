...
{
    public class EngravedBerylBraceletofAgility : MasterIngredients
    {
        public static string DisplayName = "Engraved Beryl Bracelet of Agility";

        public EngravedBerylBraceletofAgility(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedBerylBraceletofAgility(QuantityRequested);
        }
