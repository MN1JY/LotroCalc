...
{
    public class BerylBraceletofSuccour : MasterIngredients
    {
        public static string DisplayName = "Beryl Bracelet of Succour";

        public BerylBraceletofSuccour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BerylBraceletofSuccour(QuantityRequested);
        }
