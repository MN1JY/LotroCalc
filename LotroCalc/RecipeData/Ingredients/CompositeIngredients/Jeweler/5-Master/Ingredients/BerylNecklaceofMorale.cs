...
{
    public class BerylNecklaceofMorale : MasterIngredients
    {
        public static string DisplayName = "Beryl Necklace of Morale";

        public BerylNecklaceofMorale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BerylNecklaceofMorale(QuantityRequested);
        }
