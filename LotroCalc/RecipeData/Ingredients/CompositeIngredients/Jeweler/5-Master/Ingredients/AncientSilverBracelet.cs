...
{
    public class AncientSilverBracelet : MasterIngredients
    {
        public static string DisplayName = "Ancient Silver Bracelet";

        public AncientSilverBracelet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientSilverBracelet(QuantityRequested);
        }
