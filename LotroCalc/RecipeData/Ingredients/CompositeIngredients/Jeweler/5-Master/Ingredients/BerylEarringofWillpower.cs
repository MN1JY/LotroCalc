...
{
    public class BerylEarringofWillpower : MasterIngredients
    {
        public static string DisplayName = "Beryl Earring of Willpower";

        public BerylEarringofWillpower(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BerylEarringofWillpower(QuantityRequested);
        }
