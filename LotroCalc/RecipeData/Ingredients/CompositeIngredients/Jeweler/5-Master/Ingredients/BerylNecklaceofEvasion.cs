...
{
    public class BerylNecklaceofEvasion : MasterIngredients
    {
        public static string DisplayName = "Beryl Necklace of Evasion";

        public BerylNecklaceofEvasion(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BerylNecklaceofEvasion(QuantityRequested);
        }
