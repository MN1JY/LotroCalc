...
{
    public class EngravedBerylFlintRunestone : MasterIngredients
    {
        public static string DisplayName = "Engraved Beryl Flint Rune-stone";

        public EngravedBerylFlintRunestone(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedBerylFlintRunestone(QuantityRequested);
        }
