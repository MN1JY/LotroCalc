...
{
    public class BerylRingofVitality : MasterIngredients
    {
        public static string DisplayName = "Beryl Ring of Vitality";

        public BerylRingofVitality(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BerylRingofVitality(QuantityRequested);
        }
