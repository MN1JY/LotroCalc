...
{
    public class GlitteringAncientSilverBracelet : MasterIngredients
    {
        public static string DisplayName = "Glittering Ancient Silver Bracelet";

        public GlitteringAncientSilverBracelet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringAncientSilverBracelet(QuantityRequested);
        }
