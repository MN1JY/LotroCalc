...
{
    public class EngravedBerylNecklaceofMight : MasterIngredients
    {
        public static string DisplayName = "Engraved Beryl Necklace of Might";

        public EngravedBerylNecklaceofMight(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedBerylNecklaceofMight(QuantityRequested);
        }
