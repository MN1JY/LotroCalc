...
{
    public class TinyAmuletofthePolarBear : MasterIngredients
    {
        public static string DisplayName = "Tiny Amulet of the Tundra Bear";

        public TinyAmuletofthePolarBear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new TinyAmuletofthePolarBear(QuantityRequested);
        }
