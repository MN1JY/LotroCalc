...
{
    public class MediumMasterSymbolGuild : MasterIngredients
    {
        public static string DisplayName = "Medium Master Symbol (Guild)";

        public MediumMasterSymbolGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MediumMasterSymbolGuild(QuantityRequested);
        }
