...
{
    public class EngravedBerylEarringofCombat : MasterIngredients
    {
        public static string DisplayName = "Engraved Beryl Earring of Combat";

        public EngravedBerylEarringofCombat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedBerylEarringofCombat(QuantityRequested);
        }
