...
{
    public class EtchedBerylBraceletofAgilityGuild : MasterIngredients
    {
        public static string DisplayName = "Etched Beryl Bracelet of Agility (Guild)";

        public EtchedBerylBraceletofAgilityGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedBerylBraceletofAgilityGuild(QuantityRequested);
        }
