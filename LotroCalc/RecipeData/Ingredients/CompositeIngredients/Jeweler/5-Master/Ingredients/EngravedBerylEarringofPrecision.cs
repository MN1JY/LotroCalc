...
{
    public class EngravedBerylEarringofPrecision : MasterIngredients
    {
        public static string DisplayName = "Engraved Beryl Earring of Precision";

        public EngravedBerylEarringofPrecision(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedBerylEarringofPrecision(QuantityRequested);
        }
