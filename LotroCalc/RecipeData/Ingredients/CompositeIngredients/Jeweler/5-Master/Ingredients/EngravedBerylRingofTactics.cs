...
{
    public class EngravedBerylRingofTactics : MasterIngredients
    {
        public static string DisplayName = "Engraved Beryl Ring of Tactics";

        public EngravedBerylRingofTactics(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedBerylRingofTactics(QuantityRequested);
        }
