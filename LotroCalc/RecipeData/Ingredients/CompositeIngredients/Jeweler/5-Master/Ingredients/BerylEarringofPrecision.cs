...
{
    public class BerylEarringofPrecision : MasterIngredients
    {
        public static string DisplayName = "Beryl Earring of Precision";

        public BerylEarringofPrecision(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BerylEarringofPrecision(QuantityRequested);
        }
