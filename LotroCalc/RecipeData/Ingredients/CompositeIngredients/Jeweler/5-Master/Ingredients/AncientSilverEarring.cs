...
{
    public class AncientSilverEarring : MasterIngredients
    {
        public static string DisplayName = "Ancient Silver Earring";

        public AncientSilverEarring(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientSilverEarring(QuantityRequested);
        }
