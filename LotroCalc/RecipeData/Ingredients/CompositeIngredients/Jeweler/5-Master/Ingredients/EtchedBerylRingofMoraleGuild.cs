...
{
    public class EtchedBerylRingofMoraleGuild : MasterIngredients
    {
        public static string DisplayName = "Etched Beryl Ring of Morale (Guild)";

        public EtchedBerylRingofMoraleGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedBerylRingofMoraleGuild(QuantityRequested);
        }
