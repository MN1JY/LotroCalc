...
{
    public class BerylEarringofCombat : MasterIngredients
    {
        public static string DisplayName = "Beryl Earring of Combat";

        public BerylEarringofCombat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BerylEarringofCombat(QuantityRequested);
        }
