...
{
    public class EtchedBerylNecklaceofHealingGuild : MasterIngredients
    {
        public static string DisplayName = "Etched Beryl Necklace of Healing (Guild)";

        public EtchedBerylNecklaceofHealingGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedBerylNecklaceofHealingGuild(QuantityRequested);
        }
