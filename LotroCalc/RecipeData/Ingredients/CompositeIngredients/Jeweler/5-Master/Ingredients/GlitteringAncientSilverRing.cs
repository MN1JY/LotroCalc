...
{
    public class GlitteringAncientSilverRing : MasterIngredients
    {
        public static string DisplayName = "Glittering Ancient Silver Ring";

        public GlitteringAncientSilverRing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringAncientSilverRing(QuantityRequested);
        }
