...
{
    public class EtchedBerylEarringofCombatGuild : MasterIngredients
    {
        public static string DisplayName = "Etched Beryl Earring of Combat (Guild)";

        public EtchedBerylEarringofCombatGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedBerylEarringofCombatGuild(QuantityRequested);
        }
