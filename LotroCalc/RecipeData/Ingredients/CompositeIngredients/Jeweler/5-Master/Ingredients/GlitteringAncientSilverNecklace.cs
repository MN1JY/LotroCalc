...
{
    public class GlitteringAncientSilverNecklace : MasterIngredients
    {
        public static string DisplayName = "Glittering Ancient Silver Necklace";

        public GlitteringAncientSilverNecklace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringAncientSilverNecklace(QuantityRequested);
        }
