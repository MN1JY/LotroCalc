...
{
    public class EngravedBerylBraceletofMorale : MasterIngredients
    {
        public static string DisplayName = "Engraved Beryl Bracelet of Morale";

        public EngravedBerylBraceletofMorale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedBerylBraceletofMorale(QuantityRequested);
        }
