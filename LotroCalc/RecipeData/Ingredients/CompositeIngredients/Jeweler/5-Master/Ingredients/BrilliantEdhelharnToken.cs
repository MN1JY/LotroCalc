...
{
    public class BrilliantEdhelharnToken : MasterIngredients
    {
        public static string DisplayName = "Brilliant Edhelharn Token";

        public BrilliantEdhelharnToken(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BrilliantEdhelharnToken(QuantityRequested);
        }
