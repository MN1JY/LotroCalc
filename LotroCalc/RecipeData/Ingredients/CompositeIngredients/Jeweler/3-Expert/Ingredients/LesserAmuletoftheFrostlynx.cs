...
{
    public class LesserAmuletoftheFrostlynx : ExpertIngredients
    {
        public static string DisplayName = "Lesser Amulet of the Frost-lynx";

        public LesserAmuletoftheFrostlynx(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LesserAmuletoftheFrostlynx(QuantityRequested);
        }
