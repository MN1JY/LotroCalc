...
{
    public class StrongAmuletofthePolarBear : ExpertIngredients
    {
        public static string DisplayName = "Strong Amulet of the Polar Bear";

        public StrongAmuletofthePolarBear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new StrongAmuletofthePolarBear(QuantityRequested);
        }
