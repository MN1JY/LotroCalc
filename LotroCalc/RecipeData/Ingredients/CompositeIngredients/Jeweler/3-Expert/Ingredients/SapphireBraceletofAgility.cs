...
{
    public class SapphireBraceletofAgility : ExpertIngredients
    {
        public static string DisplayName = "Sapphire Bracelet of Agility";

        public SapphireBraceletofAgility(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SapphireBraceletofAgility(QuantityRequested);
        }
