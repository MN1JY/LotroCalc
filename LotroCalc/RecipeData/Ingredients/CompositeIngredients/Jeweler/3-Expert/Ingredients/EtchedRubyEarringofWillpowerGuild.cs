...
{
    public class EtchedRubyEarringofWillpowerGuild : ExpertIngredients
    {
        public static string DisplayName = "Etched Ruby Earring of Willpower (Guild)";

        public EtchedRubyEarringofWillpowerGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedRubyEarringofWillpowerGuild(QuantityRequested);
        }
