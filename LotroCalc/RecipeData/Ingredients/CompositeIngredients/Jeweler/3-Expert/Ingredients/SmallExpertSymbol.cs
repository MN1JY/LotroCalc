...
{
    public class SmallExpertSymbol : ExpertIngredients
    {
        public static string DisplayName = "Small Expert Symbol (Guild)";

        public SmallExpertSymbol(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallExpertSymbol(QuantityRequested);
        }
