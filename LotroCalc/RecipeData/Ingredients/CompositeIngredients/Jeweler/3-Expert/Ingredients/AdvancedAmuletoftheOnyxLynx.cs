...
{
    public class AdvancedAmuletoftheOnyxLynx : ExpertIngredients
    {
        public static string DisplayName = "Advanced Amulet of the Onyx Lynx";

        public AdvancedAmuletoftheOnyxLynx(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AdvancedAmuletoftheOnyxLynx(QuantityRequested);
        }
