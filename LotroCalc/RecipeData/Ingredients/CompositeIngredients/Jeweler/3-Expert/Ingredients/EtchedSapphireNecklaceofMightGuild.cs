...
{
    public class EtchedSapphireNecklaceofMightGuild : ExpertIngredients
    {
        public static string DisplayName = "Etched Sapphire Necklace of Might (Guild)";

        public EtchedSapphireNecklaceofMightGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedSapphireNecklaceofMightGuild(QuantityRequested);
        }
