...
{
    public class SapphireNecklaceofHealing : ExpertIngredients
    {
        public static string DisplayName = "Sapphire Necklace of Healing";

        public SapphireNecklaceofHealing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SapphireNecklaceofHealing(QuantityRequested);
        }
