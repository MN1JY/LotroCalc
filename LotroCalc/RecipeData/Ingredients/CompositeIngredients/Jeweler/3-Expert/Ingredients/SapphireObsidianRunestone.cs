...
{
    public class SapphireObsidianRunestone : ExpertIngredients
    {
        public static string DisplayName = "Sapphire Obsidian Rune-stone";

        public SapphireObsidianRunestone(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SapphireObsidianRunestone(QuantityRequested);
        }
