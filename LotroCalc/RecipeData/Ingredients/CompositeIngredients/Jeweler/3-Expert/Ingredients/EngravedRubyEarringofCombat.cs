...
{
    public class EngravedRubyEarringofCombat : ExpertIngredients
    {
        public static string DisplayName = "Engraved Ruby Earring of Combat";

        public EngravedRubyEarringofCombat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedRubyEarringofCombat(QuantityRequested);
        }
