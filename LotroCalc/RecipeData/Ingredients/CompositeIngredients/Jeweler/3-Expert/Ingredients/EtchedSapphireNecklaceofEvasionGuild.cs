...
{
    public class EtchedSapphireNecklaceofEvasionGuild : ExpertIngredients
    {
        public static string DisplayName = "Etched Sapphire Necklace of Evasion (Guild)";

        public EtchedSapphireNecklaceofEvasionGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedSapphireNecklaceofEvasionGuild(QuantityRequested);
        }
