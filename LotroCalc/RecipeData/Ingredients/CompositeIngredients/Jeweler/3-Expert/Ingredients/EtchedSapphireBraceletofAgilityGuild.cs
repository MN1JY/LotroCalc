...
{
    public class EtchedSapphireBraceletofAgilityGuild : ExpertIngredients
    {
        public static string DisplayName = "Etched Sapphire Bracelet of Agility (Guild)";

        public EtchedSapphireBraceletofAgilityGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedSapphireBraceletofAgilityGuild(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = MediumExpertSymbol.DisplayName;
