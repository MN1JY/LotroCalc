...
{
    public class EtchedSapphireBraceletofMightGuild : ExpertIngredients
    {
        public static string DisplayName = "Etched Sapphire Bracelet of Might (Guild)";

        public EtchedSapphireBraceletofMightGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedSapphireBraceletofMightGuild(QuantityRequested);
        }
