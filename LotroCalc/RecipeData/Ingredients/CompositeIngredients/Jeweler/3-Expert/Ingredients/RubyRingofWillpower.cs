...
{
    public class RubyRingofWillpower : ExpertIngredients
    {
        public static string DisplayName = "Ruby Ring of Willpower";

        public RubyRingofWillpower(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RubyRingofWillpower(QuantityRequested);
        }
