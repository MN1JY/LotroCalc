...
{
    public class GoldObsidianRunestone : ExpertIngredients
    {
        public static string DisplayName = "Gold Obsidian Rune-stone";

        public GoldObsidianRunestone(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldObsidianRunestone(QuantityRequested);
        }
