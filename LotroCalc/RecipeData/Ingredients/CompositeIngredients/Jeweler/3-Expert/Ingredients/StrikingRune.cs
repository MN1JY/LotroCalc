...
{
    public class StrikingRune : ExpertIngredients
    {
        public static string DisplayName = "Striking Rune";

        public StrikingRune(int count)
        {
            Name = DisplayName;
        ...
        {
            return new StrikingRune(QuantityRequested);
        }
