...
{
    public class GoldBracelet : ExpertIngredients
    {
        public static string DisplayName = "Gold Bracelet";

        public GoldBracelet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldBracelet(QuantityRequested);
        }
