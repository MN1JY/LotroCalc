...
{
    public class EngravedSapphireBraceletofSuccour : ExpertIngredients
    {
        public static string DisplayName = "Engraved Sapphire Bracelet of Succour";

        public EngravedSapphireBraceletofSuccour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedSapphireBraceletofSuccour(QuantityRequested);
        }
