...
{
    public class GlitteringGoldRing : ExpertIngredients
    {
        public static string DisplayName = "Glittering Gold Ring";

        public GlitteringGoldRing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringGoldRing(QuantityRequested);
        }
