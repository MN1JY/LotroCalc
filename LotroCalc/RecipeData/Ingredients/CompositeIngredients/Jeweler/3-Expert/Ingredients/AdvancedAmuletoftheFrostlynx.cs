...
{
    public class AdvancedAmuletoftheFrostlynx : ExpertIngredients
    {
        public static string DisplayName = "Advanced Amulet of the Frost-lynx";

        public AdvancedAmuletoftheFrostlynx(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AdvancedAmuletoftheFrostlynx(QuantityRequested);
        }
