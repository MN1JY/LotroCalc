...
{
    public class GlitteringGoldNecklace : ExpertIngredients
    {
        public static string DisplayName = "Glittering Gold Necklace";

        public GlitteringGoldNecklace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringGoldNecklace(QuantityRequested);
        }
