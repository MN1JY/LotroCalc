...
{
    public class StarryChandelier : ExpertIngredients
    {
        public static string DisplayName = "Starry Chandelier";

        public StarryChandelier(int count)
        {
            Name = DisplayName;
        ...
        {
            return new StarryChandelier(QuantityRequested);
        }
