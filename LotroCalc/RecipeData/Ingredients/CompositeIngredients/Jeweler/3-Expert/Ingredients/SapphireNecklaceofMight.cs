...
{
    public class SapphireNecklaceofMight : ExpertIngredients
    {
        public static string DisplayName = "Sapphire Necklace of Might";

        public SapphireNecklaceofMight(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SapphireNecklaceofMight(QuantityRequested);
        }
