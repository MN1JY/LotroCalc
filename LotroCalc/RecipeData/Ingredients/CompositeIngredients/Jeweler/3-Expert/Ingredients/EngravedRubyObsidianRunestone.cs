...
{
    public class EngravedRubyObsidianRunestone : ExpertIngredients
    {
        public static string DisplayName = "Engraved Ruby Obsidian Rune-stone";

        public EngravedRubyObsidianRunestone(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedRubyObsidianRunestone(QuantityRequested);
        }
