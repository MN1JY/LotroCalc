...
{
    public class RubyEarringofFate : ExpertIngredients
    {
        public static string DisplayName = "Ruby Earring of Fate";

        public RubyEarringofFate(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RubyEarringofFate(QuantityRequested);
        }
