...
{
    public class GlitteringGoldEarring : ExpertIngredients
    {
        public static string DisplayName = "Glittering Gold Earring";

        public GlitteringGoldEarring(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringGoldEarring(QuantityRequested);
        }
