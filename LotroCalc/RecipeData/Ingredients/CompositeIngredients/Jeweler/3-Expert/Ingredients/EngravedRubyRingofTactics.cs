...
{
    public class EngravedRubyRingofTactics : ExpertIngredients
    {
        public static string DisplayName = "Engraved Ruby Ring of Tactics";

        public EngravedRubyRingofTactics(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedRubyRingofTactics(QuantityRequested);
        }
