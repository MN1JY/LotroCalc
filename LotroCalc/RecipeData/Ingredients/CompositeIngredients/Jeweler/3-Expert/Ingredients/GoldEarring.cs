...
{
    public class GoldEarring : ExpertIngredients
    {
        public static string DisplayName = "Gold Earring";

        public GoldEarring(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldEarring(QuantityRequested);
        }
