...
{
    public class EtchedRubyRingofVitalityGuild : ExpertIngredients
    {
        public static string DisplayName = "Etched Ruby Ring of Vitality (Guild)";

        public EtchedRubyRingofVitalityGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedRubyRingofVitalityGuild(QuantityRequested);
        }
