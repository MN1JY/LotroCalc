...
{
    public class LesserAmuletoftheWildpawbear : ExpertIngredients
    {
        public static string DisplayName = "Lesser Amulet of the Wildpaw-bear";

        public LesserAmuletoftheWildpawbear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LesserAmuletoftheWildpawbear(QuantityRequested);
        }
