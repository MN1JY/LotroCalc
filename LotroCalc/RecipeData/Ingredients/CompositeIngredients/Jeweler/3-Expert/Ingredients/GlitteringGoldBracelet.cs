...
{
    public class GlitteringGoldBracelet : ExpertIngredients
    {
        public static string DisplayName = "Glittering Gold Bracelet";

        public GlitteringGoldBracelet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringGoldBracelet(QuantityRequested);
        }
