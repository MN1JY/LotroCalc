...
{
    public class StrongAmuletoftheSpottedLynx : ExpertIngredients
    {
        public static string DisplayName = "Strong Amulet of the Spotted Lynx";

        public StrongAmuletoftheSpottedLynx(int count)
        {
            Name = DisplayName;
        ...
        {
            return new StrongAmuletoftheSpottedLynx(QuantityRequested);
        }
