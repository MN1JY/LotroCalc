...
{
    public class RubyRingofTactics : ExpertIngredients
    {
        public static string DisplayName = "Ruby Ring of Tactics";

        public RubyRingofTactics(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RubyRingofTactics(QuantityRequested);
        }
