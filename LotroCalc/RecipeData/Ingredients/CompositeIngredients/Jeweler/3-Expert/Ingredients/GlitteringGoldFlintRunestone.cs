...
{
    public class GlitteringGoldFlintRunestone : ExpertIngredients
    {
        public static string DisplayName = "Glittering Gold Flint Rune-stone";

        public GlitteringGoldFlintRunestone(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GlitteringGoldFlintRunestone(QuantityRequested);
        }
