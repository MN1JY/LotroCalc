...
{
    public class EtchedRubyObsidianRunestone : ExpertIngredients
    {
        public static string DisplayName = "Etched Ruby Obsidian Rune-stone (Guild)";

        public EtchedRubyObsidianRunestone(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EtchedRubyObsidianRunestone(QuantityRequested);
        }
