...
{
    public class SapphireBraceletofBlocking : ExpertIngredients
    {
        public static string DisplayName = "Sapphire Bracelet of Blocking";

        public SapphireBraceletofBlocking(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SapphireBraceletofBlocking(QuantityRequested);
        }
