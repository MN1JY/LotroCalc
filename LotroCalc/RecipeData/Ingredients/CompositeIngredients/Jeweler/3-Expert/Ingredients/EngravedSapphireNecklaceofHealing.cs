...
{
    public class EngravedSapphireNecklaceofHealing : ExpertIngredients
    {
        public static string DisplayName = "Engraved Sapphire Necklace of Healing";

        public EngravedSapphireNecklaceofHealing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedSapphireNecklaceofHealing(QuantityRequested);
        }
