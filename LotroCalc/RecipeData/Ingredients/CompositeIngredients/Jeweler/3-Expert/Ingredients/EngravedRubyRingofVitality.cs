...
{
    public class EngravedRubyRingofVitality : ExpertIngredients
    {
        public static string DisplayName = "Engraved Ruby Ring of Vitality";

        public EngravedRubyRingofVitality(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedRubyRingofVitality(QuantityRequested);
        }
