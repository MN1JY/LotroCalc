...
{
    public class LesserAmuletoftheBlackBear : ExpertIngredients
    {
        public static string DisplayName = "Lesser Amulet of the Black Bear";

        public LesserAmuletoftheBlackBear(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LesserAmuletoftheBlackBear(QuantityRequested);
        }
