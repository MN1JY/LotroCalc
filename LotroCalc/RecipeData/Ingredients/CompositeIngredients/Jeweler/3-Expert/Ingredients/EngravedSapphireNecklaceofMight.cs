...
{
    public class EngravedSapphireNecklaceofMight : ExpertIngredients
    {
        public static string DisplayName = "Engraved Sapphire Necklace of Might";

        public EngravedSapphireNecklaceofMight(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EngravedSapphireNecklaceofMight(QuantityRequested);
        }
