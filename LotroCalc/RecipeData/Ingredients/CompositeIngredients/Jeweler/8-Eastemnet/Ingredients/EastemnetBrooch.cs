...
{
    public class EastemnetBrooch : EastemnetIngredients
    {
        public static string DisplayName = "Eastemnet Brooch";

        public EastemnetBrooch(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EastemnetBrooch(QuantityRequested);
        }
