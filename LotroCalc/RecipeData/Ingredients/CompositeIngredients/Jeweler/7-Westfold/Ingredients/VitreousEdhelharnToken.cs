...
{
    public class VitreousEdhelharnToken : WestfoldIngredients
    {
        public static string DisplayName = "Vitreous Edhelharn Token";

        public VitreousEdhelharnToken(int count)
        {
            Name = DisplayName;
        ...
        {
            return new VitreousEdhelharnToken(QuantityRequested);
        }
