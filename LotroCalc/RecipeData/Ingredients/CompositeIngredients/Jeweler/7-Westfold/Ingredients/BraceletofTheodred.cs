...
{
   public class BraceletofTheodred : WestfoldIngredients
   {
       public static string DisplayName = "Bracelet of Theodred";

       public BraceletofTheodred(int count)
       {
           Name = DisplayName;
       ...
       {
           return new BraceletofTheodred(QuantityRequested);
       }
