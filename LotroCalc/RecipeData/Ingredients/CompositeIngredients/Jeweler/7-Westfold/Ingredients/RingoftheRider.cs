...
{
    public class RingoftheRider : WestfoldIngredients
    {
        public static string DisplayName = "Ring of the Rider";

        public RingoftheRider(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RingoftheRider(QuantityRequested);
        }
