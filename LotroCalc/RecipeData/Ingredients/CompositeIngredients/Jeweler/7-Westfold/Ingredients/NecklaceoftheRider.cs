...
{
    public class NecklaceoftheRider : WestfoldIngredients
    {
        public static string DisplayName = "Necklace of the Rider";

        public NecklaceoftheRider(int count)
        {
            Name = DisplayName;
        ...
        {
            return new NecklaceoftheRider(QuantityRequested);
        }
