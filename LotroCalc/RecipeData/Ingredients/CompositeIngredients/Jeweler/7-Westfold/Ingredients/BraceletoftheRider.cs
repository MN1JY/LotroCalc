...
{
    public class BraceletoftheRider : WestfoldIngredients
    {
        public static string DisplayName = "Bracelet of the Rider";

        public BraceletoftheRider(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BraceletoftheRider(QuantityRequested);
        }
