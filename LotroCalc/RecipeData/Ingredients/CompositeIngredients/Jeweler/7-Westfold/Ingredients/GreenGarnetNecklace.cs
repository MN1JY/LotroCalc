...
{
    public class GreenGarnetNecklace : WestfoldIngredients
    {
        public static string DisplayName = "Green Garnet Necklace";

        public GreenGarnetNecklace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GreenGarnetNecklace(QuantityRequested);
        }
