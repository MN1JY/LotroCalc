...
{
   public class NecklaceofTheodred : WestfoldIngredients
   {
       public static string DisplayName = "Necklace of Theodred";

       public NecklaceofTheodred(int count)
       {
           Name = DisplayName;
       ...
       {
           return new NecklaceofTheodred(QuantityRequested);
       }
