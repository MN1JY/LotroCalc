...
{
    public class EarringoftheRider : WestfoldIngredients
    {
        public static string DisplayName = "Earring of the Rider";

        public EarringoftheRider(int count)
        {
            Name = DisplayName;
        ...
        {
            return new EarringoftheRider(QuantityRequested);
        }
