...
{
    public class SmallWestfoldSymbol : WestfoldIngredients
    {
        public static string DisplayName = "Small Westfold Symbol";

        public SmallWestfoldSymbol(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallWestfoldSymbol(QuantityRequested);
        }
