...
{
    public class CalenardNecklace : WestfoldIngredients
    {
        public static string DisplayName = "Calenard Necklace";

        public CalenardNecklace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CalenardNecklace(QuantityRequested);
        }
