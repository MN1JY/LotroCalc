...
{
   public class RingofTheodred : WestfoldIngredients
   {
       public static string DisplayName = "Ring of Theodred";

       public RingofTheodred(int count)
       {
           Name = DisplayName;
       ...
       {
           return new RingofTheodred(QuantityRequested);
       }
