...
{
    public class DunlendingRing : WestfoldIngredients
    {
        public static string DisplayName = "Dunlending Ring";

        public DunlendingRing(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DunlendingRing(QuantityRequested);
        }
