...
{
    public class DunlendingEarring : WestfoldIngredients
    {
        public static string DisplayName = "Dunlending Earring";

        public DunlendingEarring(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DunlendingEarring(QuantityRequested);
        }
