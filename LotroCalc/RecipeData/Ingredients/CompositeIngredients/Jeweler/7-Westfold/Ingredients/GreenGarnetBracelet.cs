...
{
    public class GreenGarnetBracelet : WestfoldIngredients
    {
        public static string DisplayName = "Green Garnet Bracelet";

        public GreenGarnetBracelet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GreenGarnetBracelet(QuantityRequested);
        }
