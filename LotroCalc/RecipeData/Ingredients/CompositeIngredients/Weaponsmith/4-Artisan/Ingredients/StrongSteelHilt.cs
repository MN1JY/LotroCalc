...
{
    public class StrongSteelHilt : ArtisanIngredients
    {
        public static string DisplayName = "Strong Steel Hilt";

        public StrongSteelHilt(int count)
        {
            Name = DisplayName;
        ...
        {
            return new StrongSteelHilt(QuantityRequested);
        }
