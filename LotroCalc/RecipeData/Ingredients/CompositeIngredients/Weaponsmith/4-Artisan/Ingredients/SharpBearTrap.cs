...
{
    public class SharpBearTrap : ArtisanIngredients
    {
        public static string DisplayName = "Sharp Bear Trap";

        public SharpBearTrap(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SharpBearTrap(QuantityRequested);
        }
