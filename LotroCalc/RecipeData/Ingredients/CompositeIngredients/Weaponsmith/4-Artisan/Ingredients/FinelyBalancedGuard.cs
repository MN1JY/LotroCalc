...
{
    public class FinelyBalancedGuard : ArtisanIngredients
    {
        public static string DisplayName = "Finely Balanced Guard";

        public FinelyBalancedGuard(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FinelyBalancedGuard(QuantityRequested);
        }
