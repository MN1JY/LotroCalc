...
{
    public class RepairAnvil : ArtisanIngredients
    {
        public static string DisplayName = "Repair Anvil";

        public RepairAnvil(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RepairAnvil(QuantityRequested);
        }
