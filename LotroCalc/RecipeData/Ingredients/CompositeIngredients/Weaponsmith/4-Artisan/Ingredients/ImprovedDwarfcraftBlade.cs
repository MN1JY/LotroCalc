...
{
    public class ImprovedDwarfcraftBlade : ArtisanIngredients
    {
        public static string DisplayName = "Improved Dwarf-craft Blade (Guild)";

        public ImprovedDwarfcraftBlade(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedDwarfcraftBlade(QuantityRequested);
        }
