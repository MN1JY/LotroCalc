...
{
    public class BlindingStunDusts : ArtisanIngredients
    {
        public static string DisplayName = "Blinding Stun Dusts";

        public BlindingStunDusts(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BlindingStunDusts(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.DwarfSteelFile;
