...
{
    public class SmallArtisanEmblemGuild : ArtisanIngredients
    {
        public static string DisplayName = "Small Artisan Emblem (Guild)";

        public SmallArtisanEmblemGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallArtisanEmblemGuild(QuantityRequested);
        }
