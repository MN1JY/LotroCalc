...
{
    public class ImprovedLureTrap : ArtisanIngredients
    {
        public static string DisplayName = "Improved Lure Trap";

        public ImprovedLureTrap(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedLureTrap(QuantityRequested);
        }
