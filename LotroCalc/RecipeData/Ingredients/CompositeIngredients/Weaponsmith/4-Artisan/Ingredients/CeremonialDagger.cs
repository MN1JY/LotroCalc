...
{
    public class CeremonialDagger : ArtisanIngredients
    {
        public static string DisplayName = "Ceremonial Dagger";

        public CeremonialDagger(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CeremonialDagger(QuantityRequested);
        }
