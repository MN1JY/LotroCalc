...
{
    public class ImprovedStrongTrap : ArtisanIngredients
    {
        public static string DisplayName = "Improved Strong Trap";

        public ImprovedStrongTrap(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedStrongTrap(QuantityRequested);
        }
