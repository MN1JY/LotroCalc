...
{
    public class SharpCaltrops : ArtisanIngredients
    {
        public static string DisplayName = "Sharp Caltrops";

        public SharpCaltrops(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SharpCaltrops(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.DwarfSteelNails;
