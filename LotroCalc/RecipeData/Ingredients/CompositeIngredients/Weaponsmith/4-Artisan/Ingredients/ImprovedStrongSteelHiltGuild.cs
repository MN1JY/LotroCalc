...
{
    public class ImprovedStrongSteelHiltGuild : ArtisanIngredients
    {
        public static string DisplayName = "Improved Strong Steel Hilt (Guild)";

        public ImprovedStrongSteelHiltGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedStrongSteelHiltGuild(QuantityRequested);
        }
