...
{
    public class WesternesseBlade : ArtisanIngredients
    {
        public static string DisplayName = "Westernesse Blade";

        public WesternesseBlade(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WesternesseBlade(QuantityRequested);
        }
