...
{
    public class ImprovedBrightSteelBladeGuild : ExpertIngredients
    {
        public static string DisplayName = "Improved Bright Steel Blade (Guild)";

        public ImprovedBrightSteelBladeGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedBrightSteelBladeGuild(QuantityRequested);
        }
