...
{
    public class SteelPommel : ExpertIngredients
    {
        public static string DisplayName = "Steel Pommel";

        public SteelPommel(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SteelPommel(QuantityRequested);
        }
