...
{
    public class ImprovedSteelHiltGuild : ExpertIngredients
    {
        public static string DisplayName = "Improved Steel Hilt (Guild)";

        public ImprovedSteelHiltGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedSteelHiltGuild(QuantityRequested);
        }
