...
{
    public class ImprovedQuickTraps : ExpertIngredients
    {
        public static string DisplayName = "Improved Quick Traps";

        public ImprovedQuickTraps(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedQuickTraps(QuantityRequested);
        }
