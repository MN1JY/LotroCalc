...
{
    public class StrongTrap : ExpertIngredients
    {
        public static string DisplayName = "Strong Trap";

        public StrongTrap(int count)
        {
            Name = DisplayName;
        ...
        {
            return new StrongTrap(QuantityRequested);
        }
