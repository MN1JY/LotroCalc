...
{
    public class Caltrops : JourneymanIngredients
    {
        public static string DisplayName = "Caltrops";

        public Caltrops(int count)
        {
            Name = DisplayName;
        ...
        {
            return new Caltrops(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.LowGradeSteelNail;
