...
{
    public class QuickTrap : JourneymanIngredients
    {
        public static string DisplayName = "Quick Trap";

        public QuickTrap(int count)
        {
            Name = DisplayName;
        ...
        {
            return new QuickTrap(QuantityRequested);
        }
