...
{
    public class Doubletraps : JourneymanIngredients
    {
        public static string DisplayName = "Double-traps";

        public Doubletraps(int count)
        {
            Name = DisplayName;
        ...
        {
            return new Doubletraps(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.LowGradeSteelBolts;
