...
{
    public class BalancedSteelHilt : JourneymanIngredients
    {
        public static string DisplayName = "Balanced Steel Hilt";

        public BalancedSteelHilt(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BalancedSteelHilt(QuantityRequested);
        }
