...
{
    public class StunDust : JourneymanIngredients
    {
        public static string DisplayName = "Stun Dust";

        public StunDust(int count)
        {
            Name = DisplayName;
        ...
        {
            return new StunDust(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.LowGradeSteelFile;
