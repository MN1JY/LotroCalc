...
{
    public class IronBlade : JourneymanIngredients
    {
        public static string DisplayName = "Iron Blade";

        public IronBlade(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IronBlade(QuantityRequested);
        }
