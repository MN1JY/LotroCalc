...
{
    public class AncientSteelAxe : MasterIngredients
    {
        public static string DisplayName = "Ancient Steel Axe";

        public AncientSteelAxe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientSteelAxe(QuantityRequested);
        }
