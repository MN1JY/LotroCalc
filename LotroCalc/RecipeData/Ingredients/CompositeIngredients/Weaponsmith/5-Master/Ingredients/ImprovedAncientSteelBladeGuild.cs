...
{
    public class ImprovedAncientSteelBladeGuild : MasterIngredients
    {
        public static string DisplayName = "Improved Ancient Steel Blade (Guild)";

        public ImprovedAncientSteelBladeGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedAncientSteelBladeGuild(QuantityRequested);
        }
