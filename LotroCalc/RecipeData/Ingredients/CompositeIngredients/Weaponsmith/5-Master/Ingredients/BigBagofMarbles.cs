...
{
    public class BigBagofMarbles : SupremeIngredients
    {
        public static string DisplayName = "Big Bag of Marbles";

        public BigBagofMarbles(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BigBagofMarbles(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.BlackenedSteelSphereMould;
