...
{
    public class ImprovedTripwire : MasterIngredients
    {
        public static string DisplayName = "Improved Tripwire";

        public ImprovedTripwire(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedTripwire(QuantityRequested);
        }
