...
{
    public class MediumMasterEmblemGuild : MasterIngredients
    {
        public static string DisplayName = "Medium Master Emblem (Guild)";

        public MediumMasterEmblemGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MediumMasterEmblemGuild(QuantityRequested);
        }
