...
{
    public class DeadlyBearTrap : MasterIngredients
    {
        public static string DisplayName = "Deadly Bear Trap";

        public DeadlyBearTrap(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DeadlyBearTrap(QuantityRequested);
        }
