...
{
    public class DeadlyCaltrop : MasterIngredients
    {
        public static string DisplayName = "Deadly Caltrop";

        public DeadlyCaltrop(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DeadlyCaltrop(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.AncientSteelNails;
