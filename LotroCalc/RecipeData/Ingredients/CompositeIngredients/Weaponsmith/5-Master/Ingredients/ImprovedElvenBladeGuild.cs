...
{
    public class ImprovedElvenBladeGuild : MasterIngredients
    {
        public static string DisplayName = "Improved Elven Blade (Guild)";

        public ImprovedElvenBladeGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedElvenBladeGuild(QuantityRequested);
        }
