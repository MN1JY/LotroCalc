...
{
    public class QualityQuickTrap : MasterIngredients
    {
        public static string DisplayName = "Quality Quick Trap";

        public QualityQuickTrap(int count)
        {
            Name = DisplayName;
        ...
        {
            return new QualityQuickTrap(QuantityRequested);
        }
