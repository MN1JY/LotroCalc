...
{
    public class WardensSceptre : MasterIngredients
    {
        public static string DisplayName = "Warden's Sceptre";

        public WardensSceptre(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WardensSceptre(QuantityRequested);
        }
