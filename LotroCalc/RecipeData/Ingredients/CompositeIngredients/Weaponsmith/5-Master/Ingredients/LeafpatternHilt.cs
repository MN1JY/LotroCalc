...
{
    public class LeafpatternHilt : MasterIngredients
    {
        public static string DisplayName = "Leaf-pattern Hilt";

        public LeafpatternHilt(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LeafpatternHilt(QuantityRequested);
        }
