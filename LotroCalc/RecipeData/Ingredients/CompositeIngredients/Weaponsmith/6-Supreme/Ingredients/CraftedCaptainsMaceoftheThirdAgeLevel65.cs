...
{
    public class CraftedCaptainsMaceoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Mace of the Third Age (Level 65)";

        public CraftedCaptainsMaceoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsMaceoftheThirdAgeLevel65(QuantityRequested);
        }
