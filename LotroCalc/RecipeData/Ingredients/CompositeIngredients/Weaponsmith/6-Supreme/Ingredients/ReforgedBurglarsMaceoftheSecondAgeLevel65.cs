...
{
    public class ReforgedBurglarsMaceoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Burglar's Mace of the Second Age (Level 65)";

        public ReforgedBurglarsMaceoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedBurglarsMaceoftheSecondAgeLevel65(QuantityRequested);
        }
