...
{
    public class ReforgedMinstrelsMaceoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Minstrel's Mace of the Second Age (Level 60)";

        public ReforgedMinstrelsMaceoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedMinstrelsMaceoftheSecondAgeLevel60(QuantityRequested);
        }
