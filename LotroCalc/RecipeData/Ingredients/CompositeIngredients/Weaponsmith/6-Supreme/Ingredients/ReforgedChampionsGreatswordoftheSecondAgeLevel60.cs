...
{
    public class ReforgedChampionsGreatswordoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Greatsword of the Second Age (Level 60)";

        public ReforgedChampionsGreatswordoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsGreatswordoftheSecondAgeLevel60(QuantityRequested);
        }
