...
{
    public class ReforgedHuntersSwordoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Sword of the Second Age (Level 65)";

        public ReforgedHuntersSwordoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersSwordoftheSecondAgeLevel65(QuantityRequested);
        }
