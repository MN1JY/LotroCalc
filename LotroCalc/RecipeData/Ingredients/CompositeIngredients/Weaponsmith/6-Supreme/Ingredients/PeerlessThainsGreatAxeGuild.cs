...
{
    public class PeerlessThainsGreatAxeGuild : SupremeIngredients
    {
        public static string DisplayName = "Peerless Thain's Great Axe (Guild)";

        public PeerlessThainsGreatAxeGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PeerlessThainsGreatAxeGuild(QuantityRequested);
        }
