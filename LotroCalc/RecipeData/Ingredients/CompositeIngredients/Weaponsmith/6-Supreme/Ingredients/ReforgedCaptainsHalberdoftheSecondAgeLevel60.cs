...
{
    public class ReforgedCaptainsHalberdoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Halberd of the Second Age (Level 60)";

        public ReforgedCaptainsHalberdoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsHalberdoftheSecondAgeLevel60(QuantityRequested);
        }
