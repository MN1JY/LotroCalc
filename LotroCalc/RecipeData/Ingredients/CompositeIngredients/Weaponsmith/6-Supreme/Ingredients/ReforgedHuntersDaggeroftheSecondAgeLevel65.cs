...
{
    public class ReforgedHuntersDaggeroftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Dagger of the Second Age (Level 65)";

        public ReforgedHuntersDaggeroftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersDaggeroftheSecondAgeLevel65(QuantityRequested);
        }
