...
{
    public class ReforgedGuardiansMaceoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Mace of the Second Age (Level 65)";

        public ReforgedGuardiansMaceoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansMaceoftheSecondAgeLevel65(QuantityRequested);
        }
