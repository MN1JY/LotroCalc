...
{
    public class CraftedHuntersSwordoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Hunter's Sword of the Third Age (Level 65)";

        public CraftedHuntersSwordoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedHuntersSwordoftheThirdAgeLevel65(QuantityRequested);
        }
