...
{
    public class InevitableStrongTrap : SupremeIngredients
    {
        public static string DisplayName = "Inevitable Strong Trap";

        public InevitableStrongTrap(int count)
        {
            Name = DisplayName;
        ...
        {
            return new InevitableStrongTrap(QuantityRequested);
        }
