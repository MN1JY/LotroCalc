...
{
    public class MalledhrimGreatAxeofStriking : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Great Axe of Striking";

        public MalledhrimGreatAxeofStriking(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimGreatAxeofStriking(QuantityRequested);
        }
