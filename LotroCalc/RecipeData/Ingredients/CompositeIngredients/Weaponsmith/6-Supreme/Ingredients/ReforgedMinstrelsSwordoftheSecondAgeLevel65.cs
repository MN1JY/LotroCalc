...
{
    public class ReforgedMinstrelsSwordoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Minstrel's Sword of the Second Age (Level 65)";

        public ReforgedMinstrelsSwordoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedMinstrelsSwordoftheSecondAgeLevel65(QuantityRequested);
        }
