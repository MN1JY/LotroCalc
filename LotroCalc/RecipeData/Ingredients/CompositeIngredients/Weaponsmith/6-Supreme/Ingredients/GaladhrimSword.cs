...
{
    public class GaladhrimSword : SupremeIngredients
    {
        public static string DisplayName = "Galadhrim Sword";

        public GaladhrimSword(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GaladhrimSword(QuantityRequested);
        }
