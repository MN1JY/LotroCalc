...
{
    public class CraftedWardensAxeoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Warden's Axe of the Third Age (Level 65)";

        public CraftedWardensAxeoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedWardensAxeoftheThirdAgeLevel65(QuantityRequested);
        }
