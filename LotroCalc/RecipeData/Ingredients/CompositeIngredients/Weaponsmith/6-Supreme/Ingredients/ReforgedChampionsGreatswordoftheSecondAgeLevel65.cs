...
{
    public class ReforgedChampionsGreatswordoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Greatsword of the Second Age (Level 65)";

        public ReforgedChampionsGreatswordoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsGreatswordoftheSecondAgeLevel65(QuantityRequested);
        }
