...
{
    public class PeerlessThainsDaggerGuild : SupremeIngredients
    {
        public static string DisplayName = "Peerless Thain's Dagger (Guild)";

        public PeerlessThainsDaggerGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PeerlessThainsDaggerGuild(QuantityRequested);
        }
