...
{
    public class CraftedGuardiansMaceoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Mace of the Third Age (Level 65)";

        public CraftedGuardiansMaceoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansMaceoftheThirdAgeLevel65(QuantityRequested);
        }
