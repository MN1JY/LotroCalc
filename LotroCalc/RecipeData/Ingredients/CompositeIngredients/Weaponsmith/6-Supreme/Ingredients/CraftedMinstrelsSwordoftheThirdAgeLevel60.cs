...
{
    public class CraftedMinstrelsSwordoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Minstrel's Sword of the Third Age (Level 60)";

        public CraftedMinstrelsSwordoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedMinstrelsSwordoftheThirdAgeLevel60(QuantityRequested);
        }
