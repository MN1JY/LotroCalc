...
{
    public class ReforgedWardensSwordoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Warden's Sword of the Second Age (Level 65)";

        public ReforgedWardensSwordoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedWardensSwordoftheSecondAgeLevel65(QuantityRequested);
        }
