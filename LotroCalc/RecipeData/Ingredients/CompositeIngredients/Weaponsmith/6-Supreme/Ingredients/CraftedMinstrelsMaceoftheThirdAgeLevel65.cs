...
{
    public class CraftedMinstrelsMaceoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Minstrel's Mace of the Third Age (Level 65)";

        public CraftedMinstrelsMaceoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedMinstrelsMaceoftheThirdAgeLevel65(QuantityRequested);
        }
