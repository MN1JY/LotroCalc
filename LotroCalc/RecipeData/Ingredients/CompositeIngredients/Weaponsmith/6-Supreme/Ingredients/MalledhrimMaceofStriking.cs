...
{
    public class MalledhrimMaceofStriking : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Mace of Striking";

        public MalledhrimMaceofStriking(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimMaceofStriking(QuantityRequested);
        }
