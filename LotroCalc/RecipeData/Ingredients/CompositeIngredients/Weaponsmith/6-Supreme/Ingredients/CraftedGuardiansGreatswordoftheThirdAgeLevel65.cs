...
{
    public class CraftedGuardiansGreatswordoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Greatsword of the Third Age (Level 65)";

        public CraftedGuardiansGreatswordoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansGreatswordoftheThirdAgeLevel65(QuantityRequested);
        }
