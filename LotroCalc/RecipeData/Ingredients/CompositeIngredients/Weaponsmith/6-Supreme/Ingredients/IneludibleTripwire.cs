...
{
    public class IneludibleTripwire : SupremeIngredients
    {
        public static string DisplayName = "Ineludible Tripwire";

        public IneludibleTripwire(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IneludibleTripwire(QuantityRequested);
        }
