...
{
    public class CraftedGuardiansDaggeroftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Dagger of the Third Age (Level 60)";

        public CraftedGuardiansDaggeroftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansDaggeroftheThirdAgeLevel60(QuantityRequested);
        }
