...
{
    public class FlawlessGaladhrimSwordGuild : SupremeIngredients
    {
        public static string DisplayName = "Flawless Galadhrim Sword (Guild)";

        public FlawlessGaladhrimSwordGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FlawlessGaladhrimSwordGuild(QuantityRequested);
        }
