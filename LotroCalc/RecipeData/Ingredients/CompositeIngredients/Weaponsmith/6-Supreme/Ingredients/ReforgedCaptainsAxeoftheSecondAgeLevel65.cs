...
{
    public class ReforgedCaptainsAxeoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Axe of the Second Age (Level 65)";

        public ReforgedCaptainsAxeoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsAxeoftheSecondAgeLevel65(QuantityRequested);
        }
