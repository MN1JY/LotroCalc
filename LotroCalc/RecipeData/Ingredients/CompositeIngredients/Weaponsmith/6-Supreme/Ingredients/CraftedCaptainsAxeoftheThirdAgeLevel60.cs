...
{
    public class CraftedCaptainsAxeoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Axe of the Third Age (Level 60)";

        public CraftedCaptainsAxeoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsAxeoftheThirdAgeLevel60(QuantityRequested);
        }
