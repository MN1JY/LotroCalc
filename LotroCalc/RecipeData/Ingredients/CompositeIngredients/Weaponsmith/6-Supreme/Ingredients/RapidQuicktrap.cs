...
{
    public class RapidQuicktrap : SupremeIngredients
    {
        public static string DisplayName = "Rapid Quick-trap";

        public RapidQuicktrap(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RapidQuicktrap(QuantityRequested);
        }
