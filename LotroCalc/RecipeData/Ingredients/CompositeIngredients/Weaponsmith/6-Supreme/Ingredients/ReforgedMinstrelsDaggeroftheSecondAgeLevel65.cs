...
{
    public class ReforgedMinstrelsDaggeroftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Minstrel's Dagger of the Second Age (Level 65)";

        public ReforgedMinstrelsDaggeroftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedMinstrelsDaggeroftheSecondAgeLevel65(QuantityRequested);
        }
