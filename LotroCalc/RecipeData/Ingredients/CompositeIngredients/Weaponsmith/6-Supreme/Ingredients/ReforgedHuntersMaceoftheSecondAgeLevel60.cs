...
{
    public class ReforgedHuntersMaceoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Mace of the Second Age (Level 60)";

        public ReforgedHuntersMaceoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersMaceoftheSecondAgeLevel60(QuantityRequested);
        }
