...
{
    public class ReforgedGuardiansMaceoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Mace of the Second Age (Level 60)";

        public ReforgedGuardiansMaceoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansMaceoftheSecondAgeLevel60(QuantityRequested);
        }
