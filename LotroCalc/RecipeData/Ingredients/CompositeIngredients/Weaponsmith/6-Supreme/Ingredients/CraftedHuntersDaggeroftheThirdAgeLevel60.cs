...
{
    public class CraftedHuntersDaggeroftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Hunter's Dagger of the Third Age (Level 60)";

        public CraftedHuntersDaggeroftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedHuntersDaggeroftheThirdAgeLevel60(QuantityRequested);
        }
