...
{
    public class CraftedWardensAxeoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Warden's Axe of the Third Age (Level 60)";

        public CraftedWardensAxeoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedWardensAxeoftheThirdAgeLevel60(QuantityRequested);
        }
