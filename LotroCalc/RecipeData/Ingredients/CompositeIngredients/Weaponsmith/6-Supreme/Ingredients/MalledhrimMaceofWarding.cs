...
{
    public class MalledhrimMaceofWarding : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Mace of Warding";

        public MalledhrimMaceofWarding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimMaceofWarding(QuantityRequested);
        }
