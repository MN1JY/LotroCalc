...
{
    public class PeerlessThainsSwordGuild : SupremeIngredients
    {
        public static string DisplayName = "Peerless Thain's Sword (Guild)";

        public PeerlessThainsSwordGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PeerlessThainsSwordGuild(QuantityRequested);
        }
