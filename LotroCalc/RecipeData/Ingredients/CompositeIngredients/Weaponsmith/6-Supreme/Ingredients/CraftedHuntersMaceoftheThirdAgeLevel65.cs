...
{
    public class CraftedHuntersMaceoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Hunter's Mace of the Third Age (Level 65)";

        public CraftedHuntersMaceoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedHuntersMaceoftheThirdAgeLevel65(QuantityRequested);
        }
