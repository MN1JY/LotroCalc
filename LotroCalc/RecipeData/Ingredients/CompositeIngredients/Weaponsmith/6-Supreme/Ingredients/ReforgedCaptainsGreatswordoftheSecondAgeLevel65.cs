...
{
    public class ReforgedCaptainsGreatswordoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Greatsword of the Second Age (Level 65)";

        public ReforgedCaptainsGreatswordoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsGreatswordoftheSecondAgeLevel65(QuantityRequested);
        }
