...
{
    public class DarkBronzeBlade : SupremeIngredients
    {
        public static string DisplayName = "Dark Bronze Blade";

        public DarkBronzeBlade(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DarkBronzeBlade(QuantityRequested);
        }
