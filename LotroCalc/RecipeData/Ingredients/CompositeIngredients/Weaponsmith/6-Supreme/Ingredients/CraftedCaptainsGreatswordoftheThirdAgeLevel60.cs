...
{
    public class CraftedCaptainsGreatswordoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Greatsword of the Third Age (Level 60)";

        public CraftedCaptainsGreatswordoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsGreatswordoftheThirdAgeLevel60(QuantityRequested);
        }
