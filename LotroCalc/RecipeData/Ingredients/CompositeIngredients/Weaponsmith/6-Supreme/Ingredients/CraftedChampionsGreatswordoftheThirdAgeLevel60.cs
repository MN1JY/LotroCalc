...
{
    public class CraftedChampionsGreatswordoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Greatsword of the Third Age (Level 60)";

        public CraftedChampionsGreatswordoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsGreatswordoftheThirdAgeLevel60(QuantityRequested);
        }
