...
{
    public class ThainsGreatsword : SupremeIngredients
    {
        public static string DisplayName = "Thain's Greatsword";

        public ThainsGreatsword(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ThainsGreatsword(QuantityRequested);
        }
