...
{
    public class ReforgedWardensDaggeroftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Warden's Dagger of the Second Age (Level 65)";

        public ReforgedWardensDaggeroftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedWardensDaggeroftheSecondAgeLevel65(QuantityRequested);
        }
