...
{
    public class CraftedGuardiansSwordoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Sword of the Third Age (Level 65)";

        public CraftedGuardiansSwordoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansSwordoftheThirdAgeLevel65(QuantityRequested);
        }
