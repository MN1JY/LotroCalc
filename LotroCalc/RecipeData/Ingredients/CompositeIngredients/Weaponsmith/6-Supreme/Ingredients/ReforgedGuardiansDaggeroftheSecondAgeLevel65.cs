...
{
    public class ReforgedGuardiansDaggeroftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Dagger of the Second Age (Level 65)";

        public ReforgedGuardiansDaggeroftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansDaggeroftheSecondAgeLevel65(QuantityRequested);
        }
