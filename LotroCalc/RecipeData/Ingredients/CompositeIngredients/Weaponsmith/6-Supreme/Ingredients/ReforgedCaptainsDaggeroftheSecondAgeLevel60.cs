...
{
    public class ReforgedCaptainsDaggeroftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Dagger of the Second Age (Level 60)";

        public ReforgedCaptainsDaggeroftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsDaggeroftheSecondAgeLevel60(QuantityRequested);
        }
