...
{
    public class NumenoreanSceptreGuild : SupremeIngredients
    {
        public static string DisplayName = "Numenorean Sceptre (Guild)";

        public NumenoreanSceptreGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new NumenoreanSceptreGuild(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = TraderIngredients.CompendiumOfMiddleEarthVolume2;
