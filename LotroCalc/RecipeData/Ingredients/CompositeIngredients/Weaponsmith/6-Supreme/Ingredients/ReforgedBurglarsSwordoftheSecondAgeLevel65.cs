...
{
    public class ReforgedBurglarsSwordoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Burglar's Sword of the Second Age (Level 65)";

        public ReforgedBurglarsSwordoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedBurglarsSwordoftheSecondAgeLevel65(QuantityRequested);
        }
