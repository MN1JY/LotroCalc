...
{
    public class PeerlessThainsAxeGuild : SupremeIngredients
    {
        public static string DisplayName = "Peerless Thain's Axe (Guild)";

        public PeerlessThainsAxeGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PeerlessThainsAxeGuild(QuantityRequested);
        }
