...
{
    public class ReforgedWardensAxeoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Warden's Axe of the Second Age (Level 65)";

        public ReforgedWardensAxeoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedWardensAxeoftheSecondAgeLevel65(QuantityRequested);
        }
