...
{
    public class CraftedMinstrelsDaggeroftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Minstrel's Dagger of the Third Age (Level 65)";

        public CraftedMinstrelsDaggeroftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedMinstrelsDaggeroftheThirdAgeLevel65(QuantityRequested);
        }
