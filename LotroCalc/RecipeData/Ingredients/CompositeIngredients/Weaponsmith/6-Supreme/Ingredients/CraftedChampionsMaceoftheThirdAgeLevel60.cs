...
{
    public class CraftedChampionsMaceoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Mace of the Third Age (Level 60)";

        public CraftedChampionsMaceoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsMaceoftheThirdAgeLevel60(QuantityRequested);
        }
