...
{
    public class CraftedGuardiansMaceoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Mace of the Third Age (Level 60)";

        public CraftedGuardiansMaceoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansMaceoftheThirdAgeLevel60(QuantityRequested);
        }
