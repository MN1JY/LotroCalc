...
{
    public class WarriorsMace : SupremeIngredients
    {
        public static string DisplayName = "Warrior's Mace";

        public WarriorsMace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WarriorsMace(QuantityRequested);
        }
