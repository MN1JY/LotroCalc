...
{
    public class ReforgedChampionsSwordoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Sword of the Second Age (Level 65)";

        public ReforgedChampionsSwordoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsSwordoftheSecondAgeLevel65(QuantityRequested);
        }
