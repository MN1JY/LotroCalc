...
{
    public class PeerlessThainsMaceGuild : SupremeIngredients
    {
        public static string DisplayName = "Peerless Thain's Mace (Guild)";

        public PeerlessThainsMaceGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PeerlessThainsMaceGuild(QuantityRequested);
        }
