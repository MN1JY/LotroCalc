...
{
    public class CraftedChampionsGreatAxeoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Great Axe of the Third Age (Level 65)";

        public CraftedChampionsGreatAxeoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsGreatAxeoftheThirdAgeLevel65(QuantityRequested);
        }
