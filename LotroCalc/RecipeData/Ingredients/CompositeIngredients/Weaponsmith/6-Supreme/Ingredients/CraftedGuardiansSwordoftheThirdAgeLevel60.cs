...
{
    public class CraftedGuardiansSwordoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Sword of the Third Age (Level 60)";

        public CraftedGuardiansSwordoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansSwordoftheThirdAgeLevel60(QuantityRequested);
        }
