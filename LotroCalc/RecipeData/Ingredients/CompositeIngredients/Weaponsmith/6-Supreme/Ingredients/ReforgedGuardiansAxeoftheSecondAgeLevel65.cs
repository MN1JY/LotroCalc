...
{
    public class ReforgedGuardiansAxeoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Axe of the Second Age (Level 65)";

        public ReforgedGuardiansAxeoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansAxeoftheSecondAgeLevel65(QuantityRequested);
        }
