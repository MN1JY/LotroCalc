...
{
    public class ReforgedHuntersDaggeroftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Dagger of the Second Age (Level 60)";

        public ReforgedHuntersDaggeroftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersDaggeroftheSecondAgeLevel60(QuantityRequested);
        }
