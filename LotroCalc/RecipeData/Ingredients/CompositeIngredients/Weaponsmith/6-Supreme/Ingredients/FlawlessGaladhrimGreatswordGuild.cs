...
{
    public class FlawlessGaladhrimGreatswordGuild : SupremeIngredients
    {
        public static string DisplayName = "Flawless Galadhrim Greatsword (Guild)";

        public FlawlessGaladhrimGreatswordGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FlawlessGaladhrimGreatswordGuild(QuantityRequested);
        }
