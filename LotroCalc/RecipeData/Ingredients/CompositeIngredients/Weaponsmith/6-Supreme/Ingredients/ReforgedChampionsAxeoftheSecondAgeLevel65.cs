...
{
    public class ReforgedChampionsAxeoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Axe of the Second Age (Level 65)";

        public ReforgedChampionsAxeoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsAxeoftheSecondAgeLevel65(QuantityRequested);
        }
