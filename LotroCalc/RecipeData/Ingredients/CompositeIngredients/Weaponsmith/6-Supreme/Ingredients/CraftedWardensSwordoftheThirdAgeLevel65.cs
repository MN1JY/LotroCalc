...
{
    public class CraftedWardensSwordoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Warden's Sword of the Third Age (Level 65)";

        public CraftedWardensSwordoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedWardensSwordoftheThirdAgeLevel65(QuantityRequested);
        }
