...
{
    public class CraftedBurglarsMaceoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Burglar's Mace of the Third Age (Level 65)";

        public CraftedBurglarsMaceoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedBurglarsMaceoftheThirdAgeLevel65(QuantityRequested);
        }
