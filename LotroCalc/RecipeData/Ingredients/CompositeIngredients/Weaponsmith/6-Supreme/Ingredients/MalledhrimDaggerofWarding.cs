...
{
    public class MalledhrimDaggerofWarding : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Dagger of Warding";

        public MalledhrimDaggerofWarding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimDaggerofWarding(QuantityRequested);
        }
