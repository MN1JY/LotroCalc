...
{
    public class CraftedCaptainsGreatAxeoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Great Axe of the Third Age (Level 60)";

        public CraftedCaptainsGreatAxeoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsGreatAxeoftheThirdAgeLevel60(QuantityRequested);
        }
