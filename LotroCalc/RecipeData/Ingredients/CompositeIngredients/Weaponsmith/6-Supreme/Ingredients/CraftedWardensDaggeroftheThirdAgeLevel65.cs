...
{
    public class CraftedWardensDaggeroftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Warden's Dagger of the Third Age (Level 65)";

        public CraftedWardensDaggeroftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedWardensDaggeroftheThirdAgeLevel65(QuantityRequested);
        }
