...
{
    public class CraftedGuardiansDaggeroftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Dagger of the Third Age (Level 65)";

        public CraftedGuardiansDaggeroftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansDaggeroftheThirdAgeLevel65(QuantityRequested);
        }
