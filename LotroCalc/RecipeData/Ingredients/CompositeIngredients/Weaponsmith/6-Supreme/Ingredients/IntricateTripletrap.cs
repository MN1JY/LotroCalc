...
{
    public class IntricateTripletrap : SupremeIngredients
    {
        public static string DisplayName = "Intricate Triple-trap";

        public IntricateTripletrap(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IntricateTripletrap(QuantityRequested);
        }
