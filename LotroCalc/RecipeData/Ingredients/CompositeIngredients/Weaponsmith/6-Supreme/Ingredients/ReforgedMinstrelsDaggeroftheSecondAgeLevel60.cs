...
{
    public class ReforgedMinstrelsDaggeroftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Minstrel's Dagger of the Second Age (Level 60)";

        public ReforgedMinstrelsDaggeroftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedMinstrelsDaggeroftheSecondAgeLevel60(QuantityRequested);
        }
