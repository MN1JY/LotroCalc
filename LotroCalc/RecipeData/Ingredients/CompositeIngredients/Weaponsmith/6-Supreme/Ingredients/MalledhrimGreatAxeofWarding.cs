...
{
    public class MalledhrimGreatAxeofWarding : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Great Axe of Warding";

        public MalledhrimGreatAxeofWarding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimGreatAxeofWarding(QuantityRequested);
        }
