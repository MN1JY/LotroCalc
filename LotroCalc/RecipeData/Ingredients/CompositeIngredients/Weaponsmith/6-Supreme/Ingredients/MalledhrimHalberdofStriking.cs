...
{
    public class MalledhrimHalberdofStriking : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Halberd of Striking";

        public MalledhrimHalberdofStriking(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimHalberdofStriking(QuantityRequested);
        }
