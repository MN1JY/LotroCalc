...
{
    public class CraftedChampionsSwordoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Sword of the Third Age (Level 65)";

        public CraftedChampionsSwordoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsSwordoftheThirdAgeLevel65(QuantityRequested);
        }
