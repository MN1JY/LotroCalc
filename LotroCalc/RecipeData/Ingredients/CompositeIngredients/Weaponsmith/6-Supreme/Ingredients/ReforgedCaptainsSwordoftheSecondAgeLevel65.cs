...
{
    public class ReforgedCaptainsSwordoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Sword of the Second Age (Level 65)";

        public ReforgedCaptainsSwordoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsSwordoftheSecondAgeLevel65(QuantityRequested);
        }
