...
{
    public class MalledhrimGreatswordofWarding : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Greatsword of Warding";

        public MalledhrimGreatswordofWarding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimGreatswordofWarding(QuantityRequested);
        }
