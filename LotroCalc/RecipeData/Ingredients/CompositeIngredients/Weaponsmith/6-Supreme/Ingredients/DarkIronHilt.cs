...
{
    public class DarkIronHilt : SupremeIngredients
    {
        public static string DisplayName = "Dark Iron Hilt";

        public DarkIronHilt(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DarkIronHilt(QuantityRequested);
        }
