...
{
    public class ReforgedMinstrelsSwordoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Minstrel's Sword of the Second Age (Level 60)";

        public ReforgedMinstrelsSwordoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedMinstrelsSwordoftheSecondAgeLevel60(QuantityRequested);
        }
