...
{
    public class ReforgedMinstrelsMaceoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Minstrel's Mace of the Second Age (Level 65)";

        public ReforgedMinstrelsMaceoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedMinstrelsMaceoftheSecondAgeLevel65(QuantityRequested);
        }
