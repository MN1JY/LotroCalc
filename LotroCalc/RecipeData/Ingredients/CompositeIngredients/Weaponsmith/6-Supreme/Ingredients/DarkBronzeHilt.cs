...
{
    public class DarkBronzeHilt : SupremeIngredients
    {
        public static string DisplayName = "Dark Bronze Hilt";

        public DarkBronzeHilt(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DarkBronzeHilt(QuantityRequested);
        }
