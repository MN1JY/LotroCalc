...
{
    public class CraftedCaptainsSwordoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Sword of the Third Age (Level 60)";

        public CraftedCaptainsSwordoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsSwordoftheThirdAgeLevel60(QuantityRequested);
        }
