...
{
    public class PeerlessThainsGreatswordGuild : SupremeIngredients
    {
        public static string DisplayName = "Peerless Thain's Greatsword (Guild)";

        public PeerlessThainsGreatswordGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PeerlessThainsGreatswordGuild(QuantityRequested);
        }
