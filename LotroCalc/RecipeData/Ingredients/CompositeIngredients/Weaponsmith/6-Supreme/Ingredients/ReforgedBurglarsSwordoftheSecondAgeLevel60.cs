...
{
    public class ReforgedBurglarsSwordoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Burglar's Sword of the Second Age (Level 60)";

        public ReforgedBurglarsSwordoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedBurglarsSwordoftheSecondAgeLevel60(QuantityRequested);
        }
