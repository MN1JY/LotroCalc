...
{
    public class ReforgedWardensAxeoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Warden's Axe of the Second Age (Level 60)";

        public ReforgedWardensAxeoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedWardensAxeoftheSecondAgeLevel60(QuantityRequested);
        }
