...
{
    public class CraftedWardensSwordoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Warden's Sword of the Third Age (Level 60)";

        public CraftedWardensSwordoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedWardensSwordoftheThirdAgeLevel60(QuantityRequested);
        }
