...
{
    public class CraftedCaptainsGreatswordoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Greatsword of the Third Age (Level 65)";

        public CraftedCaptainsGreatswordoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsGreatswordoftheThirdAgeLevel65(QuantityRequested);
        }
