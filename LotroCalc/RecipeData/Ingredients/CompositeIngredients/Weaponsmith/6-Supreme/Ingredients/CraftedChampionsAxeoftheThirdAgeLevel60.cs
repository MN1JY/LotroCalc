...
{
    public class CraftedChampionsAxeoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Axe of the Third Age (Level 60)";

        public CraftedChampionsAxeoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsAxeoftheThirdAgeLevel60(QuantityRequested);
        }
