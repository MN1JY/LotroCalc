...
{
    public class MalledhrimAxeofStriking : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Axe of Striking";

        public MalledhrimAxeofStriking(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimAxeofStriking(QuantityRequested);
        }
