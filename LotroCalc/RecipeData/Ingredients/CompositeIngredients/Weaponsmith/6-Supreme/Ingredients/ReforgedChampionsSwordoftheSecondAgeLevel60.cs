...
{
    public class ReforgedChampionsSwordoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Sword of the Second Age (Level 60)";

        public ReforgedChampionsSwordoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsSwordoftheSecondAgeLevel60(QuantityRequested);
        }
