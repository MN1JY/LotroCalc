...
{
    public class WarriorsAxe : SupremeIngredients
    {
        public static string DisplayName = "Warrior's Axe";

        public WarriorsAxe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WarriorsAxe(QuantityRequested);
        }
