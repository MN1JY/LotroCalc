...
{
    public class CripplingCaltrop : SupremeIngredients
    {
        public static string DisplayName = "Crippling Caltrop";

        public CripplingCaltrop(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CripplingCaltrop(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.BlackenedSteelNails;
