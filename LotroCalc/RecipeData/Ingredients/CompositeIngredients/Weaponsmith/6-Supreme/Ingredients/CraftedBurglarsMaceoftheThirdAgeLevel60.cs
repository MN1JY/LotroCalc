...
{
    public class CraftedBurglarsMaceoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Burglar's Mace of the Third Age (Level 60)";

        public CraftedBurglarsMaceoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedBurglarsMaceoftheThirdAgeLevel60(QuantityRequested);
        }
