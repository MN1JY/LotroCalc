...
{
    public class ReforgedHuntersAxeoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Axe of the Second Age (Level 65)";

        public ReforgedHuntersAxeoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersAxeoftheSecondAgeLevel65(QuantityRequested);
        }
