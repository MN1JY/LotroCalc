...
{
    public class CraftedHuntersSwordoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Hunter's Sword of the Third Age (Level 60)";

        public CraftedHuntersSwordoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedHuntersSwordoftheThirdAgeLevel60(QuantityRequested);
        }
