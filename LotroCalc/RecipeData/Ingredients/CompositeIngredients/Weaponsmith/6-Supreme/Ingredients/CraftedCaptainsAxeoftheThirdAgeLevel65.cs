...
{
    public class CraftedCaptainsAxeoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Axe of the Third Age (Level 65)";

        public CraftedCaptainsAxeoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsAxeoftheThirdAgeLevel65(QuantityRequested);
        }
