...
{
    public class ReforgedCaptainsGreatAxeoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Great Axe of the Second Age (Level 60)";

        public ReforgedCaptainsGreatAxeoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsGreatAxeoftheSecondAgeLevel60(QuantityRequested);
        }
