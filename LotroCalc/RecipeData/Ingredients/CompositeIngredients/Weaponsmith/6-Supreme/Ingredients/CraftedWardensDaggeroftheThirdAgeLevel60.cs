...
{
    public class CraftedWardensDaggeroftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Warden's Dagger of the Third Age (Level 60)";

        public CraftedWardensDaggeroftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedWardensDaggeroftheThirdAgeLevel60(QuantityRequested);
        }
