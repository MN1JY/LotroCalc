...
{
    public class CraftedChampionsGreatswordoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Greatsword of the Third Age (Level 65)";

        public CraftedChampionsGreatswordoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsGreatswordoftheThirdAgeLevel65(QuantityRequested);
        }
