...
{
    public class CraftedGuardiansAxeoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Axe of the Third Age (Level 65)";

        public CraftedGuardiansAxeoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansAxeoftheThirdAgeLevel65(QuantityRequested);
        }
