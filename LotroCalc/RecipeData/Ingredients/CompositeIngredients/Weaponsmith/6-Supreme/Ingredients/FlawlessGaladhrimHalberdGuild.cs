...
{
    public class FlawlessGaladhrimHalberdGuild : SupremeIngredients
    {
        public static string DisplayName = "Flawless Galadhrim Halberd (Guild)";

        public FlawlessGaladhrimHalberdGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FlawlessGaladhrimHalberdGuild(QuantityRequested);
        }
