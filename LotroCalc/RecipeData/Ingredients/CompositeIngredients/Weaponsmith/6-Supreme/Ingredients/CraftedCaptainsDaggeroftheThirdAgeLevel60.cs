...
{
    public class CraftedCaptainsDaggeroftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Dagger of the Third Age (Level 60)";

        public CraftedCaptainsDaggeroftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsDaggeroftheThirdAgeLevel60(QuantityRequested);
        }
