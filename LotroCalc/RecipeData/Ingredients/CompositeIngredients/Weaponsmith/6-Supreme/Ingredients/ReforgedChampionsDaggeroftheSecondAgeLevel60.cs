...
{
    public class ReforgedChampionsDaggeroftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Dagger of the Second Age (Level 60)";

        public ReforgedChampionsDaggeroftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsDaggeroftheSecondAgeLevel60(QuantityRequested);
        }
