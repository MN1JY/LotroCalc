...
{
    public class CraftedChampionsGreatAxeoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Great Axe of the Third Age (Level 60)";

        public CraftedChampionsGreatAxeoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsGreatAxeoftheThirdAgeLevel60(QuantityRequested);
        }
