...
{
    public class ReforgedGuardiansGreatAxeoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Great Axe of the Second Age (Level 60)";

        public ReforgedGuardiansGreatAxeoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansGreatAxeoftheSecondAgeLevel60(QuantityRequested);
        }
