...
{
    public class ReforgedWardensMaceoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Warden's Mace of the Second Age (Level 65)";

        public ReforgedWardensMaceoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedWardensMaceoftheSecondAgeLevel65(QuantityRequested);
        }
