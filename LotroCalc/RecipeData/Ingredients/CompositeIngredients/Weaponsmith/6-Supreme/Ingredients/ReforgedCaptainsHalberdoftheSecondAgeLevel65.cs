...
{
    public class ReforgedCaptainsHalberdoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Halberd of the Second Age (Level 65)";

        public ReforgedCaptainsHalberdoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsHalberdoftheSecondAgeLevel65(QuantityRequested);
        }
