...
{
    public class CraftedMinstrelsMaceoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Minstrel's Mace of the Third Age (Level 60)";

        public CraftedMinstrelsMaceoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedMinstrelsMaceoftheThirdAgeLevel60(QuantityRequested);
        }
