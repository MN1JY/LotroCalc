...
{
    public class ReforgedCaptainsMaceoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Mace of the Second Age (Level 60)";

        public ReforgedCaptainsMaceoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsMaceoftheSecondAgeLevel60(QuantityRequested);
        }
