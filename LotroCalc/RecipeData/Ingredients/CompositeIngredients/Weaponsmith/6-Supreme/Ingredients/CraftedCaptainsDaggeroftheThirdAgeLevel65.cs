...
{
    public class CraftedCaptainsDaggeroftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Dagger of the Third Age (Level 65)";

        public CraftedCaptainsDaggeroftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsDaggeroftheThirdAgeLevel65(QuantityRequested);
        }
