...
{
    public class CraftedBurglarsDaggeroftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Burglar's Dagger of the Third Age (Level 60)";

        public CraftedBurglarsDaggeroftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedBurglarsDaggeroftheThirdAgeLevel60(QuantityRequested);
        }
