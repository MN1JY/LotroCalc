...
{
    public class GaladhrimGreatsword : SupremeIngredients
    {
        public static string DisplayName = "Galadhrim Greatsword";

        public GaladhrimGreatsword(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GaladhrimGreatsword(QuantityRequested);
        }
