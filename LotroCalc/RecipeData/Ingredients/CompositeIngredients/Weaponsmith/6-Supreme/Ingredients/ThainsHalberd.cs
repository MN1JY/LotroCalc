...
{
    public class ThainsHalberd : SupremeIngredients
    {
        public static string DisplayName = "Thain's Halberd";

        public ThainsHalberd(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ThainsHalberd(QuantityRequested);
        }
