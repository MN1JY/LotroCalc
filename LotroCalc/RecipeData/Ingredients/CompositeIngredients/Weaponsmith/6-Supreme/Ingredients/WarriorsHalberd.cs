...
{
    public class WarriorsHalberd : SupremeIngredients
    {
        public static string DisplayName = "Warrior's Halberd";

        public WarriorsHalberd(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WarriorsHalberd(QuantityRequested);
        }
