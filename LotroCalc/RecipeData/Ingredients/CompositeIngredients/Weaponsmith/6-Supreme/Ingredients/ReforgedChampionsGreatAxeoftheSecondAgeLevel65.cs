...
{
    public class ReforgedChampionsGreatAxeoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Great Axe of the Second Age (Level 65)";

        public ReforgedChampionsGreatAxeoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsGreatAxeoftheSecondAgeLevel65(QuantityRequested);
        }
