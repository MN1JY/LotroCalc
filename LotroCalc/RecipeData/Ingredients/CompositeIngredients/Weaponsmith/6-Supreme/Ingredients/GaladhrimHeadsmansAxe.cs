...
{
    public class GaladhrimHeadsmansAxe : SupremeIngredients
    {
        public static string DisplayName = "Galadhrim Headsman's Axe";

        public GaladhrimHeadsmansAxe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GaladhrimHeadsmansAxe(QuantityRequested);
        }
