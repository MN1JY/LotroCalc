...
{
    public class ReforgedHuntersMaceoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Mace of the Second Age (Level 65)";

        public ReforgedHuntersMaceoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersMaceoftheSecondAgeLevel65(QuantityRequested);
        }
