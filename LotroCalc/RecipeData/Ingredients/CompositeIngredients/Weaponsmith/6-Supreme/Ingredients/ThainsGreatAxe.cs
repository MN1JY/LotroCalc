...
{
    public class ThainsGreatAxe : SupremeIngredients
    {
        public static string DisplayName = "Thain's Great Axe";

        public ThainsGreatAxe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ThainsGreatAxe(QuantityRequested);
        }
