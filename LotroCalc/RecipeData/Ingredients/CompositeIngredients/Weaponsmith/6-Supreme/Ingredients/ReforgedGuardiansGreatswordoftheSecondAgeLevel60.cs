...
{
    public class ReforgedGuardiansGreatswordoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Greatsword of the Second Age (Level 60)";

        public ReforgedGuardiansGreatswordoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansGreatswordoftheSecondAgeLevel60(QuantityRequested);
        }
