...
{
    public class FlawlessGaladhrimAxeGuild : SupremeIngredients
    {
        public static string DisplayName = "Flawless Galadhrim Axe (Guild)";

        public FlawlessGaladhrimAxeGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FlawlessGaladhrimAxeGuild(QuantityRequested);
        }
