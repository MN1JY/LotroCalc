...
{
    public class CraftedCaptainsHalberdoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Halberd of the Third Age (Level 60)";

        public CraftedCaptainsHalberdoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsHalberdoftheThirdAgeLevel60(QuantityRequested);
        }
