...
{
    public class WarriorsDagger : SupremeIngredients
    {
        public static string DisplayName = "Warrior's Dagger";

        public WarriorsDagger(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WarriorsDagger(QuantityRequested);
        }
