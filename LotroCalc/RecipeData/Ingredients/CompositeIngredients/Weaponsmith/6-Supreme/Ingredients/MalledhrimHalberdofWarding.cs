...
{
    public class MalledhrimHalberdofWarding : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Halberd of Warding";

        public MalledhrimHalberdofWarding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimHalberdofWarding(QuantityRequested);
        }
