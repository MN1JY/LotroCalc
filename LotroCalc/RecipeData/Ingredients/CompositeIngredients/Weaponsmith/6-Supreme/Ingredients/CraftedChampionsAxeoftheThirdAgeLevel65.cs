...
{
    public class CraftedChampionsAxeoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Axe of the Third Age (Level 65)";

        public CraftedChampionsAxeoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsAxeoftheThirdAgeLevel65(QuantityRequested);
        }
