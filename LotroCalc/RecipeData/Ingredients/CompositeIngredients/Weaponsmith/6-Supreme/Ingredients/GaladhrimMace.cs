...
{
    public class GaladhrimMace : SupremeIngredients
    {
        public static string DisplayName = "Galadhrim Mace";

        public GaladhrimMace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GaladhrimMace(QuantityRequested);
        }
