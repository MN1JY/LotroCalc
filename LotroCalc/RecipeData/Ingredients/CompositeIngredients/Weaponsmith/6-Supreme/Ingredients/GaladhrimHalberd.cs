...
{
    public class GaladhrimHalberd : SupremeIngredients
    {
        public static string DisplayName = "Galadhrim Halberd";

        public GaladhrimHalberd(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GaladhrimHalberd(QuantityRequested);
        }
