...
{
    public class ReforgedBurglarsDaggeroftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Burglar's Dagger of the Second Age (Level 65)";

        public ReforgedBurglarsDaggeroftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedBurglarsDaggeroftheSecondAgeLevel65(QuantityRequested);
        }
