...
{
    public class CraftedCaptainsMaceoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Mace of the Third Age (Level 60)";

        public CraftedCaptainsMaceoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsMaceoftheThirdAgeLevel60(QuantityRequested);
        }
