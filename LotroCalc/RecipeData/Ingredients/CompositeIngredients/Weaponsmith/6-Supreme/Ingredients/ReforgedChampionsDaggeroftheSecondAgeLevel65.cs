...
{
    public class ReforgedChampionsDaggeroftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Dagger of the Second Age (Level 65)";

        public ReforgedChampionsDaggeroftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsDaggeroftheSecondAgeLevel65(QuantityRequested);
        }
