...
{
    public class ReforgedGuardiansSwordoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Sword of the Second Age (Level 60)";

        public ReforgedGuardiansSwordoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansSwordoftheSecondAgeLevel60(QuantityRequested);
        }
