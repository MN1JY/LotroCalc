...
{
    public class ThainsDagger : SupremeIngredients
    {
        public static string DisplayName = "Thain's Dagger";

        public ThainsDagger(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ThainsDagger(QuantityRequested);
        }
