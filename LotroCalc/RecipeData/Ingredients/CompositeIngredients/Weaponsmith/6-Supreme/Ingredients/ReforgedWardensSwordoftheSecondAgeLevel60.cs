...
{
    public class ReforgedWardensSwordoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Warden's Sword of the Second Age (Level 60)";

        public ReforgedWardensSwordoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedWardensSwordoftheSecondAgeLevel60(QuantityRequested);
        }
