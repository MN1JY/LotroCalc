...
{
    public class LethalBearTrap : SupremeIngredients
    {
        public static string DisplayName = "Lethal Bear Trap";

        public LethalBearTrap(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LethalBearTrap(QuantityRequested);
        }
