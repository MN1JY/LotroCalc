...
{
    public class ReforgedGuardiansSwordoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Sword of the Second Age (Level 65)";

        public ReforgedGuardiansSwordoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansSwordoftheSecondAgeLevel65(QuantityRequested);
        }
