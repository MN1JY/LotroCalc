...
{
    public class CraftedBurglarsDaggeroftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Burglar's Dagger of the Third Age (Level 65)";

        public CraftedBurglarsDaggeroftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedBurglarsDaggeroftheThirdAgeLevel65(QuantityRequested);
        }
