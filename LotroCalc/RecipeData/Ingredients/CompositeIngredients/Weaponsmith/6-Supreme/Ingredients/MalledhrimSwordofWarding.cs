...
{
    public class MalledhrimSwordofWarding : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Sword of Warding";

        public MalledhrimSwordofWarding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimSwordofWarding(QuantityRequested);
        }
