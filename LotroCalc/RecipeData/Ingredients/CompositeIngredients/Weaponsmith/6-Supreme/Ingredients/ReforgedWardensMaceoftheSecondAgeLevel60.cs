...
{
    public class ReforgedWardensMaceoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Warden's Mace of the Second Age (Level 60)";

        public ReforgedWardensMaceoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedWardensMaceoftheSecondAgeLevel60(QuantityRequested);
        }
