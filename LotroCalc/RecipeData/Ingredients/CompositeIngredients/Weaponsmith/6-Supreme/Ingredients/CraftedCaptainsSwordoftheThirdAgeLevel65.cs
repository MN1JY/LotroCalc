...
{
    public class CraftedCaptainsSwordoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Sword of the Third Age (Level 65)";

        public CraftedCaptainsSwordoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsSwordoftheThirdAgeLevel65(QuantityRequested);
        }
