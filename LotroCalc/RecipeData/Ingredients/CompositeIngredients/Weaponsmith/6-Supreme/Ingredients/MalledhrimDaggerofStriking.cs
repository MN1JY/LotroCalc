...
{
    public class MalledhrimDaggerofStriking : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Dagger of Striking";

        public MalledhrimDaggerofStriking(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimDaggerofStriking(QuantityRequested);
        }
