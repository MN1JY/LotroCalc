...
{
    public class ReforgedCaptainsDaggeroftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Dagger of the Second Age (Level 65)";

        public ReforgedCaptainsDaggeroftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsDaggeroftheSecondAgeLevel65(QuantityRequested);
        }
