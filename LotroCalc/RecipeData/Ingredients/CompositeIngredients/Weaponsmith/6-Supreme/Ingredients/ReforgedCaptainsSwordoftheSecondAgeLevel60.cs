...
{
    public class ReforgedCaptainsSwordoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Sword of the Second Age (Level 60)";

        public ReforgedCaptainsSwordoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsSwordoftheSecondAgeLevel60(QuantityRequested);
        }
