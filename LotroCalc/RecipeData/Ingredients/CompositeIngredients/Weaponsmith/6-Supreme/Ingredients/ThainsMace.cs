...
{
    public class ThainsMace : SupremeIngredients
    {
        public static string DisplayName = "Thain's Mace";

        public ThainsMace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ThainsMace(QuantityRequested);
        }
