...
{
    public class CraftedChampionsMaceoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Mace of the Third Age (Level 65)";

        public CraftedChampionsMaceoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsMaceoftheThirdAgeLevel65(QuantityRequested);
        }
