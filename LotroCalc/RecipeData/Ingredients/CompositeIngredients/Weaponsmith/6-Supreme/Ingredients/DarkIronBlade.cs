...
{
    public class DarkIronBlade : SupremeIngredients
    {
        public static string DisplayName = "Dark Iron Blade";

        public DarkIronBlade(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DarkIronBlade(QuantityRequested);
        }
