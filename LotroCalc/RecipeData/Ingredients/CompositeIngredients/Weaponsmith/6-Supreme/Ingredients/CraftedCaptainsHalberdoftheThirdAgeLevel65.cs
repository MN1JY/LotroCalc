...
{
    public class CraftedCaptainsHalberdoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Halberd of the Third Age (Level 65)";

        public CraftedCaptainsHalberdoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsHalberdoftheThirdAgeLevel65(QuantityRequested);
        }
