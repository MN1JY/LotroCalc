...
{
    public class ReforgedGuardiansGreatswordoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Greatsword of the Second Age (Level 65)";

        public ReforgedGuardiansGreatswordoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansGreatswordoftheSecondAgeLevel65(QuantityRequested);
        }
