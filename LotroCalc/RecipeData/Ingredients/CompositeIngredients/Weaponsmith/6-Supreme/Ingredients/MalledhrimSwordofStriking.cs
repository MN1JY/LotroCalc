...
{
    public class MalledhrimSwordofStriking : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Sword of Striking";

        public MalledhrimSwordofStriking(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimSwordofStriking(QuantityRequested);
        }
