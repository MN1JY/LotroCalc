...
{
    public class ReforgedHuntersSwordoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Sword of the Second Age (Level 60)";

        public ReforgedHuntersSwordoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersSwordoftheSecondAgeLevel60(QuantityRequested);
        }
