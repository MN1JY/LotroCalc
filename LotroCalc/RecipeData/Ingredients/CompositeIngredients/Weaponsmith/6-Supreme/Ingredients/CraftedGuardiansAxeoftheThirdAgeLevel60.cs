...
{
    public class CraftedGuardiansAxeoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Axe of the Third Age (Level 60)";

        public CraftedGuardiansAxeoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansAxeoftheThirdAgeLevel60(QuantityRequested);
        }
