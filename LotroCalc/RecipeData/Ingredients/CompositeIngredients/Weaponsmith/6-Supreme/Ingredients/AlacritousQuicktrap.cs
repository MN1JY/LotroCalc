...
{
    public class AlacritousQuicktrap : SupremeIngredients
    {
        public static string DisplayName = "Alacritous Quick-trap";

        public AlacritousQuicktrap(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AlacritousQuicktrap(QuantityRequested);
        }
