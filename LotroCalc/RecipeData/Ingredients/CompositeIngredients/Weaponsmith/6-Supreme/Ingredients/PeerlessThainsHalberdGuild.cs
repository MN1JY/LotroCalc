...
{
    public class PeerlessThainsHalberdGuild : SupremeIngredients
    {
        public static string DisplayName = "Peerless Thain's Halberd (Guild)";

        public PeerlessThainsHalberdGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PeerlessThainsHalberdGuild(QuantityRequested);
        }
