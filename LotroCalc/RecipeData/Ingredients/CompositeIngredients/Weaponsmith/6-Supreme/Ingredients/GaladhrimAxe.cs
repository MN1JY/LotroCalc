...
{
    public class GaladhrimAxe : SupremeIngredients
    {
        public static string DisplayName = "Galadhrim Axe";

        public GaladhrimAxe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GaladhrimAxe(QuantityRequested);
        }
