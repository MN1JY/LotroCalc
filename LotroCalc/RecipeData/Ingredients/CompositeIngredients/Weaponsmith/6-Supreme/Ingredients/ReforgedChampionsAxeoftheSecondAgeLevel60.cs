...
{
    public class ReforgedChampionsAxeoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Axe of the Second Age (Level 60)";

        public ReforgedChampionsAxeoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsAxeoftheSecondAgeLevel60(QuantityRequested);
        }
