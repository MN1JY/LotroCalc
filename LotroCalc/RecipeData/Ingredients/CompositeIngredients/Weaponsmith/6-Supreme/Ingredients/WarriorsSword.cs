...
{
    public class WarriorsSword : SupremeIngredients
    {
        public static string DisplayName = "Warrior's Sword";

        public WarriorsSword(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WarriorsSword(QuantityRequested);
        }
