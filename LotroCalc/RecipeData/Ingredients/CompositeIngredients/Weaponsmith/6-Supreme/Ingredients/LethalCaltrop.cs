...
{
    public class LethalCaltrop : SupremeIngredients
    {
        public static string DisplayName = "Lethal Caltrop";

        public LethalCaltrop(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LethalCaltrop(QuantityRequested);
        }
