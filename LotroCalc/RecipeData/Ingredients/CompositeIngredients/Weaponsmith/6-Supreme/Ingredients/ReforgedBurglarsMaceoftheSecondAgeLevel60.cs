...
{
    public class ReforgedBurglarsMaceoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Burglar's Mace of the Second Age (Level 60)";

        public ReforgedBurglarsMaceoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedBurglarsMaceoftheSecondAgeLevel60(QuantityRequested);
        }
