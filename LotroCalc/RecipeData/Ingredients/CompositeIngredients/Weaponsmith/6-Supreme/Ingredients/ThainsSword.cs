...
{
    public class ThainsSword : SupremeIngredients
    {
        public static string DisplayName = "Thain's Sword";

        public ThainsSword(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ThainsSword(QuantityRequested);
        }
