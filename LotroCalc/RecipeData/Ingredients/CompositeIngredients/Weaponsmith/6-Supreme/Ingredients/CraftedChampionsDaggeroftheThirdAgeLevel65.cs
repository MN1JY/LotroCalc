...
{
    public class CraftedChampionsDaggeroftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Dagger of the Third Age (Level 65)";

        public CraftedChampionsDaggeroftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsDaggeroftheThirdAgeLevel65(QuantityRequested);
        }
