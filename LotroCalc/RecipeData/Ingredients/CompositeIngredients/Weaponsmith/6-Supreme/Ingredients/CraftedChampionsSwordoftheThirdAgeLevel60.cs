...
{
    public class CraftedChampionsSwordoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Sword of the Third Age (Level 60)";

        public CraftedChampionsSwordoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsSwordoftheThirdAgeLevel60(QuantityRequested);
        }
