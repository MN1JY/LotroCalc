...
{
    public class ReforgedCaptainsGreatAxeoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Great Axe of the Second Age (Level 65)";

        public ReforgedCaptainsGreatAxeoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsGreatAxeoftheSecondAgeLevel65(QuantityRequested);
        }
