...
{
    public class CraftedGuardiansGreatswordoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Greatsword of the Third Age (Level 60)";

        public CraftedGuardiansGreatswordoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansGreatswordoftheThirdAgeLevel60(QuantityRequested);
        }
