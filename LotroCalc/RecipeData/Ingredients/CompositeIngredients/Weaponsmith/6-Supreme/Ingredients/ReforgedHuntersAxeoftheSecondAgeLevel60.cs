...
{
    public class ReforgedHuntersAxeoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Hunter's Axe of the Second Age (Level 60)";

        public ReforgedHuntersAxeoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedHuntersAxeoftheSecondAgeLevel60(QuantityRequested);
        }
