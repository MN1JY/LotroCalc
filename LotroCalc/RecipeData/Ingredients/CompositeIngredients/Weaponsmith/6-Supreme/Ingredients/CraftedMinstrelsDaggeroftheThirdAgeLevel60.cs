...
{
    public class CraftedMinstrelsDaggeroftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Minstrel's Dagger of the Third Age (Level 60)";

        public CraftedMinstrelsDaggeroftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedMinstrelsDaggeroftheThirdAgeLevel60(QuantityRequested);
        }
