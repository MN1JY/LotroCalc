...
{
    public class FlawlessGaladhrimHeadsmansAxeGuild : SupremeIngredients
    {
        public static string DisplayName = "Flawless Galadhrim Headsman's Axe (Guild)";

        public FlawlessGaladhrimHeadsmansAxeGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FlawlessGaladhrimHeadsmansAxeGuild(QuantityRequested);
        }
