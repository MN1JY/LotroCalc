...
{
    public class CeremonialDwarfaxeGuild : SupremeIngredients
    {
        public static string DisplayName = "Ceremonial Dwarf-axe (Guild)";

        public CeremonialDwarfaxeGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CeremonialDwarfaxeGuild(QuantityRequested);
        }
