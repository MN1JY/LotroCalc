...
{
    public class ReforgedChampionsGreatAxeoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Great Axe of the Second Age (Level 60)";

        public ReforgedChampionsGreatAxeoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsGreatAxeoftheSecondAgeLevel60(QuantityRequested);
        }
