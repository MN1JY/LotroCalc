...
{
    public class CraftedBurglarsSwordoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Burglar's Sword of the Third Age (Level 60)";

        public CraftedBurglarsSwordoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedBurglarsSwordoftheThirdAgeLevel60(QuantityRequested);
        }
