...
{
    public class FlawlessGaladhrimDaggerGuild : SupremeIngredients
    {
        public static string DisplayName = "Flawless Galadhrim Dagger (Guild)";

        public FlawlessGaladhrimDaggerGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FlawlessGaladhrimDaggerGuild(QuantityRequested);
        }
