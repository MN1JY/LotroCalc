...
{
    public class ReforgedCaptainsGreatswordoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Greatsword of the Second Age (Level 60)";

        public ReforgedCaptainsGreatswordoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsGreatswordoftheSecondAgeLevel60(QuantityRequested);
        }
