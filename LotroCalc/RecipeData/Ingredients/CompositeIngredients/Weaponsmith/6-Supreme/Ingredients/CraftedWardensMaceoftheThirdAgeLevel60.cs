...
{
    public class CraftedWardensMaceoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Warden's Mace of the Third Age (Level 60)";

        public CraftedWardensMaceoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedWardensMaceoftheThirdAgeLevel60(QuantityRequested);
        }
