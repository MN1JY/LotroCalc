...
{
    public class CraftedGuardiansGreatAxeoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Great Axe of the Third Age (Level 65)";

        public CraftedGuardiansGreatAxeoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansGreatAxeoftheThirdAgeLevel65(QuantityRequested);
        }
