...
{
    public class GaladhrimDagger : SupremeIngredients
    {
        public static string DisplayName = "Galadhrim Dagger";

        public GaladhrimDagger(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GaladhrimDagger(QuantityRequested);
        }
