...
{
    public class CraftedGuardiansGreatAxeoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Great Axe of the Third Age (Level 60)";

        public CraftedGuardiansGreatAxeoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansGreatAxeoftheThirdAgeLevel60(QuantityRequested);
        }
