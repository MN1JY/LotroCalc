...
{
    public class CraftedMinstrelsSwordoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Minstrel's Sword of the Third Age (Level 65)";

        public CraftedMinstrelsSwordoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedMinstrelsSwordoftheThirdAgeLevel65(QuantityRequested);
        }
