...
{
    public class CraftedChampionsDaggeroftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Champion's Dagger of the Third Age (Level 60)";

        public CraftedChampionsDaggeroftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedChampionsDaggeroftheThirdAgeLevel60(QuantityRequested);
        }
