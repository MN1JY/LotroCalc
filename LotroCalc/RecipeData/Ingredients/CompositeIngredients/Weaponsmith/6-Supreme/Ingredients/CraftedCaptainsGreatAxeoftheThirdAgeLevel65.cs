...
{
    public class CraftedCaptainsGreatAxeoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Great Axe of the Third Age (Level 65)";

        public CraftedCaptainsGreatAxeoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsGreatAxeoftheThirdAgeLevel65(QuantityRequested);
        }
