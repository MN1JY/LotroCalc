...
{
    public class ReforgedChampionsMaceoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Mace of the Second Age (Level 65)";

        public ReforgedChampionsMaceoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsMaceoftheSecondAgeLevel65(QuantityRequested);
        }
