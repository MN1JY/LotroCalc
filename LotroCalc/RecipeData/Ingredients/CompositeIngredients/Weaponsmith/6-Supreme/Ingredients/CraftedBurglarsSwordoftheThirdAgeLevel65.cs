...
{
    public class CraftedBurglarsSwordoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Burglar's Sword of the Third Age (Level 65)";

        public CraftedBurglarsSwordoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedBurglarsSwordoftheThirdAgeLevel65(QuantityRequested);
        }
