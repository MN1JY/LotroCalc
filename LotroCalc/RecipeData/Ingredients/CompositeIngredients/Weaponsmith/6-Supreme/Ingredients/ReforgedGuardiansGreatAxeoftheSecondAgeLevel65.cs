...
{
    public class ReforgedGuardiansGreatAxeoftheSecondAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Great Axe of the Second Age (Level 65)";

        public ReforgedGuardiansGreatAxeoftheSecondAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansGreatAxeoftheSecondAgeLevel65(QuantityRequested);
        }
