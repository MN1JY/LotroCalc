...
{
    public class CraftedHuntersMaceoftheThirdAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Hunter's Mace of the Third Age (Level 60)";

        public CraftedHuntersMaceoftheThirdAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedHuntersMaceoftheThirdAgeLevel60(QuantityRequested);
        }
