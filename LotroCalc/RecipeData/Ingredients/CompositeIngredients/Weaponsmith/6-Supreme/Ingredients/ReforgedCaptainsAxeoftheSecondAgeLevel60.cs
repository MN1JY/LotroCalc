...
{
    public class ReforgedCaptainsAxeoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Captain's Axe of the Second Age (Level 60)";

        public ReforgedCaptainsAxeoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedCaptainsAxeoftheSecondAgeLevel60(QuantityRequested);
        }
