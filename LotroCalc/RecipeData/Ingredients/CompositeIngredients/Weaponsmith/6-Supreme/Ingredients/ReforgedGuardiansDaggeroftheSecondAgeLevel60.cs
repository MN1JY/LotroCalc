...
{
    public class ReforgedGuardiansDaggeroftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Dagger of the Second Age (Level 60)";

        public ReforgedGuardiansDaggeroftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansDaggeroftheSecondAgeLevel60(QuantityRequested);
        }
