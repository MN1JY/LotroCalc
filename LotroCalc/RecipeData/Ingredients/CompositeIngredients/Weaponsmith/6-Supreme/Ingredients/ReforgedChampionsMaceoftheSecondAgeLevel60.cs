...
{
    public class ReforgedChampionsMaceoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Champion's Mace of the Second Age (Level 60)";

        public ReforgedChampionsMaceoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedChampionsMaceoftheSecondAgeLevel60(QuantityRequested);
        }
