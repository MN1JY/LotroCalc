...
{
    public class UnyieldingStrongTrap : SupremeIngredients
    {
        public static string DisplayName = "Unyielding Strong Trap";

        public UnyieldingStrongTrap(int count)
        {
            Name = DisplayName;
        ...
        {
            return new UnyieldingStrongTrap(QuantityRequested);
        }
