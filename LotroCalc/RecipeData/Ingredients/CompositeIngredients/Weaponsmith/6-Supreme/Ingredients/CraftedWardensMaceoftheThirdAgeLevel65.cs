...
{
    public class CraftedWardensMaceoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Warden's Mace of the Third Age (Level 65)";

        public CraftedWardensMaceoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedWardensMaceoftheThirdAgeLevel65(QuantityRequested);
        }
