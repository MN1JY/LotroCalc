...
{
    public class CraftedHuntersAxeoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Hunter's Axe of the Third Age (Level 65)";

        public CraftedHuntersAxeoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedHuntersAxeoftheThirdAgeLevel65(QuantityRequested);
        }
