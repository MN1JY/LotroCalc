...
{
    public class CraftedHuntersDaggeroftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Hunter's Dagger of the Third Age (Level 65)";

        public CraftedHuntersDaggeroftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedHuntersDaggeroftheThirdAgeLevel65(QuantityRequested);
        }
