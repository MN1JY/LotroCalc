...
{
    public class MalledhrimAxeofWarding : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Axe of Warding";

        public MalledhrimAxeofWarding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimAxeofWarding(QuantityRequested);
        }
