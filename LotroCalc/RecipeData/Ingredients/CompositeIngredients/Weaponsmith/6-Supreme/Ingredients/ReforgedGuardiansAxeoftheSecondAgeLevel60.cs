...
{
    public class ReforgedGuardiansAxeoftheSecondAgeLevel60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Axe of the Second Age (Level 60)";

        public ReforgedGuardiansAxeoftheSecondAgeLevel60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansAxeoftheSecondAgeLevel60(QuantityRequested);
        }
