...
{
    public class CalenardThrowingHatchet : WestfoldIngredients
    {
        public static string DisplayName = "Calenard Throwing Hatchet";

        public CalenardThrowingHatchet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CalenardThrowingHatchet(QuantityRequested);
        }
