...
{
    public class CalenardMarbles : WestfoldIngredients
    {
        public static string DisplayName = "Calenard Marbles";

        public CalenardMarbles(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CalenardMarbles(QuantityRequested);
        }
