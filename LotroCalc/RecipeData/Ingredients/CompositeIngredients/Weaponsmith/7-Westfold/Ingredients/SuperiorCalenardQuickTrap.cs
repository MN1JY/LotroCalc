...
{
    public class SuperiorCalenardQuickTrap : WestfoldIngredients
    {
        public static string DisplayName = "Superior Calenard Quick Trap";

        public SuperiorCalenardQuickTrap(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorCalenardQuickTrap(QuantityRequested);
        }
