...
{
    public class SuperiorCalenardBearTrap : WestfoldIngredients
    {
        public static string DisplayName = "Superior Calenard Bear Trap";

        public SuperiorCalenardBearTrap(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorCalenardBearTrap(QuantityRequested);
        }
