...
{
    public class CalenardCaltrops : WestfoldIngredients
    {
        public static string DisplayName = "Calenard Caltrops";

        public CalenardCaltrops(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CalenardCaltrops(QuantityRequested);
        }
