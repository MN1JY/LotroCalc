...
{
    public class CalenardDagger : WestfoldIngredients
    {
        public static string DisplayName = "Calenard Dagger";

        public CalenardDagger(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CalenardDagger(QuantityRequested);
        }
