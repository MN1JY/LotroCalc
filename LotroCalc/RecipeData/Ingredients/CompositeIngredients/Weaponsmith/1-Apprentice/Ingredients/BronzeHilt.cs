...
{
    public class BronzeHilt : ApprenticeIngredients
    {
        public static string DisplayName = "Bronze Hilt";

        public BronzeHilt(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BronzeHilt(QuantityRequested);
        }
