...
{
    public class SuperiorGaladhrimRation : SupremeIngredients
    {
        public static string DisplayName = "Superior Galadhrim Ration (Guild)";

        public SuperiorGaladhrimRation(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorGaladhrimRation(QuantityRequested);
        }
