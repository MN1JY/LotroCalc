...
{
    public class BubbleAndSqueak : SupremeIngredients
    {
        public static string DisplayName = "Bubble And Squeak";

        public BubbleAndSqueak(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BubbleAndSqueak(QuantityRequested);
        }
