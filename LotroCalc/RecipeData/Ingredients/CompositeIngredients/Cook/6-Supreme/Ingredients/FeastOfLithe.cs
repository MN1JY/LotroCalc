...
{
    public class FeastOfLithe : SupremeIngredients
    {
        public static string DisplayName = "Feast Of Lithe (Relic)";

        public FeastOfLithe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FeastOfLithe(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = JarOfMintSauce.DisplayName;
            ...
            ingName = StrawberryStout.DisplayName;
            ing = (Ingredient)DictCraftedIngredients[ingName].Clone();
            ing.QuantityRequested = 1 * QuantityRequested;
            recipe.Add(ingName, ing);
