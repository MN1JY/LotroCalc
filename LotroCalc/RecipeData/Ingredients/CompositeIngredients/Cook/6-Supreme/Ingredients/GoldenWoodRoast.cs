...
{
    public class GoldenWoodRoast : SupremeIngredients
    {
        public static string DisplayName = "Golden Wood Roast";

        public GoldenWoodRoast(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GoldenWoodRoast(QuantityRequested);
        }
