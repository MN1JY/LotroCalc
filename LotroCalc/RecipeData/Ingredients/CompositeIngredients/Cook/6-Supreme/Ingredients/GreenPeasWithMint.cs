...
{
    public class GreenPeasWithMint : SupremeIngredients
    {
        public static string DisplayName = "Green Peas With Mint";

        public GreenPeasWithMint(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GreenPeasWithMint(QuantityRequested);
        }
