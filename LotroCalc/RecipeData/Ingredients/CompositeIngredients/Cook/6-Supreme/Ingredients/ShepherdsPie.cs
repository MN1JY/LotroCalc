...
{
    public class ShepherdsPie : SupremeIngredients
    {
        public static string DisplayName = "Shepherd's Pie";

        public ShepherdsPie(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ShepherdsPie(QuantityRequested);
        }
