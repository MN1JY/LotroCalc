...
{
    public class FeastOfHarvestmath : SupremeIngredients
    {
        public static string DisplayName = "Feast Of Harvestmath (Relic)";

        public FeastOfHarvestmath(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FeastOfHarvestmath(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = BlackberryAle.DisplayName;
