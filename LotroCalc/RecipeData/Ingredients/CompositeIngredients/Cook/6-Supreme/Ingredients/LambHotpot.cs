...
{
    public class LambHotpot : SupremeIngredients
    {
        public static string DisplayName = "Lamb Hotpot";

        public LambHotpot(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LambHotpot(QuantityRequested);
        }
