...
{
    public class PotOfSweetHoneyAndOats : SupremeIngredients
    {
        public static string DisplayName = "Pot Of Sweet Honey And Oats";

        public PotOfSweetHoneyAndOats(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PotOfSweetHoneyAndOats(QuantityRequested);
        }
