...
{
    public class MushyGreenPeas : SupremeIngredients
    {
        public static string DisplayName = "Mushy Green Peas";

        public MushyGreenPeas(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MushyGreenPeas(QuantityRequested);
        }
