...
{
    public class CutofLeanMeat : SupremeIngredients
    {
        public static string DisplayName = "Cut of Lean Meat";

        public CutofLeanMeat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CutofLeanMeat(QuantityRequested);
        }
