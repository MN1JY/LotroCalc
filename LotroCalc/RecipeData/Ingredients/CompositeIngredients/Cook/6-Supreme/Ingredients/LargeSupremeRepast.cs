...
{
    public class LargeSupremeRepast : SupremeIngredients
    {
        public static string DisplayName = "Large Supreme Repast (Guild)";

        public LargeSupremeRepast(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LargeSupremeRepast(QuantityRequested);
        }
