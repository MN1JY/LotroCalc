...
{
    public class LambAndCarrotSoup : SupremeIngredients
    {
        public static string DisplayName = "Lamb And Carrot Soup";

        public LambAndCarrotSoup(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LambAndCarrotSoup(QuantityRequested);
        }
