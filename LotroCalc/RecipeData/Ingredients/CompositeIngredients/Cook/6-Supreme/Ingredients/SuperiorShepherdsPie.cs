...
{
    public class SuperiorShepherdsPie : SupremeIngredients
    {
        public static string DisplayName = "Superior Shepherd's Pie (Guild)";

        public SuperiorShepherdsPie(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorShepherdsPie(QuantityRequested);
        }
