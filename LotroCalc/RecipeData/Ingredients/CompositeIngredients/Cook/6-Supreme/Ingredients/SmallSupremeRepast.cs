...
{
    public class SmallSupremeRepast : SupremeIngredients
    {
        public static string DisplayName = "Small Supreme Repast (Guild)";

        public SmallSupremeRepast(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallSupremeRepast(QuantityRequested);
        }
