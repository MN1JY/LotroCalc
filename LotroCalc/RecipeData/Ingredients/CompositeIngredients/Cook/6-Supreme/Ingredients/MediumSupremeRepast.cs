...
{
    public class MediumSupremeRepast : SupremeIngredients
    {
        public static string DisplayName = "Medium Supreme Repast (Guild)";

        public MediumSupremeRepast(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MediumSupremeRepast(QuantityRequested);
        }
