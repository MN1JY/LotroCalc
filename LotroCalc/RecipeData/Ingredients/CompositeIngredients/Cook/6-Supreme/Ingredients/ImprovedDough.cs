...
{
    public class ImprovedDough : SupremeIngredients
    {
        public static string DisplayName = "Improved Dough (Guild)";

        public ImprovedDough(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedDough(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SmallSupremeRepast.DisplayName;
            ing = (Ingredient)DictCraftedIngredients[ingName].Clone();
