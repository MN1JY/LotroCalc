...
{
    public class BagofDeliciousCrumbs : SupremeIngredients
    {
        public static string DisplayName = "Bag of Delicious Crumbs";

        public BagofDeliciousCrumbs(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BagofDeliciousCrumbs(QuantityRequested);
        }
