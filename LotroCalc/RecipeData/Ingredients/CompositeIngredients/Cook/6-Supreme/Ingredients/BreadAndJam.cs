...
{
    public class BreadAndJam : SupremeIngredients
    {
        public static string DisplayName = "Bread And Jam";

        public BreadAndJam(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BreadAndJam(QuantityRequested);
        }
