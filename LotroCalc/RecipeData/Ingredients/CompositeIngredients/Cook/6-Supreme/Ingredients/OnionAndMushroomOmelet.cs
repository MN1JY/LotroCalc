...
{
    public class OnionAndMushroomOmelet : SupremeIngredients
    {
        public static string DisplayName = "Onion And Mushroom Omelet";

        public OnionAndMushroomOmelet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OnionAndMushroomOmelet(QuantityRequested);
        }
