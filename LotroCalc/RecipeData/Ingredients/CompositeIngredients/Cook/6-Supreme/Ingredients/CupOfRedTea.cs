...
{
    public class CupOfRedTea : SupremeIngredients
    {
        public static string DisplayName = "Cup Of Red Tea";

        public CupOfRedTea(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CupOfRedTea(QuantityRequested);
        }
