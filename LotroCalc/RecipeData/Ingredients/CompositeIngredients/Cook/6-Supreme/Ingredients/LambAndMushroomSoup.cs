...
{
    public class LambAndMushroomSoup : SupremeIngredients
    {
        public static string DisplayName = "Lamb And Mushroom Soup";

        public LambAndMushroomSoup(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LambAndMushroomSoup(QuantityRequested);
        }
