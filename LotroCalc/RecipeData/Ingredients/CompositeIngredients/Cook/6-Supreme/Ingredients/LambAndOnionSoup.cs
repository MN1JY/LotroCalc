...
{
    public class LambAndOnionSoup : SupremeIngredients
    {
        public static string DisplayName = "Lamb And Onion Soup";

        public LambAndOnionSoup(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LambAndOnionSoup(QuantityRequested);
        }
