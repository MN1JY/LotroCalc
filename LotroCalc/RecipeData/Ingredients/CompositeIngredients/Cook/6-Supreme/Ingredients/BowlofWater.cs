...
{
    public class BowlOfWater : SupremeIngredients
    {
        public static string DisplayName = "Bowl Of Water";

        public BowlOfWater(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BowlOfWater(QuantityRequested);
        }
