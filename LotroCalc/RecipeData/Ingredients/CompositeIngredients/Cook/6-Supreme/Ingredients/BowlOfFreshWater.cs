...
{
    public class BowlOfFreshWater : SupremeIngredients
    {
        public static string DisplayName = "Bowl Of Fresh Water";

        public BowlOfFreshWater(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BowlOfFreshWater(QuantityRequested);
        }
