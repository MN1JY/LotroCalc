...
{
    public class StrawberryRhubarbFilling : SupremeIngredients
    {
        public static string DisplayName = "Strawberry-Rhubarb Filling";

        public StrawberryRhubarbFilling(int count)
        {
            Name = DisplayName;
        ...
        {
            return new StrawberryRhubarbFilling(QuantityRequested);
        }
