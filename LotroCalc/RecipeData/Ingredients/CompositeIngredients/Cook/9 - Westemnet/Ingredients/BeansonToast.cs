...
{
    public class BeansonToast : WestemnetIngredients
    {
        public static string DisplayName = "Beans on Toast";

        public BeansonToast(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BeansonToast(QuantityRequested);
        }
