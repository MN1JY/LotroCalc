...
{
    public class CheddarPearPie : WestemnetIngredients
    {
        public static string DisplayName = "Cheddar Pear Pie";

        public CheddarPearPie(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CheddarPearPie(QuantityRequested);
        }
