...
{
    public class HeartyVenisonVegetableSoup : WestemnetIngredients
    {
        public static string DisplayName = "Hearty Venison Vegetable Soup";

        public HeartyVenisonVegetableSoup(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeartyVenisonVegetableSoup(QuantityRequested);
        }
