...
{
    public class AppleandPearSoup : WestemnetIngredients
    {
        public static string DisplayName = "Apple and Pear Soup";

        public AppleandPearSoup(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AppleandPearSoup(QuantityRequested);
        }
