...
{
    public class BakedPearPudding : WestemnetIngredients
    {
        public static string DisplayName = "Baked Pear Pudding";

        public BakedPearPudding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BakedPearPudding(QuantityRequested);
        }
