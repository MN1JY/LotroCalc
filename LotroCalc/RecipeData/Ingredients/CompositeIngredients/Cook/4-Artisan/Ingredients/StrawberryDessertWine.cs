...
{
    public class StrawberryDessertWine : ArtisanIngredients
    {
        public static string DisplayName = "Strawberry Dessert-Wine";

        public StrawberryDessertWine(int count)
        {
            Name = DisplayName;
        ...
        {
            return new StrawberryDessertWine(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.EmptyGlassBottle;
            ing = (Ingredient)DictSimpleIngredients[ingName].Clone();
            ing.QuantityRequested = 1 * QuantityRequested;
            recipe.Add(ingName, ing);
