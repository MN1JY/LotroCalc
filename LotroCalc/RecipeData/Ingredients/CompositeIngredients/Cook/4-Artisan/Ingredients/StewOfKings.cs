...
{
    public class StewOfKings : ArtisanIngredients
    {
        public static string DisplayName = "Stew Of Kings";

        public StewOfKings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new StewOfKings(QuantityRequested);
        }
