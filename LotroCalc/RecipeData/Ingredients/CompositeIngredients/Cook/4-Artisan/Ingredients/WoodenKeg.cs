...
{
    public class WoodenKeg : ArtisanIngredients
    {
        public static string DisplayName = "Wooden Keg";

        public WoodenKeg(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WoodenKeg(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = PreparedGreenHillHops.DisplayName;
            ing = (Ingredient)DictCraftedIngredients[ingName].Clone();
            ing.QuantityRequested = 1 * QuantityRequested;
            recipe.Add(ingName, ing);

            ingName = BucketOfWinterBarleyMash.DisplayName;
            ing = (Ingredient)DictCraftedIngredients[ingName].Clone();
            ing.QuantityRequested = 1 * QuantityRequested;
            recipe.Add(ingName, ing);
