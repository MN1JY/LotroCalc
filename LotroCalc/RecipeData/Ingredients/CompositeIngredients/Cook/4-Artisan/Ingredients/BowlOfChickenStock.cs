...
{
    public class BowlofChickenStock : ArtisanIngredients
    {
        public static string DisplayName = "Bowl of Chicken Stock";

        public BowlofChickenStock(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BowlofChickenStock(QuantityRequested);
        }
