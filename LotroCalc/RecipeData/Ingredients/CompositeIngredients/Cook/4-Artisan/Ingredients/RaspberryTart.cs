...
{
    public class RaspberryTart : ArtisanIngredients
    {
        public static string DisplayName = "Raspberry Tart";

        public RaspberryTart(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RaspberryTart(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = RaspberryPieFilling.DisplayName;
