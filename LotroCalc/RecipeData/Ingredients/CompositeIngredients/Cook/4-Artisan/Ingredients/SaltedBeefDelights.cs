...
{
    public class SaltedBeefDelights : ArtisanIngredients
    {
        public static string DisplayName = "Salted Beef Delights";

        public SaltedBeefDelights(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SaltedBeefDelights(QuantityRequested);
        }
