...
{
    public class ChickenCarrotSoup : ArtisanIngredients
    {
        public static string DisplayName = "Chicken Carrot Soup";

        public ChickenCarrotSoup(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ChickenCarrotSoup(QuantityRequested);
        }
