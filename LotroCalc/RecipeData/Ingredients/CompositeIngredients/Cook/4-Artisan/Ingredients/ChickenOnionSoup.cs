...
{
    public class ChickenOnionSoup : ArtisanIngredients
    {
        public static string DisplayName = "Chicken Onion Soup";

        public ChickenOnionSoup(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ChickenOnionSoup(QuantityRequested);
        }
