...
{
    public class ChickenMushroomSoup : ArtisanIngredients
    {
        public static string DisplayName = "Chicken Mushroom Soup";

        public ChickenMushroomSoup(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ChickenMushroomSoup(QuantityRequested);
        }
