...
{
    public class HobbitonOmlet : ArtisanIngredients
    {
        public static string DisplayName = "Hobbiton Omlet";

        public HobbitonOmlet(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HobbitonOmlet(QuantityRequested);
        }
