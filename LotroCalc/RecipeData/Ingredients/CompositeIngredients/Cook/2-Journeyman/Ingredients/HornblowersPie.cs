...
{
    public class HornblowersPie : JourneymanIngredients
    {
        public static string DisplayName = "Hornblower's Pie";

        public HornblowersPie(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HornblowersPie(QuantityRequested);
        }
