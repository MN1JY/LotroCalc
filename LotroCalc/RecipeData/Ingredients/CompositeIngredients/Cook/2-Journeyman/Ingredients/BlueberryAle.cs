...
{
    public class BlueberryAle : JourneymanIngredients
    {
        public static string DisplayName = "Blueberry Ale";

        public BlueberryAle(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BlueberryAle(QuantityRequested);
        }
