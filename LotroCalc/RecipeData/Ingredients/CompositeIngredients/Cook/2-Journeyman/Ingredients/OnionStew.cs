...
{
    public class OnionStew : JourneymanIngredients
    {
        public static string DisplayName = "Onion Stew";

        public OnionStew(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OnionStew(QuantityRequested);
        }
