...
{
    public class BowlOfOatmeal : JourneymanIngredients
    {
        public static string DisplayName = "Bowl Of Oatmeal";

        public BowlOfOatmeal(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BowlOfOatmeal(QuantityRequested);
        }
