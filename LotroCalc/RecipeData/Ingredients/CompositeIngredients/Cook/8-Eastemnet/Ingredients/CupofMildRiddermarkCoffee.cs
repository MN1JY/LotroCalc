...
{
    public class CupofMildRiddermarkCoffee : EastemnetIngredients
    {
        public static string DisplayName = "Cup of Mild Riddermark Coffee (Guild)";

        public CupofMildRiddermarkCoffee(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CupofMildRiddermarkCoffee(QuantityRequested);
        }
