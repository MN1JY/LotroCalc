...
{
    public class SuperiorVegetablePasty : EastemnetIngredients
    {
        public static string DisplayName = "Superior Vegetable Pasty (Guild)";

        public SuperiorVegetablePasty(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorVegetablePasty(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = LargeEastemnetRepast.DisplayName;
            ing = (Ingredient)DictCraftedIngredients[ingName].Clone();
