...
{
    public class JarOfCherryJam : EastemnetIngredients
    {
        public static string DisplayName = "Jar Of Cherry Jam";

        public JarOfCherryJam(int count)
        {
            Name = DisplayName;
        ...
        {
            return new JarOfCherryJam(QuantityRequested);
        }
