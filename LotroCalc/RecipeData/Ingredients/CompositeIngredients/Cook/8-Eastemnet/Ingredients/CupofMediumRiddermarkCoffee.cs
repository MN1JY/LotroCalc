...
{
    public class CupofMediumRiddermarkCoffee : EastemnetIngredients
    {
        public static string DisplayName = "Cup of Medium Riddermark Coffee (Guild)";

        public CupofMediumRiddermarkCoffee(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CupofMediumRiddermarkCoffee(QuantityRequested);
        }
