...
{
    public class VegetablePotPie : EastemnetIngredients
    {
        public static string DisplayName = "Vegetable Pot Pie";

        public VegetablePotPie(int count)
        {
            Name = DisplayName;
        ...
        {
            return new VegetablePotPie(QuantityRequested);
        }
