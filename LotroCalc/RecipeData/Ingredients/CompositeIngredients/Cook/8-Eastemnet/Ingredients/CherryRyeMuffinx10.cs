...
{
    public class CherryRyeMuffinx10 : EastemnetIngredients
    {
        public static string DisplayName = "Cherry Rye Muffin (x10)";

        public CherryRyeMuffinx10(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CherryRyeMuffinx10(QuantityRequested);
        }
