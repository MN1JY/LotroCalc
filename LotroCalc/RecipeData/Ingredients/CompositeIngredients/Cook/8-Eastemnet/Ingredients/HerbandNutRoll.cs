...
{
    public class HerbandNutRoll : EastemnetIngredients
    {
        public static string DisplayName = "Herb and Nut Roll";

        public HerbandNutRoll(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HerbandNutRoll(QuantityRequested);
        }
