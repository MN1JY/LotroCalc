...
{
    public class CherryFilling : EastemnetIngredients
    {
        public static string DisplayName = "Cherry Filling";

        public CherryFilling(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CherryFilling(QuantityRequested);
        }
