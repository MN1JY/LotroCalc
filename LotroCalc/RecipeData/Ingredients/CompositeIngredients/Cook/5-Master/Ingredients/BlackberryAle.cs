...
{
    public class BlackberryAle : MasterIngredients
    {
        public static string DisplayName = "Blackberry Ale";

        public BlackberryAle(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BlackberryAle(QuantityRequested);
        }
