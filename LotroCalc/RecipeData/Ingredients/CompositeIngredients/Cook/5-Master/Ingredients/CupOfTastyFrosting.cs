...
{
    public class CupOfTastyFrosting : MasterIngredients
    {
        public static string DisplayName = "Cup Of Tasty Frosting";

        public CupOfTastyFrosting(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CupOfTastyFrosting(QuantityRequested);
        }
