...
{
    public class FeastOfRohan : MasterIngredients
    {
        public static string DisplayName = "Feast Of Rohan";

        public FeastOfRohan(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FeastOfRohan(QuantityRequested);
        }
