...
{
    public class CreamOfCarrotSoup : MasterIngredients
    {
        public static string DisplayName = "Cream Of Carrot Soup";

        public CreamOfCarrotSoup(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CreamOfCarrotSoup(QuantityRequested);
        }
