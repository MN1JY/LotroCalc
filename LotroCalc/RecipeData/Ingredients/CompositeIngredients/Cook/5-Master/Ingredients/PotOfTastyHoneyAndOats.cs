...
{
    public class PotOfTastyHoneyAndOats : MasterIngredients
    {
        public static string DisplayName = "Pot Of Tasty Honey And Oats";

        public PotOfTastyHoneyAndOats(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PotOfTastyHoneyAndOats(QuantityRequested);
        }
