...
{
    public class BlackberryTart : MasterIngredients
    {
        public static string DisplayName = "Blackberry Tart";

        public BlackberryTart(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BlackberryTart(QuantityRequested);
        }
