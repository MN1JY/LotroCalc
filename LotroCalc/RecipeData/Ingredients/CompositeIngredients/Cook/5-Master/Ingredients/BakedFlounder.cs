...
{
    public class BakedFlounder : MasterIngredients
    {
        public static string DisplayName = "Baked Flounder";

        public BakedFlounder(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BakedFlounder(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = FishingIngredients.Flounder;
