...
{
    public class CreamOfMushroomSoup : MasterIngredients
    {
        public static string DisplayName = "Cream Of Mushroom Soup";

        public CreamOfMushroomSoup(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CreamOfMushroomSoup(QuantityRequested);
        }
