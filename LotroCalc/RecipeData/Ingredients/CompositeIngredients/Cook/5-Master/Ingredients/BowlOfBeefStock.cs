...
{
    public class BowlOfBeefStock : MasterIngredients
    {
        public static string DisplayName = "Bowl Of Beef Stock";

        public BowlOfBeefStock(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BowlOfBeefStock(QuantityRequested);
        }
