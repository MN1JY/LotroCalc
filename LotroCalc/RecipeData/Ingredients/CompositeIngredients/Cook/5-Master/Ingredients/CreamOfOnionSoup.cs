...
{
    public class CreamOfOnionSoup : MasterIngredients
    {
        public static string DisplayName = "Cream Of Onion Soup";

        public CreamOfOnionSoup(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CreamOfOnionSoup(QuantityRequested);
        }
