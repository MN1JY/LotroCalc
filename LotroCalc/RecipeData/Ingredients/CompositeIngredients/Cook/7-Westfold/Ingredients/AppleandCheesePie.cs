...
{
    public class AppleandCheesePie : WestfoldIngredients
    {
        public static string DisplayName = "Apple And Cheese Pie";

        public AppleandCheesePie(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AppleandCheesePie(QuantityRequested);
        }
