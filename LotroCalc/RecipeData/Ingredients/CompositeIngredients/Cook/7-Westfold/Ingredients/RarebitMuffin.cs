...
{
    public class RarebitMuffin : WestfoldIngredients
    {
        public static string DisplayName = "Rarebit Muffin";

        public RarebitMuffin(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RarebitMuffin(QuantityRequested);
        }
