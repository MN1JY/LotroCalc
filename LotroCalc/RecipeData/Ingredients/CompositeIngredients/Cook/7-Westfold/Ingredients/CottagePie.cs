...
{
    public class CottagePie : WestfoldIngredients
    {
        public static string DisplayName = "Cottage Pie";

        public CottagePie(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CottagePie(QuantityRequested);
        }
