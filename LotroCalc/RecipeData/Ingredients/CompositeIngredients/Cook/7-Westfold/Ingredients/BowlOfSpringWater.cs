...
{
    public class BowlOfSpringWater : WestfoldIngredients
    {
        public static string DisplayName = "Bowl Of Spring Water";

        public BowlOfSpringWater(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BowlOfSpringWater(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = FarmedIngredients.PinchOfWestfoldHerbs;
            ing = (Ingredient)DictSimpleIngredients[ingName].Clone();
            ing.QuantityRequested = 1 * QuantityRequested;
            recipe.Add(ingName, ing);
