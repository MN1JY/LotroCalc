...
{
    public class RohanPasty : WestfoldIngredients
    {
        public static string DisplayName = "Rohan Pasty";

        public RohanPasty(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RohanPasty(QuantityRequested);
        }
