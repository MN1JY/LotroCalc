...
{
    public class SmallWestfoldRepast : WestfoldIngredients
    {
        public static string DisplayName = "Small Westfold Repast";

        public SmallWestfoldRepast(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallWestfoldRepast(QuantityRequested);
        }
