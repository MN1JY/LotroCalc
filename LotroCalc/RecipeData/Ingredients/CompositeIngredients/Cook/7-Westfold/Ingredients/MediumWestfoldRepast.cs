...
{
    public class MediumWestfoldRepast : WestfoldIngredients
    {
        public static string DisplayName = "Medium Westfold Repast";

        public MediumWestfoldRepast(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MediumWestfoldRepast(QuantityRequested);
        }
