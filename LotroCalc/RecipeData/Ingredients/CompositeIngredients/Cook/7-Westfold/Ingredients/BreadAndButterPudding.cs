...
{
    public class BreadAndButterPudding : WestfoldIngredients
    {
        public static string DisplayName = "Bread And Butter Pudding";

        public BreadAndButterPudding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BreadAndButterPudding(QuantityRequested);
        }
