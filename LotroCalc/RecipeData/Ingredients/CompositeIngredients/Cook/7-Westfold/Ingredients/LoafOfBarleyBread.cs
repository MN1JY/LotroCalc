...
{
    public class LoafOfBarleyBread : WestfoldIngredients
    {
        public static string DisplayName = "Loaf Of Barley Bread";

        public LoafOfBarleyBread(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LoafOfBarleyBread(QuantityRequested);
        }
