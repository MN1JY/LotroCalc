...
{
    public class CockaLeekieSoup : WestfoldIngredients
    {
        public static string DisplayName = "Cock-a-Leekie Soup";

        public CockaLeekieSoup(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CockaLeekieSoup(QuantityRequested);
        }
