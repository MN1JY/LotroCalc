...
{
    public class OxtailStew : WestfoldIngredients
    {
        public static string DisplayName = "Oxtail Stew";

        public OxtailStew(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OxtailStew(QuantityRequested);
        }
