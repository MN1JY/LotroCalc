...
{
    public class PotatoScone : WestfoldIngredients
    {
        public static string DisplayName = "Potato Scone";

        public PotatoScone(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PotatoScone(QuantityRequested);
        }
