...
{
    public class BlackPudding : WestfoldIngredients
    {
        public static string DisplayName = "Black Pudding";

        public BlackPudding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BlackPudding(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = CupOfOatmeal.DisplayName;
            ...
            ingName = SupplierIngredients.CutofMutton;
            ing = (Ingredient)DictSimpleIngredients[ingName].Clone();
            ing.QuantityRequested = 1 * QuantityRequested;
            recipe.Add(ingName, ing);
