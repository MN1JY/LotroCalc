...
{
    public class SpicedBeefStew : WestfoldIngredients
    {
        public static string DisplayName = "Spiced Beef Stew";

        public SpicedBeefStew(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SpicedBeefStew(QuantityRequested);
        }
