...
{
    public class BaconwrappedFlapjack : WestfoldIngredients
    {
        public static string DisplayName = "Bacon-wrapped Flapjack";

        public BaconwrappedFlapjack(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BaconwrappedFlapjack(QuantityRequested);
        }
