...
{
    public class ToadInTheHole : WestfoldIngredients
    {
        public static string DisplayName = "Toad-In-The-Hole";

        public ToadInTheHole(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ToadInTheHole(QuantityRequested);
        }
