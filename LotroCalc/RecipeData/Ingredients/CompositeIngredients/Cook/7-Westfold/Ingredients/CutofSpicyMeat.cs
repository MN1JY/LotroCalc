...
{
    public class CutofSpicyMeat : WestfoldIngredients
    {
        public static string DisplayName = "Cut of Spicy Meat";

        public CutofSpicyMeat(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CutofSpicyMeat(QuantityRequested);
        }
