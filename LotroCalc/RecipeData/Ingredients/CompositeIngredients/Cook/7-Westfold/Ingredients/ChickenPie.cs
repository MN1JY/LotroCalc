...
{
    public class ChickenPie : WestfoldIngredients
    {
        public static string DisplayName = "Chicken Pie";

        public ChickenPie(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ChickenPie(QuantityRequested);
        }
