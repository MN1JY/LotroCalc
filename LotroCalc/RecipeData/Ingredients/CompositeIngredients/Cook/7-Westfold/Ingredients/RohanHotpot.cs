...
{
    public class RohanHotpot : WestfoldIngredients
    {
        public static string DisplayName = "Rohan Hotpot";

        public RohanHotpot(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RohanHotpot(QuantityRequested);
        }
