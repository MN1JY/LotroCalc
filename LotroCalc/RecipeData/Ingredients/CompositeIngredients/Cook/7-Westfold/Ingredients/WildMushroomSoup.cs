...
{
    public class WildMushroomSoup : WestfoldIngredients
    {
        public static string DisplayName = "Wild Mushroom Soup";

        public WildMushroomSoup(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WildMushroomSoup(QuantityRequested);
        }
