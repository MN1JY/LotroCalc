...
{
    public class BreadedOxtail : WestfoldIngredients
    {
        public static string DisplayName = "Breaded Oxtail";

        public BreadedOxtail(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BreadedOxtail(QuantityRequested);
        }
