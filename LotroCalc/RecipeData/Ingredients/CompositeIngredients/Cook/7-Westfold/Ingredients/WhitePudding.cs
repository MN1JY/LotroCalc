...
{
    public class WhitePudding : WestfoldIngredients
    {
        public static string DisplayName = "White Pudding";

        public WhitePudding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WhitePudding(QuantityRequested);
        }
