...
{
    public class StrawberryTart : ExpertIngredients
    {
        public static string DisplayName = "Strawberry Tart";

        public StrawberryTart(int count)
        {
            Name = DisplayName;
        ...
        {
            return new StrawberryTart(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = StrawberryPieFilling.DisplayName;
