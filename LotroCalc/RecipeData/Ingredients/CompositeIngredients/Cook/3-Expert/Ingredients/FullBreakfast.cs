...
{
    public class FullBreakfast : ExpertIngredients
    {
        public static string DisplayName = "Full Breakfast";

        public FullBreakfast(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FullBreakfast(QuantityRequested);
        }
