...
{
    public class VegetableMedley : ExpertIngredients
    {
        public static string DisplayName = "Vegetable Medley";

        public VegetableMedley(int count)
        {
            Name = DisplayName;
        ...
        {
            return new VegetableMedley(QuantityRequested);
        }
