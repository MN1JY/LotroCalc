...
{
    public class CarrotSticks : ApprenticeIngredients
    {
        public static string DisplayName = "Carrot Sticks";

        public CarrotSticks(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CarrotSticks(QuantityRequested);
        }
