...
{
    public class OnionSoup : ApprenticeIngredients
    {
        public static string DisplayName = "Onion Soup";

        public OnionSoup(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OnionSoup(QuantityRequested);
        }
