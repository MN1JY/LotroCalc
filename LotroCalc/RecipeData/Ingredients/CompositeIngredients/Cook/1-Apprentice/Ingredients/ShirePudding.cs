...
{
    public class ShirePudding : ApprenticeIngredients
    {
        public static string DisplayName = "Shire Pudding";

        public ShirePudding(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ShirePudding(QuantityRequested);
        }
