...
{
    public class FriedMushrooms : ApprenticeIngredients
    {
        public static string DisplayName = "Fried Mushrooms";

        public FriedMushrooms(int count)
        {
            Name = DisplayName;
        ...
        {
            return new FriedMushrooms(QuantityRequested);
        }
