...
{
    public class RoastPork : ApprenticeIngredients
    {
        public static string DisplayName = "Roast Pork";

        public RoastPork(int count)
        {
            Name = DisplayName;
        ...
        {
            return new RoastPork(QuantityRequested);
        }
