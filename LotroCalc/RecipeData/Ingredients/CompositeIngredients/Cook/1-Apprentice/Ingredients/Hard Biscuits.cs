...
{
    public class HardBiscuits : ApprenticeIngredients
    {
        public static string DisplayName = "Hard Biscuits";

        public HardBiscuits(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HardBiscuits(QuantityRequested);
        }
