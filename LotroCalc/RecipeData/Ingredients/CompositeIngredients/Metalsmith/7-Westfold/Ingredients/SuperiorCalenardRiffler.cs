...
{
    public class SuperiorCalenardRiffler : WestfoldIngredients
    {
        public static string DisplayName = "Superior Calenard Riffler";

        public SuperiorCalenardRiffler(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorCalenardRiffler(QuantityRequested);
        }
