...
{
    public class MediumWestfoldCrest : WestfoldIngredients
    {
        public static string DisplayName = "Medium Westfold Crest";

        public MediumWestfoldCrest(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MediumWestfoldCrest(QuantityRequested);
        }
