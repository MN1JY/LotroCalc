...
{
    public class SmallWestfoldCrest : WestfoldIngredients
    {
        public static string DisplayName = "Small Westfold Crest";

        public SmallWestfoldCrest(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallWestfoldCrest(QuantityRequested);
        }
