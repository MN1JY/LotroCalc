...
{
    public class CalenardWarGauntlets : WestfoldIngredients
    {
        public static string DisplayName = "Calenard War Gauntlets";

        public CalenardWarGauntlets(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CalenardWarGauntlets(QuantityRequested);
        }
