...
{
    public class DunlendingSkirmishShield : WestfoldIngredients
    {
        public static string DisplayName = "Dunlending Skirmish Shield";

        public DunlendingSkirmishShield(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DunlendingSkirmishShield(QuantityRequested);
        }
