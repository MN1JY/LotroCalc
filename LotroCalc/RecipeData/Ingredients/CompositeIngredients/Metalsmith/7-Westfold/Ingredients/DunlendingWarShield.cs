...
{
    public class DunlendingWarShield : WestfoldIngredients
    {
        public static string DisplayName = "Dunlending War Shield";

        public DunlendingWarShield(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DunlendingWarShield(QuantityRequested);
        }
