...
{
    public class DunlendingWarArmour : WestfoldIngredients
    {
        public static string DisplayName = "Dunlending War Armour";

        public DunlendingWarArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DunlendingWarArmour(QuantityRequested);
        }
