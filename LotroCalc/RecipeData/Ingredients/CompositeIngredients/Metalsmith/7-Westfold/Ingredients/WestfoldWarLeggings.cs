...
{
    public class WestfoldWarLeggings : WestfoldIngredients
    {
        public static string DisplayName = "Westfold War Leggings";

        public WestfoldWarLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WestfoldWarLeggings(QuantityRequested);
        }
