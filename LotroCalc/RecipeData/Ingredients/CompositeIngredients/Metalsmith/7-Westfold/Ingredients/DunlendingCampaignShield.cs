...
{
    public class DunlendingCampaignShield : WestfoldIngredients
    {
        public static string DisplayName = "Dunlending Campaign Shield";

        public DunlendingCampaignShield(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DunlendingCampaignShield(QuantityRequested);
        }
