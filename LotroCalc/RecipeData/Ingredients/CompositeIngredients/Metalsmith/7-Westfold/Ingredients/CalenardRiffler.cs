...
{
    public class CalenardRiffler : WestfoldIngredients
    {
        public static string DisplayName = "Calenard Riffler";

        public CalenardRiffler(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CalenardRiffler(QuantityRequested);
        }
