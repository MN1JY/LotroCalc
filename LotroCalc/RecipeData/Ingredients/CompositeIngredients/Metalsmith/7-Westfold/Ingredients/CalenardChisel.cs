...
{
    public class CalenardChisel : WestfoldIngredients
    {
        public static string DisplayName = "Calenard Chisel";

        public CalenardChisel(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CalenardChisel(QuantityRequested);
        }
