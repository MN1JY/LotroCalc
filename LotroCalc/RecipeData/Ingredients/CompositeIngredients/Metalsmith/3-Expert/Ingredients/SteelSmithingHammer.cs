...
{
    public class SteelSmithingHammer : ExpertIngredients
    {
        public static string DisplayName = "Steel Smithing Hammer";

        public SteelSmithingHammer(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SteelSmithingHammer(QuantityRequested);
        }
