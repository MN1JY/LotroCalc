...
{
    public class HeavySteelBoots : ExpertIngredients
    {
        public static string DisplayName = "Heavy Steel Boots";

        public HeavySteelBoots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavySteelBoots(QuantityRequested);
        }
