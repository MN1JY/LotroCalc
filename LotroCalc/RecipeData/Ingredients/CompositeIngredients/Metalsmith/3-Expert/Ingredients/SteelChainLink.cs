...
{
    public class SteelChainLink : ExpertIngredients
    {
        public static string DisplayName = "Steel Chain Link";

        public SteelChainLink(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SteelChainLink(QuantityRequested);
        }
