...
{
    public class HeavySteelHelm : ExpertIngredients
    {
        public static string DisplayName = "Heavy Steel Helm";

        public HeavySteelHelm(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavySteelHelm(QuantityRequested);
        }
