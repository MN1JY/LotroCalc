...
{
    public class ImprovedSteelRivets : ExpertIngredients
    {
        public static string DisplayName = "Improved Steel Rivets (Guild)";

        public ImprovedSteelRivets(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedSteelRivets(QuantityRequested);
        }
