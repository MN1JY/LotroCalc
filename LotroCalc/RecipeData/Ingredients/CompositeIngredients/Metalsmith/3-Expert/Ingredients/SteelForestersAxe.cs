...
{
    public class SteelForestersAxe : ExpertIngredients
    {
        public static string DisplayName = "Steel Forester's Axe";

        public SteelForestersAxe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SteelForestersAxe(QuantityRequested);
        }
