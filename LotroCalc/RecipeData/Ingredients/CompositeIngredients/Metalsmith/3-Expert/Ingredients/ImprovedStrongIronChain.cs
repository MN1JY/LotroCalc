...
{
    public class ImprovedStrongIronChain : ExpertIngredients
    {
        public static string DisplayName = "Improved Strong Iron Chain (Guild)";

        public ImprovedStrongIronChain(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedStrongIronChain(QuantityRequested);
        }
