...
{
    public class SteelJewellersTools : ExpertIngredients
    {
        public static string DisplayName = "Steel Jeweller's Tools";

        public SteelJewellersTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SteelJewellersTools(QuantityRequested);
        }
