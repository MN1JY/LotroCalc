...
{
    public class StudentsChisel : ExpertIngredients
    {
        public static string DisplayName = "Student's Chisel";

        public StudentsChisel(int count)
        {
            Name = DisplayName;
        ...
        {
            return new StudentsChisel(QuantityRequested);
        }
