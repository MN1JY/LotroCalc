...
{
    public class ImprovedFinelyPolishedScale : ExpertIngredients
    {
        public static string DisplayName = "Improved Finely Polished Scale (Guild)";

        public ImprovedFinelyPolishedScale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedFinelyPolishedScale(QuantityRequested);
        }
