...
{
    public class SteelProspectorsTools : ExpertIngredients
    {
        public static string DisplayName = "Steel Prospector's Tools";

        public SteelProspectorsTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SteelProspectorsTools(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.ShortYewShaft;
