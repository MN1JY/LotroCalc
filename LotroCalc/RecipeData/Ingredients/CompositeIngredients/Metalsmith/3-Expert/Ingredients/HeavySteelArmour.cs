...
{
    public class HeavySteelArmour : ExpertIngredients
    {
        public static string DisplayName = "Heavy Steel Armour";

        public HeavySteelArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavySteelArmour(QuantityRequested);
        }
