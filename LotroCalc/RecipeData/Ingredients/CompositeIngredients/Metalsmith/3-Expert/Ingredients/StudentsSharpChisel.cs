...
{
    public class StudentsSharpChisel : ExpertIngredients
    {
        public static string DisplayName = "Student's Sharp Chisel";

        public StudentsSharpChisel(int count)
        {
            Name = DisplayName;
        ...
        {
            return new StudentsSharpChisel(QuantityRequested);
        }
