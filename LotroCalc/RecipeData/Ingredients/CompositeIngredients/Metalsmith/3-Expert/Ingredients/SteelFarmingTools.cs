...
{
    public class SteelFarmingTools : ExpertIngredients
    {
        public static string DisplayName = "Steel Farming Tools";

        public SteelFarmingTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SteelFarmingTools(QuantityRequested);
        }
