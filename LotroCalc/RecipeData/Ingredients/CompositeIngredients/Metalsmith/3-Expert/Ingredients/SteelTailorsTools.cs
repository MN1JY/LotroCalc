...
{
    public class SteelTailorsTools : ExpertIngredients
    {
        public static string DisplayName = "Steel Tailor's Tools";

        public SteelTailorsTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SteelTailorsTools(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.SpoolOfHighGradeSteelWire;
