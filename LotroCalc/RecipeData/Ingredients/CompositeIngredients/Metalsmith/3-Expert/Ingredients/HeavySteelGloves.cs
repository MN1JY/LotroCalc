...
{
    public class HeavySteelGloves : ExpertIngredients
    {
        public static string DisplayName = "Heavy Steel Gloves";

        public HeavySteelGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavySteelGloves(QuantityRequested);
        }
