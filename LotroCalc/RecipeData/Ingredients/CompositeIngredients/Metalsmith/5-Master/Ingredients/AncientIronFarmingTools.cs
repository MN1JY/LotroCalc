...
{
    public class AncientIronFarmingTools : MasterIngredients
    {
        public static string DisplayName = "Ancient Iron Farming Tools";

        public AncientIronFarmingTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientIronFarmingTools(QuantityRequested);
        }
