...
{
    public class AncientSteelFarmingTools : MasterIngredients
    {
        public static string DisplayName = "Ancient Steel Farming Tools";

        public AncientSteelFarmingTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientSteelFarmingTools(QuantityRequested);
        }
