...
{
    public class PolishedKnightsLeggings : MasterIngredients
    {
        public static string DisplayName = "Polished Knight's Leggings";

        public PolishedKnightsLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PolishedKnightsLeggings(QuantityRequested);
        }
