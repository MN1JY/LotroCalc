...
{
    public class ElvenKnightsLightShield : MasterIngredients
    {
        public static string DisplayName = "Elven Knight's Light Shield";

        public ElvenKnightsLightShield(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenKnightsLightShield(QuantityRequested);
        }
