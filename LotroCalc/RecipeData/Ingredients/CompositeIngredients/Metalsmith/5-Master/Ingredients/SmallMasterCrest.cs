...
{
    public class SmallMasterCrest : MasterIngredients
    {
        public static string DisplayName = "Small Master Crest (Guild)";

        public SmallMasterCrest(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallMasterCrest(QuantityRequested);
        }
