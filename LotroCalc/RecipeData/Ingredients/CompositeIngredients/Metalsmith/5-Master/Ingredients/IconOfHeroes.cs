...
{
    public class IconofHeroes : MasterIngredients
    {
        public static string DisplayName = "Icon of Heroes";

        public IconofHeroes(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IconofHeroes(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = AncientNickelIngot.DisplayName;
            ing = (Ingredient)DictCraftedIngredients[ingName].Clone();
