...
{
    public class AncientIronCookingSupplies : MasterIngredients
    {
        public static string DisplayName = "Ancient Iron Cooking Supplies";

        public AncientIronCookingSupplies(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientIronCookingSupplies(QuantityRequested);
        }
