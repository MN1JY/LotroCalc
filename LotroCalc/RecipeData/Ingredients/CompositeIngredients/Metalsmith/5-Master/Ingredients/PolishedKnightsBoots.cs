...
{
    public class PolishedKnightsBoots : MasterIngredients
    {
        public static string DisplayName = "Polished Knight's Boots";

        public PolishedKnightsBoots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PolishedKnightsBoots(QuantityRequested);
        }
