...
{
    public class MastersSharpChisel : MasterIngredients
    {
        public static string DisplayName = "Master's Sharp Chisel";

        public MastersSharpChisel(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MastersSharpChisel(QuantityRequested);
        }
