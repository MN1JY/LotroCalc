...
{
    public class AncientSteelWoodworkingTools : MasterIngredients
    {
        public static string DisplayName = "Ancient Steel Woodworking Tools";

        public AncientSteelWoodworkingTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientSteelWoodworkingTools(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.AncientSteelBladeMould;
            ing = (Ingredient)DictSimpleIngredients[ingName].Clone();
            ing.QuantityRequested = 1 * QuantityRequested;
            recipe.Add(ingName, ing);
