...
{
    public class ElvenKnightsBoots : MasterIngredients
    {
        public static string DisplayName = "Elven Knight's Boots";

        public ElvenKnightsBoots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenKnightsBoots(QuantityRequested);
        }
