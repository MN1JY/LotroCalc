...
{
    public class AncientIronWoodworkingTools : MasterIngredients
    {
        public static string DisplayName = "Ancient Iron Woodworking Tools";

        public AncientIronWoodworkingTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientIronWoodworkingTools(QuantityRequested);
        }
