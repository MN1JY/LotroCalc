...
{
    public class AncientSteelSmithingHammer : MasterIngredients
    {
        public static string DisplayName = "Ancient Steel Smithing Hammer";

        public AncientSteelSmithingHammer(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientSteelSmithingHammer(QuantityRequested);
        }
