...
{
    public class AncientSteelScale : MasterIngredients
    {
        public static string DisplayName = "Ancient Steel Scale";

        public AncientSteelScale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientSteelScale(QuantityRequested);
        }
