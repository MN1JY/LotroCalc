...
{
    public class ElvenKnightsGloves : MasterIngredients
    {
        public static string DisplayName = "Elven Knight's Gloves";

        public ElvenKnightsGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenKnightsGloves(QuantityRequested);
        }
