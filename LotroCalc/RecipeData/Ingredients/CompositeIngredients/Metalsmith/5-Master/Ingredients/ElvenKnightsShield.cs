...
{
    public class ElvenKnightsShield : MasterIngredients
    {
        public static string DisplayName = "Elven Knight's Shield";

        public ElvenKnightsShield(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenKnightsShield(QuantityRequested);
        }
