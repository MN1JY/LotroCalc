...
{
    public class AncientIronTailorsTools : MasterIngredients
    {
        public static string DisplayName = "Ancient Iron Tailor's Tools";

        public AncientIronTailorsTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientIronTailorsTools(QuantityRequested);
        }
