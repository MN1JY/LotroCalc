...
{
    public class PolishedKnightsGloves : MasterIngredients
    {
        public static string DisplayName = "Polished Knight's Gloves";

        public PolishedKnightsGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PolishedKnightsGloves(QuantityRequested);
        }
