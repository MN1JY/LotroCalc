...
{
    public class KnightsLeggings : MasterIngredients
    {
        public static string DisplayName = "Knight's Leggings";

        public KnightsLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new KnightsLeggings(QuantityRequested);
        }
