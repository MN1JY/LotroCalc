...
{
    public class AncientIronForestersAxe : MasterIngredients
    {
        public static string DisplayName = "Ancient Iron Forester's Axe";

        public AncientIronForestersAxe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientIronForestersAxe(QuantityRequested);
        }
