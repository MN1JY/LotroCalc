...
{
    public class CrestOfValour : MasterIngredients
    {
        public static string DisplayName = "Crest Of Valour";

        public CrestOfValour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CrestOfValour(QuantityRequested);
        }
