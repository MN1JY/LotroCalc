...
{
    public class ElvenKnightsHeavyShield : MasterIngredients
    {
        public static string DisplayName = "Elven Knight's Heavy Shield";

        public ElvenKnightsHeavyShield(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenKnightsHeavyShield(QuantityRequested);
        }
