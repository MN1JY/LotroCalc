...
{
    public class ElvenKnightsHelm : MasterIngredients
    {
        public static string DisplayName = "Elven Knight's Helm";

        public ElvenKnightsHelm(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenKnightsHelm(QuantityRequested);
        }
