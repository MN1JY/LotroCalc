...
{
    public class AncientIronJewellersTools : MasterIngredients
    {
        public static string DisplayName = "Ancient Iron Jeweller's Tools";

        public AncientIronJewellersTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientIronJewellersTools(QuantityRequested);
        }
