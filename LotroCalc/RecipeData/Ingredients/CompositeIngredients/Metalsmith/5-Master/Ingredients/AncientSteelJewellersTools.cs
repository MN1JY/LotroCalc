...
{
    public class AncientSteelJewellersTools : MasterIngredients
    {
        public static string DisplayName = "Ancient Steel Jeweller's Tools";

        public AncientSteelJewellersTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientSteelJewellersTools(QuantityRequested);
        }
