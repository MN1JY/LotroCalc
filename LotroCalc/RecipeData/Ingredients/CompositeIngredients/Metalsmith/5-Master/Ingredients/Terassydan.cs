...
{
    public class Terassydan : MasterIngredients
    {
        public static string DisplayName = "Teras-sydan";

        public Terassydan(int count)
        {
            Name = DisplayName;
        ...
        {
            return new Terassydan(QuantityRequested);
        }
