...
{
    public class KnightsArmour : MasterIngredients
    {
        public static string DisplayName = "Knight's Armour";

        public KnightsArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new KnightsArmour(QuantityRequested);
        }
