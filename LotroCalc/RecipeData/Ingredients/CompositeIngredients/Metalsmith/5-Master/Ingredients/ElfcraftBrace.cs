...
{
    public class ElfcraftBrace : MasterIngredients
    {
        public static string DisplayName = "Elf-craft Brace";

        public ElfcraftBrace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElfcraftBrace(QuantityRequested);
        }
