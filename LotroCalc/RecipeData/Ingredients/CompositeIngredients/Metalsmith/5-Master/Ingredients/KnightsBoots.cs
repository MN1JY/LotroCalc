...
{
    public class KnightsBoots : MasterIngredients
    {
        public static string DisplayName = "Knight's Boots";

        public KnightsBoots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new KnightsBoots(QuantityRequested);
        }
