...
{
    public class ImprovedAncientSteelChain : MasterIngredients
    {
        public static string DisplayName = "Improved Ancient Steel Chain (Guild)";

        public ImprovedAncientSteelChain(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedAncientSteelChain(QuantityRequested);
        }
