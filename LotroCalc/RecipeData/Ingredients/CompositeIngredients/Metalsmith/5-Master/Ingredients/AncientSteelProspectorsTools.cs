...
{
    public class AncientSteelProspectorsTools : MasterIngredients
    {
        public static string DisplayName = "Ancient Steel Prospector's Tools";

        public AncientSteelProspectorsTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientSteelProspectorsTools(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.ShortBlackAshShaft;
            ing = (Ingredient)DictSimpleIngredients[ingName].Clone();
            ing.QuantityRequested = 1 * QuantityRequested;
            recipe.Add(ingName, ing);
