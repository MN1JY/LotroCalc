...
{
    public class AncientSteelCookingSupplies : MasterIngredients
    {
        public static string DisplayName = "Ancient Steel Cooking Supplies";

        public AncientSteelCookingSupplies(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientSteelCookingSupplies(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.AncientSteelCutleryMould;
            ing = (Ingredient)DictSimpleIngredients[ingName].Clone();
            ing.QuantityRequested = 1 * QuantityRequested;
            recipe.Add(ingName, ing);
