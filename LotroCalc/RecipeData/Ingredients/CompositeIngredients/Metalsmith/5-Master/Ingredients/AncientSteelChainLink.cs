...
{
    public class AncientSteelChainLink : MasterIngredients
    {
        public static string DisplayName = "Ancient Steel Chain Link";

        public AncientSteelChainLink(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientSteelChainLink(QuantityRequested);
        }
