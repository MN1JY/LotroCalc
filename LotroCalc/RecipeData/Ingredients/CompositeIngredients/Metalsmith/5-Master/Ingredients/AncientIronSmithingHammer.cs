...
{
    public class AncientIronSmithingHammer : MasterIngredients
    {
        public static string DisplayName = "Ancient Iron Smithing Hammer";

        public AncientIronSmithingHammer(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientIronSmithingHammer(QuantityRequested);
        }
