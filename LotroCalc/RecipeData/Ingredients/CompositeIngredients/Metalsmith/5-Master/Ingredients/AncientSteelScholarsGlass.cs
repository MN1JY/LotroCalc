...
{
    public class AncientSteelScholarsGlass : MasterIngredients
    {
        public static string DisplayName = "Ancient Steel Scholar's Glass";

        public AncientSteelScholarsGlass(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientSteelScholarsGlass(QuantityRequested);
        }
