...
{
    public class PolishedKnightsArmour : MasterIngredients
    {
        public static string DisplayName = "Polished Knight's Armour";

        public PolishedKnightsArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PolishedKnightsArmour(QuantityRequested);
        }
