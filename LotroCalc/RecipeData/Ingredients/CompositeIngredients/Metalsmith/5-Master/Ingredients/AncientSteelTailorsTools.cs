...
{
    public class AncientSteelTailorsTools : MasterIngredients
    {
        public static string DisplayName = "Ancient Steel Tailor's Tools";

        public AncientSteelTailorsTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientSteelTailorsTools(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.SpoolOfAncientSteelWire;
            ing = (Ingredient)DictSimpleIngredients[ingName].Clone();
            ing.QuantityRequested = 1 * QuantityRequested;
            recipe.Add(ingName, ing);
