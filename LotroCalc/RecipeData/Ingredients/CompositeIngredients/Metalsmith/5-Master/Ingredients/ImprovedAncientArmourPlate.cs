...
{
    public class ImprovedAncientArmourPlate : MasterIngredients
    {
        public static string DisplayName = "Improved Ancient Armour Plate (Guild)";

        public ImprovedAncientArmourPlate(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedAncientArmourPlate(QuantityRequested);
        }
