...
{
    public class MastersChisel : MasterIngredients
    {
        public static string DisplayName = "Master's Chisel";

        public MastersChisel(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MastersChisel(QuantityRequested);
        }
