...
{
    public class SuperiorElvenKnightsLightShield : MasterIngredients
    {
        public static string DisplayName = "Superior Elven Knight's Light Shield (Guild)";

        public SuperiorElvenKnightsLightShield(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperiorElvenKnightsLightShield(QuantityRequested);
        }
