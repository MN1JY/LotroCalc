...
{
    public class AncientIronProspectorsTools : MasterIngredients
    {
        public static string DisplayName = "Ancient Iron Prospector's Tools";

        public AncientIronProspectorsTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new AncientIronProspectorsTools(QuantityRequested);
        }
