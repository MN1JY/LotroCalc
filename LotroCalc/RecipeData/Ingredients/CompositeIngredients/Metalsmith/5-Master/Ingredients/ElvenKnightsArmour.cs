...
{
    public class ElvenKnightsArmour : MasterIngredients
    {
        public static string DisplayName = "Elven Knight's Armour";

        public ElvenKnightsArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ElvenKnightsArmour(QuantityRequested);
        }
