...
{
    public class SmallWestemnetCrest : WestemnetIngredients
    {
        public static string DisplayName = "Small Westemnet Crest";

        public SmallWestemnetCrest(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallWestemnetCrest(QuantityRequested);
        }
