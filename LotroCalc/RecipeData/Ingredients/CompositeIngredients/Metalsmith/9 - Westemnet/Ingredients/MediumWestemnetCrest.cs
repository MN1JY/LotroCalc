...
{
    public class MediumWestemnetCrest : WestemnetIngredients
    {
        public static string DisplayName = "Medium Westemnet Crest";

        public MediumWestemnetCrest(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MediumWestemnetCrest(QuantityRequested);
        }
