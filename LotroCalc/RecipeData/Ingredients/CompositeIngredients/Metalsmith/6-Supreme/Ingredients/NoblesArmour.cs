...
{
    public class NoblesArmour : SupremeIngredients
    {
        public static string DisplayName = "Noble's Armour";

        public NoblesArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new NoblesArmour(QuantityRequested);
        }
