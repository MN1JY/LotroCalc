...
{
    public class NoblesHelm : SupremeIngredients
    {
        public static string DisplayName = "Noble's Helm";

        public NoblesHelm(int count)
        {
            Name = DisplayName;
        ...
        {
            return new NoblesHelm(QuantityRequested);
        }
