...
{
    public class OfficersArmour : SupremeIngredients
    {
        public static string DisplayName = "Officer's Armour";

        public OfficersArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OfficersArmour(QuantityRequested);
        }
