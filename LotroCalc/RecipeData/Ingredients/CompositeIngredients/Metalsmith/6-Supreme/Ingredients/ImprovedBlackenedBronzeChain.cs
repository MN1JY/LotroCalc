...
{
    public class ImprovedBlackenedBronzeChain : SupremeIngredients
    {
        public static string DisplayName = "Improved Blackened Bronze Chain (Guild)";

        public ImprovedBlackenedBronzeChain(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedBlackenedBronzeChain(QuantityRequested);
        }
