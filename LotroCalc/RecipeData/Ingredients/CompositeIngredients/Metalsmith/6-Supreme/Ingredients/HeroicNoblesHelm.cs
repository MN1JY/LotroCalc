...
{
    public class HeroicNoblesHelm : SupremeIngredients
    {
        public static string DisplayName = "Heroic Noble's Helm (Guild)";

        public HeroicNoblesHelm(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeroicNoblesHelm(QuantityRequested);
        }
