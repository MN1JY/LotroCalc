...
{
    public class MediumSupremeCrest : SupremeIngredients
    {
        public static string DisplayName = "Medium Supreme Crest (Guild)";

        public MediumSupremeCrest(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MediumSupremeCrest(QuantityRequested);
        }
