...
{
    public class NoblesLightShield : SupremeIngredients
    {
        public static string DisplayName = "Noble's Light Shield";

        public NoblesLightShield(int count)
        {
            Name = DisplayName;
        ...
        {
            return new NoblesLightShield(QuantityRequested);
        }
