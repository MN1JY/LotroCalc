...
{
    public class SuperbLothlorienLightShield : SupremeIngredients
    {
        public static string DisplayName = "Superb Lothlorien Light Shield (Guild)";

        public SuperbLothlorienLightShield(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbLothlorienLightShield(QuantityRequested);
        }
