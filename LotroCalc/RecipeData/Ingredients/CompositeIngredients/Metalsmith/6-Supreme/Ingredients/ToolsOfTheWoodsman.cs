...
{
    public class ToolsOfTheWoodsman : SupremeIngredients
    {
        public static string DisplayName = "Tools Of The Woodsman";

        public ToolsOfTheWoodsman(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ToolsOfTheWoodsman(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.ShortMallornShaft;
            ...
            ingName = SupplierIngredients.BlackenedSteelCutleryMould;
            ing = (Ingredient)DictSimpleIngredients[ingName].Clone();
            ing.QuantityRequested = 1 * QuantityRequested;
            recipe.Add(ingName, ing);

            ingName = SupplierIngredients.LongMallornShaft;
            ing = (Ingredient)DictSimpleIngredients[ingName].Clone();
            ing.QuantityRequested = 1 * QuantityRequested;
            recipe.Add(ingName, ing);
