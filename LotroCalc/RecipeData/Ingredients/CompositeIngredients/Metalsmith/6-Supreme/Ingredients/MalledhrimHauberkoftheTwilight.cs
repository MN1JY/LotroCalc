...
{
    public class MalledhrimHauberkoftheTwilight : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Hauberk of the Twilight";

        public MalledhrimHauberkoftheTwilight(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimHauberkoftheTwilight(QuantityRequested);
        }
