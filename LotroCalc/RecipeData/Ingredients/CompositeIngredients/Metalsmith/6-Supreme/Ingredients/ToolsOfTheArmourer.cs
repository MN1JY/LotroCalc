...
{
    public class ToolsOfTheArmourer : SupremeIngredients
    {
        public static string DisplayName = "Tools Of The Armourer";

        public ToolsOfTheArmourer(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ToolsOfTheArmourer(QuantityRequested);
        }
