...
{
    public class HeroicNoblesGloves : SupremeIngredients
    {
        public static string DisplayName = "Heroic Noble's Gloves (Guild)";

        public HeroicNoblesGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeroicNoblesGloves(QuantityRequested);
        }
