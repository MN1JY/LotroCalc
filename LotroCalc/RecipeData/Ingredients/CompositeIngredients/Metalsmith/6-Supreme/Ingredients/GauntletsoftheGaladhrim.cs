...
{
    public class GauntletsoftheGaladhrim : SupremeIngredients
    {
        public static string DisplayName = "Gauntlets of the Galadhrim";

        public GauntletsoftheGaladhrim(int count)
        {
            Name = DisplayName;
        ...
        {
            return new GauntletsoftheGaladhrim(QuantityRequested);
        }
