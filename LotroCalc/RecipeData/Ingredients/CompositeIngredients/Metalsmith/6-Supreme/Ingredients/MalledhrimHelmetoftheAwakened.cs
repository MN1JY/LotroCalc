...
{
    public class MalledhrimHelmetoftheAwakened : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Helmet of the Awakened";

        public MalledhrimHelmetoftheAwakened(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimHelmetoftheAwakened(QuantityRequested);
        }
