...
{
    public class MalledhrimPauldronsofRejuvenation : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Pauldrons of Rejuvenation";

        public MalledhrimPauldronsofRejuvenation(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimPauldronsofRejuvenation(QuantityRequested);
        }
