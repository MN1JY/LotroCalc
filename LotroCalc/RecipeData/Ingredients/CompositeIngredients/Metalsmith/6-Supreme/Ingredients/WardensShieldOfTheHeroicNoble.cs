...
{
    public class WardensShieldOfTheHeroicNoble : SupremeIngredients
    {
        public static string DisplayName = "Warden's Shield Of The Heroic Noble";

        public WardensShieldOfTheHeroicNoble(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WardensShieldOfTheHeroicNoble(QuantityRequested);
        }
