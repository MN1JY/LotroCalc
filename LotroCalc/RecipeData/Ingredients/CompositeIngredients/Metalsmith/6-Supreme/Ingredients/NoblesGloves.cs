...
{
    public class NoblesGloves : SupremeIngredients
    {
        public static string DisplayName = "Noble's Gloves";

        public NoblesGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new NoblesGloves(QuantityRequested);
        }
