...
{
    public class LightShieldoftheGoldenHost : SupremeIngredients
    {
        public static string DisplayName = "Light Shield of the Golden Host";

        public LightShieldoftheGoldenHost(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LightShieldoftheGoldenHost(QuantityRequested);
        }
