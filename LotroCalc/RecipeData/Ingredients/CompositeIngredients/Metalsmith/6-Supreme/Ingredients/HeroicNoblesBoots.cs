...
{
    public class HeroicNoblesBoots : SupremeIngredients
    {
        public static string DisplayName = "Heroic Noble's Boots (Guild)";

        public HeroicNoblesBoots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeroicNoblesBoots(QuantityRequested);
        }
