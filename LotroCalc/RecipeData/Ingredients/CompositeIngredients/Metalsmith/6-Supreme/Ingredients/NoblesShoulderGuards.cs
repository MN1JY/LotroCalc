...
{
    public class NoblesShoulderGuards : SupremeIngredients
    {
        public static string DisplayName = "Noble's Shoulder Guards";

        public NoblesShoulderGuards(int count)
        {
            Name = DisplayName;
        ...
        {
            return new NoblesShoulderGuards(QuantityRequested);
        }
