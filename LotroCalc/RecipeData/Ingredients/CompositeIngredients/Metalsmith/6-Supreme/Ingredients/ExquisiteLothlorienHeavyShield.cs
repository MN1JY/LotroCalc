...
{
    public class ExquisiteLothlorienHeavyShield : SupremeIngredients
    {
        public static string DisplayName = "Exquisite Lothlorien Heavy Shield";

        public ExquisiteLothlorienHeavyShield(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ExquisiteLothlorienHeavyShield(QuantityRequested);
        }
