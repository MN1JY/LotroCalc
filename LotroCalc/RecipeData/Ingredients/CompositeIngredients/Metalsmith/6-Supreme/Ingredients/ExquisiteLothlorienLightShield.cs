...
{
    public class ExquisiteLothlorienLightShield : SupremeIngredients
    {
        public static string DisplayName = "Exquisite Lothlorien Light Shield";

        public ExquisiteLothlorienLightShield(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ExquisiteLothlorienLightShield(QuantityRequested);
        }
