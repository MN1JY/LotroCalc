...
{
    public class SmallSupremeCrest : SupremeIngredients
    {
        public static string DisplayName = "Small Supreme Crest (Guild)";

        public SmallSupremeCrest(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SmallSupremeCrest(QuantityRequested);
        }
