...
{
    public class MalledhrimBootsofRejuvenation : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Boots of Rejuvenation";

        public MalledhrimBootsofRejuvenation(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimBootsofRejuvenation(QuantityRequested);
        }
