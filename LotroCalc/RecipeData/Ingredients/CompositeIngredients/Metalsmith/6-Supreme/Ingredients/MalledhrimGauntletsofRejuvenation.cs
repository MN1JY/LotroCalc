...
{
    public class MalledhrimGauntletsofRejuvenation : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Gauntlets of Rejuvenation";

        public MalledhrimGauntletsofRejuvenation(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimGauntletsofRejuvenation(QuantityRequested);
        }
