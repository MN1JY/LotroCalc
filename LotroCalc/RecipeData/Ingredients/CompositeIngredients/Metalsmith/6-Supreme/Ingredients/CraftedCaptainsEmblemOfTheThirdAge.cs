...
{
    public class CraftedCaptainsEmblemOfTheThirdAge : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Emblem Of The Third Age (Level 60)";

        public CraftedCaptainsEmblemOfTheThirdAge(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsEmblemOfTheThirdAge(QuantityRequested);
        }
