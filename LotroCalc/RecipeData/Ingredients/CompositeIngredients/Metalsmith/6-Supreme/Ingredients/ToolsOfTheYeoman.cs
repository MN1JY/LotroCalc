...
{
    public class ToolsOfTheYeoman : SupremeIngredients
    {
        public static string DisplayName = "Tools Of The Yeoman";

        public ToolsOfTheYeoman(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ToolsOfTheYeoman(QuantityRequested);
        }
