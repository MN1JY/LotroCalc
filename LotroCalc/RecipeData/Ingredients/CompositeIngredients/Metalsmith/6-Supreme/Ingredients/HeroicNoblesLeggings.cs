...
{
    public class HeroicNoblesLeggings : SupremeIngredients
    {
        public static string DisplayName = "Heroic Noble's Leggings (Guild)";

        public HeroicNoblesLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeroicNoblesLeggings(QuantityRequested);
        }
