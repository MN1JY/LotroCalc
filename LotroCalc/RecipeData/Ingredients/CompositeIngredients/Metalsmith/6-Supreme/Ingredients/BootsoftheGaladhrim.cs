...
{
    public class BootsoftheGaladhrim : SupremeIngredients
    {
        public static string DisplayName = "Boots of the Galadhrim";

        public BootsoftheGaladhrim(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BootsoftheGaladhrim(QuantityRequested);
        }
