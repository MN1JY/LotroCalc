...
{
    public class OfficersGloves : SupremeIngredients
    {
        public static string DisplayName = "Officer's Gloves";

        public OfficersGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OfficersGloves(QuantityRequested);
        }
