...
{
    public class OfficersLeggings : SupremeIngredients
    {
        public static string DisplayName = "Officer's Leggings";

        public OfficersLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OfficersLeggings(QuantityRequested);
        }
