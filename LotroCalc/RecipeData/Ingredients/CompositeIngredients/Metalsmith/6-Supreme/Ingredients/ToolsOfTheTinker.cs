...
{
    public class ToolsOfTheTinker : SupremeIngredients
    {
        public static string DisplayName = "Tools Of The Tinker";

        public ToolsOfTheTinker(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ToolsOfTheTinker(QuantityRequested);
        }
