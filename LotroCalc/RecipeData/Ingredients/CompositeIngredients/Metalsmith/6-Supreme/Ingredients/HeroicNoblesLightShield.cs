...
{
    public class HeroicNoblesLightShield : SupremeIngredients
    {
        public static string DisplayName = "Heroic Noble's Light Shield (Guild)";

        public HeroicNoblesLightShield(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeroicNoblesLightShield(QuantityRequested);
        }
