...
{
    public class BlackenedIronPlate : SupremeIngredients
    {
        public static string DisplayName = "Blackened Iron Plate";

        public BlackenedIronPlate(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BlackenedIronPlate(QuantityRequested);
        }
