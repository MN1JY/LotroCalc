...
{
    public class MalledhrimHelmetoftheTwilight : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Helmet of the Twilight";

        public MalledhrimHelmetoftheTwilight(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimHelmetoftheTwilight(QuantityRequested);
        }
