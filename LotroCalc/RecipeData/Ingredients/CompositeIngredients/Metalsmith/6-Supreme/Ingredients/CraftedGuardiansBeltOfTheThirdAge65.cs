...
{
    public class CraftedGuardiansBeltOfTheThirdAge65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Belt Of The Third Age (Level 65)";

        public CraftedGuardiansBeltOfTheThirdAge65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansBeltOfTheThirdAge65(QuantityRequested);
        }
