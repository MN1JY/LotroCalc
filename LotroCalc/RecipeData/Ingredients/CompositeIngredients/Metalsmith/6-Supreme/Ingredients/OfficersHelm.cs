...
{
    public class OfficersHelm : SupremeIngredients
    {
        public static string DisplayName = "Officer's Helm";

        public OfficersHelm(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OfficersHelm(QuantityRequested);
        }
