...
{
    public class SavantsChisel : SupremeIngredients
    {
        public static string DisplayName = "Savant's Chisel";

        public SavantsChisel(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SavantsChisel(QuantityRequested);
        }
