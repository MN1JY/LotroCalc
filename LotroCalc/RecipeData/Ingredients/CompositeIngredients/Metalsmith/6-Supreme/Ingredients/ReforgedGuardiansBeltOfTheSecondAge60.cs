...
{
    public class ReforgedGuardiansBeltOfTheSecondAge60 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Belt Of The Second Age (Level 60)";

        public ReforgedGuardiansBeltOfTheSecondAge60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansBeltOfTheSecondAge60(QuantityRequested);
        }
