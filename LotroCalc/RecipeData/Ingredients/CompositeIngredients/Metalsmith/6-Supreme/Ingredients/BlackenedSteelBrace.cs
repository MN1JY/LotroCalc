...
{
    public class BlackenedSteelBrace : SupremeIngredients
    {
        public static string DisplayName = "Blackened Steel Brace";

        public BlackenedSteelBrace(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BlackenedSteelBrace(QuantityRequested);
        }
