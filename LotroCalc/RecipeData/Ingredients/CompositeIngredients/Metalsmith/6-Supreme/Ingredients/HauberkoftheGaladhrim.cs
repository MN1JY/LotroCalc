...
{
    public class HauberkoftheGaladhrim : SupremeIngredients
    {
        public static string DisplayName = "Hauberk of the Galadhrim";

        public HauberkoftheGaladhrim(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HauberkoftheGaladhrim(QuantityRequested);
        }
