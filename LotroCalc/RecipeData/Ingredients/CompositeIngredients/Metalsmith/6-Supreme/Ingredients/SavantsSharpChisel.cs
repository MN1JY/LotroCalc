...
{
    public class SavantsSharpChisel : SupremeIngredients
    {
        public static string DisplayName = "Savant's Sharp Chisel";

        public SavantsSharpChisel(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SavantsSharpChisel(QuantityRequested);
        }
