...
{
    public class ToolsOfTheArmsman : SupremeIngredients
    {
        public static string DisplayName = "Tools Of The Armsman";

        public ToolsOfTheArmsman(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ToolsOfTheArmsman(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.BlackenedSteelBladeMould;
            ing = (Ingredient)DictSimpleIngredients[ingName].Clone();
