...
{
    public class MalledhrimBootsoftheTwilight : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Boots of the Twilight";

        public MalledhrimBootsoftheTwilight(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimBootsoftheTwilight(QuantityRequested);
        }
