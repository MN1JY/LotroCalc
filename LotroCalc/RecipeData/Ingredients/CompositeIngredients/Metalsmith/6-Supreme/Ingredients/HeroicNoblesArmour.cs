...
{
    public class HeroicNoblesArmour : SupremeIngredients
    {
        public static string DisplayName = "Heroic Noble's Armour (Guild)";

        public HeroicNoblesArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeroicNoblesArmour(QuantityRequested);
        }
