...
{
    public class MalledhrimHauberkoftheAwakened : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Hauberk of the Awakened";

        public MalledhrimHauberkoftheAwakened(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimHauberkoftheAwakened(QuantityRequested);
        }
