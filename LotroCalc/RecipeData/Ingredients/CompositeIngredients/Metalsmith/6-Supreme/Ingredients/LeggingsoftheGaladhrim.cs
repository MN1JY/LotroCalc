...
{
    public class LeggingsoftheGaladhrim : SupremeIngredients
    {
        public static string DisplayName = "Leggings of the Galadhrim";

        public LeggingsoftheGaladhrim(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LeggingsoftheGaladhrim(QuantityRequested);
        }
