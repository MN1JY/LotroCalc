...
{
    public class WardensShieldoftheNoble : SupremeIngredients
    {
        public static string DisplayName = "Warden's Shield of the Noble";

        public WardensShieldoftheNoble(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WardensShieldoftheNoble(QuantityRequested);
        }
