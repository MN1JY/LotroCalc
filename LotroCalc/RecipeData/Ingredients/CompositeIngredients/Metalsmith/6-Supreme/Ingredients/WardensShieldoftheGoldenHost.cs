...
{
    public class WardensShieldoftheGoldenHost : SupremeIngredients
    {
        public static string DisplayName = "Warden's Shield of the Golden Host";

        public WardensShieldoftheGoldenHost(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WardensShieldoftheGoldenHost(QuantityRequested);
        }
