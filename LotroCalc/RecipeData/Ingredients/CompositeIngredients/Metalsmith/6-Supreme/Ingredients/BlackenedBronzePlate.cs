...
{
    public class BlackenedBronzePlate : SupremeIngredients
    {
        public static string DisplayName = "Blackened Bronze Plate";

        public BlackenedBronzePlate(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BlackenedBronzePlate(QuantityRequested);
        }
