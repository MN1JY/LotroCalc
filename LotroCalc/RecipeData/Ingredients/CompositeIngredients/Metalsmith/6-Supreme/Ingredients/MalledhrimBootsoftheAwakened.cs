...
{
    public class MalledhrimBootsoftheAwakened : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Boots of the Awakened";

        public MalledhrimBootsoftheAwakened(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimBootsoftheAwakened(QuantityRequested);
        }
