...
{
    public class MalledhrimHauberkofRejuvenation : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Hauberk of Rejuvenation";

        public MalledhrimHauberkofRejuvenation(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimHauberkofRejuvenation(QuantityRequested);
        }
