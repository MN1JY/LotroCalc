...
{
    public class SilverBasin : SupremeIngredients
    {
        public static string DisplayName = "Silver Basin";

        public SilverBasin(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SilverBasin(QuantityRequested);
        }
