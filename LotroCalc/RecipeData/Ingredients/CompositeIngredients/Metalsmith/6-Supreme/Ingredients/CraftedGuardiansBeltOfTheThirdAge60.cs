...
{
    public class CraftedGuardiansBeltOfTheThirdAge60 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Guardian's Belt Of The Third Age (Level 60)";

        public CraftedGuardiansBeltOfTheThirdAge60(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedGuardiansBeltOfTheThirdAge60(QuantityRequested);
        }
