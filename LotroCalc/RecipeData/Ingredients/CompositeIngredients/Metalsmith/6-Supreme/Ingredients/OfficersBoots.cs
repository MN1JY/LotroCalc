...
{
    public class OfficersBoots : SupremeIngredients
    {
        public static string DisplayName = "Officer's Boots";

        public OfficersBoots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new OfficersBoots(QuantityRequested);
        }
