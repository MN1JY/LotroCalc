...
{
    public class SuperbLothlorienHeavyShield : SupremeIngredients
    {
        public static string DisplayName = "Superb Lothlorien Heavy Shield (Guild)";

        public SuperbLothlorienHeavyShield(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SuperbLothlorienHeavyShield(QuantityRequested);
        }
