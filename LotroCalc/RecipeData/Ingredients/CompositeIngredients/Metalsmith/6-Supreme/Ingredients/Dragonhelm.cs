...
{
    public class Dragonhelm : SupremeIngredients
    {
        public static string DisplayName = "Dragon-helm";

        public Dragonhelm(int count)
        {
            Name = DisplayName;
        ...
        {
            return new Dragonhelm(QuantityRequested);
        }
