...
{
    public class ImprovedBlackenedIronMesh : SupremeIngredients
    {
        public static string DisplayName = "Improved Blackened Iron Mesh (Guild)";

        public ImprovedBlackenedIronMesh(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedBlackenedIronMesh(QuantityRequested);
        }
