...
{
    public class ReforgedGuardiansBeltOfTheSecondAge65 : SupremeIngredients
    {
        public static string DisplayName = "Reforged Guardian's Belt Of The Second Age (Level 65)";

        public ReforgedGuardiansBeltOfTheSecondAge65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ReforgedGuardiansBeltOfTheSecondAge65(QuantityRequested);
        }
