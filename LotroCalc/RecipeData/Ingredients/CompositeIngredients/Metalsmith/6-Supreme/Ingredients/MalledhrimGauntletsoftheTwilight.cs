...
{
    public class MalledhrimGauntletsoftheTwilight : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Gauntlets of the Twilight";

        public MalledhrimGauntletsoftheTwilight(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimGauntletsoftheTwilight(QuantityRequested);
        }
