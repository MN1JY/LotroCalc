...
{
    public class MalledhrimLeggingsoftheAwakened : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Leggings of the Awakened";

        public MalledhrimLeggingsoftheAwakened(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimLeggingsoftheAwakened(QuantityRequested);
        }
