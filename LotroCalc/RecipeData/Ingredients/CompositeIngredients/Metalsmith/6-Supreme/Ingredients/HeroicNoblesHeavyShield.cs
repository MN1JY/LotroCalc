...
{
    public class HeroicNoblesHeavyShield : SupremeIngredients
    {
        public static string DisplayName = "Heroic Noble's Heavy Shield (Guild)";

        public HeroicNoblesHeavyShield(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeroicNoblesHeavyShield(QuantityRequested);
        }
