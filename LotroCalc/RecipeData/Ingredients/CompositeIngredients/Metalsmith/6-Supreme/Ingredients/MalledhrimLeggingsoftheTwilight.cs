...
{
    public class MalledhrimLeggingsoftheTwilight : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Leggings of the Twilight";

        public MalledhrimLeggingsoftheTwilight(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimLeggingsoftheTwilight(QuantityRequested);
        }
