...
{
    public class NoblesBoots : SupremeIngredients
    {
        public static string DisplayName = "Noble's Boots";

        public NoblesBoots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new NoblesBoots(QuantityRequested);
        }
