...
{
    public class HeavyShieldoftheGoldenHost : SupremeIngredients
    {
        public static string DisplayName = "Heavy Shield of the Golden Host";

        public HeavyShieldoftheGoldenHost(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyShieldoftheGoldenHost(QuantityRequested);
        }
