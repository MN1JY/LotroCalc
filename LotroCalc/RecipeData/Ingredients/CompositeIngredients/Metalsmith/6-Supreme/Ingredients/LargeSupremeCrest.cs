...
{
    public class LargeSupremeCrestGuild : SupremeIngredients
    {
        public static string DisplayName = "Large Supreme Crest (Guild)";

        public LargeSupremeCrestGuild(int count)
        {
            Name = DisplayName;
        ...
        {
            return new LargeSupremeCrestGuild(QuantityRequested);
        }
