...
{
    public class CraftedCaptainsEmblemoftheThirdAgeLevel65 : SupremeIngredients
    {
        public static string DisplayName = "Crafted Captain's Emblem of the Third Age (Level 65)";

        public CraftedCaptainsEmblemoftheThirdAgeLevel65(int count)
        {
            Name = DisplayName;
        ...
        {
            return new CraftedCaptainsEmblemoftheThirdAgeLevel65(QuantityRequested);
        }
