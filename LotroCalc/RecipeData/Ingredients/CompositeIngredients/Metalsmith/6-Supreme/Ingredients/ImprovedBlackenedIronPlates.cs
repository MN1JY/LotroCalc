...
{
    public class ImprovedBlackenedIronPlates : SupremeIngredients
    {
        public static string DisplayName = "Improved Blackened Iron Plates (Guild)";

        public ImprovedBlackenedIronPlates(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedBlackenedIronPlates(QuantityRequested);
        }
