...
{
    public class BlackenedBronzeBand : SupremeIngredients
    {
        public static string DisplayName = "Blackened Bronze Band";

        public BlackenedBronzeBand(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BlackenedBronzeBand(QuantityRequested);
        }
