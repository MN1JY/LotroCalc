...
{
    public class HelmetoftheGaladhrim : SupremeIngredients
    {
        public static string DisplayName = "Helmet of the Galadhrim";

        public HelmetoftheGaladhrim(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HelmetoftheGaladhrim(QuantityRequested);
        }
