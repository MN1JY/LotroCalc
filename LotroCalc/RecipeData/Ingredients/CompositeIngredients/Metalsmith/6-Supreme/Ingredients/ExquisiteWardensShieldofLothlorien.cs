...
{
    public class ExquisiteWardensShieldofLothlorien : SupremeIngredients
    {
        public static string DisplayName = "Exquisite Warden's Shield of Lothlorien";

        public ExquisiteWardensShieldofLothlorien(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ExquisiteWardensShieldofLothlorien(QuantityRequested);
        }
