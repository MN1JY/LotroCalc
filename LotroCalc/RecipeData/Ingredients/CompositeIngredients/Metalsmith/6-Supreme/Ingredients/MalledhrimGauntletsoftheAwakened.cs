...
{
    public class MalledhrimGauntletsoftheAwakened : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Gauntlets of the Awakened";

        public MalledhrimGauntletsoftheAwakened(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimGauntletsoftheAwakened(QuantityRequested);
        }
