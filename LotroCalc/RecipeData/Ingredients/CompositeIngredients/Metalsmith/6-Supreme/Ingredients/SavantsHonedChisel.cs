...
{
    public class SavantsHonedChisel : SupremeIngredients
    {
        public static string DisplayName = "Savant's Honed Chisel";

        public SavantsHonedChisel(int count)
        {
            Name = DisplayName;
        ...
        {
            return new SavantsHonedChisel(QuantityRequested);
        }
