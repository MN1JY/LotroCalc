...
{
    public class NoblesHeavyShield : SupremeIngredients
    {
        public static string DisplayName = "Noble's Heavy Shield";

        public NoblesHeavyShield(int count)
        {
            Name = DisplayName;
        ...
        {
            return new NoblesHeavyShield(QuantityRequested);
        }
