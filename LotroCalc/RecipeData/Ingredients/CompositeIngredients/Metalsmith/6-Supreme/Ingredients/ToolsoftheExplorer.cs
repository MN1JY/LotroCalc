...
{
    public class ToolsoftheExplorer : SupremeIngredients
    {
        public static string DisplayName = "Tools of the Explorer";

        public ToolsoftheExplorer(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ToolsoftheExplorer(QuantityRequested);
        }
