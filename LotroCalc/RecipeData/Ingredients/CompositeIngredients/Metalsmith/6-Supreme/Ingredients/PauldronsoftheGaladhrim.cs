...
{
    public class PauldronsoftheGaladhrim : SupremeIngredients
    {
        public static string DisplayName = "Pauldrons of the Galadhrim";

        public PauldronsoftheGaladhrim(int count)
        {
            Name = DisplayName;
        ...
        {
            return new PauldronsoftheGaladhrim(QuantityRequested);
        }
