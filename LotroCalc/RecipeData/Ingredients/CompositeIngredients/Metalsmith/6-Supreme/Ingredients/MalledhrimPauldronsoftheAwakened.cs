...
{
    public class MalledhrimPauldronsoftheAwakened : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Pauldrons of the Awakened";

        public MalledhrimPauldronsoftheAwakened(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimPauldronsoftheAwakened(QuantityRequested);
        }
