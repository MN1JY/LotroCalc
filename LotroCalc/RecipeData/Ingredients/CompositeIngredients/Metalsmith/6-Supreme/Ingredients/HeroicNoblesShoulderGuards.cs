...
{
    public class HeroicNoblesShoulderGuards : SupremeIngredients
    {
        public static string DisplayName = "Heroic Noble's Shoulder Guards (Guild)";

        public HeroicNoblesShoulderGuards(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeroicNoblesShoulderGuards(QuantityRequested);
        }
