...
{
    public class MalledhrimHelmetofRejuvenation : SupremeIngredients
    {
        public static string DisplayName = "Malledhrim Helmet of Rejuvenation";

        public MalledhrimHelmetofRejuvenation(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MalledhrimHelmetofRejuvenation(QuantityRequested);
        }
