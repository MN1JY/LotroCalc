...
{
    public class NoblesLeggings : SupremeIngredients
    {
        public static string DisplayName = "Noble's Leggings";

        public NoblesLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new NoblesLeggings(QuantityRequested);
        }
