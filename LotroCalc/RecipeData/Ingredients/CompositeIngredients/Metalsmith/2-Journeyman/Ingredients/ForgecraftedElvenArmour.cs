...
{
    public class ForgecraftedElvenArmour : JourneymanIngredients
    {
        public static string DisplayName = "Forge-crafted Elven Armour";

        public ForgecraftedElvenArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ForgecraftedElvenArmour(QuantityRequested);
        }
