...
{
    public class IronTailorsTools : JourneymanIngredients
    {
        public static string DisplayName = "Iron Tailor's Tools";

        public IronTailorsTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IronTailorsTools(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.SpoolOfLowGradeSteelWire;
