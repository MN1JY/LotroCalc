...
{
    public class ForgecraftedElvenBoots : JourneymanIngredients
    {
        public static string DisplayName = "Forge-crafted Elven Boots";

        public ForgecraftedElvenBoots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ForgecraftedElvenBoots(QuantityRequested);
        }
