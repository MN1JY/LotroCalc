...
{
    public class IronJewellersTools : JourneymanIngredients
    {
        public static string DisplayName = "Iron Jeweller's Tools";

        public IronJewellersTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IronJewellersTools(QuantityRequested);
        }
