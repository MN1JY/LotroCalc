...
{
    public class IronChainLink : JourneymanIngredients
    {
        public static string DisplayName = "Iron Chain Link";

        public IronChainLink(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IronChainLink(QuantityRequested);
        }
