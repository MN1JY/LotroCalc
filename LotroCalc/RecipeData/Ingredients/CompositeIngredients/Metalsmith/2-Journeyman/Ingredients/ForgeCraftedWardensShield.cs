...
{
    public class ForgeCraftedWardensShield : JourneymanIngredients
    {
        public static string DisplayName = "Forge-Crafted Warden's Shield";

        public ForgeCraftedWardensShield(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ForgeCraftedWardensShield(QuantityRequested);
        }
