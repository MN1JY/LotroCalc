...
{
    public class ForgecraftedDwarfmakeGloves : JourneymanIngredients
    {
        public static string DisplayName = "Forge-crafted Dwarf-make Gloves";

        public ForgecraftedDwarfmakeGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ForgecraftedDwarfmakeGloves(QuantityRequested);
        }
