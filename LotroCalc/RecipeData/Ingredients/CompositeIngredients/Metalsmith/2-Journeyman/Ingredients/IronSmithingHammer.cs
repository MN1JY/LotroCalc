...
{
    public class IronSmithingHammer : JourneymanIngredients
    {
        public static string DisplayName = "Iron Smithing Hammer";

        public IronSmithingHammer(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IronSmithingHammer(QuantityRequested);
        }
