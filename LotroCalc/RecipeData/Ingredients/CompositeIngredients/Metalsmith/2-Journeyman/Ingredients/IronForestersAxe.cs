...
{
    public class IronForestersAxe : JourneymanIngredients
    {
        public static string DisplayName = "Iron Forester's Axe";

        public IronForestersAxe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IronForestersAxe(QuantityRequested);
        }
