...
{
    public class IronWoodworkingTools : JourneymanIngredients
    {
        public static string DisplayName = "Iron Woodworking Tools";

        public IronWoodworkingTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IronWoodworkingTools(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.LowGradeSteelBladeMould;
