...
{
    public class IronScholarsGlass : JourneymanIngredients
    {
        public static string DisplayName = "Iron Scholar's Glass";

        public IronScholarsGlass(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IronScholarsGlass(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.FineGlassLens;
