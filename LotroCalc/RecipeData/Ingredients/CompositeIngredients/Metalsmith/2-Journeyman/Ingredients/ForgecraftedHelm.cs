...
{
    public class ForgecraftedHelm : JourneymanIngredients
    {
        public static string DisplayName = "Forge-crafted Helm";

        public ForgecraftedHelm(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ForgecraftedHelm(QuantityRequested);
        }
