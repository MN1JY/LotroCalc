...
{
    public class ForgecraftedShoulderGuards : JourneymanIngredients
    {
        public static string DisplayName = "Forge-crafted Shoulder Guards";

        public ForgecraftedShoulderGuards(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ForgecraftedShoulderGuards(QuantityRequested);
        }
