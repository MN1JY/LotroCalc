...
{
    public class ForgecraftedArmour : JourneymanIngredients
    {
        public static string DisplayName = "Forge-crafted Armour";

        public ForgecraftedArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ForgecraftedArmour(QuantityRequested);
        }
