...
{
    public class IronCookingSupplies : JourneymanIngredients
    {
        public static string DisplayName = "Iron Cooking Supplies";

        public IronCookingSupplies(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IronCookingSupplies(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.LowGradeSteelCutleryMould;
