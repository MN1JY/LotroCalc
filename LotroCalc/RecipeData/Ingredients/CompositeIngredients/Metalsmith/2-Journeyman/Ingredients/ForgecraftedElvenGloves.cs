...
{
    public class ForgecraftedElvenGloves : JourneymanIngredients
    {
        public static string DisplayName = "Forge-crafted Elven Gloves";

        public ForgecraftedElvenGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ForgecraftedElvenGloves(QuantityRequested);
        }
