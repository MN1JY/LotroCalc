...
{
    public class ForgecraftedBoots : JourneymanIngredients
    {
        public static string DisplayName = "Forge-crafted Boots";

        public ForgecraftedBoots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ForgecraftedBoots(QuantityRequested);
        }
