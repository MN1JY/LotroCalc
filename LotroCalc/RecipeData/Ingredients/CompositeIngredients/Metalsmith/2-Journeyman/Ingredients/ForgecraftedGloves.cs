...
{
    public class ForgecraftedGloves : JourneymanIngredients
    {
        public static string DisplayName = "Forge-crafted Gloves";

        public ForgecraftedGloves(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ForgecraftedGloves(QuantityRequested);
        }
