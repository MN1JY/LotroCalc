...
{
    public class HeavyForgeCraftedKiteShield : JourneymanIngredients
    {
        public static string DisplayName = "Heavy Forge-Crafted Kite Shield";

        public HeavyForgeCraftedKiteShield(int count)
        {
            Name = DisplayName;
        ...
        {
            return new HeavyForgeCraftedKiteShield(QuantityRequested);
        }
