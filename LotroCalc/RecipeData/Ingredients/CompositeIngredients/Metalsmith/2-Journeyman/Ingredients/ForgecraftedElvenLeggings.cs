...
{
    public class ForgecraftedElvenLeggings : JourneymanIngredients
    {
        public static string DisplayName = "Forge-crafted Elven Leggings";

        public ForgecraftedElvenLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ForgecraftedElvenLeggings(QuantityRequested);
        }
