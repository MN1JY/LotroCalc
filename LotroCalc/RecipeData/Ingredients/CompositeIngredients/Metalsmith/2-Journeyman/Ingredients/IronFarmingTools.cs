...
{
    public class IronFarmingTools : JourneymanIngredients
    {
        public static string DisplayName = "Iron Farming Tools";

        public IronFarmingTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new IronFarmingTools(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.LongAshShaft;
