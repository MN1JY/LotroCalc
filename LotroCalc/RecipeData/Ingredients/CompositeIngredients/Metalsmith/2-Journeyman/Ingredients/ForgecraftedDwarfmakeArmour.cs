...
{
    public class ForgecraftedDwarfmakeArmour : JourneymanIngredients
    {
        public static string DisplayName = "Forge-crafted Dwarf-make Armour";

        public ForgecraftedDwarfmakeArmour(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ForgecraftedDwarfmakeArmour(QuantityRequested);
        }
