...
{
    public class ForgecraftedDwarfmakeBoots : JourneymanIngredients
    {
        public static string DisplayName = "Forge-crafted Dwarf-make Boots";

        public ForgecraftedDwarfmakeBoots(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ForgecraftedDwarfmakeBoots(QuantityRequested);
        }
