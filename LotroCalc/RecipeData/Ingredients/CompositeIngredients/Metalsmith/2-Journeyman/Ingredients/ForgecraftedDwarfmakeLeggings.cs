...
{
    public class ForgecraftedDwarfmakeLeggings : JourneymanIngredients
    {
        public static string DisplayName = "Forge-crafted Dwarf-make Leggings";

        public ForgecraftedDwarfmakeLeggings(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ForgecraftedDwarfmakeLeggings(QuantityRequested);
        }
