...
{
    public class DwarfSteelFarmingTools : ArtisanIngredients
    {
        public static string DisplayName = "Dwarf-steel Farming Tools";

        public DwarfSteelFarmingTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DwarfSteelFarmingTools(QuantityRequested);
        }
