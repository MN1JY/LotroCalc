...
{
    public class MediumArtisanCrest : ArtisanIngredients
    {
        public static string DisplayName = "Medium Artisan Crest (Guild)";

        public MediumArtisanCrest(int count)
        {
            Name = DisplayName;
        ...
        {
            return new MediumArtisanCrest(QuantityRequested);
        }
