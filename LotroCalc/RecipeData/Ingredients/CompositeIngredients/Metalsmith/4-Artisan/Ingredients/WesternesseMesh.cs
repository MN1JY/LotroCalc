...
{
    public class WesternesseMesh : ArtisanIngredients
    {
        public static string DisplayName = "Westernesse Mesh";

        public WesternesseMesh(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WesternesseMesh(QuantityRequested);
        }
