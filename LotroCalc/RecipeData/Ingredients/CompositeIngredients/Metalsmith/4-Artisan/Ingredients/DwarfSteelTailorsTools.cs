...
{
    public class DwarfSteelTailorsTools : ArtisanIngredients
    {
        public static string DisplayName = "Dwarf-steel Tailor's Tools";

        public DwarfSteelTailorsTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DwarfSteelTailorsTools(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.SpoolOfDwarfSteelWire;
