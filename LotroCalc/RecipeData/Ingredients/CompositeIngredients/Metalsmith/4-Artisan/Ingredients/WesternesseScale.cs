...
{
    public class WesternesseScale : ArtisanIngredients
    {
        public static string DisplayName = "Westernesse Scale";

        public WesternesseScale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new WesternesseScale(QuantityRequested);
        }
