...
{
    public class DwarfSteelForestersAxe : ArtisanIngredients
    {
        public static string DisplayName = "Dwarf-steel Forester's Axe";

        public DwarfSteelForestersAxe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DwarfSteelForestersAxe(QuantityRequested);
        }
