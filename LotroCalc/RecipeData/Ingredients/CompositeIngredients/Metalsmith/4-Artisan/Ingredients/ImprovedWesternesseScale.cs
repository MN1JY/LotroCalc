...
{
    public class ImprovedWesternesseScale : ArtisanIngredients
    {
        public static string DisplayName = "Improved Westernesse Scale (Guild)";

        public ImprovedWesternesseScale(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedWesternesseScale(QuantityRequested);
        }
