...
{
    public class DwarfSteelProspectorsTools : ArtisanIngredients
    {
        public static string DisplayName = "Dwarf-steel Prospector's Tools";

        public DwarfSteelProspectorsTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DwarfSteelProspectorsTools(QuantityRequested);
        }
