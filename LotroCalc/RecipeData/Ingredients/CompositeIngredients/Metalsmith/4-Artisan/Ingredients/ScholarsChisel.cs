...
{
    public class ScholarsChisel : ArtisanIngredients
    {
        public static string DisplayName = "Scholar's Chisel";

        public ScholarsChisel(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ScholarsChisel(QuantityRequested);
        }
