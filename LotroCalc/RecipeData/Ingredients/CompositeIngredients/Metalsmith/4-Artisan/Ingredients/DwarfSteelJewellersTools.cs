...
{
    public class DwarfSteelJewellersTools : ArtisanIngredients
    {
        public static string DisplayName = "Dwarf-steel Jeweller's Tools";

        public DwarfSteelJewellersTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DwarfSteelJewellersTools(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.ShortLebethronShaft;
