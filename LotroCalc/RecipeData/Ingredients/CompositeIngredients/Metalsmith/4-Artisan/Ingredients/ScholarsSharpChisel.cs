...
{
    public class ScholarsSharpChisel : ArtisanIngredients
    {
        public static string DisplayName = "Scholar's Sharp Chisel";

        public ScholarsSharpChisel(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ScholarsSharpChisel(QuantityRequested);
        }
