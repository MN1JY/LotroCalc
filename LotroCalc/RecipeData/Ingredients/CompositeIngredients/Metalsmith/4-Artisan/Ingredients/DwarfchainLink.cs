...
{
    public class DwarfchainLink : ArtisanIngredients
    {
        public static string DisplayName = "Dwarf-chain Link";

        public DwarfchainLink(int count)
        {
            Name = DisplayName;
        ...
        {
            return new DwarfchainLink(QuantityRequested);
        }
