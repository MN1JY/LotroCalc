...
{
    public class ImprovedWesternesseMesh : ArtisanIngredients
    {
        public static string DisplayName = "Improved Westernesse Mesh (Guild)";

        public ImprovedWesternesseMesh(int count)
        {
            Name = DisplayName;
        ...
        {
            return new ImprovedWesternesseMesh(QuantityRequested);
        }
