...
{
    public class BronzeForestersAxe : ApprenticeIngredients
    {
        public static string DisplayName = "Bronze Forester's Axe";

        public BronzeForestersAxe(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BronzeForestersAxe(QuantityRequested);
        }
