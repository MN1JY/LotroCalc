...
{
    public class BronzeChainLinks : ApprenticeIngredients
    {
        public static string DisplayName = "Bronze Chain Link";

        public BronzeChainLinks(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BronzeChainLinks(QuantityRequested);
        }
