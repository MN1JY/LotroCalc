...
{
    public class BronzeFarmingTools : ApprenticeIngredients
    {
        public static string DisplayName = "Bronze Farming Tools";

        public BronzeFarmingTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BronzeFarmingTools(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.LongRowanShaft;
