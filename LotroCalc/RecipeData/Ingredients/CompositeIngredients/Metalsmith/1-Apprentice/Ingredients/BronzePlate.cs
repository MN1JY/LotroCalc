...
{
    public class BronzePlate : ApprenticeIngredients
    {
        public static string DisplayName = "Bronze Plate";

        public BronzePlate(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BronzePlate(QuantityRequested);
        }
