...
{
    public class BronzeJewellersTools : ApprenticeIngredients
    {
        public static string DisplayName = "Bronze Jeweller's Tools";

        public BronzeJewellersTools(int count)
        {
            Name = DisplayName;
        ...
        {
            return new BronzeJewellersTools(QuantityRequested);
        }
        ...
        public override SortedDictionary<string, Ingredient> GetRecipeIngredients()
        {
            ...
            ingName = SupplierIngredients.ShortRowanShaft;
